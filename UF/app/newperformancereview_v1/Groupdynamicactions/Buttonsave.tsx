 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      ...
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "d688887c7b759b7f518a7234f7502eeb"
      );
    ...
    if(orchestrationData?.data?.rule?.nodes?.length > 0){
      ...
      if("save" in dynamicactions31354Props?.dynamicActionRule){
        setShowFlag(true)
        setStyleSate({...getGridPositionFromOrder(dynamicactions31354Props?.dynamicActionRule?.save,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }
      else
      {
        setShowFlag(false)   
      ...
      if("save" in newperformancereview_v1?.dynamicactions && newperformancereview_v1?.dynamicactions["save"]?.itsHaveArtifact== true)
      {
        setShowFlag(newperformancereview_v1?.dynamicactions["save"]?.show||false)
        
        setStyleSate({...getGridPositionFromOrder(newperformancereview_v1?.dynamicactions?.save?.order,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }else{
        setShowFlag(false)
      }
    }
  ...
  useEffect(()=>{
    ...
    const triggerElementHandler = async (id:any) => {
      if (id === "d688887c7b759b7f518a7234f7502eeb") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "save02eeb");
    return () => {
  ...
  useEffect(()=>{
    if (!save02eeb?.trigger) return;
      if(save02eeb?.trigger){
      setsave02eeb((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
  ...
  async function handleSave2eeb_1_1_1(){
      

  setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    await delay(1000); 

    const dynamicactions31354Props = dynamicactions31354PropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.newPerformanceReview_v1 || {}).some(val => {
    ...
    try{
      ...
      let mainData:any=structuredClone(dynamicactions31354Ref.current);
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addPerformanceReview:AFVK:v1|6235d6b4e27e33eceb1d1fac6007a2b6"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addPerformanceReview:AFVK:v1|6235d6b4e27e33eceb1d1fac6007a2b6"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "d688887c7b759b7f518a7234f7502eeb",
  "type": "button",
  "name": "save",
  "label": "save",
  "sequence": 1,
  "children": [
    {
      "id": "d688887c7b759b7f518a7234f7502eeb.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "d688887c7b759b7f518a7234f7502eeb.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "d688887c7b759b7f518a7234f7502eeb.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
            ...
            {
              "id": "d688887c7b759b7f518a7234f7502eeb.1.1.1.2",
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addPerformanceReview:AFVK:v1|6235d6b4e27e33eceb1d1fac6007a2b6"
          ]
        }
      ]
    }
      ...
      let sourceId : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:newPerformanceReview:AFVK:v1";
      sourceId+= "|"+"8e89aca3256313c5db76b7b1e3731354";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:newPerformanceReview:AFVK:v1"+"|"+"8e89aca3256313c5db76b7b1e3731354"+"|"+eventProperty.id;
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...dynamicactions31354Ref.current, ...nullFilter(new_access_groupfa034), ...nullFilter(access_req__groupdb1de), ...nullFilter(valid_groupb4569), ...nullFilter(addt__group82d26), ...nullFilter(addt__dts_group7fd81) });
    let reworkKeys:any[]=[];
    ...
    if("_groupArrays_" in reworkedObject )
    {
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"8e89aca3256313c5db76b7b1e3731354",
              controlId:"d688887c7b759b7f518a7234f7502eeb"
            };
            if (encryptionFlagCont) {
        ...
        if(dynamicactions31354?.upId){
          te_saveBody['upId']= dynamicactions31354?.upId;
        }
        if(dynamicactions31354?.upid){
          te_saveBody['upId']= dynamicactions31354?.upid;
        }
        ...
        if (dynamicactions31354Props.ssKey !== '' && dynamicactions31354Props.ssKey !== undefined) {
          te_saveBody["ssKey"] = dynamicactions31354Props.ssKey;
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdynamicactions31354((prev: any) => ({ ...prev, save: true }));
        //onClick

    //saveHandler
    await handleSave2eeb_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdynamicactions31354((prev: any) => ({ ...prev, save: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
  ...
  }, [newperformancereview_v1?.dynamicactions?.save,dynamicactions31354Props?.dynamicActionRule?.save,])

 if (save02eeb?.isHidden) {
    return <></>
  }
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='normal'
          disabled= {save02eeb?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
