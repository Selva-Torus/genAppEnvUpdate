...
const Progressmanager_rating_progress = ({encryptionFlagCompData, isDynamic, index, item,setIsProcessing,controlData}:any) => { 
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "e8b4ac1d325f4808ae2f5fc756fa49aa"
      );
  ...
  useEffect(()=>{
    handleMapperValue()
  },[manager_rating_progressa49aa?.refresh])

  if (manager_rating_progressa49aa?.isHidden) {
    return <></>
  }

return (
  <div 
    style={{gridColumn: `7 / 24`,gridRow: `16 / 23`, gap:``, height: `100%`, overflow: 'auto'}} >
    <Progress 
      className=""
        theme = {'misc'}
        value = {90}
...
export default Progressmanager_rating_progress
