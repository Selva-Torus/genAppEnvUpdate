...
const Textfinancial_dtls_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {financial_dtls_text3451fProps, setfinancial_dtls_text3451fProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[financial_dtls_text3451f?.refresh])

  if (financial_dtls_text3451f?.isHidden) {
    return <></>
  }
