...
const TextInputinterest = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:LAP:AFGK:LAP:AFK:viewCase:AFVK:v1|7371fc8250b615220e8d394f4c4ed0d9|4c1e36f427e92cda7167a9bdd29a6b7d"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,viewCase_v1:{...pre?.viewCase_v1,interest:undefined}}));
    if(dynamicStateandType.type=="number"){
    setfinancial_details_grouped0d9((prev: any) => ({ ...prev, interest: +e.target.value }));
    }
    else{
    setfinancial_details_grouped0d9((prev: any) => ({ ...prev, interest: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "4c1e36f427e92cda7167a9bdd29a6b7d"
      );
      ...
      //     controlId: "4c1e36f427e92cda7167a9bdd29a6b7d",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "4c1e36f427e92cda7167a9bdd29a6b7d") {
        handleChange({target:{value:financial_details_grouped0d9Ref?.current?.interest||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "4c1e36f427e92cda7167a9bdd29a6b7d") {
        handleBlur({target:{value:financial_details_grouped0d9Ref?.current?.interest||""}});
      }
    };
  ...
  if(dfd_addcase_v1Props?.setSearchFilters && dfd_addcase_v1Props?.data)
  {
    if(Array.isArray(dfd_addcase_v1Props.data) && dfd_addcase_v1Props.data.length > 0){
      setfinancial_details_grouped0d9((pre:any)=>({...pre,interest:dfd_addcase_v1Props.data[0]?.interest}));
    }
  }
  },[dfd_addcase_v1Props?.setSearchFilters])
  if (interesta6b7d?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={financial_details_grouped0d9?.interest||""}
         disabled= {interesta6b7d?.isDisabled ? true : false}
        pin='brick-brick'     
        placeholder='$ 0.00'      
        readOnly={true}
        view='normal'
        ...
        headerText="Interest"
      errorMessage={error}
        validationState={validate?.viewCase_v1?.interest ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
