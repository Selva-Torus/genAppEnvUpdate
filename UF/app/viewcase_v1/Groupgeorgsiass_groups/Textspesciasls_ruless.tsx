...
const Textspesciasls_ruless = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {spesciasls_ruless910f1Props, setspesciasls_ruless910f1Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[spesciasls_ruless910f1?.refresh])

  if (spesciasls_ruless910f1?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `13 / 55`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className="!p-1"
  variant="subheader-3"
  color="primary"
>
      {keyset("Verifies claims involving written contracts in Florida and determines whether they are enforceable based on the state's 5-year statute of limitations.")}
</Text>
  </div>
  )
}

export default Textspesciasls_ruless
