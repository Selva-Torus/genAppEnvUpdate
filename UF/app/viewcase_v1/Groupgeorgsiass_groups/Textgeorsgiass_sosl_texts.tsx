...
const Textgeorsgiass_sosl_texts = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {georsgiass_sosl_texts15f5eProps, setgeorsgiass_sosl_texts15f5eProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[georsgiass_sosl_texts15f5e?.refresh])

  if (georsgiass_sosl_texts15f5e?.isHidden) {
    return <></>
  }
