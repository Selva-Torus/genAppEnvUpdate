...
const Textven_name_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {ven_name_text0c8baProps, setven_name_text0c8baProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[ven_name_text0c8ba?.refresh])

  if (ven_name_text0c8ba?.isHidden) {
    return <></>
  }
