...
const Textdebt_info_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {debt_info_textb09b8Props, setdebt_info_textb09b8Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[debt_info_textb09b8?.refresh])

  if (debt_info_textb09b8?.isHidden) {
    return <></>
  }
...
export default Textdebt_info_text
