...
const Textgeorgia_sol_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {georgia_sol_text460efProps, setgeorgia_sol_text460efProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[georgia_sol_text460ef?.refresh])

  if (georgia_sol_text460ef?.isHidden) {
    return <></>
  }
