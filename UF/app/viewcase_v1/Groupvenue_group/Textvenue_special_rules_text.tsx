...
const Textvenue_special_rules_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {venue_special_rules_textecd92Props, setvenue_special_rules_textecd92Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[venue_special_rules_textecd92?.refresh])

  if (venue_special_rules_textecd92?.isHidden) {
    return <></>
  }
