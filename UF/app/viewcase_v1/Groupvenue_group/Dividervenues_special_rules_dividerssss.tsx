...
const Dividervenues_special_rules_dividerssss = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[venues_special_rules_dividerssss44419?.refresh])

  if (venues_special_rules_dividerssss44419?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 25`,gridRow: `241 / 244`, gap:``, height: `100%`}} >
<Divider
  className=""
