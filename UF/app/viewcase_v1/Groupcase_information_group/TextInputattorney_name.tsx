...
const TextInputattorney_name = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const [dynamicStateandType,setDynamicStateandType]=useState<Record<string, any>>({name:'attorney_name',type:"text"})
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,viewCase_v1:{...pre?.viewCase_v1,attorney_name:undefined}}));
    if(dynamicStateandType.type=="number"){
    setcase_information_groupcec29((prev: any) => ({ ...prev, attorney_name: +e.target.value }));
    }
    else{
    setcase_information_groupcec29((prev: any) => ({ ...prev, attorney_name: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "a1438af6d7ab4fc89b56bbfa4ef87be1"
      );
      ...
      //     controlId: "a1438af6d7ab4fc89b56bbfa4ef87be1",
      //     isTable: false,
      //     from:"TextInputattorney_name",
      ...
      if (orchestrationData?.data?.dataType ==='integer' || orchestrationData?.data?.dataType ==='number') {
        setDynamicStateandType({name:'attorney_name', type: 'number'});
      }
      // if(orchestrationData?.data?.schemaData?.at(0)?.nodeType=='apinode'){
      // if(orchestrationData?.data?.schemaData?.at(0)?.schema.responses["200"].content["application/json"].schema.items.properties){
      //   let type:any={name:'attorney_name',type:'text'};
      //   type={
      //     name:'attorney_name',
      //     type: orchestrationData?.data?.schemaData?.at(0)?.schema.responses["200"].content["application/json"].schema.items.properties.attorney_name.type == 'string' ? 'text' : orchestrationData?.data?.schemaData?.at(0)?.schema.responses["200"].content["application/json"].schema.items.properties.attorney_name.type =='integer' ? 'number' : orchestrationData?.data?.schemaData?.at(0)?.schema.responses["200"].content["application/json"].schema.items.properties.attorney_name.type
      //   }
      ...
      //   type={
      //     name:'attorney_name',
      //     type: orchestrationData?.data?.schemaData?.at(0)?.schema.properties.attorney_name.type == 'string' ? 'text' : orchestrationData?.data?.schemaData?.at(0)?.schema.properties.attorney_name.type =='integer' ? 'number' : orchestrationData?.data?.schemaData?.at(0)?.schema.properties.attorney_name.type
      //   }
      //   setDynamicStateandType(type);
      // }
      // }
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "a1438af6d7ab4fc89b56bbfa4ef87be1") {
        handleChange({target:{value:case_information_groupcec29Ref?.current?.attorney_name||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "a1438af6d7ab4fc89b56bbfa4ef87be1") {
        handleBlur({target:{value:case_information_groupcec29Ref?.current?.attorney_name||""}});
      }
    };
  ...
  if (attorney_name87be1?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={case_information_groupcec29?.attorney_name||""}
         disabled= {attorney_name87be1?.isDisabled ? true : false}
        pin='brick-brick'     
        ...
        contentAlign={"left"}
        headerPosition='top'
        headerText="Assigned Attorney"
      errorMessage={error}
        validationState={validate?.viewCase_v1?.attorney_name ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
...
export default TextInputattorney_name
