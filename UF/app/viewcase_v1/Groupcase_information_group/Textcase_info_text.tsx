...
const Textcase_info_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {case_info_textdf3f1Props, setcase_info_textdf3f1Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[case_info_textdf3f1?.refresh])

  if (case_info_textdf3f1?.isHidden) {
    return <></>
  }
