...
const Textreeq_doc_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {reeq_doc_text732f8Props, setreeq_doc_text732f8Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[reeq_doc_text732f8?.refresh])

  if (reeq_doc_text732f8?.isHidden) {
    return <></>
  }
