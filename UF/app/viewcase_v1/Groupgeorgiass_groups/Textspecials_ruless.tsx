...
const Textspecials_ruless = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {specials_ruless95686Props, setspecials_ruless95686Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[specials_ruless95686?.refresh])

  if (specials_ruless95686?.isHidden) {
    return <></>
  }
