...
const Textgeorgiass_sosl_texts = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {georgiass_sosl_texts88097Props, setgeorgiass_sosl_texts88097Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[georgiass_sosl_texts88097?.refresh])

  if (georgiass_sosl_texts88097?.isHidden) {
    return <></>
  }
