...
const Textgeorgias_sosl_texts = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {georgias_sosl_texts3f264Props, setgeorgias_sosl_texts3f264Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[georgias_sosl_texts3f264?.refresh])

  if (georgias_sosl_texts3f264?.isHidden) {
    return <></>
  }
