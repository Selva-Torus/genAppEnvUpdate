...
const Textspecials_ruless = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {specials_rulesscc30fProps, setspecials_rulesscc30fProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[specials_rulesscc30f?.refresh])

  if (specials_rulesscc30f?.isHidden) {
    return <></>
  }
