...
const TextInputtextinput123123 = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const handleChange = async(e: any) => {
    ...
    setgrouparray81c1a_1((prev: any) => ({ ...prev, textinput123123: +e.target.value }));
    }
    else{
    setgrouparray81c1a_1((prev: any) => ({ ...prev, textinput123123: e.target.value }));
    }
  ...
  const grouparray81c1a_1Ref = useRef<any>(grouparray81c1a_1);
  useEffect(() => { grouparray81c1a_1Ref.current = grouparray81c1a_1; }, [grouparray81c1a_1]);
  useEffect(()=>{
      handleMapperValue();
    ...
    const handlerChange = (id:any) => {
      if (id === "7c1d33069a16415f8ddfe82d554539f0") {
        handleChange({target:{value:grouparray81c1a_1Ref?.current?.textinput123123||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "7c1d33069a16415f8ddfe82d554539f0") {
        handleBlur({target:{value:grouparray81c1a_1Ref?.current?.textinput123123||""}});
      }
    };
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={grouparray81c1a_1?.textinput123123||""}
