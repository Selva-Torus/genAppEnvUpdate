...
const TextInputmanufacturer = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:newAssetView:AFVK:v1|13d6f9aca9f08ad0e2052fe4913cc113|bf6b44eb00b7596a7ab9d02c8d5825e8"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,newAssetView_v1:{...pre?.newAssetView_v1,manufacturer:undefined}}));
    if(dynamicStateandType.type=="number"){
    setasset_info_groupcc113((prev: any) => ({ ...prev, manufacturer: +e.target.value }));
    }
    else{
    setasset_info_groupcc113((prev: any) => ({ ...prev, manufacturer: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "bf6b44eb00b7596a7ab9d02c8d5825e8"
      );
      ...
      //     controlId: "bf6b44eb00b7596a7ab9d02c8d5825e8",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "bf6b44eb00b7596a7ab9d02c8d5825e8") {
        handleChange({target:{value:asset_info_groupcc113Ref?.current?.manufacturer||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "bf6b44eb00b7596a7ab9d02c8d5825e8") {
        handleBlur({target:{value:asset_info_groupcc113Ref?.current?.manufacturer||""}});
      }
    };
  ...
  if(dfd_assets_v1Props?.setSearchFilters && dfd_assets_v1Props?.data)
  {
    if(Array.isArray(dfd_assets_v1Props.data) && dfd_assets_v1Props.data.length > 0){
      setasset_info_groupcc113((pre:any)=>({...pre,manufacturer:dfd_assets_v1Props.data[0]?.manufacturer}));
    }
  }
  },[dfd_assets_v1Props?.setSearchFilters])
  if (manufacturer825e8?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={asset_info_groupcc113?.manufacturer||""}
         disabled= {manufacturer825e8?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.newAssetView_v1?.manufacturer ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
