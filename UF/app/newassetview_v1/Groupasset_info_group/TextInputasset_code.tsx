...
const TextInputasset_code = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:newAssetView:AFVK:v1|13d6f9aca9f08ad0e2052fe4913cc113|d21c9f9fc769e0a2416aa9e56899d69b"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,newAssetView_v1:{...pre?.newAssetView_v1,asset_code:undefined}}));
    if(dynamicStateandType.type=="number"){
    setasset_info_groupcc113((prev: any) => ({ ...prev, asset_code: +e.target.value }));
    }
    else{
    setasset_info_groupcc113((prev: any) => ({ ...prev, asset_code: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "d21c9f9fc769e0a2416aa9e56899d69b"
      );
      ...
      //     controlId: "d21c9f9fc769e0a2416aa9e56899d69b",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "d21c9f9fc769e0a2416aa9e56899d69b") {
        handleChange({target:{value:asset_info_groupcc113Ref?.current?.asset_code||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "d21c9f9fc769e0a2416aa9e56899d69b") {
        handleBlur({target:{value:asset_info_groupcc113Ref?.current?.asset_code||""}});
      }
    };
  ...
  if(dfd_assets_v1Props?.setSearchFilters && dfd_assets_v1Props?.data)
  {
    if(Array.isArray(dfd_assets_v1Props.data) && dfd_assets_v1Props.data.length > 0){
      setasset_info_groupcc113((pre:any)=>({...pre,asset_code:dfd_assets_v1Props.data[0]?.asset_code}));
    }
  }
  },[dfd_assets_v1Props?.setSearchFilters])
  if (asset_code9d69b?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={asset_info_groupcc113?.asset_code||""}
         disabled= {asset_code9d69b?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.newAssetView_v1?.asset_code ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
