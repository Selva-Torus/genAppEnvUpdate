...
const TextInputdisposal_method = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      "sourceKey": [
        "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:AMS:AFK:assets:AFVK:v1|19752269565d4be2be63be1bd8cf4ff6|properties.disposal_method"
      ],
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:newAssetView:AFVK:v1|dce7d099650788e566ce578dc2067f77|4234d17ff560404bb53a3e6357e1fd3c"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,newAssetView_v1:{...pre?.newAssetView_v1,disposal_method:undefined}}));
    if(dynamicStateandType.type=="number"){
    setdisposal_details_group67f77((prev: any) => ({ ...prev, disposal_method: +e.target.value }));
    }
    else{
    setdisposal_details_group67f77((prev: any) => ({ ...prev, disposal_method: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "4234d17ff560404bb53a3e6357e1fd3c"
      );
      ...
      //     controlId: "4234d17ff560404bb53a3e6357e1fd3c",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "4234d17ff560404bb53a3e6357e1fd3c") {
        handleChange({target:{value:disposal_details_group67f77Ref?.current?.disposal_method||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "4234d17ff560404bb53a3e6357e1fd3c") {
        handleBlur({target:{value:disposal_details_group67f77Ref?.current?.disposal_method||""}});
      }
    };
  ...
  if(dfd_assets_v1Props?.setSearchFilters && dfd_assets_v1Props?.data)
  {
    if(Array.isArray(dfd_assets_v1Props.data) && dfd_assets_v1Props.data.length > 0){
      setdisposal_details_group67f77((pre:any)=>({...pre,disposal_method:dfd_assets_v1Props.data[0]?.disposal_method}));
    }
  }
  },[dfd_assets_v1Props?.setSearchFilters])
  if (disposal_method1fd3c?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={disposal_details_group67f77?.disposal_method||""}
         disabled= {disposal_method1fd3c?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.newAssetView_v1?.disposal_method ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
