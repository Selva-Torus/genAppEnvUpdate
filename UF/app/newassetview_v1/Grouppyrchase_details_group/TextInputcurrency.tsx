...
const TextInputcurrency = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      "sourceKey": [
        "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:AMS:AFK:assets:AFVK:v1|19752269565d4be2be63be1bd8cf4ff6|properties.currency"
      ],
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:newAssetView:AFVK:v1|50a619a1af5a843efc63dd18a4ac3900|818b7c3183664f119852b2ef27b0f0b1"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,newAssetView_v1:{...pre?.newAssetView_v1,currency:undefined}}));
    if(dynamicStateandType.type=="number"){
    setpyrchase_details_groupc3900((prev: any) => ({ ...prev, currency: +e.target.value }));
    }
    else{
    setpyrchase_details_groupc3900((prev: any) => ({ ...prev, currency: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "818b7c3183664f119852b2ef27b0f0b1"
      );
      ...
      //     controlId: "818b7c3183664f119852b2ef27b0f0b1",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "818b7c3183664f119852b2ef27b0f0b1") {
        handleChange({target:{value:pyrchase_details_groupc3900Ref?.current?.currency||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "818b7c3183664f119852b2ef27b0f0b1") {
        handleBlur({target:{value:pyrchase_details_groupc3900Ref?.current?.currency||""}});
      }
    };
  ...
  if(dfd_assets_v1Props?.setSearchFilters && dfd_assets_v1Props?.data)
  {
    if(Array.isArray(dfd_assets_v1Props.data) && dfd_assets_v1Props.data.length > 0){
      setpyrchase_details_groupc3900((pre:any)=>({...pre,currency:dfd_assets_v1Props.data[0]?.currency}));
    }
  }
  },[dfd_assets_v1Props?.setSearchFilters])
  if (currency0f0b1?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={pyrchase_details_groupc3900?.currency||""}
         disabled= {currency0f0b1?.isDisabled ? true : false}
        pin='brick-brick'     
        readOnly={true}
        view='normal'
        contentAlign={"left"}
        ...
        headerText="Currency"
      errorMessage={error}
        validationState={validate?.newAssetView_v1?.currency ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
