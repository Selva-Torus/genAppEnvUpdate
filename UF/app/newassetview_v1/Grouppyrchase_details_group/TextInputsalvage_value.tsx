...
const TextInputsalvage_value = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:newAssetView:AFVK:v1|50a619a1af5a843efc63dd18a4ac3900|db60a25848fa8879a3b95b8e09e9adb6"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,newAssetView_v1:{...pre?.newAssetView_v1,salvage_value:undefined}}));
    if(dynamicStateandType.type=="number"){
    setpyrchase_details_groupc3900((prev: any) => ({ ...prev, salvage_value: +e.target.value }));
    }
    else{
    setpyrchase_details_groupc3900((prev: any) => ({ ...prev, salvage_value: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "db60a25848fa8879a3b95b8e09e9adb6"
      );
      ...
      //     controlId: "db60a25848fa8879a3b95b8e09e9adb6",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "db60a25848fa8879a3b95b8e09e9adb6") {
        handleChange({target:{value:pyrchase_details_groupc3900Ref?.current?.salvage_value||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "db60a25848fa8879a3b95b8e09e9adb6") {
        handleBlur({target:{value:pyrchase_details_groupc3900Ref?.current?.salvage_value||""}});
      }
    };
  ...
  if(dfd_assets_v1Props?.setSearchFilters && dfd_assets_v1Props?.data)
  {
    if(Array.isArray(dfd_assets_v1Props.data) && dfd_assets_v1Props.data.length > 0){
      setpyrchase_details_groupc3900((pre:any)=>({...pre,salvage_value:dfd_assets_v1Props.data[0]?.salvage_value}));
    }
  }
  },[dfd_assets_v1Props?.setSearchFilters])
  if (salvage_value9adb6?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={pyrchase_details_groupc3900?.salvage_value||""}
         disabled= {salvage_value9adb6?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.newAssetView_v1?.salvage_value ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
