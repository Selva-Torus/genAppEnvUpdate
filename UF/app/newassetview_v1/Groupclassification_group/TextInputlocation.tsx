...
const TextInputlocation = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const handleChange = async(e: any) => {
    ...
    setclassification_groupd9d65((prev: any) => ({ ...prev, location: +e.target.value }));
    }
    else{
    setclassification_groupd9d65((prev: any) => ({ ...prev, location: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "860ba9ab7fbb4ec58cea1acd8ce323da"
      );
      ...
      //     controlId: "860ba9ab7fbb4ec58cea1acd8ce323da",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "860ba9ab7fbb4ec58cea1acd8ce323da") {
        handleChange({target:{value:classification_groupd9d65Ref?.current?.location||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "860ba9ab7fbb4ec58cea1acd8ce323da") {
        handleBlur({target:{value:classification_groupd9d65Ref?.current?.location||""}});
      }
    };
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={classification_groupd9d65?.location||""}
         disabled= {location323da?.isDisabled ? true : false}
        pin='brick-brick'     
