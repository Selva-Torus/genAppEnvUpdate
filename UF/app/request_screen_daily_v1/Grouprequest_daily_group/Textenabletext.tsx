...
const Textenabletext = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[enabletextb4878?.refresh])

  if (enabletextb4878?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `18 / 24`,gridRow: `124 / 134`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-3"
  color="primary"
>
      {keyset("Enable Description")}
</Text>
  </div>
  )
}

export default Textenabletext
