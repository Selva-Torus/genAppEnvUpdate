...
const Textdaily_expense = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[daily_expensefb8cc?.refresh])

  if (daily_expensefb8cc?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `4 / 14`,gridRow: `1 / 10`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="display-1"
...
export default Textdaily_expense
