...
const Textuuid_op_setlmnt = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {uuid_op_setlmntffbc8Props, setuuid_op_setlmntffbc8Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[uuid_op_setlmntffbc8?.refresh])

  if (uuid_op_setlmntffbc8?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 6`,gridRow: `30 / 37`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=""
  variant="subheader-2"
...
export default Textuuid_op_setlmnt
