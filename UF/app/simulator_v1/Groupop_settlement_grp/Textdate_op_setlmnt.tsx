...
const Textdate_op_setlmnt = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {date_op_setlmntaf3c2Props, setdate_op_setlmntaf3c2Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[date_op_setlmntaf3c2?.refresh])

  if (date_op_setlmntaf3c2?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 6`,gridRow: `21 / 28`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=""
  variant="subheader-2"
...
export default Textdate_op_setlmnt
