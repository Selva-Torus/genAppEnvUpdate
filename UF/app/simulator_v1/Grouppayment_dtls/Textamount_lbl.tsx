...
const Textamount_lbl = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {amount_lblc3248Props, setamount_lblc3248Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[amount_lblc3248?.refresh])

  if (amount_lblc3248?.isHidden) {
    return <></>
  }
