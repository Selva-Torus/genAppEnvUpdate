...
const Textpayment_info = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {payment_info0041bProps, setpayment_info0041bProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[payment_info0041b?.refresh])

  if (payment_info0041b?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 5`,gridRow: `1 / 6`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=""
  variant="header-2"
...
export default Textpayment_info
