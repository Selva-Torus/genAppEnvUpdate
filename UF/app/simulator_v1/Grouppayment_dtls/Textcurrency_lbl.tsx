...
const Textcurrency_lbl = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {currency_lbl99714Props, setcurrency_lbl99714Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[currency_lbl99714?.refresh])

  if (currency_lbl99714?.isHidden) {
    return <></>
  }
...
export default Textcurrency_lbl
