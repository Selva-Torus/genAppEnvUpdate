...
const Textaddtional_info = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {addtional_info60a69Props, setaddtional_info60a69Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[addtional_info60a69?.refresh])

  if (addtional_info60a69?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 6`,gridRow: `1 / 6`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=""
  variant="header-2"
