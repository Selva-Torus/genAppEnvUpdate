...
const Textremittance_lbl = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {remittance_lbl3a5c2Props, setremittance_lbl3a5c2Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[remittance_lbl3a5c2?.refresh])

  if (remittance_lbl3a5c2?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 7`,gridRow: `8 / 11`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=""
  variant="subheader-3"
  color="primary"
>
      {keyset("Remittance Information")}
</Text>
  </div>
  )
}

export default Textremittance_lbl
