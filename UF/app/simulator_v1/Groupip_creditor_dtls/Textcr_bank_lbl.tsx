...
const Textcr_bank_lbl = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {cr_bank_lble07fcProps, setcr_bank_lble07fcProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[cr_bank_lble07fc?.refresh])

  if (cr_bank_lble07fc?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 7`,gridRow: `20 / 23`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=""
  variant="subheader-3"
...
export default Textcr_bank_lbl
