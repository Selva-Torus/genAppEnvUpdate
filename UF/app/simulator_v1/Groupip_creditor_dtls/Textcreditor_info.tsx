...
const Textcreditor_info = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {creditor_info1146fProps, setcreditor_info1146fProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[creditor_info1146f?.refresh])

  if (creditor_info1146f?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 6`,gridRow: `1 / 5`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=""
  variant="header-1"
...
export default Textcreditor_info
