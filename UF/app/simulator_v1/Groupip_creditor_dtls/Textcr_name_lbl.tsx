...
const Textcr_name_lbl = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {cr_name_lbla2539Props, setcr_name_lbla2539Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[cr_name_lbla2539?.refresh])

  if (cr_name_lbla2539?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 7`,gridRow: `14 / 17`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=""
  variant="subheader-3"
...
export default Textcr_name_lbl
