...
const Textdebtor_info = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {debtor_info5fbb6Props, setdebtor_info5fbb6Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[debtor_info5fbb6?.refresh])

  if (debtor_info5fbb6?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 6`,gridRow: `1 / 4`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=""
  variant="header-1"
...
export default Textdebtor_info
