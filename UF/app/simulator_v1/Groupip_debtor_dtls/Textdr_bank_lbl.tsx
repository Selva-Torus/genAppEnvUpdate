...
const Textdr_bank_lbl = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {dr_bank_lbl81c4cProps, setdr_bank_lbl81c4cProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[dr_bank_lbl81c4c?.refresh])

  if (dr_bank_lbl81c4c?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 6`,gridRow: `14 / 17`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=""
  variant="subheader-2"
...
export default Textdr_bank_lbl
