...
const Textuuid_op_financ = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {uuid_op_financb7282Props, setuuid_op_financb7282Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[uuid_op_financb7282?.refresh])

  if (uuid_op_financb7282?.isHidden) {
    return <></>
  }
...
export default Textuuid_op_financ
