...
const Textdate_op_fianc = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {date_op_fianc516b0Props, setdate_op_fianc516b0Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[date_op_fianc516b0?.refresh])

  if (date_op_fianc516b0?.isHidden) {
    return <></>
  }
...
export default Textdate_op_fianc
