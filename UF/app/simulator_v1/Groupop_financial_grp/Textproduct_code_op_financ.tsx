...
const Textproduct_code_op_financ = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {product_code_op_financ92df8Props, setproduct_code_op_financ92df8Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[product_code_op_financ92df8?.refresh])

  if (product_code_op_financ92df8?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 6`,gridRow: `3 / 10`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=""
  variant="subheader-2"
...
export default Textproduct_code_op_financ
