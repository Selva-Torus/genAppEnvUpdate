...
let defaultColumns = [
  {
    "id": "expense_name",
    "nodeid": "93fd920bf84e4aca85eab3ae510c8f13",
    "name": "Expense Name",
    "meta": {
      "sort": true
    },
    ...
    "isSearch": false,
    "colourIndicator": [],
    "dfdName": "expense_name"
  },
  {
    "id": "category_total_amount",
    "nodeid": "6b50343fed8f4355afcc40de5d1fb61b",
    "name": "Amount",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "trs_status",
    "nodeid": "def6b2aaf6b5424888754a5781d79b0b",
    "name": "Status",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "formatted_date",
    "nodeid": "5b53dc0b5e2a410fb5821a505d546435",
    "name": "Date",
    "meta": {
      "sort": true
    },
...
const Tableoffsite_expense_table = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,refetch, setRefetch,setData,encryptionFlagCompData,paginationDetails,open, setOpen, ref, ButtonGoRuleData, setButtonGoRuleData }: any)=>{
 ...
 /////////////
    ...
    mapperData = [
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Dashboard_For_Manager:AFVK:v1|f999c73172354a838090a0f8eda1e924|249da64dff3e4f46abbec7e4ef14a599"
  },
  {
    "elementname": "expense_name",
    "sourcekey": "CK:CT003:FNGK:AF:FNK:DF-DFD:CATK:AG001:AFGK:A001:AFK:claim_table_data:AFVK:v1|bc094f2d2b914ccfaeed3d2a293a01fe|properties.expense_name",
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Dashboard_For_Manager:AFVK:v1|f999c73172354a838090a0f8eda1e924|93fd920bf84e4aca85eab3ae510c8f13"
  },
  {
    "elementname": "category_total_amount",
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Dashboard_For_Manager:AFVK:v1|f999c73172354a838090a0f8eda1e924|6b50343fed8f4355afcc40de5d1fb61b"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Dashboard_For_Manager:AFVK:v1|f999c73172354a838090a0f8eda1e924|def6b2aaf6b5424888754a5781d79b0b"
  },
  {
    "elementname": "formatted_date",
    "sourcekey": "CK:CT003:FNGK:AF:FNK:DF-DFD:CATK:AG001:AFGK:A001:AFK:claim_table_data:AFVK:v1|bc094f2d2b914ccfaeed3d2a293a01fe|properties.formatted_date",
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Dashboard_For_Manager:AFVK:v1|f999c73172354a838090a0f8eda1e924|5b53dc0b5e2a410fb5821a505d546435"
  }
];
    schemaDataDFO = [
  {
  ...
  const [SearchParams,setSearchParams] = useState<any>({})
    ...
    if(needLockingAndRule.lockMode=='Single'){
      ...
      if (ids.length == 0) {
        let keys:any
        keys={}       
        Object.keys(claim_detail_table1835f).map((item: any) => {
          keys[item] = null
        }) 
        setclaim_detail_table1835f(keys)
        keys={}       
        Object.keys(claim_detail_table1835fProps?.presetValues).map((item: any) => {
          keys[item] = null
        }) 
        setclaim_detail_table1835fProps((pre:any)=>({...pre.presetValues,...keys}))
        keys={}       
        ...
        keys={}       
        Object.keys(offsite_approval_group8d6ccProps?.presetValues).map((item: any) => {
          keys[item] = null
        }) 
        setoffsite_approval_group8d6ccProps((pre:any)=>({...pre.presetValues,...keys}))
        setoffsite_expense_table1e924Props((pre:any)=>({...pre, selectedIds:[]}))
        setclaim_detail_table1835f({})
        setclaim_detail_table1835fProps({...claim_detail_table1835fProps,presetValues:{}})
        setoffsite_approval_group8d6cc({})
        setoffsite_approval_group8d6ccProps({...offsite_approval_group8d6ccProps,presetValues:{}})
        setLockedData((pre:any)=>({...pre,data:[]}))
        return
      }

      offsite_expense_table1e924.filter((item:any,id:number)=>{
      ...
      //////////
        setclaim_detail_table1835f(allData[ids])
        setclaim_detail_table1835fProps({...claim_detail_table1835fProps,presetValues:{}})
        setoffsite_approval_group8d6cc(allData[ids])
        setoffsite_approval_group8d6ccProps({...offsite_approval_group8d6ccProps,presetValues:{}})
      //////////
      setoffsite_expense_table1e924Props((pre:any)=>({...pre, selectedIds:[ids[ids.length-1]]}))      
    }
      ...
      setoffsite_expense_table1e924Props((pre:any)=>({...pre, selectedIds:ids}))
    }
      setclaim_detail_table1835f(selectedData[0]||{})
      setclaim_detail_table1835fProps({...claim_detail_table1835fProps,presetValues:selectedData[0]||{}})
      setoffsite_approval_group8d6cc(selectedData[0]||{})
      setoffsite_approval_group8d6ccProps({...offsite_approval_group8d6ccProps,presetValues:selectedData[0]||{}})
    ...
    setreject74228((prev: any) => ({ ...prev, isDisabled: false }))
    setapprove098ea((prev: any) => ({ ...prev, isDisabled: false }))
    setmanager_comments4bec2((prev: any) => ({ ...prev, isDisabled: true }))
    let filterProps:any =  [];
    let filterData = await getFilterProps(filterProps,lockedData);
    setapproval_screen_offsite_v1Props([...filterData ]);
    ...
    if (checkedData.length) {
      for (let i = 0; i < checkedData.length; i++) {
        if (checkedData[i].page == page) {
          setoffsite_expense_table1e924Props((pre:any)=>({...pre, selectedIds:checkedData[i].data}))
        }
      }
    }
  ...
  async function fetchData(page:any = 1, pageSize:any = 10, searchParams = {},dfKey:any,isRulePresent:any=false,isOnLoad = false,filterProps?:any) {
    ...
    try {
      ...
      if (isRulePresent==false) {
        ...
        const api_paginationBody: api_paginationDto = {
          ...
          filterDetails: {
            ...
            nodeId: 'f999c73172354a838090a0f8eda1e924',
            elementId: 'f999c73172354a838090a0f8eda1e924'
          },
          searchFilter: searchParams
        }
        if(encryptionFlagCont) {
      ...
      // CopyFromData (Parent table): use presetValues if present, else use pagination-filtered data
        ...
        if ( offsite_expense_table1e924Props?.presetValues&&Object.keys(offsite_expense_table1e924Props?.presetValues).length > 0) {
          filtertedData = [offsite_expense_table1e924Props?.presetValues];
        }else {
          filtertedData = structuredClone(uf_paginationDataFilter.data)||[]
          setoffsite_expense_table1e924(uf_paginationDataFilter.data||[])
        }
...
const colurIndicator = (keyValue:any=[], comingValue:any,ColourIndicatorType:any) => {
  ...
  useEffect(() => {
    if (prevRefreshRef.current) {
      UpdatedDataHandle(offsite_expense_table1e924Props.filterProps)
    }else 
      prevRefreshRef.current= true
  }, [offsite_expense_table1e924Props.filterProps])
  ...
  const handlePrimaryTable = () => {
    let findData = offsite_expense_table1e924Props?.selectedIds[offsite_expense_table1e924Props?.selectedIds?.length-1]
    if(Array.isArray(offsite_expense_table1e924) && offsite_expense_table1e924.length>0)
    {
      let data = offsite_expense_table1e924[findData]
      setPrimaryTableData({
        ...primaryTableData,
        primaryKey: "claim_id",
        value: data["claim_id"],
  ...
  useEffect(() => {
    if (offsite_expense_table1e924Props?.selectedIds?.length != 0) handlePrimaryTable()
  }, [offsite_expense_table1e924Props?.selectedIds])
  ...
  if (offsite_expense_table1e924?.isHidden) {
    return <></>
  }
  return(
        ...
        <PageApprovalScreenOffsitepage/>
          ...
          <div className=' w-full flex flex-row h-[70%]'>
            <Table
              ...
              tableSettings={true}
              tableSorting={true}
              selectedIds={offsite_expense_table1e924Props?.selectedIds}  
...
export default Tableoffsite_expense_table
