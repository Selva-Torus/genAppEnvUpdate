...
const Textbusiness_justify = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[business_justify89ef9?.refresh])

  if (business_justify89ef9?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Business Justification")}
</Text>
  </div>
  )
}

export default Textbusiness_justify
