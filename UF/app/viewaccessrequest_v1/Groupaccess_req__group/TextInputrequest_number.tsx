...
const TextInputrequest_number = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:viewAccessRequest:AFVK:v1|009cd55942c4a593e51245660f2580cf|3319889569e1bc45c059bb40156c6f16"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,viewAccessRequest_v1:{...pre?.viewAccessRequest_v1,request_number:undefined}}));
    if(dynamicStateandType.type=="number"){
    setaccess_req__group580cf((prev: any) => ({ ...prev, request_number: +e.target.value }));
    }
    else{
    setaccess_req__group580cf((prev: any) => ({ ...prev, request_number: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "3319889569e1bc45c059bb40156c6f16"
      );
      ...
      //     controlId: "3319889569e1bc45c059bb40156c6f16",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "3319889569e1bc45c059bb40156c6f16") {
        handleChange({target:{value:access_req__group580cfRef?.current?.request_number||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "3319889569e1bc45c059bb40156c6f16") {
        handleBlur({target:{value:access_req__group580cfRef?.current?.request_number||""}});
      }
    };
  ...
  if(dfd_addaccessrequestmodify_v1Props?.setSearchFilters && dfd_addaccessrequestmodify_v1Props?.data)
  {
    if(Array.isArray(dfd_addaccessrequestmodify_v1Props.data) && dfd_addaccessrequestmodify_v1Props.data.length > 0){
      setaccess_req__group580cf((pre:any)=>({...pre,request_number:dfd_addaccessrequestmodify_v1Props.data[0]?.request_number}));
    }
  }
  },[dfd_addaccessrequestmodify_v1Props?.setSearchFilters])
  if (request_numberc6f16?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={access_req__group580cf?.request_number||""}
         disabled= {request_numberc6f16?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.viewAccessRequest_v1?.request_number ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
