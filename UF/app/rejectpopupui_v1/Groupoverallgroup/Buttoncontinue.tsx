...
const Buttoncontinue = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  useEffect(()=>{
    ...
    const triggerElementHandler = async (id:any) => {
      if (id === "3773ca523a1849fa92542912ce1599e4") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "continue599e4");
    return () => {
  ...
  async function handleSave99e4_1_1_1(){
      

  setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    await delay(1000); 

    const overallgroup05ff6Props = overallgroup05ff6PropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.rejectPopUpUi_v1 || {}).some(val => {
    ...
    try{
      ...
      let mainData:any=structuredClone(overallgroup05ff6Ref.current);
      ...
      let lockedKeysLength:number;
        if(overallgroup05ff6?.upId === "" && (!lockedData?.data || Object.keys(lockedData?.data)?.length == 0)){
          throw 'Please give proper data';
        }
      let eventProperty :any = {
  "id": "3773ca523a1849fa92542912ce1599e4",
  "type": "button",
  "name": "continue",
  "label": "continue",
  "sequence": 1,
  "children": [
    {
      "id": "3773ca523a1849fa92542912ce1599e4.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "3773ca523a1849fa92542912ce1599e4.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "3773ca523a1849fa92542912ce1599e4.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "3773ca523a1849fa92542912ce1599e4.1.1.1.1.1",
                  ...
                  "children": [
                    {
                      "id": "8741182b2ce945e89bbf9d7810f05ff6.1.1.1.1.1.1",
                      "type": "group",
                      "name": "rejectPopUpUi|overallgroup",
                      "label": "rejectPopUpUi|overallgroup",
                      "key": "CK:CT005:FNGK:AF:FNK:UF-UFW:CATK:GSS:AFGK:RTGS:AFK:rejectPopUpUi:AFVK:v1|overallgroup",
                      "elementType": "group",
                      "groupType": "group",
                    ...
                    {
                      "id": "3773ca523a1849fa92542912ce1599e4.1.1.1.1.1.2",
                      "eventContext": "rise",
                      "value": "",
                      "type": "handlerNode",
                      "name": "closeHandler",
                      ...
                      "children": [
                        {
                          "id": "3773ca523a1849fa92542912ce1599e4.1.1.1.1.1.2.1",
                          "eventContext": "riseListen",
                          "value": "",
                          "type": "handlerNode",
                          "name": "showArtifact",
                          ...
                          "children": [
                            {
                              "id": "725e307e709a44dbadee4b7e12f2bfe5.1.1.1.1.1.2.1.1",
                              "value": "",
                              "type": "screen",
                        ...
                        {
                          "id": "3773ca523a1849fa92542912ce1599e4.1.1.1.1.1.2.2",
                          "eventContext": "riseListen",
                          "value": "",
                          "type": "handlerNode",
                          "name": "refreshElement",
      ...
      let sourceId : string = "CK:CT005:FNGK:AF:FNK:UF-UFW:CATK:GSS:AFGK:RTGS:AFK:rejectPopUpUi:AFVK:v1";
      sourceId+= "|"+"8741182b2ce945e89bbf9d7810f05ff6";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT005:FNGK:AF:FNK:UF-UFW:CATK:GSS:AFGK:RTGS:AFK:rejectPopUpUi:AFVK:v1"+"|"+"8741182b2ce945e89bbf9d7810f05ff6"+"|"+eventProperty.id;
      ...
      te_eventEmitterBody = {
        ...
        upId : overallgroup05ff6?.upId? [overallgroup05ff6?.upId ] : lockedData.processIds,
      ...
      if(Array.isArray(tableData) && hasValidupId){
        ...
        ...uf_initiatePf.data.nodeProperty,
        data:{"trs_event_process_status":uf_getPFDetails.status},
        upId : overallgroup05ff6?.upId? [overallgroup05ff6?.upId ] : upId,
        event : uf_initiatePf.data.eventProperty?.source?.status,
        sourceId : uf_initiatePf.data.eventProperty?.sourceId
      }}else{
        te_eventEmitterBody = {
        ...uf_initiatePf.data.nodeProperty,
        data:{"trs_event_process_status":uf_getPFDetails.status},
        upId : overallgroup05ff6?.upId? [overallgroup05ff6?.upId ] : overallgroup05ff6?.trs_process_id? [overallgroup05ff6?.trs_process_id ] : lockedData.processIds,
        event : uf_initiatePf.data.eventProperty?.source?.status,
        sourceId : uf_initiatePf.data.eventProperty?.sourceId,
        controlName: "continue"
      }
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...overallgroup05ff6Ref.current });
    let reworkKeys:any[]=[];
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"8741182b2ce945e89bbf9d7810f05ff6",
              controlId:"3773ca523a1849fa92542912ce1599e4"
            };
            if (encryptionFlagCont) {
    ...
    //eventEmitter
    if (overallgroup05ff6Props.ssKey !== '' && overallgroup05ff6Props.ssKey !== undefined) {
    te_eventEmitterBody["ssKey"] = overallgroup05ff6Props.ssKey;          
    }
    te_eventEmitterBody["lock"] = actionLockData;
    if (overallgroup05ff6Props?.tableName) {
      te_eventEmitterBody["tableName"] = overallgroup05ff6Props?.tableName;
    }
    if (encryptionFlagCont) {
    ...
    //infoMsg
    toast('Data rejected ', 'success',true);
    ...
    let filterProps4: any =  [];
      let filterData4 = await getFilterProps(filterProps4,{...overallgroup05ff6});
 ...
 if (continue599e4?.isHidden) {
  ...
  return (
    <div
      style={{gridColumn: `20 / 24`,gridRow: `32 / 41`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
