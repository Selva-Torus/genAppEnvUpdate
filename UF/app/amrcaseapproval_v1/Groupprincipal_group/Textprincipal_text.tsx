...
const Textprincipal_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {principal_textb6dc5Props, setprincipal_textb6dc5Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[principal_textb6dc5?.refresh])

  if (principal_textb6dc5?.isHidden) {
    return <></>
  }
