...
const Textfees_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {fees_textdf3dbProps, setfees_textdf3dbProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[fees_textdf3db?.refresh])

  if (fees_textdf3db?.isHidden) {
    return <></>
  }
