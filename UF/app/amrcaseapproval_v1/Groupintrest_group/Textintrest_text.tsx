...
const Textintrest_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {intrest_textfab09Props, setintrest_textfab09Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[intrest_textfab09?.refresh])

  if (intrest_textfab09?.isHidden) {
    return <></>
  }
