...
const Textvalid_checklist_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {valid_checklist_text6a0daProps, setvalid_checklist_text6a0daProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[valid_checklist_text6a0da?.refresh])

  if (valid_checklist_text6a0da?.isHidden) {
    return <></>
  }
