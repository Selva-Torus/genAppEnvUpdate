...
const Textspecial_rules_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {special_rules_textdd5e9Props, setspecial_rules_textdd5e9Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[special_rules_textdd5e9?.refresh])

  if (special_rules_textdd5e9?.isHidden) {
    return <></>
  }
