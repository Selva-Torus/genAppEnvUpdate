...
const Textven_name_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {ven_name_text4470cProps, setven_name_text4470cProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[ven_name_text4470c?.refresh])

  if (ven_name_text4470c?.isHidden) {
    return <></>
  }
