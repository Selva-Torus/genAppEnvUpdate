...
const Texttotal_balance_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {total_balance_texta06dfProps, settotal_balance_texta06dfProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[total_balance_texta06df?.refresh])

  if (total_balance_texta06df?.isHidden) {
    return <></>
  }
