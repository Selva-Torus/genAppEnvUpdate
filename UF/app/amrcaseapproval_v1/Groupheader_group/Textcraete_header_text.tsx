...
const Textcraete_header_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {craete_header_text26dc6Props, setcraete_header_text26dc6Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[craete_header_text26dc6?.refresh])

  if (craete_header_text26dc6?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 19`,gridRow: `1 / 8`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className="!font-bold"
  variant="subheader-3"
  color="primary"
>
      {keyset("Approval AMR Console")}
</Text>
  </div>
  )
}

export default Textcraete_header_text
