...
const Groupasset_search_group = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "4a04f11db9e9433aa311b85863846c56");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setasset_search_group46c56Props((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("advancesearch")){
        setadvancesearch9e02b({...advancesearch9e02b,isDisabled:true});

    }else
    {
      if(advancesearch9e02b?.isDisabled==null)
      {
        setadvancesearch9e02b({...advancesearch9e02b,isDisabled:false});
      }
    }
  //////////////
    if (code != '') {
  ...
  const asset_search_group46c56Ref = useRef<any>(null);
  const handleClearSearch = () => {
    asset_search_group46c56Ref.current?.setSearchParams();
    asset_search_group46c56Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(asset_search_group46c56) && Object.keys(asset_search_group46c56)?.length>0)
      {
        setasset_search_group46c56({})
      }
    }else 
      prevRefreshRef.current= true
  }, [asset_search_group46c56Props?.refresh,token])
  ...
  return (
    ...
    >
        {allowedControls.includes("advancesearch")?<AdvancedSearchadvancesearch /* 9e02b */ encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
    </div>
 )
}
