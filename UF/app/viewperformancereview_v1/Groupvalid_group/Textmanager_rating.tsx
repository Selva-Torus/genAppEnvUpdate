...
const Textmanager_rating = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[manager_rating7a9e7?.refresh])

  if (manager_rating7a9e7?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 7`,gridRow: `16 / 23`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-1"
  color="primary"
>
      {keyset("Manager Rating")}
</Text>
  </div>
  )
}

export default Textmanager_rating
