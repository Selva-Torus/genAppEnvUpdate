...
const Buttonbt_delete = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "3a439ff6210b4b9e42bf5d2492117f42"
      );
  ...
  async function handleSave7f42_1_1_1(){
    ...
    // Check if any field is invalid using .some() with null safety
     const hasInvalidField = Object.values(validate || currentValidate?.addSoftwareLicensesDocument_v1 || {}).some(val => {
  ...
  return val === 'invalid';
    ...
    try{
      //let mainData:any=structuredClone(software_licenses_doc_table265b6);
      ...
      //eventEmitter
      if(software_licenses_doc_table265b6?.upId === "" && (!lockedData?.data || Object.keys(lockedData?.data)?.length == 0)){
         throw 'Please give proper data';
      }
      let eventProperty :any = {
  "id": "3a439ff6210b4b9e42bf5d2492117f42",
  "type": "button",
  "name": "bt_delete",
  "label": "bt_delete",
  "sequence": 1,
  "children": [
    {
      "id": "3a439ff6210b4b9e42bf5d2492117f42.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "3a439ff6210b4b9e42bf5d2492117f42.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "3a439ff6210b4b9e42bf5d2492117f42.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
      ...
      sourceId+= "|"+"a5e9d57592215705ddce865ad37265b6";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:addSoftwareLicensesDocument:AFVK:v1"+"|"+"a5e9d57592215705ddce865ad37265b6"+"|"+eventProperty.id;
      ...
      te_eventEmitterBody = {
        ...
        upId : software_licenses_doc_table265b6?.upId? [software_licenses_doc_table265b6?.upId ] : lockedData.processIds,
    ...
    let reworkKeys:any[]=[];
      ...
      Object.keys(reworkedObject).map((item: any) => {
        if (
          typeof software_licenses_doc_table265b6[item] === 'object' && 
          Array.isArray(software_licenses_doc_table265b6[item]) && 
          software_licenses_doc_table265b6[item].length > 0 && 
          typeof software_licenses_doc_table265b6[item][0] !== "string"
        ) {
          const hasUrlProperty = software_licenses_doc_table265b6[item][0]?.url !== undefined;
          const hasFileProperty = software_licenses_doc_table265b6[item][0]?.file !== undefined;
          const hasSelectedFlag = Object.keys(software_licenses_doc_table265b6[item][0]).includes('_isSelected_');
      ...
      Object.keys(software_licenses_doc_table265b6).map((item: any) => {
        if (
          typeof software_licenses_doc_table265b6[item] === 'object' && 
          Array.isArray(software_licenses_doc_table265b6[item]) && 
          software_licenses_doc_table265b6[item].length > 0 && 
      ...
      if(reworkKeys.length)
      {
        for(let i=0;i<reworkKeys.length;i++){
          let fileBody:any = software_licenses_doc_table265b6[reworkKeys[i]].map((item:any) => item?.file)
      ...
      Object.keys(reworkedObject).map((item:any)=>{
        if(typeof software_licenses_doc_table265b6[item]=='object')
        {
          if( software_licenses_doc_table265b6[item].length>0 &&Object.keys(software_licenses_doc_table265b6[item][0]).includes('_isSelected_'))
          {
      ...
      if ("childTables" in software_licenses_doc_table265b6) {
        te_saveBody.childTables = software_licenses_doc_table265b6.childTables
      }  
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        {
          formData=lockedData?.data || software_licenses_doc_table265b6 || {};
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"a5e9d57592215705ddce865ad37265b6",
              controlId:"3a439ff6210b4b9e42bf5d2492117f42"
            };
            if (encryptionFlagCont) {
          ...
          formData=mainData
          const uf_ifoBody:uf_ifoDto={
            formData:{...formData, ...nullFilter(doc_attached_groupc3d26), ...nullFilter(table_group7bc52)},
            key:uf_getPFDetails.key,
            groupId:"a5e9d57592215705ddce865ad37265b6",
            controlId:"3a439ff6210b4b9e42bf5d2492117f42"
          };
    ...
    //eventEmitter
    if (software_licenses_doc_table265b6Props.ssKey !== '' && software_licenses_doc_table265b6Props.ssKey !== undefined) {
    te_eventEmitterBody["ssKey"] = software_licenses_doc_table265b6Props.ssKey;          
    }
    if(mainData?.upId){
      te_eventEmitterBody['upId']= [mainData.upId];
    }
    if(software_licenses_doc_table265b6?.upId){
      te_eventEmitterBody['upId']= [software_licenses_doc_table265b6?.upId];
    }
    if(software_licenses_doc_table265b6?.upid){
      te_eventEmitterBody['upId']= [software_licenses_doc_table265b6?.upid];
    }
 ...
 if (bt_delete17f42?.isHidden) {
  ...
  return (
    <div 
     onMouseDown={(e:any) => 
      getRouteScreenDetails('CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:addSoftwareLicensesDocument:AFVK:v1','addsoftwarelicensesdocument','needstopPropagate')=='not in assembler'?e.stopPropagation():null
    }
    >
        ...
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='flat-contrast'
          disabled= {bt_delete17f42?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
