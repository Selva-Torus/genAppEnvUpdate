...
const Textlicense_id_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[license_id_text641eb?.refresh])

  if (license_id_text641eb?.isHidden) {
    return <></>
  }
...
export default Textlicense_id_text
