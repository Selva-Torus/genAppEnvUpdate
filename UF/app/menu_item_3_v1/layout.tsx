...
export const metadata: Metadata = {
  title: 'TestApplication | Menu Item 3',
  description: 'Screen generated from Torus metadata key: CK:CT001:FNGK:AF:FNK:UF-UFW:CATK:TAM:AFGK:TA:AFK:ad_search_table:AFVK:v1'
}
