...
const Textadd_info = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {add_info70aa5, setadd_info70aa5}= useContext(TotalContext) as TotalContextProps;
  const {add_inf_textareab8ae8, setadd_inf_textareab8ae8}= useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[add_info70aa5?.refresh])

  if (add_info70aa5?.isHidden) {
    return <></>
  }
