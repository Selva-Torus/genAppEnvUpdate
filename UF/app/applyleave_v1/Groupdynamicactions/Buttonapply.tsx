 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      ...
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "0bc2de2112b8964c5bab616941a6811c"
      );
    ...
    if(orchestrationData?.data?.rule?.nodes?.length > 0){
      ...
      if("apply" in dynamicactionse55b7Props?.dynamicActionRule){
        setShowFlag(true)
        setStyleSate({...getGridPositionFromOrder(dynamicactionse55b7Props?.dynamicActionRule?.apply,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }
      else
      {
        setShowFlag(false)   
      ...
      if("apply" in applyleave_v1?.dynamicactions && applyleave_v1?.dynamicactions["apply"]?.itsHaveArtifact== true)
      {
        setShowFlag(applyleave_v1?.dynamicactions["apply"]?.show||false)
        
        setStyleSate({...getGridPositionFromOrder(applyleave_v1?.dynamicactions?.apply?.order,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }else{
        setShowFlag(false)
      }
    }
  ...
  useEffect(()=>{
    ...
    const triggerElementHandler = async (id:any) => {
      if (id === "0bc2de2112b8964c5bab616941a6811c") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "apply6811c");
    return () => {
  ...
  useEffect(()=>{
    if (!apply6811c?.trigger) return;
      if(apply6811c?.trigger){
      setapply6811c((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
  ...
  async function handleSave811c_1_1_1(){
      

  setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    await delay(1000); 

    const dynamicactionse55b7Props = dynamicactionse55b7PropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.applyLeave_v1 || {}).some(val => {
    ...
    try{
      ...
      let mainData:any=structuredClone(dynamicactionse55b7Ref.current);
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addLeaveRequest:AFVK:v1|47609815e80744eca0ecfea9f406a906"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addLeaveRequest:AFVK:v1|47609815e80744eca0ecfea9f406a906"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "0bc2de2112b8964c5bab616941a6811c",
  "type": "button",
  "name": "save",
  "label": "save",
  "sequence": 1,
  "children": [
    {
      "id": "0bc2de2112b8964c5bab616941a6811c.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "0bc2de2112b8964c5bab616941a6811c.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "0bc2de2112b8964c5bab616941a6811c.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
            ...
            {
              "id": "0bc2de2112b8964c5bab616941a6811c.1.1.1.2",
              ...
              "children": [
                {
                  "id": "6ae8b086b23d14630c1c13c329c1dfa0.1.1.1.2.1",
                  "value": "",
                  "type": "screen",
                  "name": "IndividualLeaveManagement.v1|leave_req_table",
                  "label": "IndividualLeaveManagement.v1|leave_req_table",
                  "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:IndividualLeaveManagement:AFVK:v1|leave_req_table",
                  "elementType": "group",
                  "groupType": "table",
                  "sequence": "1.1.1.2.1",
                  "children": []
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addLeaveRequest:AFVK:v1|47609815e80744eca0ecfea9f406a906"
          ]
        }
      ]
    }
      ...
      let sourceId : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:applyLeave:AFVK:v1";
      sourceId+= "|"+"a78e3f0cdef141126f39f959ea8e55b7";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:applyLeave:AFVK:v1"+"|"+"a78e3f0cdef141126f39f959ea8e55b7"+"|"+eventProperty.id;
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...dynamicactionse55b7Ref.current, ...nullFilter(new_access_group9bde0), ...nullFilter(access_req__group23855), ...nullFilter(emp_avail_group21476), ...nullFilter(leave_balance_group2b19a), ...nullFilter(app_det_groupe1335), ...nullFilter(approve_group1e00a), ...nullFilter(audit_groupa0703) });
    let reworkKeys:any[]=[];
    ...
    if("_groupArrays_" in reworkedObject )
    {
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"a78e3f0cdef141126f39f959ea8e55b7",
              controlId:"0bc2de2112b8964c5bab616941a6811c"
            };
            if (encryptionFlagCont) {
        ...
        if(dynamicactionse55b7?.upId){
          te_saveBody['upId']= dynamicactionse55b7?.upId;
        }
        if(dynamicactionse55b7?.upid){
          te_saveBody['upId']= dynamicactionse55b7?.upid;
        }
        ...
        if (dynamicactionse55b7Props.ssKey !== '' && dynamicactionse55b7Props.ssKey !== undefined) {
          te_saveBody["ssKey"] = dynamicactionse55b7Props.ssKey;
    ...
    //riseListen
    // for group
    setleave_req_table1dfa0Props((pre:any)=>({...pre,refresh:!pre?.refresh}));
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdynamicactionse55b7((prev: any) => ({ ...prev, apply: true }));
        //onClick

    //saveHandler
    await handleSave811c_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdynamicactionse55b7((prev: any) => ({ ...prev, apply: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
  ...
  }, [applyleave_v1?.dynamicactions?.apply,dynamicactionse55b7Props?.dynamicActionRule?.apply,])

 if (apply6811c?.isHidden) {
    return <></>
  }
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='normal'
          disabled= {apply6811c?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
          icon="MdArrowRight"
