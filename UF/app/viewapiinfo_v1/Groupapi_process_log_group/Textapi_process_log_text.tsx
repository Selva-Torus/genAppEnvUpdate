...
const Textapi_process_log_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {api_process_log_texte6f38Props, setapi_process_log_texte6f38Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[api_process_log_texte6f38?.refresh])

  if (api_process_log_texte6f38?.isHidden) {
    return <></>
  }
...
export default Textapi_process_log_text
