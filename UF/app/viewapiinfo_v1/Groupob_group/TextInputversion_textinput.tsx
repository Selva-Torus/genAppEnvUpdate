...
const TextInputversion_textinput = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      "sourceKey": [
        "CK:CT003:FNGK:AF:FNK:DF-DFD:CATK:Trs:AFGK:TOB:AFK:Mongo_API_Repository_DFD:AFVK:v1|fcdd4a9059f84161990c20c300139cd7|properties.version"
      ],
      "targetKey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:Trs:AFGK:TOB:AFK:viewApiInfo:AFVK:v1|58264eecca5f4b09982e0f561e876678|fd2868fcd992491c95a7f3fd62b19065"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,viewApiInfo_v1:{...pre?.viewApiInfo_v1,version:undefined}}));
    if(dynamicStateandType.type=="number"){
    setob_group76678((prev: any) => ({ ...prev, version: +e.target.value }));
    }
    else{
    setob_group76678((prev: any) => ({ ...prev, version: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "fd2868fcd992491c95a7f3fd62b19065"
      );
      ...
      //     controlId: "fd2868fcd992491c95a7f3fd62b19065",
      //     isTable: false,
      //     from:"TextInputversion_textinput",
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "fd2868fcd992491c95a7f3fd62b19065") {
        handleChange({target:{value:ob_group76678Ref?.current?.version||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "fd2868fcd992491c95a7f3fd62b19065") {
        handleBlur({target:{value:ob_group76678Ref?.current?.version||""}});
      }
    };
  ...
  if(dfd_mongo_api_repository_dfd_v1Props?.setSearchFilters && dfd_mongo_api_repository_dfd_v1Props?.data)
  {
    if(Array.isArray(dfd_mongo_api_repository_dfd_v1Props.data) && dfd_mongo_api_repository_dfd_v1Props.data.length > 0){
      setob_group76678((pre:any)=>({...pre,version:dfd_mongo_api_repository_dfd_v1Props.data[0]?.version}));
    }
  }
  },[dfd_mongo_api_repository_dfd_v1Props?.setSearchFilters])
  if (version_textinput19065?.isHidden) {
    return <></>
  }
  return (   
    <div  
      style={{gridColumn: `9 / 25`,gridRow: `25 / 34`, gap:``, height: `100%`, overflow: 'auto', display: 'flex', flexDirection: 'column'}} >
      ...
      <TextInput
        ...
        value={ob_group76678?.version||""}
         disabled= {version_textinput19065?.isDisabled ? true : false}
        pin='brick-brick'     
        placeholder='type here....'      
        view='normal'
        contentAlign={"left"}
      errorMessage={error}
        validationState={validate?.viewApiInfo_v1?.version ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
...
export default TextInputversion_textinput
