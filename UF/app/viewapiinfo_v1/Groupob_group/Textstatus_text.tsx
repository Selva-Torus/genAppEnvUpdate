...
const Textstatus_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {status_text66555Props, setstatus_text66555Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[status_text66555?.refresh])

  if (status_text66555?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 9`,gridRow: `36 / 45`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
...
export default Textstatus_text
