...
const Textcategiry_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {categiry_text7520bProps, setcategiry_text7520bProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[categiry_text7520b?.refresh])

  if (categiry_text7520b?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 9`,gridRow: `47 / 56`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
...
export default Textcategiry_text
