...
const Textapi_info_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {api_info_text692fdProps, setapi_info_text692fdProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[api_info_text692fd?.refresh])

  if (api_info_text692fd?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `2 / 11`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className="!font-bold !bg-white !rounded-xl"
  variant="header-1"
  color="primary"
>
      {keyset("API Overview")}
...
export default Textapi_info_text
