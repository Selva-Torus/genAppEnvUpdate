...
const Textversion_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {version_text67538Props, setversion_text67538Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[version_text67538?.refresh])

  if (version_text67538?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 9`,gridRow: `25 / 34`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
...
export default Textversion_text
