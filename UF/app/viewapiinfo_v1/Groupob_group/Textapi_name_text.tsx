...
const Textapi_name_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {api_name_textaccc0Props, setapi_name_textaccc0Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[api_name_textaccc0?.refresh])

  if (api_name_textaccc0?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 9`,gridRow: `13 / 22`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
...
export default Textapi_name_text
