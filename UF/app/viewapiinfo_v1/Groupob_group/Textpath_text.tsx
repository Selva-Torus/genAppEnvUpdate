...
const Textpath_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {path_textaf97aProps, setpath_textaf97aProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[path_textaf97a?.refresh])

  if (path_textaf97a?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 9`,gridRow: `69 / 78`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
