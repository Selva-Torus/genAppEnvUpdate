...
const Textappraisal_cycle_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[appraisal_cycle_text2841d?.refresh])

  if (appraisal_cycle_text2841d?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 8`,gridRow: `36 / 42`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-2"
  color="primary"
>
      {keyset("Appraisal Cycle")}
</Text>
  </div>
  )
}

export default Textappraisal_cycle_text
