...
const Textgrade_code_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[grade_code_textff14c?.refresh])

  if (grade_code_textff14c?.isHidden) {
    return <></>
  }
...
export default Textgrade_code_text
