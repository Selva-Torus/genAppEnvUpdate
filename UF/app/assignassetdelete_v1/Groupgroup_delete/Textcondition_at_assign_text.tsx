...
const Textcondition_at_assign_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[condition_at_assign_text4ad2d?.refresh])

  if (condition_at_assign_text4ad2d?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 9`,gridRow: `25 / 30`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-2"
  color="primary"
>
      {keyset("Condition At Assign")}
</Text>
  </div>
  )
}

export default Textcondition_at_assign_text
