...
const Textassigned_at_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[assigned_at_text4a3af?.refresh])

  if (assigned_at_text4a3af?.isHidden) {
    return <></>
  }
...
export default Textassigned_at_text
