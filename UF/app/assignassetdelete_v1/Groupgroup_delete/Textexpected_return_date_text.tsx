...
const Textexpected_return_date_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[expected_return_date_text80abb?.refresh])

  if (expected_return_date_text80abb?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Expected Return Date")}
</Text>
  </div>
  )
}

export default Textexpected_return_date_text
