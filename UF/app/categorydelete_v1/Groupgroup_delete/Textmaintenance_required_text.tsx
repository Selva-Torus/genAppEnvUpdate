...
const Textmaintenance_required_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[maintenance_required_textf1aaf?.refresh])

  if (maintenance_required_textf1aaf?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 9`,gridRow: `31 / 36`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-2"
  color="primary"
>
      {keyset("Maintenance Required")}
</Text>
  </div>
  )
}

export default Textmaintenance_required_text
