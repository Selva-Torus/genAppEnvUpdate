...
const Textuseful_life_years_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[useful_life_years_text30347?.refresh])

  if (useful_life_years_text30347?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Useful Life Years")}
</Text>
  </div>
  )
}

export default Textuseful_life_years_text
