...
const Textcategory_name_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[category_name_text7648e?.refresh])

  if (category_name_text7648e?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Category Name")}
</Text>
  </div>
  )
}

export default Textcategory_name_text
