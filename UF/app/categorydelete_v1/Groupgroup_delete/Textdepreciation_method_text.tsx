...
const Textdepreciation_method_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[depreciation_method_text82fb3?.refresh])

  if (depreciation_method_text82fb3?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 9`,gridRow: `19 / 24`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-2"
  color="primary"
>
      {keyset("Depreciation Method")}
</Text>
  </div>
  )
}

export default Textdepreciation_method_text
