...
const Textpolicy_id_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[policy_id_textbba07?.refresh])

  if (policy_id_textbba07?.isHidden) {
    return <></>
  }
...
export default Textpolicy_id_text
