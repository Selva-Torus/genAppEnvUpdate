...
const Textpolicy_name_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[policy_name_textf741b?.refresh])

  if (policy_name_textf741b?.isHidden) {
    return <></>
  }
...
export default Textpolicy_name_text
