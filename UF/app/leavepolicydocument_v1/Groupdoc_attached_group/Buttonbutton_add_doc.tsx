...
const Buttonbutton_add_doc = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      ...
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "b1318de0bf44a27d738396173cbc4540"
      );
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "button_add_docc4540") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "b1318de0bf44a27d738396173cbc4540") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "button_add_docc4540");
    return () => {
  ...
  useEffect(()=>{
    if (!button_add_docc4540?.trigger) return;
      if(button_add_docc4540?.trigger){
      setbutton_add_docc4540((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[button_add_docc4540?.trigger])

  useEffect(()=>{
    if(button_add_docc4540?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[button_add_docc4540?.refresh])
  ...
  async function handleSave4540_1_1_1(){
      

  setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    await delay(1000); 

    const doc_attached_group1c693Props = doc_attached_group1c693PropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.leavePolicyDocument_v1 || {}).some(val => {
    ...
    try{
      ...
      let mainData:any=structuredClone(doc_attached_group1c693Ref.current);
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:leavePolicyDocument:AFVK:v1|cb614b66a924e08332cb3c28e619cbcb"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:leavePolicyDocument:AFVK:v1|cb614b66a924e08332cb3c28e619cbcb"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "b1318de0bf44a27d738396173cbc4540",
  "type": "button",
  "name": "button_add_doc",
  ...
  "children": [
    {
      "id": "b1318de0bf44a27d738396173cbc4540.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "b1318de0bf44a27d738396173cbc4540.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "b1318de0bf44a27d738396173cbc4540.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "b1318de0bf44a27d738396173cbc4540.1.1.1.1.2",
                  ...
                  "children": [
                    {
                      "id": "d533a4c0379855f0c56a8cd9ffc1c693|fab51e3bf009152e5d8cc6ae92cf0a9b.1.1.1.1.2.1",
                      "type": "documentuploadpanel",
                      "name": "leavePolicyDocument|doc_attached_group|documentuploadpanel",
                      "label": "leavePolicyDocument|doc_attached_group|documentuploadpanel",
                      "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:leavePolicyDocument:AFVK:v1|documentuploadpanel",
                ...
                {
                  "id": "b1318de0bf44a27d738396173cbc4540.1.1.1.1.3",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "refreshElement",
                  ...
                  "children": [
                    {
                      "id": "fa9dc617684d49ae4bf52f23d0806d23.1.1.1.1.3.1",
                      "value": "",
                      "type": "screen",
                      "name": "leavePolicyDocument.v1|policy_doc_table",
                      "label": "leavePolicyDocument.v1|policy_doc_table",
                      "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:leavePolicyDocument:AFVK:v1|policy_doc_table",
                      "elementType": "group",
                      "groupType": "table",
                ...
                "params": [
                  {
                    "name": "message",
                    "_type": "text",
                    "value": "Policy Document Added Successfully",
                    "enabled": true
                  },
                  {
                    "name": "type",
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:leavePolicyDocument:AFVK:v1|cb614b66a924e08332cb3c28e619cbcb"
          ]
        }
      ]
    }
      ...
      let sourceId : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:leavePolicyDocument:AFVK:v1";
      sourceId+= "|"+"d533a4c0379855f0c56a8cd9ffc1c693";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:leavePolicyDocument:AFVK:v1"+"|"+"d533a4c0379855f0c56a8cd9ffc1c693"+"|"+eventProperty.id;
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...doc_attached_group1c693Ref.current, ...nullFilter(table_group973f0) });
    let reworkKeys:any[]=[];
    ...
    if("_groupArrays_" in reworkedObject )
    {
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"d533a4c0379855f0c56a8cd9ffc1c693",
              controlId:"b1318de0bf44a27d738396173cbc4540"
            };
            if (encryptionFlagCont) {
        ...
        if(doc_attached_group1c693?.upId){
          te_saveBody['upId']= doc_attached_group1c693?.upId;
        }
        if(doc_attached_group1c693?.upid){
          te_saveBody['upId']= doc_attached_group1c693?.upid;
        }
        ...
        if (doc_attached_group1c693Props.ssKey !== '' && doc_attached_group1c693Props.ssKey !== undefined) {
          te_saveBody["ssKey"] = doc_attached_group1c693Props.ssKey;
    ...
    //infoMsg
    toast('Policy Document Added Successfully', 'success',false);
    // clearHandler riseListen
    // for controller
    // clearHandler riseListen
      setdoc_attached_group1c693((pre:any)=>({...pre,documentuploadpanel:""}));
    // refreshElement
    //riseListen
    // for group
    setpolicy_doc_table06d23Props((pre:any)=>({...pre,refresh:!pre?.refresh}));
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdoc_attached_group1c693((prev: any) => ({ ...prev, button_add_doc: true }));
        //onClick

    //saveHandler
    await handleSave4540_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdoc_attached_group1c693((prev: any) => ({ ...prev, button_add_doc: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
 ...
 if (button_add_docc4540?.isHidden) {
    return <></>
  }

  return (
    <div
      style={{gridColumn: `22 / 25`,gridRow: `136 / 142`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          ...
          onClick={handleClick}
          view='action'
          disabled= {button_add_docc4540?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
          icon="MdAttachFile"
