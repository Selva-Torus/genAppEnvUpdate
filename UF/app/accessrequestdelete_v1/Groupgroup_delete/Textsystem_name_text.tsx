...
const Textsystem_name_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[system_name_text214d0?.refresh])

  if (system_name_text214d0?.isHidden) {
    return <></>
  }
...
export default Textsystem_name_text
