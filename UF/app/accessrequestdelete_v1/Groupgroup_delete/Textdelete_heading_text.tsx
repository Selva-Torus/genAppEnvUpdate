...
const Textdelete_heading_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[delete_heading_text9fa17?.refresh])

  if (delete_heading_text9fa17?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `5 / 10`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-2"
  color="primary"
>
      {keyset("Are you sure you want to delete this Request?")}
</Text>
  </div>
  )
}
