...
const Textleave_rules = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[leave_rules5433b?.refresh])

  if (leave_rules5433b?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 11`,gridRow: `1 / 7`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className="!font-bold"
  variant="subheader-1"
...
export default Textleave_rules
