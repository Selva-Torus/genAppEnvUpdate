...
const Textadv_conf = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[adv_conf3740b?.refresh])

  if (adv_conf3740b?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 10`,gridRow: `1 / 7`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className="!font-bold"
  variant="subheader-1"
  color="primary"
>
      {keyset("Advanced Configuration")}
</Text>
  </div>
  )
}

export default Textadv_conf
