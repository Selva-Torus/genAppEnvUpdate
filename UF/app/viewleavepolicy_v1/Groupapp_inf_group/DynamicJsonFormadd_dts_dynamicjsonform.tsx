...
const DynamicJsonFormadd_dts_dynamicjsonform = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      "sourceKey": [
        "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:addLeavePolicyModify:AFVK:v1|4e279f3010e947cda8cc341d6c0ac371|properties.additional_details"
      ],
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:viewLeavePolicy:AFVK:v1|08b04617c842ba0b659b6b0a73f60e94|e670cb63899bff2a4607621dbd605d0a"
    }
  ],
  "schemaData": {
    "type": "object",
        ...
        "items": [
          {
            ...
            "schema": {
              "name": "schema",
              "_label": "Schema",
              "value": "CK:CT006:FNGK:AF:FNK:DF-DST:CATK:ECP:AFGK:HRM:AFK:additionalPolicyInfoJson:AFVK:v1:NDP",
  ...
  const fetchSchema = async (goruleData:any={},groupData:any={}) => {
    try {
      ...
      if (data) {
        ...
        if (!app_inf_group60e94?.additional_details) {
  ...
  const handleChange = async(values: any) => {
    ...
    //setValidate((pre:any)=>({...pre,additional_details:{}}))
      setapp_inf_group60e94((prev: any) => ({ ...prev, additional_details: processedValues }))
  ...
  const handleMapperValue=async()=>{
    ...
    const orchestrationData = getControlOrchestrationData(
      ...
      "e670cb63899bff2a4607621dbd605d0a"
    );
...
const [dynamicDFDData,setDynamicDFDData]=useState<any>({})
  ...
  if (add_dts_dynamicjsonform05d0a?.isHidden) {
    return <></>
  }
   if (isLoading) {
    return  <div style={{gridColumn: `1 / 25`,gridRow: `91 / 131`, gap:``, height: `100%`, overflow: 'auto'}} >
      Loading schema...</div>
  }
  ...
  return (   
    <div  
      style={{gridColumn: `1 / 25`,gridRow: `91 / 131`, gap:``, height: `100%`, overflow: 'auto'}} >
      <DynamicJsonForm
        metadata={renderData}
        ...
        values={app_inf_group60e94?.additional_details}
        revalidate={revalidate}
        contentAlign={"left"}
        headerPosition='top'
        headerText="Additional Policy Information"
...
export default DynamicJsonFormadd_dts_dynamicjsonform
