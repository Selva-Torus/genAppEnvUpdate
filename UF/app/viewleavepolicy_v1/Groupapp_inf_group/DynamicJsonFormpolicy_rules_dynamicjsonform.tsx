...
const DynamicJsonFormpolicy_rules_dynamicjsonform = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:viewLeavePolicy:AFVK:v1|08b04617c842ba0b659b6b0a73f60e94|a200d51f740e3777e0718e4a1a4ac2da"
    }
  ],
  "schemaData": {
    "type": "object",
  ...
  const fetchSchema = async (goruleData:any={},groupData:any={}) => {
    try {
      ...
      if (data) {
        ...
        if (!app_inf_group60e94?.policy_rules_json) {
  ...
  const handleChange = async(values: any) => {
    ...
    //setValidate((pre:any)=>({...pre,policy_rules_json:{}}))
      setapp_inf_group60e94((prev: any) => ({ ...prev, policy_rules_json: processedValues }))
  ...
  const handleMapperValue=async()=>{
    ...
    const orchestrationData = getControlOrchestrationData(
      ...
      "a200d51f740e3777e0718e4a1a4ac2da"
    );
...
const [dynamicDFDData,setDynamicDFDData]=useState<any>({})
  ...
  if (policy_rules_dynamicjsonformac2da?.isHidden) {
    return <></>
  }
   if (isLoading) {
    return  <div style={{gridColumn: `1 / 25`,gridRow: `49 / 89`, gap:``, height: `100%`, overflow: 'auto'}} >
      Loading schema...</div>
  }
  ...
  return (   
    <div  
      style={{gridColumn: `1 / 25`,gridRow: `49 / 89`, gap:``, height: `100%`, overflow: 'auto'}} >
      <DynamicJsonForm
        metadata={renderData}
        ...
        values={app_inf_group60e94?.policy_rules_json}
        revalidate={revalidate}
        contentAlign={"left"}
        headerPosition='top'
        headerText="Policy Rules"
