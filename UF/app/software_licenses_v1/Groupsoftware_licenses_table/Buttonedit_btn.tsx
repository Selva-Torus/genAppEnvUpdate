...
const Buttonedit_btn = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "d7b3d0379cea4b0c993eea541dce7446"
      );
    ...
    let filterProps2:any =  [
  {
    ...
    //disableElement
    setadd_license3b16e((prev: any) => ({ ...prev, isDisabled: true }));
    //enableElement
    setupdate0d16c((prev: any) => ({ ...prev, isDisabled: false }));
    //bindTran
    // For group or table
    let bindData8 = filterByKeys(mainData,add_license_groupdb5a7Props?.controls);
    setadd_license_groupdb5a7(bindData8||{})
    setadd_license_groupdb5a7Props({...add_license_groupdb5a7Props,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData10 = filterByKeys(mainData,license_information_groupfae34Props?.controls);
    setlicense_information_groupfae34(bindData10||{})
    setlicense_information_groupfae34Props({...license_information_groupfae34Props,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData12 = filterByKeys(mainData,license_configuration_groupb5d91Props?.controls);
    setlicense_configuration_groupb5d91(bindData12||{})
    setlicense_configuration_groupb5d91Props({...license_configuration_groupb5d91Props,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData14 = filterByKeys(mainData,validity_financial_details_grouped4a1Props?.controls);
    setvalidity_financial_details_grouped4a1(bindData14||{})
    setvalidity_financial_details_grouped4a1Props({...validity_financial_details_grouped4a1Props,presetValues:mainData||{}})  
    ...
    >
      ...
      >
        ...
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='outlined'
          disabled= {edit_btne7446?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Edit")}
