...
import PageLicensedeletepage2 from '@/app/licensedelete_v1/licensedelete_v1page';
...
const Buttonbutton_delete = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleCustomCode=async () => {
    ...
    if (code != '') {
      ...
      codeStates['licensedelete_v1'] = licensedelete_v1Props,
      codeStates['setlicensedelete_v1'] = setlicensedelete_v1Props,
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "db9fa5085a6740bd92e506aaa246b394"
      );
    ...
    let filterProps2:any =  [
  {
    ...
    setlicensedelete_v1Props([...filterData2 ]);
    setShowProfileAsModalOpen2(true);
    //bindTran
    // For group or table
    setgroup_deletedf5b8(mainData||{})
    setgroup_deletedf5b8Props({...group_deletedf5b8Props,presetValues:mainData||{}})  
 ...
 if (button_delete6b394?.isHidden) {
    return <></>
  }
  ...
  return (
    ...
    >
      ...
      <Modal 
        ...
        showOverlay = {true}
        position = {"center"}
        modalName = "licensedelete"
        className='w-[50%] h-[] bg-gray-50 overflow-auto'
      >
        <PageLicensedeletepage2/>
      </Modal>
        {showFlag && <Button 
          ref={buttonRef}
          ...
          onClick={handleClick}
          view='outlined'
          disabled= {button_delete6b394?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Delete")}
...
export default Buttonbutton_delete
