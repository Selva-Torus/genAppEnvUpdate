...
const Textsoftware_license_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[software_license_text8a69d?.refresh])

  if (software_license_text8a69d?.isHidden) {
    return <></>
  }
...
export default Textsoftware_license_text
