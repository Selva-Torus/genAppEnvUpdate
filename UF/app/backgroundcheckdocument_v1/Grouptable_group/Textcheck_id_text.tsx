...
const Textcheck_id_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[check_id_text5c745?.refresh])

  if (check_id_text5c745?.isHidden) {
    return <></>
  }
...
export default Textcheck_id_text
