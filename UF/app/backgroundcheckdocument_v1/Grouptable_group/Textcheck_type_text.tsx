...
const Textcheck_type_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[check_type_text4cf7f?.refresh])

  if (check_type_text4cf7f?.isHidden) {
    return <></>
  }
...
export default Textcheck_type_text
