...
const Buttonbutton_add_doc = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const doc_attached_groupb4f40Ref = useRef(doc_attached_groupb4f40);
  useEffect(() => {
    doc_attached_groupb4f40Ref.current = doc_attached_groupb4f40;
    if (!pendingAutoSearch.current) return;
      pendingAutoSearch.current = false;
      handleClick(false);
  }, [doc_attached_groupb4f40]);
  
  //group props in ref to access latest props value
  const doc_attached_groupb4f40PropsRef = useRef(doc_attached_groupb4f40Props);
  useEffect(() => {
    doc_attached_groupb4f40PropsRef.current = doc_attached_groupb4f40Props;
  }, [doc_attached_groupb4f40Props]);
  ...
  const handleMapper=async (data?:any) => {
    try{     
      data = {...data,...doc_attached_groupb4f40Ref.current};
      let parentRowSpan = 161;
      const orchestrationData : any = getControlOrchestrationData(
        controlData,
        "c877483ce67926f75e218c9de64b4f40",
        "3820bce8a63305c747dbee83cbb9fdc1"
      );
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "button_add_doc9fdc1") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "3820bce8a63305c747dbee83cbb9fdc1") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "button_add_doc9fdc1");
    return () => {
  ...
  useEffect(()=>{
    if (!button_add_doc9fdc1?.trigger) return;
      if(button_add_doc9fdc1?.trigger){
      setbutton_add_doc9fdc1((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[button_add_doc9fdc1?.trigger])

  useEffect(()=>{
    if(button_add_doc9fdc1?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[button_add_doc9fdc1?.refresh])
  ...
  async function handleSavefdc1_1_1_1(){
      

  setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    await delay(1000); 

    const doc_attached_groupb4f40Props = doc_attached_groupb4f40PropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.backgroundCheckDocument_v1 || {}).some(val => {
    ...
    try{
      ...
      let mainData:any=structuredClone(doc_attached_groupb4f40Ref.current);
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:backgroundCheckDocument:AFVK:v1|7d5b9a2d175c69cdeae5f79e0f6cf283"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:backgroundCheckDocument:AFVK:v1|7d5b9a2d175c69cdeae5f79e0f6cf283"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "3820bce8a63305c747dbee83cbb9fdc1",
  "type": "button",
  "name": "button_add_doc",
  ...
  "children": [
    {
      "id": "3820bce8a63305c747dbee83cbb9fdc1.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "3820bce8a63305c747dbee83cbb9fdc1.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "3820bce8a63305c747dbee83cbb9fdc1.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "3820bce8a63305c747dbee83cbb9fdc1.1.1.1.1.3",
                  ...
                  "children": [
                    {
                      "id": "dcfab41f782d61d24821f9774c078f2f.1.1.1.1.3.1",
                      "value": "",
                      "type": "screen",
                      "name": "backgroundCheckDocument.v1|employee_doc_table",
                      "label": "backgroundCheckDocument.v1|employee_doc_table",
                      "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:backgroundCheckDocument:AFVK:v1|employee_doc_table",
                      "elementType": "group",
                      "groupType": "table",
                ...
                {
                  "id": "3820bce8a63305c747dbee83cbb9fdc1.1.1.1.1.4",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "c877483ce67926f75e218c9de64b4f40|2b3faa4990fe7ee50208ef0674450001.1.1.1.1.4.1",
                      "type": "documentuploadpanel",
                      "name": "backgroundCheckDocument|doc_attached_group|documentuploadpanel",
                      "label": "backgroundCheckDocument|doc_attached_group|documentuploadpanel",
                      "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:backgroundCheckDocument:AFVK:v1|documentuploadpanel",
                      "elementType": "documentuploadpanel",
                      "groupType": "group|documentuploadpanel",
                ...
                "params": [
                  {
                    "name": "message",
                    "_type": "text",
                    "value": "Document Added Successfully",
                    "enabled": true
                  },
                  {
                    "name": "type",
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:backgroundCheckDocument:AFVK:v1|7d5b9a2d175c69cdeae5f79e0f6cf283"
          ]
        }
      ]
    }
      ...
      let sourceId : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:backgroundCheckDocument:AFVK:v1";
      sourceId+= "|"+"c877483ce67926f75e218c9de64b4f40";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:backgroundCheckDocument:AFVK:v1"+"|"+"c877483ce67926f75e218c9de64b4f40"+"|"+eventProperty.id;
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...doc_attached_groupb4f40Ref.current, ...nullFilter(table_groupb0ef9) });
    let reworkKeys:any[]=[];
    ...
    if("_groupArrays_" in reworkedObject )
    {
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"c877483ce67926f75e218c9de64b4f40",
              controlId:"3820bce8a63305c747dbee83cbb9fdc1"
            };
            if (encryptionFlagCont) {
        ...
        if(doc_attached_groupb4f40?.upId){
          te_saveBody['upId']= doc_attached_groupb4f40?.upId;
        }
        if(doc_attached_groupb4f40?.upid){
          te_saveBody['upId']= doc_attached_groupb4f40?.upid;
        }
        ...
        if (doc_attached_groupb4f40Props.ssKey !== '' && doc_attached_groupb4f40Props.ssKey !== undefined) {
          te_saveBody["ssKey"] = doc_attached_groupb4f40Props.ssKey;
    ...
    //infoMsg
    toast('Document Added Successfully', 'success',true);
    // refreshElement
    //riseListen
    // for group
    setemployee_doc_table78f2fProps((pre:any)=>({...pre,refresh:!pre?.refresh}));
    ...
    // for controller
    // clearHandler riseListen
      setdoc_attached_groupb4f40((pre:any)=>({...pre,documentuploadpanel:""}));
    }catch(err:any){
      savedData.current = {};
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdoc_attached_groupb4f40((prev: any) => ({ ...prev, button_add_doc: true }));
        //onClick

    //saveHandler
    await handleSavefdc1_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdoc_attached_groupb4f40((prev: any) => ({ ...prev, button_add_doc: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
 ...
 if (button_add_doc9fdc1?.isHidden) {
    return <></>
  }

  return (
    <div
      style={{gridColumn: `22 / 25`,gridRow: `151 / 158`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          className=""
          onClick={handleClick}
          view='action'
          disabled= {button_add_doc9fdc1?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Add Document")}
