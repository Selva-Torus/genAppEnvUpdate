...
const ButtonApprove =  ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
  ...
  },[approve28765?.refresh,currentToken])
  ...
  async function handleSave8765_1_1_1(){
    try{
  ...
  "id": "1a8d8b3319124f5f87f740c4bd628765",
  "type": "button",
  "name": "Approve",
  "sequence": 1,
  "children": [
    {
      "id": "1a8d8b3319124f5f87f740c4bd628765.1.1",
      "type": "eventNode",
      "name": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "1a8d8b3319124f5f87f740c4bd628765.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "1a8d8b3319124f5f87f740c4bd628765.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "1a8d8b3319124f5f87f740c4bd628765.1.1.1.1.1",
                  ...
                  "children": [
                    ...
                    {
                      "id": "1a8d8b3319124f5f87f740c4bd628765.1.1.1.1.1.2",
                      "eventContext": "riseListen",
                      "value": "",
                      "type": "handlerNode",
                      "name": "refreshElement",
                      ...
                      "children": [
                        {
                          "id": "e0abb5b5f6d949fa8b9e38f3f4741477|8cfd41ac08154260a70b7026e91727e3.1.1.1.1.1.2.1",
                          "value": "",
                          "type": "screen",
                    ...
                    {
                      "id": "1a8d8b3319124f5f87f740c4bd628765.1.1.1.1.1.3",
                      "eventContext": "riseListen",
                      "value": "",
                      "type": "handlerNode",
                      "name": "refreshElement",
                      "sequence": "1.1.1.1.1.3",
                      "children": [
                        {
                          "id": "e0abb5b5f6d949fa8b9e38f3f4741477|2253d3b315914a749f8bbfdadea75ed7.1.1.1.1.1.3.1",
                          "value": "",
                          "type": "screen",
                          ...
                          "elementType": "card",
                          "sequence": "1.1.1.1.1.3.1",
                          "children": []
                        }
                      ]
                    },
                    {
                      "id": "1a8d8b3319124f5f87f740c4bd628765.1.1.1.1.1.4",
                      "eventContext": "riseListen",
                      "value": "",
                      "type": "handlerNode",
                      "name": "disableElement",
                      "sequence": "1.1.1.1.1.4",
                      "children": [
                        {
                          "id": "91dcb5fe99014c21add21a4d00669531|a0b10e934dc447099f6b85449f5d309a.1.1.1.1.1.4.1",
                          "value": "",
                          "type": "screen",
        ...
        if(Array.isArray(daily_approval_group69531))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              ...
              controlId:"1a8d8b3319124f5f87f740c4bd628765"
            };
            if (encryptionFlagCont) {
 ...
 if (approve28765?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `21 / 23`,gridRow: `208 / 218`, gap:``, height: `100%`, overflow: 'auto'}} 
 >
        {showFlag && <Button 
          ref={buttonRef}
          className=""
          ...
          disabled= {approve28765?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Approve")}
