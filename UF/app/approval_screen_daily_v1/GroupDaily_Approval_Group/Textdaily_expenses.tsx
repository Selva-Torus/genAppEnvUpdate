...
const Textdaily_expenses = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[daily_expenses89868?.refresh])

  if (daily_expenses89868?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `3 / 16`,gridRow: `14 / 24`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="display-1"
...
export default Textdaily_expenses
