...
export const metadata: Metadata = {
  title: 'TestApplication | set_memory',
  description: 'Screen generated from Torus metadata key: CK:CT001:FNGK:AF:FNK:UF-UFW:CATK:TAM:AFGK:TA:AFK:setMemoryValuesevent:AFVK:v1'
}
