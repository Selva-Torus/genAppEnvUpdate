...
const TextInputcategory_total_amount = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const handleChange = async(e: any) => {
    ...
    setgrouparray494e0_1((prev: any) => ({ ...prev, total_amount: +e.target.value }));
    }
    else{
    setgrouparray494e0_1((prev: any) => ({ ...prev, total_amount: e.target.value }));
    }
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "bc4d3d30a6c44ca798c0adba83c49375") {
        handleChange({target:{value:grouparray494e0_1Ref?.current?.total_amount||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "bc4d3d30a6c44ca798c0adba83c49375") {
        handleBlur({target:{value:grouparray494e0_1Ref?.current?.total_amount||""}});
      }
    };
  ...
  if(dfd_group_array_dsd_v1Props?.setSearchFilters && dfd_group_array_dsd_v1Props?.data)
  {
    if(Array.isArray(dfd_group_array_dsd_v1Props.data) && dfd_group_array_dsd_v1Props.data.length > 0){
      setgrouparray494e0_1((pre:any)=>({...pre,total_amount:dfd_group_array_dsd_v1Props.data[0]?.total_amount}));
    }
  }
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={grouparray494e0_1?.total_amount||""}
