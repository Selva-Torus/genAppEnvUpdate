...
const TextInputexpense_name = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const handleChange = async(e: any) => {
    ...
    setgrouparray494e0_1((prev: any) => ({ ...prev, expense_name: +e.target.value }));
    }
    else{
    setgrouparray494e0_1((prev: any) => ({ ...prev, expense_name: e.target.value }));
    }
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "469416b65d2a47c9a07eff3cb93c83ee") {
        handleChange({target:{value:grouparray494e0_1Ref?.current?.expense_name||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "469416b65d2a47c9a07eff3cb93c83ee") {
        handleBlur({target:{value:grouparray494e0_1Ref?.current?.expense_name||""}});
      }
    };
  ...
  if(dfd_group_array_dsd_v1Props?.setSearchFilters && dfd_group_array_dsd_v1Props?.data)
  {
    if(Array.isArray(dfd_group_array_dsd_v1Props.data) && dfd_group_array_dsd_v1Props.data.length > 0){
      setgrouparray494e0_1((pre:any)=>({...pre,expense_name:dfd_group_array_dsd_v1Props.data[0]?.expense_name}));
    }
  }
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={grouparray494e0_1?.expense_name||""}
