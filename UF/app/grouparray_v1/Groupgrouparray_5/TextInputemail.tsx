...
const TextInputemail = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const handleChange = async(e: any) => {
    ...
    setgrouparray494e0_5((prev: any) => ({ ...prev, email_id: +e.target.value }));
    }
    else{
    setgrouparray494e0_5((prev: any) => ({ ...prev, email_id: e.target.value }));
    }
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "3b8d8479e3734bb7b76d452b62d0c3ca") {
        handleChange({target:{value:grouparray494e0_5Ref?.current?.email_id||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "3b8d8479e3734bb7b76d452b62d0c3ca") {
        handleBlur({target:{value:grouparray494e0_5Ref?.current?.email_id||""}});
      }
    };
  ...
  if(dfd_group_array_dsd_v1Props?.setSearchFilters && dfd_group_array_dsd_v1Props?.data)
  {
    if(Array.isArray(dfd_group_array_dsd_v1Props.data) && dfd_group_array_dsd_v1Props.data.length > 0){
      setgrouparray494e0_5((pre:any)=>({...pre,email_id:dfd_group_array_dsd_v1Props.data[0]?.email_id}));
    }
  }
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={grouparray494e0_5?.email_id||""}
