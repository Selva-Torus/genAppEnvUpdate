 ...
 /////////////
  ...
  useEffect(()=>{
    if (prevRefreshRef.current) {
      setgrouparray494e0_4((pre:any)=>({...pre,description:""}))
    }else 
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "28dc2bc8f2c4493bb1f6423f7207171e") {
        handleChange({target:{value:grouparray494e0_4Ref?.current?.description||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "28dc2bc8f2c4493bb1f6423f7207171e") {
        handleBlur({target:{value:grouparray494e0_4Ref?.current?.description||""}});
      }
    };
  ...
  const handleChange = async(e: any) => {
    ...
    setgrouparray494e0_4((prev: any) => ({ ...prev, description: +e?.target?.value }));
    }
    else{
    setgrouparray494e0_4((prev: any) => ({ ...prev, description: e?.target?.value }));
    }
...
return (
  ...
  style={{gridColumn: `10 / 17`,gridRow: `139 / 159`, gap:``, height: `100%`}} >
    <TextArea
      ...
      pin = {'brick-brick'}
      value = { grouparray494e0_4?.description != null && typeof grouparray494e0_4?.description =='object' ? Object.keys(grouparray494e0_4?.description)?.length ?  JSON.stringify(grouparray494e0_4?.description,null ,2):"" : grouparray494e0_4?.description||""}
      errorMessage={error}
