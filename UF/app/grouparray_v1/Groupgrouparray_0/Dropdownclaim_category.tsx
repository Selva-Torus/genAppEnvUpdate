...
const Dropdownclaim_category = ({lockedData,setLockedData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: any) => {
 ...
 /////////////
  ...
  useEffect(() => {
  if(grouparray494e0_0?.claim_category=="" || grouparray494e0_0?.claim_category==undefined || grouparray494e0_0?.claim_category==null ){
    setSelectedItem("");
  }
  },[grouparray494e0_0?.claim_category])
  ...
  },
  {
    ...
    "value": {
      ...
      setgrouparray494e0_0((prev: any) => ({ ...prev, claim_category: staticTextValue, claim_categoryf03f1: value}))
         setIsRequredData(false)
    } else {
       setgrouparray494e0_0((prev: any) => ({ ...prev, claim_category: '', claim_categoryf03f1: '' }))
  ...
  useEffect(() => { grouparray494e0_0Ref.current = grouparray494e0_0; }, [grouparray494e0_0]);
    useEffect(()=>{
       ...
       const handler = (id:any) => {
        ...
        handleClick(grouparray494e0_0Ref?.current?.claim_categoryf03f1?grouparray494e0_0Ref?.current?.claim_categoryf03f1:"");
          }
        };
  ...
  useEffect(() => {
    if(initialCount!=0)
     setgrouparray494e0_0((pre:any)=>({...pre,claim_category:""}))
    else
      setInitialCount(1)
  },[claim_categoryf03f1?.refresh])
  ...
  return (
    <div
      ...
      <Dropdown
        ...
        value={
            grouparray494e0_0?.claim_categoryf03f1 ? [grouparray494e0_0?.claim_categoryf03f1] :
                grouparray494e0_0?.claim_category ? grouparray494e0_0?.claim_category : []
            }
