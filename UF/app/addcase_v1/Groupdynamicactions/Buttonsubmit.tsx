...
const Buttonsubmit = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      ...
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "270a2993d12946e4bac669e5d750112f"
      );
    ...
    if(orchestrationData?.data?.rule?.nodes?.length > 0){
      ...
      if("submit" in dynamicactions094c3Props?.dynamicActionRule){
        setShowFlag(true)
        setStyleSate({...getGridPositionFromOrder(dynamicactions094c3Props?.dynamicActionRule?.submit,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }
      else
      {
        setShowFlag(false)   
      ...
      if("submit" in addcase_v1?.dynamicactions && addcase_v1?.dynamicactions["submit"]?.itsHaveArtifact== true)
      {
        setShowFlag(addcase_v1?.dynamicactions["submit"]?.show||false)
        
        setStyleSate({...getGridPositionFromOrder(addcase_v1?.dynamicactions?.submit?.order,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }else{
        setShowFlag(false)
      }
    }
  ...
  useEffect(()=>{
    ...
    const triggerElementHandler = async (id:any) => {
      if (id === "270a2993d12946e4bac669e5d750112f") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "submit0112f");
    return () => {
  ...
  useEffect(()=>{
    if (!submit0112f?.trigger) return;
      if(submit0112f?.trigger){
      setsubmit0112f((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
  ...
  async function handleSave112f_1_1_1(){
  ...
  const hasInvalidField = Object.values(currentValidate?.addCase_v1 || {}).some(val => {
    ...
    try{
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:LAP:AFGK:LAP:AFK:addCase:AFVK:v1|e06a7a667dcb4c248f796cddc5428476"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:LAP:AFGK:LAP:AFK:addCase:AFVK:v1|e06a7a667dcb4c248f796cddc5428476"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "270a2993d12946e4bac669e5d750112f",
  "type": "button",
  "name": "submit",
  "label": "submit",
  "sequence": 1,
  "children": [
    {
      "id": "270a2993d12946e4bac669e5d750112f.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "270a2993d12946e4bac669e5d750112f.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "270a2993d12946e4bac669e5d750112f.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
            ...
            {
              "id": "270a2993d12946e4bac669e5d750112f.1.1.1.2",
              ...
              "children": [
                {
                  "id": "6638e195416b4642bda98e40af0852e3.1.1.1.2.1",
                  "value": "",
                  "type": "screen",
            ...
            {
              "id": "270a2993d12946e4bac669e5d750112f.1.1.1.3",
              "eventContext": "riseListen",
              "value": "",
              "type": "handlerNode",
              "name": "refreshElement",
              ...
              "children": [
                {
                  "id": "31d0c407d67675a58107f5dad6dc92ca.1.1.1.3.1",
                  "value": "",
                  "type": "screen",
                  "name": "dashboard.v1|amr_queue_group",
                  "label": "dashboard.v1|amr_queue_group",
                  "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:LAP:AFGK:LAP:AFK:dashboard:AFVK:v1|amr_queue_group",
                  "elementType": "group",
                  "groupType": "group",
                  "sequence": "1.1.1.3.1",
                  "children": []
            ...
            {
              "id": "270a2993d12946e4bac669e5d750112f.1.1.1.4",
              "eventContext": "riseListen",
              "value": "",
              "type": "handlerNode",
              "name": "refreshElement",
              ...
              "children": [
                {
                  "id": "3884c0194bbdf12fcbeb80f07f6ffe32.1.1.1.4.1",
                  "value": "",
                  "type": "screen",
                  "name": "dashboard.v1|pending_file_group",
                  "label": "dashboard.v1|pending_file_group",
                  "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:LAP:AFGK:LAP:AFK:dashboard:AFVK:v1|pending_file_group",
                  "elementType": "group",
                  "groupType": "group",
                  "sequence": "1.1.1.4.1",
                  "children": []
            ...
            {
              "id": "270a2993d12946e4bac669e5d750112f.1.1.1.5",
              "eventContext": "riseListen",
              "value": "",
              "type": "handlerNode",
              "name": "refreshElement",
              ...
              "children": [
                {
                  "id": "ff94621c3e014341b5c0038c37011279.1.1.1.5.1",
                  "value": "",
                  "type": "screen",
                  "name": "dashboard.v1|pending_fillings_table",
                  "label": "dashboard.v1|pending_fillings_table",
                  "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:LAP:AFGK:LAP:AFK:dashboard:AFVK:v1|pending_fillings_table",
                  "elementType": "group",
                  "groupType": "table",
                  "sequence": "1.1.1.5.1",
                  "children": []
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:LAP:AFGK:LAP:AFK:addCase:AFVK:v1|e06a7a667dcb4c248f796cddc5428476"
          ]
        }
      ]
    }
  ...
  // saveHandler
    ...
    if("_groupArrays_" in reworkedObject )
    {
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              ...
              controlId:"270a2993d12946e4bac669e5d750112f"
            };
            if (encryptionFlagCont) {
        ...
        te_saveBody.controlName = "submit";
        if(mainData?.upId)
        {
        ...
        if(dynamicactions094c3?.upId){
          te_saveBody['upId']= dynamicactions094c3?.upId;
        }
        if(dynamicactions094c3?.upid){
          te_saveBody['upId']= dynamicactions094c3?.upid;
        }
        ...
        if (dynamicactions094c3Props.ssKey !== '' && dynamicactions094c3Props.ssKey !== undefined) {
          te_saveBody["ssKey"] = dynamicactions094c3Props.ssKey;
    ...
    //infoMsg
    toast('Case Added Successfully', 'success',true);
    // refreshElement
    //riseListen
    // for group
    ...
    //riseListen
    // for group
    setamr_queue_groupc92caProps((pre:any)=>({...pre,refresh:!pre?.refresh}));
    setLockedData({}) //Clears lockedData and resets it in subsequent screens.
    lockedData={} //Clears lockedData; clicking the button again without a selection returns no value.
    setValidate({}); 
    setValidateRefetch({
    ...
    //riseListen
    // for group
    setpending_file_groupffe32Props((pre:any)=>({...pre,refresh:!pre?.refresh}));
    setLockedData({}) //Clears lockedData and resets it in subsequent screens.
    lockedData={} //Clears lockedData; clicking the button again without a selection returns no value.
    setValidate({}); 
    setValidateRefetch({
    ...
    //riseListen
    // for group
    setpending_fillings_table11279Props((pre:any)=>({...pre,refresh:!pre?.refresh}));
    setLockedData({}) //Clears lockedData and resets it in subsequent screens.
    lockedData={} //Clears lockedData; clicking the button again without a selection returns no value.
    setValidate({}); 
    setValidateRefetch({
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdynamicactions094c3((prev: any) => ({ ...prev, submit: true }));
        //onClick

    //saveHandler
    await handleSave112f_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdynamicactions094c3((prev: any) => ({ ...prev, submit: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
  ...
  }, [addcase_v1?.dynamicactions?.submit,dynamicactions094c3Props?.dynamicActionRule?.submit,])

 if (submit0112f?.isHidden) {
    return <></>
  }
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {submit0112f?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Submit")}
