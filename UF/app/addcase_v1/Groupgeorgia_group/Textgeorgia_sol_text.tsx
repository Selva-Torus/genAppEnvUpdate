...
const Textgeorgia_sol_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {georgia_sol_text6238eProps, setgeorgia_sol_text6238eProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[georgia_sol_text6238e?.refresh])

  if (georgia_sol_text6238e?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Georgia SOL:6 Years")}
</Text>
  </div>
  )
}

export default Textgeorgia_sol_text
