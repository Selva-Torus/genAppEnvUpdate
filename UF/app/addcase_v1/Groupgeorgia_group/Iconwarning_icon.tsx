...
const Iconwarning_icon = ({encryptionFlagCompData,setIsProcessing,controlData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData : any = getControlOrchestrationData(
      controlData,
      "ab5a2814dea24a6d9e6c988df9e0fa18",
      "0a483a064f2f489e8c6450ebcd4c4eea"
    );
...
export default Iconwarning_icon
