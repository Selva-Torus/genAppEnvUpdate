...
const TextInputquality_score = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:LAP:AFGK:LAP:AFK:addCase:AFVK:v1|765fc890b6a2413b897557a765428f6f|968c7f711d0747308a0db6a80822c29e"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,addCase_v1:{...pre?.addCase_v1,quality_score:undefined}}));
    if(dynamicStateandType.type=="number"){
    setcase_information_group28f6f((prev: any) => ({ ...prev, quality_score: +e.target.value }));
    }
    else{
    setcase_information_group28f6f((prev: any) => ({ ...prev, quality_score: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "968c7f711d0747308a0db6a80822c29e"
      );
      ...
      //     controlId: "968c7f711d0747308a0db6a80822c29e",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "968c7f711d0747308a0db6a80822c29e") {
        handleChange({target:{value:case_information_group28f6fRef?.current?.quality_score||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "968c7f711d0747308a0db6a80822c29e") {
        handleBlur({target:{value:case_information_group28f6fRef?.current?.quality_score||""}});
      }
    };
  ...
  if(dfd_addcase_v1Props?.setSearchFilters && dfd_addcase_v1Props?.data)
  {
    if(Array.isArray(dfd_addcase_v1Props.data) && dfd_addcase_v1Props.data.length > 0){
      setcase_information_group28f6f((pre:any)=>({...pre,quality_score:dfd_addcase_v1Props.data[0]?.quality_score}));
    }
  }
  },[dfd_addcase_v1Props?.setSearchFilters])
  if (quality_score2c29e?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={case_information_group28f6f?.quality_score||""}
         disabled= {quality_score2c29e?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.addCase_v1?.quality_score ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
