...
const Textspecials_rules = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {specials_rulesb4b8bProps, setspecials_rulesb4b8bProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[specials_rulesb4b8b?.refresh])

  if (specials_rulesb4b8b?.isHidden) {
    return <></>
  }
