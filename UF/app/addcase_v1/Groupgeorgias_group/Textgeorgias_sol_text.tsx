...
const Textgeorgias_sol_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {georgias_sol_textea2e1Props, setgeorgias_sol_textea2e1Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[georgias_sol_textea2e1?.refresh])

  if (georgias_sol_textea2e1?.isHidden) {
    return <></>
  }
