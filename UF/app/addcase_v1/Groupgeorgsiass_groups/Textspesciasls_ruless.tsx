...
const Textspesciasls_ruless = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {spesciasls_ruless22364Props, setspesciasls_ruless22364Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[spesciasls_ruless22364?.refresh])

  if (spesciasls_ruless22364?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `12 / 45`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className="!p-1"
  variant="subheader-3"
