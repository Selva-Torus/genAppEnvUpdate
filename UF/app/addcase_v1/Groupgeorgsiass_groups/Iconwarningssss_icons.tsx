...
const Iconwarningssss_icons = ({encryptionFlagCompData,setIsProcessing,controlData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData : any = getControlOrchestrationData(
      controlData,
      "f0cd38dbc4c84e3f90246f2cebfb044a",
      "aef68e28d8c04a0ab7a801f7b5dbdae5"
    );
  ...
  if (warningssss_iconsbdae5?.isHidden) {
    return <></>
  }
...
export default Iconwarningssss_icons
