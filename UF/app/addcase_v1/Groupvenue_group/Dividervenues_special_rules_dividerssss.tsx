...
const Dividervenues_special_rules_dividerssss = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[venues_special_rules_dividerssss9b36c?.refresh])

  if (venues_special_rules_dividerssss9b36c?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 25`,gridRow: `238 / 241`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Dividervenues_special_rules_dividerssss
