...
const Dividervenue_special_rules_dividers = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[venue_special_rules_dividerscd6e7?.refresh])

  if (venue_special_rules_dividerscd6e7?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 25`,gridRow: `91 / 94`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Dividervenue_special_rules_dividers
