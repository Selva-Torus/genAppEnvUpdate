...
const Textspecial_rules = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {special_rulesbd9d8Props, setspecial_rulesbd9d8Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[special_rulesbd9d8?.refresh])

  if (special_rulesbd9d8?.isHidden) {
    return <></>
  }
