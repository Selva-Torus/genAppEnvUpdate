...
const Dividervenue_special_rules_dividerssss = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[venue_special_rules_dividerssss2b01f?.refresh])

  if (venue_special_rules_dividerssss2b01f?.isHidden) {
    return <></>
  }
...
export default Dividervenue_special_rules_dividerssss
