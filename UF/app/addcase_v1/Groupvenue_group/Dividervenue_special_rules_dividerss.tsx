...
const Dividervenue_special_rules_dividerss = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[venue_special_rules_dividerss0fa18?.refresh])

  if (venue_special_rules_dividerss0fa18?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 25`,gridRow: `135 / 138`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Dividervenue_special_rules_dividerss
