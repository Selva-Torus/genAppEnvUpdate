...
const Dividervenue_special_rules_divider = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[venue_special_rules_dividere4760?.refresh])

  if (venue_special_rules_dividere4760?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 25`,gridRow: `46 / 49`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Dividervenue_special_rules_divider
