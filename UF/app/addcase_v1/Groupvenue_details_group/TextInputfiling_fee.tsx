...
const TextInputfiling_fee = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:LAP:AFGK:LAP:AFK:addCase:AFVK:v1|98c070f07547402d854c337bbb817ac6|49515d7b81c14ef58f7e981b34e389dd"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,addCase_v1:{...pre?.addCase_v1,filing_fee:undefined}}));
    if(dynamicStateandType.type=="number"){
    setvenue_details_group17ac6((prev: any) => ({ ...prev, filing_fee: +e.target.value }));
    }
    else{
    setvenue_details_group17ac6((prev: any) => ({ ...prev, filing_fee: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "49515d7b81c14ef58f7e981b34e389dd"
      );
      ...
      //     controlId: "49515d7b81c14ef58f7e981b34e389dd",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "49515d7b81c14ef58f7e981b34e389dd") {
        handleChange({target:{value:venue_details_group17ac6Ref?.current?.filing_fee||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "49515d7b81c14ef58f7e981b34e389dd") {
        handleBlur({target:{value:venue_details_group17ac6Ref?.current?.filing_fee||""}});
      }
    };
  ...
  if(dfd_addcase_v1Props?.setSearchFilters && dfd_addcase_v1Props?.data)
  {
    if(Array.isArray(dfd_addcase_v1Props.data) && dfd_addcase_v1Props.data.length > 0){
      setvenue_details_group17ac6((pre:any)=>({...pre,filing_fee:dfd_addcase_v1Props.data[0]?.filing_fee}));
    }
  }
  },[dfd_addcase_v1Props?.setSearchFilters])
  if (filing_fee389dd?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={venue_details_group17ac6?.filing_fee||""}
         disabled= {filing_fee389dd?.isDisabled ? true : false}
        pin='brick-brick'     
        placeholder='$ 0.00'      
        view='normal'
        contentAlign={"left"}
      ...
      errorMessage={error}
        validationState={validate?.addCase_v1?.filing_fee ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
