...
const Textven_name_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {ven_name_textef3acProps, setven_name_textef3acProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[ven_name_textef3ac?.refresh])

  if (ven_name_textef3ac?.isHidden) {
    return <></>
  }
