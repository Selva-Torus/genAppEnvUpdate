...
const Textcraete_header_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {craete_header_textace67Props, setcraete_header_textace67Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[craete_header_textace67?.refresh])

  if (craete_header_textace67?.isHidden) {
    return <></>
  }
