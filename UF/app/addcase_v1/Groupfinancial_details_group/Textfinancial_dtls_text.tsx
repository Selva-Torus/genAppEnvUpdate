...
const Textfinancial_dtls_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {financial_dtls_text3b122Props, setfinancial_dtls_text3b122Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[financial_dtls_text3b122?.refresh])

  if (financial_dtls_text3b122?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Financial Details")}
</Text>
  </div>
  )
}

export default Textfinancial_dtls_text
