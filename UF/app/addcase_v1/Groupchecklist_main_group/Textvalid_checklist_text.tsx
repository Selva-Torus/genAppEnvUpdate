...
const Textvalid_checklist_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {valid_checklist_textc0f22Props, setvalid_checklist_textc0f22Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[valid_checklist_textc0f22?.refresh])

  if (valid_checklist_textc0f22?.isHidden) {
    return <></>
  }
