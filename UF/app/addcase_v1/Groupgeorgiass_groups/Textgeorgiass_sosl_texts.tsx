...
const Textgeorgiass_sosl_texts = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {georgiass_sosl_texts52ad5Props, setgeorgiass_sosl_texts52ad5Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[georgiass_sosl_texts52ad5?.refresh])

  if (georgiass_sosl_texts52ad5?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Texas SOL: 4 years")}
</Text>
  </div>
  )
}

export default Textgeorgiass_sosl_texts
