...
const Textdebt_info_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {debt_info_text9078eProps, setdebt_info_text9078eProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[debt_info_text9078e?.refresh])

  if (debt_info_text9078e?.isHidden) {
    return <></>
  }
