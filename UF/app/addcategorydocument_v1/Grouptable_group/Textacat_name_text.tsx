...
const Textacat_name_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[acat_name_textc9d3e?.refresh])

  if (acat_name_textc9d3e?.isHidden) {
    return <></>
  }
...
export default Textacat_name_text
