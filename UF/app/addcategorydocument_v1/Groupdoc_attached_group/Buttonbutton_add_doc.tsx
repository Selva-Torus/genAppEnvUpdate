...
const Buttonbutton_add_doc = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const doc_attached_groupb9604Ref = useRef(doc_attached_groupb9604);
  useEffect(() => {
    doc_attached_groupb9604Ref.current = doc_attached_groupb9604;
  ...
  const doc_attached_groupb9604PropsRef = useRef(doc_attached_groupb9604Props);
  useEffect(() => {
    doc_attached_groupb9604PropsRef.current = doc_attached_groupb9604Props;
  ...
  const handleMapper=async (data?:any) => {
    try{     
      data = {...data,...doc_attached_groupb9604Ref.current};
      let parentRowSpan = 152;
      const orchestrationData : any = getControlOrchestrationData(
        controlData,
        "fd72de83de24cd5c26d4606276bb9604",
        "2c09d388ef1797fa2e26593fcce24b11"
      );
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "button_add_doc24b11") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "2c09d388ef1797fa2e26593fcce24b11") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "button_add_doc24b11");
    return () => {
  ...
  useEffect(()=>{
    if (!button_add_doc24b11?.trigger) return;
      if(button_add_doc24b11?.trigger){
      setbutton_add_doc24b11((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[button_add_doc24b11?.trigger])

  useEffect(()=>{
    if(button_add_doc24b11?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[button_add_doc24b11?.refresh])
  ...
  async function handleSave4b11_1_1_1(){

    setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    // await delay(1000); // RTGS New Payment: isProcessing turns false before API completion.

    const doc_attached_groupb9604Props = doc_attached_groupb9604PropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.addCategoryDocument_v1 || {}).some(val => {
  ...
  return val === 'invalid';
    ...
    try{
      let mainData:any=structuredClone(doc_attached_groupb9604Ref.current);
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:AMS:AFK:addCategoryDocument:AFVK:v1|8124bff30627f7480d9bfbc9e8b48b43"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:AMS:AFK:addCategoryDocument:AFVK:v1|8124bff30627f7480d9bfbc9e8b48b43"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "2c09d388ef1797fa2e26593fcce24b11",
  "type": "button",
  "name": "button_add_doc",
  ...
  "children": [
    {
      "id": "2c09d388ef1797fa2e26593fcce24b11.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "2c09d388ef1797fa2e26593fcce24b11.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "2c09d388ef1797fa2e26593fcce24b11.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "2c09d388ef1797fa2e26593fcce24b11.1.1.1.1.1",
                  ...
                  "children": [
                    {
                      "id": "9b20382bc06fd1df012270625059b042.1.1.1.1.1.1",
                      "value": "",
                      "type": "screen",
                      "name": "addCategoryDocument.v1|category_doc_table",
                      "label": "addCategoryDocument.v1|category_doc_table",
                      "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:addCategoryDocument:AFVK:v1|category_doc_table",
                      "elementType": "group",
                      "groupType": "table",
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:AMS:AFK:addCategoryDocument:AFVK:v1|8124bff30627f7480d9bfbc9e8b48b43"
          ]
        }
      ]
    }
      ...
      sourceId+= "|"+"fd72de83de24cd5c26d4606276bb9604";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:addCategoryDocument:AFVK:v1"+"|"+"fd72de83de24cd5c26d4606276bb9604"+"|"+eventProperty.id;
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...doc_attached_groupb9604Ref.current, ...nullFilter(table_groupefcb8) });
    let reworkKeys:any[]=[];
    ...
    if("_groupArrays_" in reworkedObject )
    {
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"fd72de83de24cd5c26d4606276bb9604",
              controlId:"2c09d388ef1797fa2e26593fcce24b11"
            };
            if (encryptionFlagCont) {
        ...
        if(doc_attached_groupb9604?.upId){
          te_saveBody['upId']= doc_attached_groupb9604?.upId;
        }
        if(doc_attached_groupb9604?.upid){
          te_saveBody['upId']= doc_attached_groupb9604?.upid;
        }
        ...
        if (doc_attached_groupb9604Props.ssKey !== '' && doc_attached_groupb9604Props.ssKey !== undefined) {
          te_saveBody["ssKey"] = doc_attached_groupb9604Props.ssKey;
    ...
    //riseListen
    // for group
    setcategory_doc_table9b042Props((pre:any)=>({...pre,refresh:!pre?.refresh}));
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdoc_attached_groupb9604((prev: any) => ({ ...prev, button_add_doc: true }));
        //onClick

    //saveHandler
    await handleSave4b11_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdoc_attached_groupb9604((prev: any) => ({ ...prev, button_add_doc: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
 ...
 if (button_add_doc24b11?.isHidden) {
    return <></>
  }
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {button_add_doc24b11?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Add Document")}
