...
const TextInputleave_balance_before = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:viewLeaveApply:AFVK:v1|cb67779dc62446ee4c8fe7435ac98af0|3c59a8efa5974256e0085ed3c5bda2cc"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,viewLeaveApply_v1:{...pre?.viewLeaveApply_v1,leave_balance_before:undefined}}));
    if(dynamicStateandType.type=="number"){
    setleave_balance_group98af0((prev: any) => ({ ...prev, leave_balance_before: +e.target.value }));
    }
    else{
    setleave_balance_group98af0((prev: any) => ({ ...prev, leave_balance_before: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "3c59a8efa5974256e0085ed3c5bda2cc"
      );
      ...
      //     controlId: "3c59a8efa5974256e0085ed3c5bda2cc",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "3c59a8efa5974256e0085ed3c5bda2cc") {
        handleChange({target:{value:leave_balance_group98af0Ref?.current?.leave_balance_before||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "3c59a8efa5974256e0085ed3c5bda2cc") {
        handleBlur({target:{value:leave_balance_group98af0Ref?.current?.leave_balance_before||""}});
      }
    };
  ...
  if(dfd_applyleave_v1Props?.setSearchFilters && dfd_applyleave_v1Props?.data)
  {
    if(Array.isArray(dfd_applyleave_v1Props.data) && dfd_applyleave_v1Props.data.length > 0){
      setleave_balance_group98af0((pre:any)=>({...pre,leave_balance_before:dfd_applyleave_v1Props.data[0]?.leave_balance_before}));
    }
  }
  },[dfd_applyleave_v1Props?.setSearchFilters])
  if (leave_balance_beforeda2cc?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={leave_balance_group98af0?.leave_balance_before||""}
         disabled= {leave_balance_beforeda2cc?.isDisabled ? true : false}
        pin='brick-brick'     
        placeholder='--'      
        view='normal'
        contentAlign={"left"}
      ...
      errorMessage={error}
        validationState={validate?.viewLeaveApply_v1?.leave_balance_before ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
