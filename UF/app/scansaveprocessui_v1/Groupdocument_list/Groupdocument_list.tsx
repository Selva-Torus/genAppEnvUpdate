 ...
 /////////////
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("doclisttable")){
        setdoclisttable56e97Props((pre:any)=>({...pre,...doclisttable56e97,isDisabled:true}));

    }else
    {
      if(doclisttable56e97?.isDisabled==null)
      {
        setdoclisttable56e97Props((pre:any)=>({...pre,isDisabled:false}));
      }
    }
  //////////////
    if (code != '') {
  ...
  useEffect(()=>{
    if(list_tab_groupd6905?.list_tab_group === "document_list"){
    handleOnChange()
    }
    ...
    <div 
      ...
      className={`flex flex-col overflow-auto rounded-md  ${isDark ? 'text-white' : 'text-black'}`}
       onClick={(e:any)=>{e.stopPropagation()
        handleOnClick({}, 0);
          setscansaveprocessui_v1((pre:any)=>({...pre,_selectedGroup_:"document_list"}))
        }}
    >
