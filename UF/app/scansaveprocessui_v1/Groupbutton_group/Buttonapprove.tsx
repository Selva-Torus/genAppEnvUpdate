 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      ...
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "6b31c6b63ab740dd95c469e837005fe8"
      );
    ...
    if(orchestrationData?.data?.rule?.nodes?.length > 0){
      ...
      if("approve" in button_group74f3eProps?.dynamicActionRule){
        setShowFlag(true)
        setStyleSate({...getGridPositionFromOrder(button_group74f3eProps?.dynamicActionRule?.approve,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }
      else
      {
        setShowFlag(false)   
      ...
      if("approve" in scansaveprocessui_v1?.button_group && scansaveprocessui_v1?.button_group["approve"]?.itsHaveArtifact== true)
      {
        setShowFlag(scansaveprocessui_v1?.button_group["approve"]?.show||false)
        
        setStyleSate({...getGridPositionFromOrder(scansaveprocessui_v1?.button_group?.approve?.order,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }else{
        setShowFlag(false)
      }
    }
  ...
  useEffect(()=>{
    ...
    const triggerElementHandler = async (id:any) => {
      if (id === "6b31c6b63ab740dd95c469e837005fe8") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "approve05fe8");
    return () => {
  ...
  useEffect(()=>{
    if (!approve05fe8?.trigger) return;
      if(approve05fe8?.trigger){
      setapprove05fe8((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[approve05fe8?.trigger])

  useEffect(()=>{
    if(approve05fe8?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[approve05fe8?.refresh])
  ...
  async function handleSave5fe8_1_1_2(){
  ...
  "id": "6b31c6b63ab740dd95c469e837005fe8",
  "type": "button",
  "name": "approve",
  "label": "approve",
  "sequence": 1,
  "children": [
    {
      "id": "6b31c6b63ab740dd95c469e837005fe8.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "6b31c6b63ab740dd95c469e837005fe8.1.1.1",
        ...
        {
          "id": "6b31c6b63ab740dd95c469e837005fe8.1.1.2",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "6b31c6b63ab740dd95c469e837005fe8.1.1.2.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "6b31c6b63ab740dd95c469e837005fe8.1.1.2.1.1",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "2f07f01a54904a4c93e25f47cda01c61.1.1.2.1.1.1",
                      "type": "group",
                ...
                {
                  "id": "6b31c6b63ab740dd95c469e837005fe8.1.1.2.1.2",
                  "eventContext": "rise",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "6b31c6b63ab740dd95c469e837005fe8.1.1.2.1.2.1",
                      "eventContext": "riseListen",
                      "value": "",
                      "type": "handlerNode",
                      "name": "showArtifact",
                      ...
                      "children": [
                        {
                          "id": "2798d8305d5a4ddd801179fcdf8d2f98.1.1.2.1.2.1.1",
                          "value": "",
                          "type": "screen",
                          ...
                          "elementType": "",
                          "groupType": "",
                          "sequence": "1.1.2.1.2.1.1",
                          "children": []
                        }
                      ]
                    },
                    {
                      "id": "6b31c6b63ab740dd95c469e837005fe8.1.1.2.1.2.2",
                      "eventContext": "riseListen",
                      "value": "",
                      "type": "handlerNode",
                      "name": "refreshElement",
                      ...
                      "children": [
                        {
                          "id": "ec0fa3b3e01145269d4d5b2823e0a253.1.1.2.1.2.2.1",
                          "value": "",
                          "type": "screen",
                ...
                {
                  "id": "6b31c6b63ab740dd95c469e837005fe8.1.1.2.1.3",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "f2dd7aceaf454c72bdb1327c439f4607.1.1.2.1.3.1",
                      "type": "group",
                ...
                {
                  "id": "6b31c6b63ab740dd95c469e837005fe8.1.1.2.1.4",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "409b134cde0449b5a031a7686df3d198.1.1.2.1.4.1",
                      "type": "group",
                ...
                {
                  "id": "6b31c6b63ab740dd95c469e837005fe8.1.1.2.1.5",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "18c17fb7694d4c3a944cddb2c4ed2894.1.1.2.1.5.1",
                      "type": "group",
                ...
                {
                  "id": "6b31c6b63ab740dd95c469e837005fe8.1.1.2.1.6",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "0999fb419263477bb8b19cf211256e97.1.1.2.1.6.1",
                      "type": "group",
                ...
                {
                  "id": "6b31c6b63ab740dd95c469e837005fe8.1.1.2.1.7",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "6b332e1a71dd48d3a5b440a432017ec7.1.1.2.1.7.1",
                      "type": "group",
                ...
                {
                  "id": "6b31c6b63ab740dd95c469e837005fe8.1.1.2.1.8",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "bfcb81a3220f484494becea016e02d0e.1.1.2.1.8.1",
                      "type": "group",
  ...
  // saveHandler
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              ...
              controlId:"6b31c6b63ab740dd95c469e837005fe8"
            };
            if (encryptionFlagCont) {
    ...
    if (button_group74f3eProps?.tableName) {
      te_eventEmitterBody["tableName"] = button_group74f3eProps?.tableName;
    }
    if (encryptionFlagCont) {
  ...
  }, [scansaveprocessui_v1?.button_group?.approve,button_group74f3eProps?.dynamicActionRule?.approve,control_tab_groupbc3e2])

 if (approve05fe8?.isHidden) {
    return <></>
  }
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {approve05fe8?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
          icon="MdApproval"
