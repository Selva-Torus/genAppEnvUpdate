 ...
 /////////////
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("valdnlisttable")){
        setvaldnlisttable17ec7Props((pre:any)=>({...pre,...valdnlisttable17ec7,isDisabled:true}));

    }else
    {
      if(valdnlisttable17ec7?.isDisabled==null)
      {
        setvaldnlisttable17ec7Props((pre:any)=>({...pre,isDisabled:false}));
      }
    }
  //////////////
    if (code != '') {
  ...
  useEffect(()=>{
    if(list_tab_groupd6905?.list_tab_group === "validation_list"){
    handleOnChange()
    }
    ...
    <div 
      ...
      className={`flex flex-col overflow-auto rounded-md  ${isDark ? 'text-white' : 'text-black'}`}
       onClick={(e:any)=>{e.stopPropagation()
        handleOnClick({}, 0);
          setscansaveprocessui_v1((pre:any)=>({...pre,_selectedGroup_:"validation_list"}))
        }}
    >
