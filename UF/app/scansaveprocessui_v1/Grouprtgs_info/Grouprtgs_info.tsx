 ...
 /////////////
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("allcontrols")){
        setallcontrols71c54((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(allcontrols71c54?.isDisabled==null)
      {
        setallcontrols71c54((pre:any)=>({...pre,isDisabled:false}));
      }
    }
  //////////////
    if (code != '') {
  ...
  useEffect(()=>{
    if(control_tab_groupbc3e2?.control_tab_group === "rtgs_info"){
    handleOnChange()
    }
    ...
    <div 
      ...
      className={`flex flex-col overflow-auto rounded-md  ${isDark ? 'text-white' : 'text-black'}`}
       onClick={(e:any)=>{e.stopPropagation()
        handleOnClick({}, 0);
          setscansaveprocessui_v1((pre:any)=>({...pre,_selectedGroup_:"rtgs_info"}))
        }}
    >
