...
const TextInputrate_ref_no = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const [dynamicStateandType,setDynamicStateandType]=useState<Record<string, any>>({name:'rate_ref_no',type:"number"})
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "62b60509a8084b77bfa223a118a82399") {
        handleChange({target:{value:basicinfo3d198Ref?.current?.rate_ref_no||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "62b60509a8084b77bfa223a118a82399") {
        handleBlur({target:{value:basicinfo3d198Ref?.current?.rate_ref_no||""}});
      }
    };
  ...
  return (   
    <div  
      style={{gridColumn: `13 / 19`,gridRow: `35 / 47`, gap:``, height: `100%`, overflow: 'auto', display: 'flex', flexDirection: 'column'}} >
