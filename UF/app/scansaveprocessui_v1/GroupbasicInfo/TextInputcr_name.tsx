...
const TextInputcr_name = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT005:FNGK:AF:FNK:UF-UFW:CATK:GSS:AFGK:RTGS:AFK:scanSaveProcessUi:AFVK:v1|409b134cde0449b5a031a7686df3d198|ed5ab433883844f9b9437c7fa4ba4b34"
    }
  ],
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "ed5ab433883844f9b9437c7fa4ba4b34") {
        handleChange({target:{value:basicinfo3d198Ref?.current?.cr_name||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "ed5ab433883844f9b9437c7fa4ba4b34") {
        handleBlur({target:{value:basicinfo3d198Ref?.current?.cr_name||""}});
      }
    };
  ...
  if(dfd_scansaveprocessdfd_v1Props?.setSearchFilters && dfd_scansaveprocessdfd_v1Props?.data)
  {
    if(Array.isArray(dfd_scansaveprocessdfd_v1Props.data) && dfd_scansaveprocessdfd_v1Props.data.length > 0){
      setbasicinfo3d198((pre:any)=>({...pre,cr_name:dfd_scansaveprocessdfd_v1Props.data[0]?.cr_name}));
    }
  }
  ...
  return (   
    <div  
      style={{gridColumn: `7 / 13`,gridRow: `9 / 21`, gap:``, height: `100%`, overflow: 'auto', display: 'flex', flexDirection: 'column'}} >
