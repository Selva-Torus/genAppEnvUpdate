...
const TextInputrate_code = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "5d10ccecea1648d597de15c458de56ad") {
        handleChange({target:{value:basicinfo3d198Ref?.current?.rate_code||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "5d10ccecea1648d597de15c458de56ad") {
        handleBlur({target:{value:basicinfo3d198Ref?.current?.rate_code||""}});
      }
    };
  ...
  return (   
    <div  
      style={{gridColumn: `19 / 25`,gridRow: `22 / 34`, gap:``, height: `100%`, overflow: 'auto', display: 'flex', flexDirection: 'column'}} >
