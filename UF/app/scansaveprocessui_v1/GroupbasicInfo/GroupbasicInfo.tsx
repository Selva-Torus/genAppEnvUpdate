 ...
 /////////////
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("basic_info")){
        setbasic_info216f3((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(basic_info216f3?.isDisabled==null)
      {
        setbasic_info216f3((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("waive_charges")){
        setwaive_charges929e5((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(waive_charges929e5?.isDisabled==null)
      {
        setwaive_charges929e5((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("cr_account")){
        setcr_accounta818b((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(cr_accounta818b?.isDisabled==null)
      {
        setcr_accounta818b((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("cr_name")){
        setcr_namea4b34((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(cr_namea4b34?.isDisabled==null)
      {
        setcr_namea4b34((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("cr_bank_code")){
        setcr_bank_code8a2bc((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(cr_bank_code8a2bc?.isDisabled==null)
      {
        setcr_bank_code8a2bc((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("cr_bank_name")){
        setcr_bank_name434eb((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(cr_bank_name434eb?.isDisabled==null)
      {
        setcr_bank_name434eb((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("cr_bank_bic")){
        setcr_bank_bic3d26f((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(cr_bank_bic3d26f?.isDisabled==null)
      {
        setcr_bank_bic3d26f((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("forex_currency")){
        setforex_currency65e0b((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(forex_currency65e0b?.isDisabled==null)
      {
        setforex_currency65e0b((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("exchange_rate")){
        setexchange_rate88caf((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(exchange_rate88caf?.isDisabled==null)
      {
        setexchange_rate88caf((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("rate_code")){
        setrate_codee56ad((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(rate_codee56ad?.isDisabled==null)
      {
        setrate_codee56ad((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("forex_amount")){
        setforex_amounta58a5((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(forex_amounta58a5?.isDisabled==null)
      {
        setforex_amounta58a5((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("base_amount")){
        setbase_amount3b226((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(base_amount3b226?.isDisabled==null)
      {
        setbase_amount3b226((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("rate_ref_no")){
        setrate_ref_no82399((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(rate_ref_no82399?.isDisabled==null)
      {
        setrate_ref_no82399((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("rate_cust_id")){
        setrate_cust_idad42a((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(rate_cust_idad42a?.isDisabled==null)
      {
        setrate_cust_idad42a((pre:any)=>({...pre,isDisabled:false}));
      }
    }
  //////////////
    if (code != '') {
    ...
    <div 
      ...
      className={`flex flex-col overflow-auto rounded-md !rounded-lg p-3 pr-4 pl-4 ${isDark ? 'text-white' : 'text-black'}`}
       onClick={(e:any)=>{e.stopPropagation()
        handleOnClick({}, 0);
          setscansaveprocessui_v1((pre:any)=>({...pre,_selectedGroup_:"basicinfo"}))
        }}
    >
