...
const TextInputcr_account = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT005:FNGK:AF:FNK:UF-UFW:CATK:GSS:AFGK:RTGS:AFK:scanSaveProcessUi:AFVK:v1|409b134cde0449b5a031a7686df3d198|578d127f6fe44253be91fd1230aa818b"
    }
  ],
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "578d127f6fe44253be91fd1230aa818b") {
        handleChange({target:{value:basicinfo3d198Ref?.current?.cr_account||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "578d127f6fe44253be91fd1230aa818b") {
        handleBlur({target:{value:basicinfo3d198Ref?.current?.cr_account||""}});
      }
    };
  ...
  if(dfd_scansaveprocessdfd_v1Props?.setSearchFilters && dfd_scansaveprocessdfd_v1Props?.data)
  {
    if(Array.isArray(dfd_scansaveprocessdfd_v1Props.data) && dfd_scansaveprocessdfd_v1Props.data.length > 0){
      setbasicinfo3d198((pre:any)=>({...pre,cr_account:dfd_scansaveprocessdfd_v1Props.data[0]?.cr_account}));
    }
  }
  ...
  return (   
    <div  
      style={{gridColumn: `1 / 7`,gridRow: `9 / 21`, gap:``, height: `100%`, overflow: 'auto', display: 'flex', flexDirection: 'column'}} >
