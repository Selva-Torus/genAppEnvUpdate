...
const TextInputexchange_rate = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const [dynamicStateandType,setDynamicStateandType]=useState<Record<string, any>>({name:'exchange_rate',type:"number"})
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "54d2007379c34ae88098ab09cbb88caf") {
        handleChange({target:{value:basicinfo3d198Ref?.current?.exchange_rate||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "54d2007379c34ae88098ab09cbb88caf") {
        handleBlur({target:{value:basicinfo3d198Ref?.current?.exchange_rate||""}});
      }
    };
  ...
  return (   
    <div  
      style={{gridColumn: `13 / 19`,gridRow: `22 / 34`, gap:``, height: `100%`, overflow: 'auto', display: 'flex', flexDirection: 'column'}} >
