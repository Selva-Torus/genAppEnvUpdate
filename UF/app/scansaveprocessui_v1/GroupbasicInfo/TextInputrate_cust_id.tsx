...
const TextInputrate_cust_id = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const [dynamicStateandType,setDynamicStateandType]=useState<Record<string, any>>({name:'rate_cust_id',type:"number"})
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "b661bda49225438eb99e8b0118ead42a") {
        handleChange({target:{value:basicinfo3d198Ref?.current?.rate_cust_id||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "b661bda49225438eb99e8b0118ead42a") {
        handleBlur({target:{value:basicinfo3d198Ref?.current?.rate_cust_id||""}});
      }
    };
  ...
  return (   
    <div  
      style={{gridColumn: `19 / 25`,gridRow: `35 / 47`, gap:``, height: `100%`, overflow: 'auto', display: 'flex', flexDirection: 'column'}} >
