...
const TextInputbase_currency = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "9549a13b6e484a73ae4865515e4b386d") {
        handleChange({target:{value:commoninfof4607Ref?.current?.dr_currency||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "9549a13b6e484a73ae4865515e4b386d") {
        handleBlur({target:{value:commoninfof4607Ref?.current?.dr_currency||""}});
      }
    };
