...
const TextInputdr_cust_ac_sanc_lmt = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT005:FNGK:AF:FNK:UF-UFW:CATK:GSS:AFGK:RTGS:AFK:scanSaveProcessUi:AFVK:v1|f2dd7aceaf454c72bdb1327c439f4607|ef43257873b2402b995bbd79124b74f7"
    }
  ],
  ...
  const [dynamicStateandType,setDynamicStateandType]=useState<Record<string, any>>({name:'dr_cust_ac_sanc_lmt',type:"number"})
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "ef43257873b2402b995bbd79124b74f7") {
        handleChange({target:{value:commoninfof4607Ref?.current?.dr_cust_ac_sanc_lmt||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "ef43257873b2402b995bbd79124b74f7") {
        handleBlur({target:{value:commoninfof4607Ref?.current?.dr_cust_ac_sanc_lmt||""}});
      }
    };
  ...
  if(dfd_scansaveprocessdfd_v1Props?.setSearchFilters && dfd_scansaveprocessdfd_v1Props?.data)
  {
    if(Array.isArray(dfd_scansaveprocessdfd_v1Props.data) && dfd_scansaveprocessdfd_v1Props.data.length > 0){
      setcommoninfof4607((pre:any)=>({...pre,dr_cust_ac_sanc_lmt:dfd_scansaveprocessdfd_v1Props.data[0]?.dr_cust_ac_sanc_lmt}));
    }
  }
  ...
  return (   
    <div  
      style={{gridColumn: `1 / 9`,gridRow: `22 / 34`, gap:``, height: `100%`, overflow: 'auto', display: 'flex', flexDirection: 'column'}} >
