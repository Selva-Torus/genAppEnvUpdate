...
const Buttonaction_rtgs_list = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData,onSelectLock,rowIndex,currentSelectedIds,skipUnlockRef,tableName}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any,onSelectLock?:any,rowIndex?:number,currentSelectedIds?:string[],skipUnlockRef?:React.MutableRefObject<boolean>,tableName?:string}) => {
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "e3e1602c0c944527a4fa61bf18acf67e"
      );
 ...
 if (action_rtgs_listcf67e?.isHidden) {
    return <></>
  }
  ...
  return (
    ...
    >
        ...
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {action_rtgs_listcf67e?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
