...
const TextInputremittance_info = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "5d80022ad84947259d615c470dfba5e0") {
        handleChange({target:{value:additionalinfod2894Ref?.current?.remittance_info||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "5d80022ad84947259d615c470dfba5e0") {
        handleBlur({target:{value:additionalinfod2894Ref?.current?.remittance_info||""}});
      }
    };
