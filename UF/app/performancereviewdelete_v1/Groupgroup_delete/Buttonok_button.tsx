...
const Buttonok_button = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      ...
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "aadd3270762b72f1e8717da37779b4bd"
      );
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "ok_button9b4bd") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "aadd3270762b72f1e8717da37779b4bd") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "ok_button9b4bd");
    return () => {
  ...
  useEffect(()=>{
    if (!ok_button9b4bd?.trigger) return;
      if(ok_button9b4bd?.trigger){
      setok_button9b4bd((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[ok_button9b4bd?.trigger])

  useEffect(()=>{
    if(ok_button9b4bd?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[ok_button9b4bd?.refresh])
  ...
  async function handleSaveb4bd_1_1_1(){
      

  setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    await delay(1000); 

    const group_delete3ee3bProps = group_delete3ee3bPropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.performanceReviewDelete_v1 || {}).some(val => {
    ...
    try{
      ...
      let mainData:any=structuredClone(group_delete3ee3bRef.current);
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addPerformanceReviewModify:AFVK:v1|798452814b1e4817a9fe1011935fa986"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addPerformanceReviewModify:AFVK:v1|798452814b1e4817a9fe1011935fa986"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
        if(group_delete3ee3b?.upId === "" && (!lockedData?.data || Object.keys(lockedData?.data)?.length == 0)){
          throw 'Please give proper data';
        }
      let eventProperty :any = {
  "id": "aadd3270762b72f1e8717da37779b4bd",
  "type": "button",
  "name": "ok_button",
  "label": "ok_button",
  "sequence": 1,
  "children": [
    {
      "id": "aadd3270762b72f1e8717da37779b4bd.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "aadd3270762b72f1e8717da37779b4bd.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "aadd3270762b72f1e8717da37779b4bd.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "aadd3270762b72f1e8717da37779b4bd.1.1.1.1.1",
                  "eventContext": "rise",
                  "value": "",
                  "type": "handlerNode",
                  "name": "closeHandler",
            ...
            {
              "id": "aadd3270762b72f1e8717da37779b4bd.1.1.1.2",
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addPerformanceReviewModify:AFVK:v1|798452814b1e4817a9fe1011935fa986"
          ]
        }
      ]
    }
      ...
      let sourceId : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:performanceReviewDelete:AFVK:v1";
      sourceId+= "|"+"96494fb4b5c9ae186734b6f9b033ee3b";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:performanceReviewDelete:AFVK:v1"+"|"+"96494fb4b5c9ae186734b6f9b033ee3b"+"|"+eventProperty.id;
      ...
      te_eventEmitterBody = {
        ...
        upId : group_delete3ee3b?.upId? [group_delete3ee3b?.upId ] : lockedData.processIds,
      ...
      if(Array.isArray(tableData) && hasValidupId){
        ...
        ...uf_initiatePf.data.nodeProperty,
        data:{"trs_event_process_status":uf_getPFDetails.status},
        upId : group_delete3ee3b?.upId? [group_delete3ee3b?.upId ] : upId,
        event : uf_initiatePf.data.eventProperty?.source?.status,
        sourceId : uf_initiatePf.data.eventProperty?.sourceId
      }}else{
        te_eventEmitterBody = {
        ...uf_initiatePf.data.nodeProperty,
        data:{"trs_event_process_status":uf_getPFDetails.status},
        upId : group_delete3ee3b?.upId? [group_delete3ee3b?.upId ] : group_delete3ee3b?.trs_process_id? [group_delete3ee3b?.trs_process_id ] : lockedData.processIds,
        event : uf_initiatePf.data.eventProperty?.source?.status,
        sourceId : uf_initiatePf.data.eventProperty?.sourceId,
        controlName: "ok_button"
      }
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...group_delete3ee3bRef.current });
    let reworkKeys:any[]=[];
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"96494fb4b5c9ae186734b6f9b033ee3b",
              controlId:"aadd3270762b72f1e8717da37779b4bd"
            };
            if (encryptionFlagCont) {
    ...
    //eventEmitter
    if (group_delete3ee3bProps.ssKey !== '' && group_delete3ee3bProps.ssKey !== undefined) {
    te_eventEmitterBody["ssKey"] = group_delete3ee3bProps.ssKey;          
    }
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setgroup_delete3ee3b((prev: any) => ({ ...prev, ok_button: true }));
        //onClick

    //eventEmitter
    await handleSaveb4bd_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setgroup_delete3ee3b((prev: any) => ({ ...prev, ok_button: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
 ...
 if (ok_button9b4bd?.isHidden) {
    return <></>
  }

  return (
    <div
      style={{gridColumn: `19 / 25`,gridRow: `46 / 52`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          className="!bg-[#108DDA] hover:!bg-[#38BDF8] !text-white !rounded-lg !font-bold"
          onClick={handleClick}
          disabled= {ok_button9b4bd?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
          icon="MdDoneAll"
