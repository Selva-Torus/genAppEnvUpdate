...
const Textreviewnum = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[reviewnumb10f3?.refresh])

  if (reviewnumb10f3?.isHidden) {
    return <></>
  }
