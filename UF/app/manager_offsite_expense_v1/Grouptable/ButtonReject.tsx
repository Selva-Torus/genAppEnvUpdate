...
const ButtonReject =  ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
  ...
  },[rejecte566a?.refresh,currentToken])
  ...
  async function handleSave566a_1_1_1(){
    try{
  ...
  "id": "30ccc2bd0e934f049e63731cd83e566a",
  "type": "button",
  "name": "Reject",
  "sequence": 1,
  "children": [
    {
      "id": "30ccc2bd0e934f049e63731cd83e566a.1.1",
      "type": "eventNode",
      "name": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "30ccc2bd0e934f049e63731cd83e566a.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "30ccc2bd0e934f049e63731cd83e566a.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "30ccc2bd0e934f049e63731cd83e566a.1.1.1.1.1",
        ...
        if(Array.isArray(table98ff5))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              ...
              controlId:"30ccc2bd0e934f049e63731cd83e566a"
            };
            if (encryptionFlagCont) {
 ...
 >
        {showFlag && <Button 
          ...
          disabled= {rejecte566a?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Reject")}
