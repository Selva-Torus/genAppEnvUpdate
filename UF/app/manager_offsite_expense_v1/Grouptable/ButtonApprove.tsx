...
const ButtonApprove =  ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
  ...
  },[approve5709e?.refresh,currentToken])
  ...
  async function handleSave709e_1_1_1(){
    try{
      let mainData:any=structuredClone(table98ff5);
  ...
  "id": "4c673f44f9da4729a67b9b3e7c95709e",
  "type": "button",
  "name": "Approve",
  "sequence": 1,
  "children": [
    {
      "id": "4c673f44f9da4729a67b9b3e7c95709e.1.1",
      "type": "eventNode",
      "name": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "4c673f44f9da4729a67b9b3e7c95709e.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "4c673f44f9da4729a67b9b3e7c95709e.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "4c673f44f9da4729a67b9b3e7c95709e.1.1.1.1.1",
                  ...
                  "children": [
                    {
                      "id": "68aacd73430449af9dd1ef8b5a998ff5.1.1.1.1.1.1",
                      "value": "",
                      "type": "screen",
                      "name": "Offsite_Expense_Manager_Table.v1|table",
                      "label": "",
                      "key": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_Manager_Table:AFVK:v1|table",
                      "elementType": "group",
      ...
      let sourceId:string = "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_Manager_Table:AFVK:v1";
      sourceId+= "|"+"68aacd73430449af9dd1ef8b5a998ff5";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_Manager_Table:AFVK:v1"+"|"+"68aacd73430449af9dd1ef8b5a998ff5"+"|"+eventProperty.id;
  ...
  // saveHandler
    ...
    let reworkedObject:any=nullFilter(table98ff5);
    let reworkKeys:any[]=[];
      Object.keys(reworkedObject).map((item:any)=>{
        if(typeof table98ff5[item]=='object' && Array.isArray( table98ff5[item]) &&  table98ff5[item].length && typeof table98ff5[item][0] !="string" ){
          if( table98ff5[item].length>0 && !Object.keys(table98ff5[item][0]).includes('_isSelected_'))
      ...
      if(reworkKeys.length)
      {
        for(let i=0;i<reworkKeys.length;i++){
          let fileBody:any = table98ff5[reworkKeys[i]].map((item:any) => item?.file)
      ...
      Object.keys(reworkedObject).map((item:any)=>{
        if(typeof table98ff5[item]=='object')
        {
          if( table98ff5[item].length>0 &&Object.keys(table98ff5[item][0]).includes('_isSelected_'))
          {
      ...
      if ("childTables" in table98ff5) {
        te_saveBody.childTables = table98ff5.childTables
      }  

      if (uf_getPFDetails.key != undefined) {
        let formData:any={};
        let ifoResponse:any[]=[];
        if(Array.isArray(table98ff5))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"68aacd73430449af9dd1ef8b5a998ff5",
              controlId:"4c673f44f9da4729a67b9b3e7c95709e"
            };
            if (encryptionFlagCont) {
    ...
    ///////////////////////
    toast('Data Approved', 'success');
    // refreshElement
    // for group
    settable98ff5Props((pre:any)=>({...pre,refresh:!pre?.refresh}));
    }
    catch(err:any)
    {
      ...
      if(Array.isArray(table98ff5)){
        ...
        // needClearValue
        let keys: any = {};
        Object.keys(table98ff5).map((item: any) => {
          keys[item] = '';
        })
        settable98ff5(keys);
      }
  ...
  const handleClick=async()=>{
    if(table98ff5Props?.validation==true && table98ff5Props?.required==true || table98ff5Props?.required==true)
    {
 ...
 >
        {showFlag && <Button 
          ...
          disabled= {approve5709e?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Approve")}
