...
let defaultColumns = [
  {
    "id": "trs_created_by",
    "nodeid": "df82c1e8abea474c8477355b4668053b",
    "name": "Employee",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "expense_name",
    "nodeid": "60349777ab1b4d0babbcf1236a594440",
    "name": "Expense Name",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "claim_category",
    "nodeid": "f4c02e5258b2472dbb4aa984f0f9ec61",
    "name": "Category",
    "meta": {
      "sort": true
    },
  ...
  },
  {
    ...
    "nodeid": "c05399971b764483a0ebcff1190689b8",
    "name": "Amount",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "formatted_date",
    "nodeid": "e4f5736ea7294b80b04ed2971621030f",
    "name": "Date",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "trs_status",
    "nodeid": "961446bc3a214777bffe62b74b0759b6",
    "name": "Status",
    "meta": {
      "sort": true
    },
...
const Tabletable = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,refetch, setRefetch,setData,encryptionFlagCompData,paginationDetails,open, setOpen, ref, ButtonGoRuleData, setButtonGoRuleData }: any)=>{
 ...
 /////////////
    ...
    mapperData = [
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_Manager_Table:AFVK:v1|68aacd73430449af9dd1ef8b5a998ff5|34e702858c974cc4a31c9faf1d556078"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_Manager_Table:AFVK:v1|68aacd73430449af9dd1ef8b5a998ff5|df82c1e8abea474c8477355b4668053b"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_Manager_Table:AFVK:v1|68aacd73430449af9dd1ef8b5a998ff5|60349777ab1b4d0babbcf1236a594440"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_Manager_Table:AFVK:v1|68aacd73430449af9dd1ef8b5a998ff5|f4c02e5258b2472dbb4aa984f0f9ec61"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_Manager_Table:AFVK:v1|68aacd73430449af9dd1ef8b5a998ff5|c05399971b764483a0ebcff1190689b8"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_Manager_Table:AFVK:v1|68aacd73430449af9dd1ef8b5a998ff5|e4f5736ea7294b80b04ed2971621030f"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_Manager_Table:AFVK:v1|68aacd73430449af9dd1ef8b5a998ff5|961446bc3a214777bffe62b74b0759b6"
  }
];
    schemaDataDFO = [
  {
  ...
  const [SearchParams,setSearchParams] = useState<any>({})
    ...
    if(needLockingAndRule.lockMode=='Single'){
      ...
      if (ids.length == 0) {
        let keys:any
        settable98ff5Props((pre:any)=>({...pre, selectedIds:[]}))
        setLockedData((pre:any)=>({...pre,data:[]}))
        return
      }

      table98ff5.filter((item:any,id:number)=>{
      ...
      //////////
      //////////
      settable98ff5Props((pre:any)=>({...pre, selectedIds:[ids[ids.length-1]]}))      
    }
      ...
      settable98ff5Props((pre:any)=>({...pre, selectedIds:ids}))
    }
    ...
    if (checkedData.length) {
      for (let i = 0; i < checkedData.length; i++) {
        if (checkedData[i].page == page) {
          settable98ff5Props((pre:any)=>({...pre, selectedIds:checkedData[i].data}))
        }
      }
    }
    ...
    try {
      ...
      if (isRulePresent==false) {
        ...
        const api_paginationBody: api_paginationDto = {
          ...
          count: parseInt(pageSize),
          filterDetails: {
            ufKey:'CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_Manager_Table:AFVK:v1:UO', 
            nodeId: '68aacd73430449af9dd1ef8b5a998ff5',
            elementId: '68aacd73430449af9dd1ef8b5a998ff5'
          },
          searchFilter: searchParams
        }
        if(encryptionFlagCont) {
      ...
      // CopyFromData (Parent table): use presetValues if present, else use pagination-filtered data
        ...
        if ( table98ff5Props?.presetValues&&Object.keys(table98ff5Props?.presetValues).length > 0) {
          filtertedData = [table98ff5Props?.presetValues];
        }else {
          filtertedData = structuredClone(uf_paginationDataFilter.data)||[]
          settable98ff5(uf_paginationDataFilter.data||[])
        }
...
const colurIndicator = (keyValue:any=[], comingValue:any,ColourIndicatorType:any) => {
  ...
  useEffect(() => {
    if (prevRefreshRef.current) {
      UpdatedDataHandle(table98ff5Props.filterProps)
    }else 
      prevRefreshRef.current= true
  }, [table98ff5Props.filterProps])
  ...
  const handlePrimaryTable = () => {
    let findData = table98ff5Props?.selectedIds[table98ff5Props?.selectedIds?.length-1]
    if(Array.isArray(table98ff5) && table98ff5.length>0)
    {
      let data = table98ff5[findData]
      setPrimaryTableData({
        ...primaryTableData,
        primaryKey: "claim_id",
        value: data["claim_id"],
  ...
  useEffect(() => {
    if (table98ff5Props?.selectedIds?.length != 0) handlePrimaryTable()
  }, [table98ff5Props?.selectedIds])
    ...
    <div className='w-full h-full'>
          <div className=' w-full flex flex-row h-[70%]'>
            <Table
              ...
              tableSettings={true}
              tableSorting={true}
              selectedIds={table98ff5Props?.selectedIds}  
