...
const Textasset_id_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[asset_id_text67e51?.refresh])

  if (asset_id_text67e51?.isHidden) {
    return <></>
  }
...
export default Textasset_id_text
