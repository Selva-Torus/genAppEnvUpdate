...
let defaultColumns:any = [
  ...
  {
    "id": "uuid_view_all",
    "nodeid": "97295868dcc94f3188e9b4593aaef1ca",
    "name": "UUID",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "view_process_type",
    "nodeid": "2bad4913a3fd42eca067d717959569cf",
    "name": "Process Type",
    "meta": {
      "sort": true
    },
...
const colurIndicator = (keyValue:any=[], comingValue:any,ColourIndicatorType:any) => {
  ...
  const handlePrimaryTable = () => {
    ...
    {
      let data = view_all_tablec9e87.find((data:any)=>(data?.vgphstm_uuid==findData))||{}
      setPrimaryTableData({
        ...primaryTableData,
        primaryKey: "vgphstm_uuid",
  ...
  const handleOnRowClick=async(data?:any,ids?:any)=>{
    ...
    setview_all_tablec9e87Props((pre:any)=>({...pre, selectedIds:[row?.vgphstm_uuid]}))  
    onButtonSecurityHandle(data)
    ...
    const result = allData.find((item:any) => item["vgphstm_uuid"] === data[pkCol?.id || "vgphstm_uuid"]);
          ...
          setview_all_journey_group67ce4({...view_all_journey_group67ce4,presetValues:allData[index]})
