 ...
 /////////////
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("operational_pending_journey")){
        setoperational_pending_journey1a1a5((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(operational_pending_journey1a1a5?.isDisabled==null)
      {
        setoperational_pending_journey1a1a5((pre:any)=>({...pre,isDisabled:false}));
      }
    }
  //////////////
    if (code != '') {
  ...
  return (
    <div 
      ...
      className={`flex flex-col overflow-auto rounded-md p-2  !ml-3 ${isDark ? 'text-white' : 'text-black'}`}
       onClick={(e:any)=>{e.stopPropagation()
        handleOnClick({}, 0);
          settransactionproduct_v1((pre:any)=>({...pre,_selectedGroup_:"operational_pending_journey_group"}))
        }}
    >
