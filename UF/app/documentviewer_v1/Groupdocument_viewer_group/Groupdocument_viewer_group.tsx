...
const Groupdocument_viewer_group = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "bff6afaec40241d8bb821c184a69a6ec");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setdocument_viewer_group9a6ecProps((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("documentviewer")){
        setdocumentviewerd3b4b({...documentviewerd3b4b,isDisabled:true});

    }else
    {
      if(documentviewerd3b4b?.isDisabled==null)
      {
        setdocumentviewerd3b4b({...documentviewerd3b4b,isDisabled:false});
      }
    }
  //////////////
    if (code != '') {
  ...
  const document_viewer_group9a6ecRef = useRef<any>(null);
  const handleClearSearch = () => {
    document_viewer_group9a6ecRef.current?.setSearchParams();
    document_viewer_group9a6ecRef.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(document_viewer_group9a6ec) && Object.keys(document_viewer_group9a6ec)?.length>0)
      {
        setdocument_viewer_group9a6ec({})
      }
    }else 
      prevRefreshRef.current= true
  }, [document_viewer_group9a6ecProps?.refresh,token])
  ...
  return (
    ...
    >
        {allowedControls.includes("documentviewer") ?<DocumentViewerdocumentviewer   /* d3b4b */checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
    </div>
 )
}
