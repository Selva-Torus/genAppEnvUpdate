...
const DocumentViewerdocumentviewer = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing}:any) => {
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          componentId: "bff6afaec40241d8bb821c184a69a6ec",
          controlId: "a43ac774f1c646e48a7b63331e8d3b4b",
          isTable: false,
          from:"Button",
  ...
  const {documentviewerd3b4b, setdocumentviewerd3b4b}= useContext(TotalContext) as TotalContextProps; 
  //////////////
   let customCode:any;
  const handleCustomCode=async () => {
    ...
    if (code != '') {
      let codeStates: any = {};
        ...
        codeStates['documentviewer'] = documentviewerd3b4b,
        codeStates['setdocumentviewer'] = setdocumentviewerd3b4b,
  ...
  const fetchData = async () => {
    ...
    const scanurl: string = document_viewer_group9a6ec?.attachment_id;
  ...
  useEffect(() => {
    fetchData();
  }, [document_viewer_group9a6ec?.attachment_id])
  
  if (documentviewerd3b4b?.isHidden) {
    return <></>
  }
  if (loading) {
    return (
