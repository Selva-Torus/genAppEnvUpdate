...
const TextInputseats_total = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:addLicense:AFVK:v1|eec8a7bd5fff4c538b0760c4f4eb5d91|46dc37b5386148468977e104be56dbc7"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,addLicense_v1:{...pre?.addLicense_v1,seats_total:undefined}}));
    if(dynamicStateandType.type=="number"){
    setlicense_configuration_groupb5d91((prev: any) => ({ ...prev, seats_total: +e.target.value }));
    }
    else{
    setlicense_configuration_groupb5d91((prev: any) => ({ ...prev, seats_total: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "46dc37b5386148468977e104be56dbc7"
      );
      ...
      //     controlId: "46dc37b5386148468977e104be56dbc7",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "46dc37b5386148468977e104be56dbc7") {
        handleChange({target:{value:license_configuration_groupb5d91Ref?.current?.seats_total||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "46dc37b5386148468977e104be56dbc7") {
        handleBlur({target:{value:license_configuration_groupb5d91Ref?.current?.seats_total||""}});
      }
    };
  ...
  if(dfd_assetsoftwarelicenses_v1Props?.setSearchFilters && dfd_assetsoftwarelicenses_v1Props?.data)
  {
    if(Array.isArray(dfd_assetsoftwarelicenses_v1Props.data) && dfd_assetsoftwarelicenses_v1Props.data.length > 0){
      setlicense_configuration_groupb5d91((pre:any)=>({...pre,seats_total:dfd_assetsoftwarelicenses_v1Props.data[0]?.seats_total}));
    }
  }
  },[dfd_assetsoftwarelicenses_v1Props?.setSearchFilters])
  if (seats_total6dbc7?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={license_configuration_groupb5d91?.seats_total||""}
         disabled= {seats_total6dbc7?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.addLicense_v1?.seats_total ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
