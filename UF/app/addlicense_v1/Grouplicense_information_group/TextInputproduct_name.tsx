...
const TextInputproduct_name = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:addLicense:AFVK:v1|064a0d259dc344468d8f075a560fae34|eb6754fb889e4b75b1367744edec9548"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,addLicense_v1:{...pre?.addLicense_v1,product_name:undefined}}));
    if(dynamicStateandType.type=="number"){
    setlicense_information_groupfae34((prev: any) => ({ ...prev, product_name: +e.target.value }));
    }
    else{
    setlicense_information_groupfae34((prev: any) => ({ ...prev, product_name: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "eb6754fb889e4b75b1367744edec9548"
      );
      ...
      //     controlId: "eb6754fb889e4b75b1367744edec9548",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "eb6754fb889e4b75b1367744edec9548") {
        handleChange({target:{value:license_information_groupfae34Ref?.current?.product_name||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "eb6754fb889e4b75b1367744edec9548") {
        handleBlur({target:{value:license_information_groupfae34Ref?.current?.product_name||""}});
      }
    };
  ...
  if(dfd_assetsoftwarelicenses_v1Props?.setSearchFilters && dfd_assetsoftwarelicenses_v1Props?.data)
  {
    if(Array.isArray(dfd_assetsoftwarelicenses_v1Props.data) && dfd_assetsoftwarelicenses_v1Props.data.length > 0){
      setlicense_information_groupfae34((pre:any)=>({...pre,product_name:dfd_assetsoftwarelicenses_v1Props.data[0]?.product_name}));
    }
  }
  },[dfd_assetsoftwarelicenses_v1Props?.setSearchFilters])
  if (product_namec9548?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={license_information_groupfae34?.product_name||""}
         disabled= {product_namec9548?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.addLicense_v1?.product_name ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
