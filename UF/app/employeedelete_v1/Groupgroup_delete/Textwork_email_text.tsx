...
const Textwork_email_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[work_email_text10688?.refresh])

  if (work_email_text10688?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Email Address")}
</Text>
  </div>
  )
}

export default Textwork_email_text
