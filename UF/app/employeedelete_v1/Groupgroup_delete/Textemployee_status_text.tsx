...
const Textemployee_status_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[employee_status_textef64f?.refresh])

  if (employee_status_textef64f?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Employee Status")}
</Text>
  </div>
  )
}

export default Textemployee_status_text
