 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      ...
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "2f9d1bea7a8025061dfd005f18d3d34b"
      );
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "ok_button3d34b") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "2f9d1bea7a8025061dfd005f18d3d34b") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "ok_button3d34b");
    return () => {
  ...
  useEffect(()=>{
    if (!ok_button3d34b?.trigger) return;
      if(ok_button3d34b?.trigger){
      setok_button3d34b((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[ok_button3d34b?.trigger])

  useEffect(()=>{
    if(ok_button3d34b?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[ok_button3d34b?.refresh])
  ...
  async function handleSaved34b_1_1_1(){
      

  setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    await delay(1000); 

    const group_delete68104Props = group_delete68104PropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.employeeDelete_v1 || {}).some(val => {
    ...
    try{
      ...
      let mainData:any=structuredClone(group_delete68104Ref.current);
      ...
      let lockedKeysLength:number;
        if(group_delete68104?.upId === "" && (!lockedData?.data || Object.keys(lockedData?.data)?.length == 0)){
          throw 'Please give proper data';
        }
      let eventProperty :any = {
  "id": "2f9d1bea7a8025061dfd005f18d3d34b",
  "type": "button",
  "name": "ok_button",
  "label": "ok_button",
  "sequence": 1,
  "children": [
    {
      "id": "2f9d1bea7a8025061dfd005f18d3d34b.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "2f9d1bea7a8025061dfd005f18d3d34b.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "2f9d1bea7a8025061dfd005f18d3d34b.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "2f9d1bea7a8025061dfd005f18d3d34b.1.1.1.1.1",
                  "eventContext": "rise",
                  "value": "",
                  "type": "handlerNode",
                  "name": "closeHandler",
            ...
            {
              "id": "2f9d1bea7a8025061dfd005f18d3d34b.1.1.1.2",
              ...
              "children": [
                {
                  "id": "267e1421a9f4452a8ebcf3c4183e694e.1.1.1.2.1",
                  "value": "",
                  "type": "screen",
      ...
      let sourceId : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:employeeDelete:AFVK:v1";
      sourceId+= "|"+"0ec1c18b873f7c0c40220bce6a068104";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:employeeDelete:AFVK:v1"+"|"+"0ec1c18b873f7c0c40220bce6a068104"+"|"+eventProperty.id;
      ...
      te_eventEmitterBody = {
        ...
        upId : group_delete68104?.upId? [group_delete68104?.upId ] : lockedData.processIds,
      ...
      if(Array.isArray(tableData) && hasValidupId){
        ...
        ...uf_initiatePf.data.nodeProperty,
        data:{"trs_event_process_status":uf_getPFDetails.status},
        upId : group_delete68104?.upId? [group_delete68104?.upId ] : upId,
        event : uf_initiatePf.data.eventProperty?.source?.status,
        sourceId : uf_initiatePf.data.eventProperty?.sourceId
      }}else{
        te_eventEmitterBody = {
        ...uf_initiatePf.data.nodeProperty,
        data:{"trs_event_process_status":uf_getPFDetails.status},
        upId : group_delete68104?.upId? [group_delete68104?.upId ] : group_delete68104?.trs_process_id? [group_delete68104?.trs_process_id ] : lockedData.processIds,
        event : uf_initiatePf.data.eventProperty?.source?.status,
        sourceId : uf_initiatePf.data.eventProperty?.sourceId,
        controlName: "ok_button"
      }
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...group_delete68104Ref.current });
    let reworkKeys:any[]=[];
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"0ec1c18b873f7c0c40220bce6a068104",
              controlId:"2f9d1bea7a8025061dfd005f18d3d34b"
            };
            if (encryptionFlagCont) {
    ...
    //eventEmitter
    if (group_delete68104Props.ssKey !== '' && group_delete68104Props.ssKey !== undefined) {
    te_eventEmitterBody["ssKey"] = group_delete68104Props.ssKey;          
    }
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setgroup_delete68104((prev: any) => ({ ...prev, ok_button: true }));
        //onClick

    //eventEmitter
    await handleSaved34b_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setgroup_delete68104((prev: any) => ({ ...prev, ok_button: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {ok_button3d34b?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
          icon="MdDoneAll"
