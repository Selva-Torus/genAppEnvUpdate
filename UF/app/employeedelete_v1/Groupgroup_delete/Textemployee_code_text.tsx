...
const Textemployee_code_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[employee_code_textd7eed?.refresh])

  if (employee_code_textd7eed?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Employee Code")}
</Text>
  </div>
  )
}

export default Textemployee_code_text
