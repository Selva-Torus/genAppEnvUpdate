...
const Buttonbutton_add_doc = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const doc_attached_groupe6469Ref = useRef(doc_attached_groupe6469);
  useEffect(() => {
    doc_attached_groupe6469Ref.current = doc_attached_groupe6469;
    if (!pendingAutoSearch.current) return;
      pendingAutoSearch.current = false;
      handleClick(false);
  }, [doc_attached_groupe6469]);
  
  //group props in ref to access latest props value
  const doc_attached_groupe6469PropsRef = useRef(doc_attached_groupe6469Props);
  useEffect(() => {
    doc_attached_groupe6469PropsRef.current = doc_attached_groupe6469Props;
  }, [doc_attached_groupe6469Props]);
  ...
  const handleMapper=async (data?:any) => {
    try{     
      data = {...data,...doc_attached_groupe6469Ref.current};
      let parentRowSpan = 151;
      const orchestrationData : any = getControlOrchestrationData(
        controlData,
        "61581f694de0606adbbbaf00322e6469",
        "367620eb90efa5e41d986cb4c03c82a5"
      );
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "button_add_docc82a5") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "367620eb90efa5e41d986cb4c03c82a5") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "button_add_docc82a5");
    return () => {
  ...
  useEffect(()=>{
    if (!button_add_docc82a5?.trigger) return;
      if(button_add_docc82a5?.trigger){
      setbutton_add_docc82a5((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[button_add_docc82a5?.trigger])

  useEffect(()=>{
    if(button_add_docc82a5?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[button_add_docc82a5?.refresh])
  ...
  async function handleSave82a5_1_1_1(){
      

  setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    await delay(1000); 

    const doc_attached_groupe6469Props = doc_attached_groupe6469PropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.addGradeDocument_v1 || {}).some(val => {
    ...
    try{
      ...
      let mainData:any=structuredClone(doc_attached_groupe6469Ref.current);
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addGradeDocument:AFVK:v1|31b84bc7161e97a5c5888ed8ba781a3f"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addGradeDocument:AFVK:v1|31b84bc7161e97a5c5888ed8ba781a3f"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "367620eb90efa5e41d986cb4c03c82a5",
  "type": "button",
  "name": "button_add_doc",
  ...
  "children": [
    {
      "id": "367620eb90efa5e41d986cb4c03c82a5.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "367620eb90efa5e41d986cb4c03c82a5.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "367620eb90efa5e41d986cb4c03c82a5.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "367620eb90efa5e41d986cb4c03c82a5.1.1.1.1.1",
                  ...
                  "children": [
                    {
                      "id": "85e9605f2264cf16e50000c276aa652a.1.1.1.1.1.1",
                      "value": "",
                      "type": "screen",
                ...
                "params": [
                  {
                    "name": "message",
                    "_type": "text",
                    "value": "Grade Document Added Successfully",
                    "enabled": true
                  },
                  {
                    "name": "type",
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addGradeDocument:AFVK:v1|31b84bc7161e97a5c5888ed8ba781a3f"
          ]
        }
      ]
    }
      ...
      sourceId+= "|"+"61581f694de0606adbbbaf00322e6469";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:addGradeDocument:AFVK:v1"+"|"+"61581f694de0606adbbbaf00322e6469"+"|"+eventProperty.id;
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...doc_attached_groupe6469Ref.current, ...nullFilter(table_group16d33) });
    let reworkKeys:any[]=[];
    ...
    if("_groupArrays_" in reworkedObject )
    {
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"61581f694de0606adbbbaf00322e6469",
              controlId:"367620eb90efa5e41d986cb4c03c82a5"
            };
            if (encryptionFlagCont) {
        ...
        if(doc_attached_groupe6469?.upId){
          te_saveBody['upId']= doc_attached_groupe6469?.upId;
        }
        if(doc_attached_groupe6469?.upid){
          te_saveBody['upId']= doc_attached_groupe6469?.upid;
        }
        ...
        if (doc_attached_groupe6469Props.ssKey !== '' && doc_attached_groupe6469Props.ssKey !== undefined) {
          te_saveBody["ssKey"] = doc_attached_groupe6469Props.ssKey;
    ...
    //infoMsg
    toast('Grade Document Added Successfully', 'success',true);
    // refreshElement
    //riseListen
    // for group
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdoc_attached_groupe6469((prev: any) => ({ ...prev, button_add_doc: true }));
        //onClick

    //saveHandler
    await handleSave82a5_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdoc_attached_groupe6469((prev: any) => ({ ...prev, button_add_doc: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
 ...
 if (button_add_docc82a5?.isHidden) {
    return <></>
  }
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {button_add_docc82a5?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Add Document")}
