...
const Texttextwrwer = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {textwrwer0e4e1Props, settextwrwer0e4e1Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
...
return (
  <div className="" style={{gridColumn: `5 / 15`,gridRow: `1 / 6`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className="!font-bold"
  variant="subheader-1"
