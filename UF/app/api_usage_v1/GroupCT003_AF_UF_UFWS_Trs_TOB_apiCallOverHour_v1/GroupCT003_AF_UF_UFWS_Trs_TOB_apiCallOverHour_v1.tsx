...
const Groupct003_af_uf_ufws_trs_tob_apicalloverhour_v1 = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  const data: any = await fetchBatchData(
    ...
    [user],
    'GroupCt003AfUfUfwsTrsTobApicalloverhourV1',
    token
  );
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "9ab72b3da7824eb3a1cccc124f7c8026");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setct003_af_uf_ufws_trs_tob_apicalloverhour_v1c8026Props((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("api_call_over_hour_group")){
        setapi_call_over_hour_group2febf((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(api_call_over_hour_group2febf?.isDisabled==null)
      {
        setapi_call_over_hour_group2febf((pre:any)=>({...pre,isDisabled:false}));
      }
    }
  //////////////
    if (code != '') {
  ...
  const ct003_af_uf_ufws_trs_tob_apicalloverhour_v1c8026Ref = useRef<any>(null);
  const handleClearSearch = () => {
    ct003_af_uf_ufws_trs_tob_apicalloverhour_v1c8026Ref.current?.setSearchParams();
    ct003_af_uf_ufws_trs_tob_apicalloverhour_v1c8026Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if (
        !Array.isArray(ct003_af_uf_ufws_trs_tob_apicalloverhour_v1c8026) &&
        Object.keys(ct003_af_uf_ufws_trs_tob_apicalloverhour_v1c8026)?.length > 0
      ) {
        setct003_af_uf_ufws_trs_tob_apicalloverhour_v1c8026({})
      }
    } else prevRefreshRef.current = true
  }, [ct003_af_uf_ufws_trs_tob_apicalloverhour_v1c8026Props?.refresh])
    ...
    <div 
      ...
      className={`flex flex-col overflow-auto rounded-md  ${isDark ? 'text-white' : 'text-black'}`}
       onClick={(e:any)=>{e.stopPropagation()
        handleOnClick({}, 0);
          setapiusagedashboard_v1((pre:any)=>({...pre,_selectedGroup_:"ct003_af_uf_ufws_trs_tob_apicalloverhour_v1"}))
        }}
    >
...
export default Groupct003_af_uf_ufws_trs_tob_apicalloverhour_v1
