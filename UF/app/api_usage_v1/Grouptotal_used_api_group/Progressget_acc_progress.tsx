...
const Progressget_acc_progress = ({encryptionFlagCompData, isDynamic, index, item,setIsProcessing,controlData}:any) => { 
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "07ec78dbcfc44f4581c6606a8e7f3140"
      );
...
return (
  <div 
    style={{gridColumn: `10 / 25`,gridRow: `9 / 17`, gap:``, height: `100%`, overflow: 'auto'}} >
    <Progress 
      className=""
        theme = {'info'}
