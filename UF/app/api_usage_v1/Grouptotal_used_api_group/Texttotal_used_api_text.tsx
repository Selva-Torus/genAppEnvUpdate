...
const Texttotal_used_api_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {total_used_api_text0681aProps, settotal_used_api_text0681aProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
