...
const Textproducts_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {products_textc39ebProps, setproducts_textc39ebProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
...
return (
  <div className="" style={{gridColumn: `1 / 10`,gridRow: `54 / 62`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className="bg-white"
  variant="subheader-1"
