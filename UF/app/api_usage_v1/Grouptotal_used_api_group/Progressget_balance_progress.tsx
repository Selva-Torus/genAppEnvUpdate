...
const Progressget_balance_progress = ({encryptionFlagCompData, isDynamic, index, item,setIsProcessing,controlData}:any) => { 
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "977363dd20b540af8ed8f5f4604a0d54"
      );
...
return (
  <div 
    style={{gridColumn: `10 / 25`,gridRow: `32 / 40`, gap:``, height: `100%`, overflow: 'auto'}} >
    <Progress 
      className=""
        theme = {'danger'}
