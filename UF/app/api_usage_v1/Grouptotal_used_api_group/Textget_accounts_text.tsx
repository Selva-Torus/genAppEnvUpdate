...
const Textget_accounts_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {get_accounts_textded93Props, setget_accounts_textded93Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
...
return (
  <div className="" style={{gridColumn: `1 / 10`,gridRow: `9 / 17`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className="bg-white"
  variant="subheader-1"
