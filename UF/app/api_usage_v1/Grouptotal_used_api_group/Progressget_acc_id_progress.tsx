...
const Progressget_acc_id_progress = ({encryptionFlagCompData, isDynamic, index, item,setIsProcessing,controlData}:any) => { 
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "042ccb9c7329420f9219ff91a65564cc"
      );
...
return (
  <div 
    style={{gridColumn: `10 / 25`,gridRow: `21 / 29`, gap:``, height: `100%`, overflow: 'auto'}} >
    <Progress 
      className=""
        theme = {'warning'}
