...
const Progressget_direct_debits_progress = ({encryptionFlagCompData, isDynamic, index, item,setIsProcessing,controlData}:any) => { 
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "2b35341e08714e4aad70c28b6b104032"
      );
...
return (
  <div 
    style={{gridColumn: `10 / 25`,gridRow: `43 / 51`, gap:``, height: `100%`, overflow: 'auto'}} >
    <Progress 
      className=""
        theme = {'misc'}
