...
const Textget_account_id_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {get_account_id_textcfcd9Props, setget_account_id_textcfcd9Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
...
return (
  <div className="" style={{gridColumn: `1 / 10`,gridRow: `21 / 29`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className="bg-white"
  variant="subheader-1"
