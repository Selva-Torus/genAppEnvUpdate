...
const Groupct003_af_uf_ufws_trs_tob_apicalloverweek_v1 = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  const data: any = await fetchBatchData(
    ...
    [user],
    'GroupCt003AfUfUfwsTrsTobApicalloverweekV1',
    token
  );
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "8cb1da1461364ca387dec3fa4b8b09c6");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setct003_af_uf_ufws_trs_tob_apicalloverweek_v1b09c6Props((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("api_call_over_week_group")){
        setapi_call_over_week_group987fe((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(api_call_over_week_group987fe?.isDisabled==null)
      {
        setapi_call_over_week_group987fe((pre:any)=>({...pre,isDisabled:false}));
      }
    }
  //////////////
    if (code != '') {
  ...
  const ct003_af_uf_ufws_trs_tob_apicalloverweek_v1b09c6Ref = useRef<any>(null);
  const handleClearSearch = () => {
    ct003_af_uf_ufws_trs_tob_apicalloverweek_v1b09c6Ref.current?.setSearchParams();
    ct003_af_uf_ufws_trs_tob_apicalloverweek_v1b09c6Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if (
        !Array.isArray(ct003_af_uf_ufws_trs_tob_apicalloverweek_v1b09c6) &&
        Object.keys(ct003_af_uf_ufws_trs_tob_apicalloverweek_v1b09c6)?.length > 0
      ) {
        setct003_af_uf_ufws_trs_tob_apicalloverweek_v1b09c6({})
      }
    } else prevRefreshRef.current = true
  }, [ct003_af_uf_ufws_trs_tob_apicalloverweek_v1b09c6Props?.refresh])
    ...
    <div 
      ...
      className={`flex flex-col overflow-auto rounded-md  ${isDark ? 'text-white' : 'text-black'}`}
       onClick={(e:any)=>{e.stopPropagation()
        handleOnClick({}, 0);
          setapiusagedashboard_v1((pre:any)=>({...pre,_selectedGroup_:"ct003_af_uf_ufws_trs_tob_apicalloverweek_v1"}))
        }}
    >
...
export default Groupct003_af_uf_ufws_trs_tob_apicalloverweek_v1
