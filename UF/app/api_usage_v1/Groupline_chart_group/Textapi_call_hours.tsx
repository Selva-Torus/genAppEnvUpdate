...
const Textapi_call_hours = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {api_call_hours6d062Props, setapi_call_hours6d062Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
