...
const Iconmost_used_api_icon = ({encryptionFlagCompData,setIsProcessing,controlData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData : any = getControlOrchestrationData(
      ...
      "317cba85fc294a9598fe495b1726560d"
    );
...
return (
  <div 
    style={{gridColumn: `3 / 7`,gridRow: `5 / 17`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
