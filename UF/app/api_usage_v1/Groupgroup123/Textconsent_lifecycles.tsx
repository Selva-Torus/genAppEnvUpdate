...
const Textconsent_lifecycles = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {consent_lifecycles11691Props, setconsent_lifecycles11691Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
