...
const Iconicon5645 = ({encryptionFlagCompData,setIsProcessing,controlData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData : any = getControlOrchestrationData(
      controlData,
      "98c73da3ec924b46a87aa54c7119ff98",
      "acbf8b1cee9343d9a5f6538efc44d73c"
    );
...
return (
  <div 
    style={{gridColumn: `1 / 5`,gridRow: `1 / 12`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
