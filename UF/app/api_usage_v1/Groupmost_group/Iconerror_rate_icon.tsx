...
const Iconerror_rate_icon = ({encryptionFlagCompData,setIsProcessing,controlData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData : any = getControlOrchestrationData(
      ...
      "1dc52406b9c541f881f411ebd5989a9a"
    );
...
return (
  <div 
    style={{gridColumn: `2 / 7`,gridRow: `4 / 16`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
