...
const Groupct003_af_uf_ufws_trs_tob_apicallovermonth_v1 = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  const data: any = await fetchBatchData(
    ...
    [user],
    'GroupCt003AfUfUfwsTrsTobApicallovermonthV1',
    token
  );
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "3790dca96bda4504ab0b68008a792528");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setct003_af_uf_ufws_trs_tob_apicallovermonth_v192528Props((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("api_call_over_month_group")){
        setapi_call_over_month_groupccb80((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(api_call_over_month_groupccb80?.isDisabled==null)
      {
        setapi_call_over_month_groupccb80((pre:any)=>({...pre,isDisabled:false}));
      }
    }
  //////////////
    if (code != '') {
  ...
  const ct003_af_uf_ufws_trs_tob_apicallovermonth_v192528Ref = useRef<any>(null);
  const handleClearSearch = () => {
    ct003_af_uf_ufws_trs_tob_apicallovermonth_v192528Ref.current?.setSearchParams();
    ct003_af_uf_ufws_trs_tob_apicallovermonth_v192528Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if (
        !Array.isArray(ct003_af_uf_ufws_trs_tob_apicallovermonth_v192528) &&
        Object.keys(ct003_af_uf_ufws_trs_tob_apicallovermonth_v192528)?.length > 0
      ) {
        setct003_af_uf_ufws_trs_tob_apicallovermonth_v192528({})
      }
    } else prevRefreshRef.current = true
  }, [ct003_af_uf_ufws_trs_tob_apicallovermonth_v192528Props?.refresh])
    ...
    <div 
      ...
      className={`flex flex-col overflow-auto rounded-md  ${isDark ? 'text-white' : 'text-black'}`}
       onClick={(e:any)=>{e.stopPropagation()
        handleOnClick({}, 0);
          setapiusagedashboard_v1((pre:any)=>({...pre,_selectedGroup_:"ct003_af_uf_ufws_trs_tob_apicallovermonth_v1"}))
        }}
    >
...
export default Groupct003_af_uf_ufws_trs_tob_apicallovermonth_v1
