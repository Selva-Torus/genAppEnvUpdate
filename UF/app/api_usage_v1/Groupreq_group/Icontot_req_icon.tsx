...
const Icontot_req_icon = ({encryptionFlagCompData,setIsProcessing,controlData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData : any = getControlOrchestrationData(
      ...
      "6045e75f4c4f4834b39e147c6a31fa8f"
    );
...
return (
  <div 
    style={{gridColumn: `3 / 7`,gridRow: `4 / 16`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
