...
import GroupCT003_AF_UF_UFWS_Trs_TOB_apiCallOverHour_v1  from "../GroupCT003_AF_UF_UFWS_Trs_TOB_apiCallOverHour_v1/GroupCT003_AF_UF_UFWS_Trs_TOB_apiCallOverHour_v1";
import GroupCT003_AF_UF_UFWS_Trs_TOB_apiCallOverMonth_v1  from "../GroupCT003_AF_UF_UFWS_Trs_TOB_apiCallOverMonth_v1/GroupCT003_AF_UF_UFWS_Trs_TOB_apiCallOverMonth_v1";
import GroupCT003_AF_UF_UFWS_Trs_TOB_apiCallOverWeek_v1  from "../GroupCT003_AF_UF_UFWS_Trs_TOB_apiCallOverWeek_v1/GroupCT003_AF_UF_UFWS_Trs_TOB_apiCallOverWeek_v1";
...
const Groupapi_call_over_frequency_subscreen = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  const data: any = await fetchBatchData(
    ...
    [user],
    'GroupApiCallOverFrequencySubscreen',
    token
  );
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "5d1afd4ca36c45c69e76191eb74b8acc");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setapi_call_over_frequency_subscreenb8accProps((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("ct003_af_uf_ufws_trs_tob_apicalloverhour_v1")){
        setct003_af_uf_ufws_trs_tob_apicalloverhour_v1c8026((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(ct003_af_uf_ufws_trs_tob_apicalloverhour_v1c8026?.isDisabled==null)
      {
        setct003_af_uf_ufws_trs_tob_apicalloverhour_v1c8026((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("ct003_af_uf_ufws_trs_tob_apicallovermonth_v1")){
        setct003_af_uf_ufws_trs_tob_apicallovermonth_v192528((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(ct003_af_uf_ufws_trs_tob_apicallovermonth_v192528?.isDisabled==null)
      {
        setct003_af_uf_ufws_trs_tob_apicallovermonth_v192528((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("ct003_af_uf_ufws_trs_tob_apicalloverweek_v1")){
        setct003_af_uf_ufws_trs_tob_apicalloverweek_v1b09c6((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(ct003_af_uf_ufws_trs_tob_apicalloverweek_v1b09c6?.isDisabled==null)
      {
        setct003_af_uf_ufws_trs_tob_apicalloverweek_v1b09c6((pre:any)=>({...pre,isDisabled:false}));
      }
    }
  //////////////
    if (code != '') {
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if (
        !Array.isArray(api_call_over_frequency_subscreenb8acc) &&
        Object.keys(api_call_over_frequency_subscreenb8acc)?.length > 0
      ) {
        setapi_call_over_frequency_subscreenb8acc({})
      }
    } else prevRefreshRef.current = true
  }, [api_call_over_frequency_subscreenb8accProps?.refresh,
line_chart_groupadc5c[uoMapperData["236586a005ca4e929456806d39714e0a"]["source"]]
])
    ...
    <div 
      ...
      className={`flex flex-col overflow-auto rounded-md  ${isDark ? 'text-white' : 'text-black'}`}
       onClick={(e:any)=>{e.stopPropagation()
        handleOnClick({}, 0);
          setapiusagedashboard_v1((pre:any)=>({...pre,_selectedGroup_:"api_call_over_frequency_subscreen"}))
        }}
    >
        {(showFlag == "ct003_af_uf_ufws_trs_tob_apicalloverhour_v1") &&allowedComponent.includes("ct003_af_uf_ufws_trs_tob_apicalloverhour_v1")  &&<GroupCT003_AF_UF_UFWS_Trs_TOB_apiCallOverHour_v1  
        ...
        {(showFlag == "ct003_af_uf_ufws_trs_tob_apicallovermonth_v1") &&allowedComponent.includes("ct003_af_uf_ufws_trs_tob_apicallovermonth_v1")  &&<GroupCT003_AF_UF_UFWS_Trs_TOB_apiCallOverMonth_v1  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          tableData={tableData} 
          setTableData={setTableData}
          ...
          groupData={groupData}
          controlData={controlData}        />}
        {(showFlag == "ct003_af_uf_ufws_trs_tob_apicalloverweek_v1") &&allowedComponent.includes("ct003_af_uf_ufws_trs_tob_apicalloverweek_v1")  &&<GroupCT003_AF_UF_UFWS_Trs_TOB_apiCallOverWeek_v1  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          tableData={tableData} 
          setTableData={setTableData}
