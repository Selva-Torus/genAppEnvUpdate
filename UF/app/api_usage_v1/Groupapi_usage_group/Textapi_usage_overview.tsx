...
const Textapi_usage_overview = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {api_usage_overviewecc9eProps, setapi_usage_overviewecc9eProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
...
return (
  <div className="" style={{gridColumn: `1 / 7`,gridRow: `1 / 9`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className="font-bold"
  variant="header-1"
