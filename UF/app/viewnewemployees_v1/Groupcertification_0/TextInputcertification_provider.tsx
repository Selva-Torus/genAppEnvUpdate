...
const TextInputcertification_provider = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const handleChange = async(e: any) => {
    ...
    setcertification02740_0((prev: any) => ({ ...prev, certification_provider: +e.target.value }));
    }
    else{
    setcertification02740_0((prev: any) => ({ ...prev, certification_provider: e.target.value }));
    }
  ...
  const certification02740_0Ref = useRef<any>(certification02740_0);
  useEffect(() => { certification02740_0Ref.current = certification02740_0; }, [certification02740_0]);
  useEffect(()=>{
      handleMapperValue();
    ...
    const handlerChange = (id:any) => {
      if (id === "dba4039d951e10692749b1a3beb427b4") {
        handleChange({target:{value:certification02740_0Ref?.current?.certification_provider||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "dba4039d951e10692749b1a3beb427b4") {
        handleBlur({target:{value:certification02740_0Ref?.current?.certification_provider||""}});
      }
    };
  ...
  if(dfd_certifyjson_v1Props?.setSearchFilters && dfd_certifyjson_v1Props?.data)
  {
    if(Array.isArray(dfd_certifyjson_v1Props.data) && dfd_certifyjson_v1Props.data.length > 0){
      setcertification02740_0((pre:any)=>({...pre,certification_provider:dfd_certifyjson_v1Props.data[0]?.certification_provider}));
    }
  }
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={certification02740_0?.certification_provider||""}
