...
const Textemergency_contact = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[emergency_contact8156b?.refresh])

  if (emergency_contact8156b?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Emergency Contact")}
</Text>
  </div>
  )
}

export default Textemergency_contact
