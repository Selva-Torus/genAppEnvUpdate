...
const TextInputoccupation = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const handleChange = async(e: any) => {
    ...
    setfamly_detailsb4eb8_2((prev: any) => ({ ...prev, occupation: +e.target.value }));
    }
    else{
    setfamly_detailsb4eb8_2((prev: any) => ({ ...prev, occupation: e.target.value }));
    }
  ...
  const famly_detailsb4eb8_2Ref = useRef<any>(famly_detailsb4eb8_2);
  useEffect(() => { famly_detailsb4eb8_2Ref.current = famly_detailsb4eb8_2; }, [famly_detailsb4eb8_2]);
  useEffect(()=>{
      handleMapperValue();
    ...
    const handlerChange = (id:any) => {
      if (id === "f17b8c2ca631bcc1bd734213e28c7375") {
        handleChange({target:{value:famly_detailsb4eb8_2Ref?.current?.occupation||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "f17b8c2ca631bcc1bd734213e28c7375") {
        handleBlur({target:{value:famly_detailsb4eb8_2Ref?.current?.occupation||""}});
      }
    };
  ...
  if(dfd_familyjson_v1Props?.setSearchFilters && dfd_familyjson_v1Props?.data)
  {
    if(Array.isArray(dfd_familyjson_v1Props.data) && dfd_familyjson_v1Props.data.length > 0){
      setfamly_detailsb4eb8_2((pre:any)=>({...pre,occupation:dfd_familyjson_v1Props.data[0]?.occupation}));
    }
  }
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={famly_detailsb4eb8_2?.occupation||""}
