...
const TextInputinstitution_name = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const handleChange = async(e: any) => {
    ...
    seteducation28de7_0((prev: any) => ({ ...prev, institution_name: +e.target.value }));
    }
    else{
    seteducation28de7_0((prev: any) => ({ ...prev, institution_name: e.target.value }));
    }
  ...
  const education28de7_0Ref = useRef<any>(education28de7_0);
  useEffect(() => { education28de7_0Ref.current = education28de7_0; }, [education28de7_0]);
  useEffect(()=>{
      handleMapperValue();
    ...
    const handlerChange = (id:any) => {
      if (id === "94b88182608f4ea7ac4987a0912e6f0c") {
        handleChange({target:{value:education28de7_0Ref?.current?.institution_name||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "94b88182608f4ea7ac4987a0912e6f0c") {
        handleBlur({target:{value:education28de7_0Ref?.current?.institution_name||""}});
      }
    };
  ...
  if(dfd_educationjson_v1Props?.setSearchFilters && dfd_educationjson_v1Props?.data)
  {
    if(Array.isArray(dfd_educationjson_v1Props.data) && dfd_educationjson_v1Props.data.length > 0){
      seteducation28de7_0((pre:any)=>({...pre,institution_name:dfd_educationjson_v1Props.data[0]?.institution_name}));
    }
  }
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={education28de7_0?.institution_name||""}
