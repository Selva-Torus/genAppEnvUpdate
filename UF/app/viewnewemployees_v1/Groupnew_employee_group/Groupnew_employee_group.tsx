...
const Groupnew_employee_group = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "8e706b826eb1663ddb081338b18df01f");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setnew_employee_groupdf01fProps((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("back")){
        setbackfda2e((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(backfda2e?.isDisabled==null)
      {
        setbackfda2e((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("new_emp")){
        setnew_emp72423((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(new_emp72423?.isDisabled==null)
      {
        setnew_emp72423((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("basic_divider")){
        setbasic_divider7f043((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(basic_divider7f043?.isDisabled==null)
      {
        setbasic_divider7f043((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("basic_details_group")){
        setbasic_details_groupe03ea((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(basic_details_groupe03ea?.isDisabled==null)
      {
        setbasic_details_groupe03ea((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("contact_details_group")){
        setcontact_details_group3ff3d((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(contact_details_group3ff3d?.isDisabled==null)
      {
        setcontact_details_group3ff3d((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("contact_details_divider")){
        setcontact_details_divider07ad1((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(contact_details_divider07ad1?.isDisabled==null)
      {
        setcontact_details_divider07ad1((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("address_details_group")){
        setaddress_details_group75e08((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(address_details_group75e08?.isDisabled==null)
      {
        setaddress_details_group75e08((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("identity_details_group")){
        setidentity_details_group20918((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(identity_details_group20918?.isDisabled==null)
      {
        setidentity_details_group20918((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("add_divider")){
        setadd_dividerac748((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(add_dividerac748?.isDisabled==null)
      {
        setadd_dividerac748((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("employment_details_group")){
        setemployment_details_group2c703((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(employment_details_group2c703?.isDisabled==null)
      {
        setemployment_details_group2c703((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("compensation_details_group")){
        setcompensation_details_group83106((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(compensation_details_group83106?.isDisabled==null)
      {
        setcompensation_details_group83106((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("comp_divider")){
        setcomp_divider5856c((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(comp_divider5856c?.isDisabled==null)
      {
        setcomp_divider5856c((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("bank_details")){
        setbank_detailsf21b7((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(bank_detailsf21b7?.isDisabled==null)
      {
        setbank_detailsf21b7((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("emergency_divider")){
        setemergency_divideraa178((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(emergency_divideraa178?.isDisabled==null)
      {
        setemergency_divideraa178((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("emergency_contact_group")){
        setemergency_contact_groupd1907((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(emergency_contact_groupd1907?.isDisabled==null)
      {
        setemergency_contact_groupd1907((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("skill_divider")){
        setskill_divider445fd((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(skill_divider445fd?.isDisabled==null)
      {
        setskill_divider445fd((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("skills_education_group")){
        setskills_education_groupd1667((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(skills_education_groupd1667?.isDisabled==null)
      {
        setskills_education_groupd1667((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("search_divider")){
        setsearch_dividerc76aa((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(search_dividerc76aa?.isDisabled==null)
      {
        setsearch_dividerc76aa((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("employee_id")){
        setemployee_ida5f8c((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(employee_ida5f8c?.isDisabled==null)
      {
        setemployee_ida5f8c((pre:any)=>({...pre,isDisabled:false}));
      }
    }
  //////////////
    if (code != '') {
  ...
  const new_employee_groupdf01fRef = useRef<any>(null);
  const handleClearSearch = () => {
    new_employee_groupdf01fRef.current?.setSearchParams();
    new_employee_groupdf01fRef.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(new_employee_groupdf01f) && Object.keys(new_employee_groupdf01f)?.length>0)
      {
        setnew_employee_groupdf01f({})
      }
    }else 
      prevRefreshRef.current= true
  }, [new_employee_groupdf01fProps?.refresh,token])
    ...
    <div 
      ...
      className={`flex flex-col overflow-auto rounded-md p-7 ${isDark ? 'text-white' : 'text-black'}`}
       onClick={(e:any)=>{e.stopPropagation()
        handleOnClick({}, 0);
          setviewnewemployees_v1((pre:any)=>({...pre,_selectedGroup_:"new_employee_group"}))
        }}
    >
        ...
        {allowedComponent.includes("skills_education_group")  &&<Groupskills_education_group  
          ...
          groupData={groupData}
          controlData={controlData}        />}
        {        ((ruleData?.length>0 && "back" in ButtonGoRuleData)?ButtonGoRuleData["back"]:true) && 
          allowedControls.includes("back")  ?            <Buttonback tableData={tableData} setTableData={setTableData} lockedData={lockedData} setLockedData={setLockedData} primaryTableData={primaryTableData} setPrimaryTableData={setPrimaryTableData} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} controlData={controlData} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing}/>: <div></div>} 
          {allowedControls.includes("new_emp") ?<Textnew_emp   /* 72423 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
        {allowedControls.includes("basic_divider") ?<Dividerbasic_divider   /* 7f043 */checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
        {allowedControls.includes("contact_details_divider") ?<Dividercontact_details_divider   /* 07ad1 */checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
        {allowedControls.includes("add_divider") ?<Divideradd_divider   /* ac748 */checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
        {allowedControls.includes("comp_divider") ?<Dividercomp_divider   /* 5856c */checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
        {allowedControls.includes("emergency_divider") ?<Divideremergency_divider   /* aa178 */checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
        {allowedControls.includes("skill_divider") ?<Dividerskill_divider   /* 445fd */checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
        {allowedControls.includes("search_divider") ?<Dividersearch_divider   /* c76aa */checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
          {allowedControls.includes("employee_id") ?<Textemployee_id   /* a5f8c */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
    </div>
 )
}
