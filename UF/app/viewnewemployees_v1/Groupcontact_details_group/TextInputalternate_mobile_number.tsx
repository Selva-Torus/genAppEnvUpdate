...
const TextInputalternate_mobile_number = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:viewNewEmployees:AFVK:v1|4b650f7d35bd022d03a10ffade93ff3d|bdb453d9396e247835fe08ec6134806d"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,viewNewEmployees_v1:{...pre?.viewNewEmployees_v1,alternate_mobile:undefined}}));
    if(dynamicStateandType.type=="number"){
    setcontact_details_group3ff3d((prev: any) => ({ ...prev, alternate_mobile: +e.target.value }));
    }
    else{
    setcontact_details_group3ff3d((prev: any) => ({ ...prev, alternate_mobile: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "bdb453d9396e247835fe08ec6134806d"
      );
      ...
      //     controlId: "bdb453d9396e247835fe08ec6134806d",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "bdb453d9396e247835fe08ec6134806d") {
        handleChange({target:{value:contact_details_group3ff3dRef?.current?.alternate_mobile||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "bdb453d9396e247835fe08ec6134806d") {
        handleBlur({target:{value:contact_details_group3ff3dRef?.current?.alternate_mobile||""}});
      }
    };
  ...
  if(dfd_employees_v1Props?.setSearchFilters && dfd_employees_v1Props?.data)
  {
    if(Array.isArray(dfd_employees_v1Props.data) && dfd_employees_v1Props.data.length > 0){
      setcontact_details_group3ff3d((pre:any)=>({...pre,alternate_mobile:dfd_employees_v1Props.data[0]?.alternate_mobile}));
    }
  }
  },[dfd_employees_v1Props?.setSearchFilters])
  if (alternate_mobile_number4806d?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={contact_details_group3ff3d?.alternate_mobile||""}
         disabled= {alternate_mobile_number4806d?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.viewNewEmployees_v1?.alternate_mobile ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
