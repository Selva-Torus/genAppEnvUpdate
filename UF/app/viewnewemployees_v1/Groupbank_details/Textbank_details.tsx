...
const Textbank_details = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[bank_details91264?.refresh])

  if (bank_details91264?.isHidden) {
    return <></>
  }
...
export default Textbank_details
