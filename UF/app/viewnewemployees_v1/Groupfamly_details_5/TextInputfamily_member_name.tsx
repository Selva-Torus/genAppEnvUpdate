...
const TextInputfamily_member_name = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const handleChange = async(e: any) => {
    ...
    setfamly_detailsb4eb8_5((prev: any) => ({ ...prev, member_name: +e.target.value }));
    }
    else{
    setfamly_detailsb4eb8_5((prev: any) => ({ ...prev, member_name: e.target.value }));
    }
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "6b1ca5e4681a9f27c73a98402dfdb442") {
        handleChange({target:{value:famly_detailsb4eb8_5Ref?.current?.member_name||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "6b1ca5e4681a9f27c73a98402dfdb442") {
        handleBlur({target:{value:famly_detailsb4eb8_5Ref?.current?.member_name||""}});
      }
    };
  ...
  if(dfd_familyjson_v1Props?.setSearchFilters && dfd_familyjson_v1Props?.data)
  {
    if(Array.isArray(dfd_familyjson_v1Props.data) && dfd_familyjson_v1Props.data.length > 0){
      setfamly_detailsb4eb8_5((pre:any)=>({...pre,member_name:dfd_familyjson_v1Props.data[0]?.member_name}));
    }
  }
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={famly_detailsb4eb8_5?.member_name||""}
