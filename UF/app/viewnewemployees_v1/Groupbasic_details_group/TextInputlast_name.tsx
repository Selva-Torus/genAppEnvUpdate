...
const TextInputlast_name = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:viewNewEmployees:AFVK:v1|5d92c67029c108d489235a37078e03ea|cfca22f3e86ea2e8a84da3ab3f4ce947"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,viewNewEmployees_v1:{...pre?.viewNewEmployees_v1,last_name:undefined}}));
    if(dynamicStateandType.type=="number"){
    setbasic_details_groupe03ea((prev: any) => ({ ...prev, last_name: +e.target.value }));
    }
    else{
    setbasic_details_groupe03ea((prev: any) => ({ ...prev, last_name: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "cfca22f3e86ea2e8a84da3ab3f4ce947"
      );
      ...
      //     controlId: "cfca22f3e86ea2e8a84da3ab3f4ce947",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "cfca22f3e86ea2e8a84da3ab3f4ce947") {
        handleChange({target:{value:basic_details_groupe03eaRef?.current?.last_name||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "cfca22f3e86ea2e8a84da3ab3f4ce947") {
        handleBlur({target:{value:basic_details_groupe03eaRef?.current?.last_name||""}});
      }
    };
  ...
  if(dfd_employees_v1Props?.setSearchFilters && dfd_employees_v1Props?.data)
  {
    if(Array.isArray(dfd_employees_v1Props.data) && dfd_employees_v1Props.data.length > 0){
      setbasic_details_groupe03ea((pre:any)=>({...pre,last_name:dfd_employees_v1Props.data[0]?.last_name}));
    }
  }
  },[dfd_employees_v1Props?.setSearchFilters])
  if (last_namece947?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={basic_details_groupe03ea?.last_name||""}
         disabled= {last_namece947?.isDisabled ? true : false}
        pin='brick-brick'     
        placeholder='e.g. Doe'      
        view='normal'
        contentAlign={"left"}
      ...
      errorMessage={error}
        validationState={validate?.viewNewEmployees_v1?.last_name ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
