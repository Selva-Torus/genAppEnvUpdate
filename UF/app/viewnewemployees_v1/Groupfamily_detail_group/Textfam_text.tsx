...
const Textfam_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[fam_text4ee51?.refresh])

  if (fam_text4ee51?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Family Details")}
</Text>
  </div>
  )
}

export default Textfam_text
