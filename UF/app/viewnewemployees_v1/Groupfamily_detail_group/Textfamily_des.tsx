...
const Textfamily_des = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[family_desd7843?.refresh])

  if (family_desd7843?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `3 / 19`,gridRow: `7 / 12`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-1"
  color="primary"
>
      {keyset("Add family details")}
</Text>
  </div>
  )
}

export default Textfamily_des
