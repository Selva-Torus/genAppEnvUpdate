...
const TextInputskill_category = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const handleChange = async(e: any) => {
    ...
    setskilld0dba_12((prev: any) => ({ ...prev, skill_category: +e.target.value }));
    }
    else{
    setskilld0dba_12((prev: any) => ({ ...prev, skill_category: e.target.value }));
    }
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "929f902a655b54e0a3946f3c8497ff29") {
        handleChange({target:{value:skilld0dba_12Ref?.current?.skill_category||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "929f902a655b54e0a3946f3c8497ff29") {
        handleBlur({target:{value:skilld0dba_12Ref?.current?.skill_category||""}});
      }
    };
  ...
  if(dfd_skilljson_v1Props?.setSearchFilters && dfd_skilljson_v1Props?.data)
  {
    if(Array.isArray(dfd_skilljson_v1Props.data) && dfd_skilljson_v1Props.data.length > 0){
      setskilld0dba_12((pre:any)=>({...pre,skill_category:dfd_skilljson_v1Props.data[0]?.skill_category}));
    }
  }
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={skilld0dba_12?.skill_category||""}
