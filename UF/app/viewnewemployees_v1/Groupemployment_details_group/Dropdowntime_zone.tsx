...
const Dropdowntime_zone = ({lockedData,setLockedData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: any) => {
 ...
 /////////////
  ...
  useEffect(() => {
  if(employment_details_group2c703?.timezone=="" || employment_details_group2c703?.timezone==undefined || employment_details_group2c703?.timezone==null ){
    setSelectedItem("");
  }
  },[employment_details_group2c703?.timezone])
  const handleMapperValue=async()=>{
    try{
      const orchestrationData :any = getControlOrchestrationData(
        controlData,
        "47ab0503c3ef42c41f62b7cc6712c703",
        "11c3185d8b3c0de171030681a4eba768"
      );
      ...
      let staticValueProps : any[] = [
  {
    ...
    "value": {
      ...
      setemployment_details_group2c703((prev: any) => ({ ...prev, timezone: staticTextValue, time_zoneba768: value}))
         setIsRequredData(false)
    } else {
       setemployment_details_group2c703((prev: any) => ({ ...prev, timezone: '', time_zoneba768: '' }))
        setIsRequredData(true)
    }
    setError('')
    setValidate((pre:any)=>({...pre,viewNewEmployees_v1:{...pre?.viewNewEmployees_v1,timezone:undefined}}));
  ...
  useEffect(() => { employment_details_group2c703Ref.current = employment_details_group2c703; }, [employment_details_group2c703]);
    useEffect(()=>{
       ...
       const handler = (id:any) => {
          if (id === "11c3185d8b3c0de171030681a4eba768") {
        handleClick(employment_details_group2c703Ref?.current?.time_zoneba768?employment_details_group2c703Ref?.current?.time_zoneba768:"");
          }
        };
        eventBus.on("triggerElement|onClick", handler);
        eventBus.emit("DropdownReady", "11c3185d8b3c0de171030681a4eba768");
        return () => {
  ...
  useEffect(() => {
    if(initialCount!=0)
     setemployment_details_group2c703((pre:any)=>({...pre,timezone:""}))
    else
      setInitialCount(1)
  },[time_zoneba768?.refresh])
  

  if (time_zoneba768?.isHidden) {
    return <></>
  }
  ...
  return (
    <div
      ...
      <Dropdown
        ...
        static={true}
        staticProps={items}
        disabled= {time_zoneba768?.isDisabled ? true : false}
        contentAlign={"center"}
        headerPosition='top'
        headerText={
          <>
        ...
        value={
            employment_details_group2c703?.time_zoneba768 ? [employment_details_group2c703?.time_zoneba768] :
                employment_details_group2c703?.timezone ? employment_details_group2c703?.timezone : []
            }
        onChange={handleClick} 
        validationState={validate?.viewNewEmployees_v1?.timezone ? "invalid" : undefined}
      /> 
    </div>
  );
};
