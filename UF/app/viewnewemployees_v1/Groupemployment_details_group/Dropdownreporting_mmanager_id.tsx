...
const Dropdownreporting_mmanager_id = ({lockedData,setLockedData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: any) => {
 ...
 /////////////
  ...
  useEffect(() => {
  if(employment_details_group2c703?.reporting_manager_id=="" || employment_details_group2c703?.reporting_manager_id==undefined || employment_details_group2c703?.reporting_manager_id==null ){
    setSelectedItem("");
  }
  },[employment_details_group2c703?.reporting_manager_id])
  const handleMapperValue=async()=>{
    try{
      const orchestrationData :any = getControlOrchestrationData(
        controlData,
        "47ab0503c3ef42c41f62b7cc6712c703",
        "17bd7cfdd81f166f12e6e61a1d27f8b5"
      );
  ...
  useEffect(()=>{
    handleMapperValue()
  },[reporting_mmanager_id7f8b5?.refresh])
      ...
      let staticValueProps : any[] = [
  {
    ...
    "value": {
      ...
      setemployment_details_group2c703((prev: any) => ({ ...prev, reporting_manager_id: staticTextValue, reporting_mmanager_id7f8b5: value}))
         setIsRequredData(false)
    } else {
       setemployment_details_group2c703((prev: any) => ({ ...prev, reporting_manager_id: '', reporting_mmanager_id7f8b5: '' }))
        setIsRequredData(true)
    }
    setError('')
    setValidate((pre:any)=>({...pre,viewNewEmployees_v1:{...pre?.viewNewEmployees_v1,reporting_manager_id:undefined}}));
  ...
  useEffect(() => { employment_details_group2c703Ref.current = employment_details_group2c703; }, [employment_details_group2c703]);
    useEffect(()=>{
       ...
       const handler = (id:any) => {
          if (id === "17bd7cfdd81f166f12e6e61a1d27f8b5") {
        handleClick(employment_details_group2c703Ref?.current?.reporting_mmanager_id7f8b5?employment_details_group2c703Ref?.current?.reporting_mmanager_id7f8b5:"");
          }
        };
        eventBus.on("triggerElement|onClick", handler);
        eventBus.emit("DropdownReady", "17bd7cfdd81f166f12e6e61a1d27f8b5");
        return () => {
  ...
  useEffect(() => {
    if(initialCount!=0)
     setemployment_details_group2c703((pre:any)=>({...pre,reporting_manager_id:""}))
    else
      setInitialCount(1)
  },[reporting_mmanager_id7f8b5?.refresh])
  

  if (reporting_mmanager_id7f8b5?.isHidden) {
    return <></>
  }
  ...
  return (
    <div
      ...
      <Dropdown
        ...
        static={true}
        staticProps={items}
        disabled= {reporting_mmanager_id7f8b5?.isDisabled ? true : false}
        contentAlign={"center"}
        headerPosition='top'
        headerText={
          <>
        ...
        value={
            employment_details_group2c703?.reporting_mmanager_id7f8b5 ? [employment_details_group2c703?.reporting_mmanager_id7f8b5] :
                employment_details_group2c703?.reporting_manager_id ? employment_details_group2c703?.reporting_manager_id : []
            }
        onChange={handleClick} 
        validationState={validate?.viewNewEmployees_v1?.reporting_manager_id ? "invalid" : undefined}
      /> 
    </div>
  );
};
