...
const TextInputnationality = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:viewNewEmployees:AFVK:v1|f05017610109e63bcf3eb18c12175e08|c60517ac53a31859d42ae966ddf6d67c"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,viewNewEmployees_v1:{...pre?.viewNewEmployees_v1,nationality:undefined}}));
    if(dynamicStateandType.type=="number"){
    setaddress_details_group75e08((prev: any) => ({ ...prev, nationality: +e.target.value }));
    }
    else{
    setaddress_details_group75e08((prev: any) => ({ ...prev, nationality: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "c60517ac53a31859d42ae966ddf6d67c"
      );
      ...
      //     controlId: "c60517ac53a31859d42ae966ddf6d67c",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "c60517ac53a31859d42ae966ddf6d67c") {
        handleChange({target:{value:address_details_group75e08Ref?.current?.nationality||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "c60517ac53a31859d42ae966ddf6d67c") {
        handleBlur({target:{value:address_details_group75e08Ref?.current?.nationality||""}});
      }
    };
  ...
  if(dfd_employees_v1Props?.setSearchFilters && dfd_employees_v1Props?.data)
  {
    if(Array.isArray(dfd_employees_v1Props.data) && dfd_employees_v1Props.data.length > 0){
      setaddress_details_group75e08((pre:any)=>({...pre,nationality:dfd_employees_v1Props.data[0]?.nationality}));
    }
  }
  },[dfd_employees_v1Props?.setSearchFilters])
  if (nationality6d67c?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={address_details_group75e08?.nationality||""}
         disabled= {nationality6d67c?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.viewNewEmployees_v1?.nationality ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
