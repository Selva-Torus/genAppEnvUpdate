...
const Texted_his_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[ed_his_textc52be?.refresh])

  if (ed_his_textc52be?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `3 / 20`,gridRow: `1 / 7`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className="!font-bold"
  variant="subheader-1"
  color="primary"
>
      {keyset("Education History")}
</Text>
  </div>
  )
}

export default Texted_his_text
