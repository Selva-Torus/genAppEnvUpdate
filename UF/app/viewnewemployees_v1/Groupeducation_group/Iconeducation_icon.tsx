...
const Iconeducation_icon = ({encryptionFlagCompData,setIsProcessing,controlData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData : any = getControlOrchestrationData(
      controlData,
      "777d70f852658c4e00217974b3ccd288",
      "8feea9709ce58d933f1f51b9e6399a7a"
    );
  ...
  if (education_icon99a7a?.isHidden) {
    return <></>
  }
...
export default Iconeducation_icon
