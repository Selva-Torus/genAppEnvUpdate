...
export default function PageViewnewemployeesV1() {
  ...
  const [paginationData,setPaginationData]=useState<PaginationData>({count:10,page:1})
    ...
    async function bloodgroupcombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(viewnewemployees_v1Props.length > 0){
          for(let i=0;i< viewnewemployees_v1Props.length;i++){
            if(viewnewemployees_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:bloodGroupCombo:AFVK:v1"){
              // delete viewnewemployees_v1Props[i].DFDkey;
              let temp=structuredClone(viewnewemployees_v1Props[i])
              delete temp?.DFDkey
  ...
  useEffect(()=>{
    ...
    async function maritalstatuscombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(viewnewemployees_v1Props.length > 0){
          for(let i=0;i< viewnewemployees_v1Props.length;i++){
            if(viewnewemployees_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:maritalStatusCombo:AFVK:v1"){
              // delete viewnewemployees_v1Props[i].DFDkey;
              let temp=structuredClone(viewnewemployees_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function employmenttypecombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(viewnewemployees_v1Props.length > 0){
          for(let i=0;i< viewnewemployees_v1Props.length;i++){
            if(viewnewemployees_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:employmentTypeCombo:AFVK:v1"){
              // delete viewnewemployees_v1Props[i].DFDkey;
              let temp=structuredClone(viewnewemployees_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function employeestatuscombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(viewnewemployees_v1Props.length > 0){
          for(let i=0;i< viewnewemployees_v1Props.length;i++){
            if(viewnewemployees_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:employeeStatusCombo:AFVK:v1"){
              // delete viewnewemployees_v1Props[i].DFDkey;
              let temp=structuredClone(viewnewemployees_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function gradecodecombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(viewnewemployees_v1Props.length > 0){
          for(let i=0;i< viewnewemployees_v1Props.length;i++){
            if(viewnewemployees_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:gradeCodeCombo:AFVK:v1"){
              // delete viewnewemployees_v1Props[i].DFDkey;
              let temp=structuredClone(viewnewemployees_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function vacancystatuscombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(viewnewemployees_v1Props.length > 0){
          for(let i=0;i< viewnewemployees_v1Props.length;i++){
            if(viewnewemployees_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:vacancyStatusCombo:AFVK:v1"){
              // delete viewnewemployees_v1Props[i].DFDkey;
              let temp=structuredClone(viewnewemployees_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function positioncodecombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(viewnewemployees_v1Props.length > 0){
          for(let i=0;i< viewnewemployees_v1Props.length;i++){
            if(viewnewemployees_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:positionCodeCombo:AFVK:v1"){
              // delete viewnewemployees_v1Props[i].DFDkey;
              let temp=structuredClone(viewnewemployees_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function empworkmodecombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(viewnewemployees_v1Props.length > 0){
          for(let i=0;i< viewnewemployees_v1Props.length;i++){
            if(viewnewemployees_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:empWorkModeCombo:AFVK:v1"){
              // delete viewnewemployees_v1Props[i].DFDkey;
              let temp=structuredClone(viewnewemployees_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function gendercombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(viewnewemployees_v1Props.length > 0){
          for(let i=0;i< viewnewemployees_v1Props.length;i++){
            if(viewnewemployees_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:genderCombo:AFVK:v1"){
              // delete viewnewemployees_v1Props[i].DFDkey;
              let temp=structuredClone(viewnewemployees_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function employees_v1DFD(pagination:any): Promise<void>{
        ...
        if(viewnewemployees_v1Props.length > 0){
          for(let i=0;i< viewnewemployees_v1Props.length;i++){
            if(viewnewemployees_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:employees:AFVK:v1"){
              // delete viewnewemployees_v1Props[i].DFDkey;
              let temp=structuredClone(viewnewemployees_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function skilljson_v1DFD(pagination:any): Promise<void>{
        ...
        if(viewnewemployees_v1Props.length > 0){
          for(let i=0;i< viewnewemployees_v1Props.length;i++){
            if(viewnewemployees_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:skillJson:AFVK:v1"){
              // delete viewnewemployees_v1Props[i].DFDkey;
              let temp=structuredClone(viewnewemployees_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function familyjson_v1DFD(pagination:any): Promise<void>{
        ...
        if(viewnewemployees_v1Props.length > 0){
          for(let i=0;i< viewnewemployees_v1Props.length;i++){
            if(viewnewemployees_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:familyJson:AFVK:v1"){
              // delete viewnewemployees_v1Props[i].DFDkey;
              let temp=structuredClone(viewnewemployees_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function educationjson_v1DFD(pagination:any): Promise<void>{
        ...
        if(viewnewemployees_v1Props.length > 0){
          for(let i=0;i< viewnewemployees_v1Props.length;i++){
            if(viewnewemployees_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:educationJson:AFVK:v1"){
              // delete viewnewemployees_v1Props[i].DFDkey;
              let temp=structuredClone(viewnewemployees_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function certifyjson_v1DFD(pagination:any): Promise<void>{
        ...
        if(viewnewemployees_v1Props.length > 0){
          for(let i=0;i< viewnewemployees_v1Props.length;i++){
            if(viewnewemployees_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:certifyJson:AFVK:v1"){
              // delete viewnewemployees_v1Props[i].DFDkey;
              let temp=structuredClone(viewnewemployees_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function countrycombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(viewnewemployees_v1Props.length > 0){
          for(let i=0;i< viewnewemployees_v1Props.length;i++){
            if(viewnewemployees_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:countryCombo:AFVK:v1"){
              // delete viewnewemployees_v1Props[i].DFDkey;
              let temp=structuredClone(viewnewemployees_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function statecombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(viewnewemployees_v1Props.length > 0){
          for(let i=0;i< viewnewemployees_v1Props.length;i++){
            if(viewnewemployees_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:stateCombo:AFVK:v1"){
              // delete viewnewemployees_v1Props[i].DFDkey;
              let temp=structuredClone(viewnewemployees_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function currencycombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(viewnewemployees_v1Props.length > 0){
          for(let i=0;i< viewnewemployees_v1Props.length;i++){
            if(viewnewemployees_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:currencyCombo:AFVK:v1"){
              // delete viewnewemployees_v1Props[i].DFDkey;
              let temp=structuredClone(viewnewemployees_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  const handleArtfactRule=async(rule:any,data:any={},allRuleData:any)=>{
    ...
    setviewnewemployees_v1({...result,_artfactPFRule_:rule})
  }
  ...
  useEffect(() => {    
    ...
    securityCheck();
    handleOnload();
    setviewnewemployees_v1((pre:any)=>({...pre,...allRuleData||{}}))
  }, [])

  useEffect(()=>{
    if(viewnewemployees_v1?._artfactPFRule_)
    {
      let data:any ={
        ...decodedTokenObj,
        session:decodedTokenObj,
      }
      handleArtfactRule(viewnewemployees_v1?._artfactPFRule_,data,allRuleData)
    }
  },[])
  ...
  useEffect(() => {
    const handleClickOutside = (event:any) => {
      if (parentRef.current && !parentRef.current.contains(event.target)) {
        setviewnewemployees_v1((pre:any)=>({...pre,_selectedGroup_:""}))
      }
    };
