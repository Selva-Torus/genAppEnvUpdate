...
const Textcompensation_details = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[compensation_details3c118?.refresh])

  if (compensation_details3c118?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Compensation Details")}
</Text>
  </div>
  )
}

export default Textcompensation_details
