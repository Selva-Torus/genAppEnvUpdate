...
const Buttonbt_add_grade = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      ...
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "9cc07606c6b0b17b7f38fc3e8465f754"
      );
    ...
    if(orchestrationData?.data?.rule?.nodes?.length > 0){
      ...
      if("bt_add_grade" in dynamicactions7e8c7Props?.dynamicActionRule){
        setShowFlag(true)
        setStyleSate({...getGridPositionFromOrder(dynamicactions7e8c7Props?.dynamicActionRule?.bt_add_grade,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }
      else
      {
        setShowFlag(false)   
      ...
      if("bt_add_grade" in addemployeejobgrade_v1?.dynamicactions && addemployeejobgrade_v1?.dynamicactions["bt_add_grade"]?.itsHaveArtifact== true)
      {
        setShowFlag(addemployeejobgrade_v1?.dynamicactions["bt_add_grade"]?.show||false)
        
        setStyleSate({...getGridPositionFromOrder(addemployeejobgrade_v1?.dynamicactions?.bt_add_grade?.order,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }else{
        setShowFlag(false)
      }
    }
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "bt_add_grade5f754") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "9cc07606c6b0b17b7f38fc3e8465f754") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "bt_add_grade5f754");
    return () => {
  ...
  useEffect(()=>{
    if (!bt_add_grade5f754?.trigger) return;
      if(bt_add_grade5f754?.trigger){
      setbt_add_grade5f754((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[bt_add_grade5f754?.trigger])

  useEffect(()=>{
    if(bt_add_grade5f754?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[bt_add_grade5f754?.refresh])
  ...
  async function handleSavef754_1_1_1(){
  ...
  const hasInvalidField = Object.values(currentValidate?.addEmployeeJobGrade_v1 || {}).some(val => {
    ...
    try{
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addJobGrade:AFVK:v1|a8c9d715fef02d88f21a83c5c5d9941c"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addJobGrade:AFVK:v1|a8c9d715fef02d88f21a83c5c5d9941c"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "9cc07606c6b0b17b7f38fc3e8465f754",
  "type": "button",
  ...
  "children": [
    {
      "id": "9cc07606c6b0b17b7f38fc3e8465f754.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "9cc07606c6b0b17b7f38fc3e8465f754.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "9cc07606c6b0b17b7f38fc3e8465f754.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "9cc07606c6b0b17b7f38fc3e8465f754.1.1.1.1.1",
                ...
                "params": [
                  {
                    "name": "message",
                    "_type": "text",
                    "value": "Job Grade Added Successfully",
                    "enabled": true
                  },
                  {
                    "name": "type",
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addJobGrade:AFVK:v1|a8c9d715fef02d88f21a83c5c5d9941c"
          ]
        }
      ]
    }
  ...
  // saveHandler
    ...
    if("_groupArrays_" in reworkedObject )
    {
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              ...
              controlId:"9cc07606c6b0b17b7f38fc3e8465f754"
            };
            if (encryptionFlagCont) {
        ...
        te_saveBody.controlName = "bt_add_grade";
        if(mainData?.upId)
        {
        ...
        if(dynamicactions7e8c7?.upId){
          te_saveBody['upId']= dynamicactions7e8c7?.upId;
        }
        if(dynamicactions7e8c7?.upid){
          te_saveBody['upId']= dynamicactions7e8c7?.upid;
        }
        ...
        if (dynamicactions7e8c7Props.ssKey !== '' && dynamicactions7e8c7Props.ssKey !== undefined) {
          te_saveBody["ssKey"] = dynamicactions7e8c7Props.ssKey;
    ...
    //infoMsg
    toast('Job Grade Added Successfully', 'success',true);
    // refreshElement
    //riseListen
    // for group
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdynamicactions7e8c7((prev: any) => ({ ...prev, bt_add_grade: true }));
        //onClick

    //saveHandler
    await handleSavef754_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdynamicactions7e8c7((prev: any) => ({ ...prev, bt_add_grade: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
  ...
  }, [addemployeejobgrade_v1?.dynamicactions?.bt_add_grade,dynamicactions7e8c7Props?.dynamicActionRule?.bt_add_grade,])

 if (bt_add_grade5f754?.isHidden) {
    return <></>
  }
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {bt_add_grade5f754?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Add Grade")}
...
export default Buttonbt_add_grade
