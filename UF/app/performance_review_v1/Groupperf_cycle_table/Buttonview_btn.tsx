...
import PageViewperformancereviewpage2 from '@/app/viewperformancereview_v1/viewperformancereview_v1page';
 ...
 /////////////
  ...
  const handleCustomCode=async () => {
    ...
    if (code != '') {
      ...
      codeStates['viewperformancereview_v1'] = viewperformancereview_v1Props,
      codeStates['setviewperformancereview_v1'] = setviewperformancereview_v1Props,
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "d2eca08803f13bbaa55dffde556a5669"
      );
    ...
    let filterProps2:any =  [
  {
    ...
    setviewperformancereview_v1Props([...filterData2 ]);
    setShowProfileAsModalOpen2(true);
    //bindTran
    // For group or table
    let bindData4 = filterByKeys(mainData,new_access_groupc5a99Props?.controls);
    setnew_access_groupc5a99(bindData4||{})
    setnew_access_groupc5a99Props({...new_access_groupc5a99Props,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData6 = filterByKeys(mainData,access_req__group002d0Props?.controls);
    setaccess_req__group002d0(bindData6||{})
    setaccess_req__group002d0Props({...access_req__group002d0Props,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData8 = filterByKeys(mainData,valid_group3a8abProps?.controls);
    setvalid_group3a8ab(bindData8||{})
    setvalid_group3a8abProps({...valid_group3a8abProps,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData10 = filterByKeys(mainData,valid_group3a8abProps?.controls);
    setvalid_group3a8ab(bindData10||{})
    setvalid_group3a8abProps({...valid_group3a8abProps,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData12 = filterByKeys(mainData,addt__group6ba4fProps?.controls);
    setaddt__group6ba4f(bindData12||{})
    setaddt__group6ba4fProps({...addt__group6ba4fProps,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData14 = filterByKeys(mainData,addt__dts_group613d2Props?.controls);
    setaddt__dts_group613d2(bindData14||{})
    setaddt__dts_group613d2Props({...addt__dts_group613d2Props,presetValues:mainData||{}})  
  ...
  return (
    ...
    >
      ...
      <Modal 
        ...
        showOverlay = {true}
        position = {"center"}
        modalName = "viewperformancereview"
        className='w-[90%] h-[] bg-gray-50 overflow-auto'
      >
        <PageViewperformancereviewpage2/>
      </Modal>
        {showFlag && <Button 
          ref={buttonRef}
          ...
          onClick={handleClick}
          view='outlined'
          disabled= {view_btna5669?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
          icon="MdRemoveRedEye"
