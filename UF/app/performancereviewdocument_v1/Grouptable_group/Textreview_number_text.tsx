...
const Textreview_number_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[review_number_text7becd?.refresh])

  if (review_number_text7becd?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Review Number")}
</Text>
  </div>
  )
}

export default Textreview_number_text
