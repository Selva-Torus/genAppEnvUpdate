...
const Textreview_id_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[review_id_text98d83?.refresh])

  if (review_id_text98d83?.isHidden) {
    return <></>
  }
...
export default Textreview_id_text
