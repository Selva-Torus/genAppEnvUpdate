...
const Buttonbutton_add_doc = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const doc_attached_group8ed8bRef = useRef(doc_attached_group8ed8b);
  useEffect(() => {
    doc_attached_group8ed8bRef.current = doc_attached_group8ed8b;
    if (!pendingAutoSearch.current) return;
      pendingAutoSearch.current = false;
      handleClick(false);
  }, [doc_attached_group8ed8b]);
  
  //group props in ref to access latest props value
  const doc_attached_group8ed8bPropsRef = useRef(doc_attached_group8ed8bProps);
  useEffect(() => {
    doc_attached_group8ed8bPropsRef.current = doc_attached_group8ed8bProps;
  }, [doc_attached_group8ed8bProps]);
  ...
  const handleMapper=async (data?:any) => {
    try{     
      data = {...data,...doc_attached_group8ed8bRef.current};
      let parentRowSpan = 161;
      const orchestrationData : any = getControlOrchestrationData(
        controlData,
        "46d22986c7d2f89a42104d7f2b68ed8b",
        "4a26bfd979de2405ccdc7415513b64ae"
      );
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "button_add_docb64ae") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "4a26bfd979de2405ccdc7415513b64ae") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "button_add_docb64ae");
    return () => {
  ...
  useEffect(()=>{
    if (!button_add_docb64ae?.trigger) return;
      if(button_add_docb64ae?.trigger){
      setbutton_add_docb64ae((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[button_add_docb64ae?.trigger])

  useEffect(()=>{
    if(button_add_docb64ae?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[button_add_docb64ae?.refresh])
  ...
  async function handleSave64ae_1_1_1(){
      

  setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    await delay(1000); 

    const doc_attached_group8ed8bProps = doc_attached_group8ed8bPropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.performanceReviewDocument_v1 || {}).some(val => {
    ...
    try{
      ...
      let mainData:any=structuredClone(doc_attached_group8ed8bRef.current);
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:performanceReviewDocument:AFVK:v1|729547ef422c6aa873002badc63e39f1"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:performanceReviewDocument:AFVK:v1|729547ef422c6aa873002badc63e39f1"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "4a26bfd979de2405ccdc7415513b64ae",
  "type": "button",
  "name": "button_add_doc",
  ...
  "children": [
    {
      "id": "4a26bfd979de2405ccdc7415513b64ae.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "4a26bfd979de2405ccdc7415513b64ae.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "4a26bfd979de2405ccdc7415513b64ae.1.1.1.1",
              ...
              "children": [
                {
                  "id": "bbef3aa28e652fe589f2867ed76d849d.1.1.1.1.1",
                  "value": "",
                  "type": "screen",
                  "name": "performanceReviewDocument.v1|employee_doc_table",
                  "label": "performanceReviewDocument.v1|employee_doc_table",
                  "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:performanceReviewDocument:AFVK:v1|employee_doc_table",
                  "elementType": "group",
                  "groupType": "table",
                  "sequence": "1.1.1.1.1",
                  "children": []
            ...
            {
              "id": "4a26bfd979de2405ccdc7415513b64ae.1.1.1.2",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:performanceReviewDocument:AFVK:v1|729547ef422c6aa873002badc63e39f1"
          ]
        }
      ]
    }
      ...
      let sourceId : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:performanceReviewDocument:AFVK:v1";
      sourceId+= "|"+"46d22986c7d2f89a42104d7f2b68ed8b";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:performanceReviewDocument:AFVK:v1"+"|"+"46d22986c7d2f89a42104d7f2b68ed8b"+"|"+eventProperty.id;
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...doc_attached_group8ed8bRef.current, ...nullFilter(table_group106c4) });
    let reworkKeys:any[]=[];
    ...
    if("_groupArrays_" in reworkedObject )
    {
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"46d22986c7d2f89a42104d7f2b68ed8b",
              controlId:"4a26bfd979de2405ccdc7415513b64ae"
            };
            if (encryptionFlagCont) {
        ...
        if(doc_attached_group8ed8b?.upId){
          te_saveBody['upId']= doc_attached_group8ed8b?.upId;
        }
        if(doc_attached_group8ed8b?.upid){
          te_saveBody['upId']= doc_attached_group8ed8b?.upid;
        }
        ...
        if (doc_attached_group8ed8bProps.ssKey !== '' && doc_attached_group8ed8bProps.ssKey !== undefined) {
          te_saveBody["ssKey"] = doc_attached_group8ed8bProps.ssKey;
    ...
    //riseListen
    // for group
    setemployee_doc_tabled849dProps((pre:any)=>({...pre,refresh:!pre?.refresh}));
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdoc_attached_group8ed8b((prev: any) => ({ ...prev, button_add_doc: true }));
        //onClick

    //saveHandler
    await handleSave64ae_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdoc_attached_group8ed8b((prev: any) => ({ ...prev, button_add_doc: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
 ...
 if (button_add_docb64ae?.isHidden) {
    return <></>
  }
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {button_add_docb64ae?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Add Document")}
