...
export default function PagePerformancereviewdocumentV1() {
  ...
  const handleArtfactRule=async(rule:any,data:any={},allRuleData:any)=>{
    ...
    setperformancereviewdocument_v1({...result,_artfactPFRule_:rule})
  }
  ...
  async function securityCheck(): Promise<void> {
    ...
    const data: any = await fetchBatchData(
      ...
      [user],
      'pagePerformancereviewdocumentV1',
      token
    )
  ...
  useEffect(() => {    
    ...
    securityCheck();
    handleOnload();
    setperformancereviewdocument_v1((pre:any)=>({...pre,...allRuleData||{}}))
  }, [])

  useEffect(()=>{
    if(performancereviewdocument_v1?._artfactPFRule_)
    {
      let data:any ={
        ...decodedTokenObj,
        session:decodedTokenObj,
      }
      handleArtfactRule(performancereviewdocument_v1?._artfactPFRule_,data,allRuleData)
    }
  },[])
  ...
  useEffect(() => {
    const handleClickOutside = (event:any) => {
      if (parentRef.current && !parentRef.current.contains(event.target)) {
        setperformancereviewdocument_v1((pre:any)=>({...pre,_selectedGroup_:""}))
      }
    };
