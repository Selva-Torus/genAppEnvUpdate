...
import PagePerformancereviewdocdeletepage2 from '@/app/performancereviewdocdelete_v1/performancereviewdocdelete_v1page';
...
const Buttonbt_delete = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleCustomCode=async () => {
    ...
    if (code != '') {
      ...
      codeStates['performancereviewdocdelete_v1'] = performancereviewdocdelete_v1Props,
      codeStates['setperformancereviewdocdelete_v1'] = setperformancereviewdocdelete_v1Props,
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "feddce1cdfde019a821c2c3a042676ed"
      );
    ...
    let filterProps2:any =  [
  {
    ...
    "nodeBasedData": [
      {
        ...
        "object": {
          "properties.attachment_id": "f7d80e5515a901ebdef03cb2643bfc84"
        }
      }
    ]
  }
    ...
    setperformancereviewdocdelete_v1Props([...filterData2 ]);
    setShowProfileAsModalOpen2(true);
    //bindTran
    // For group or table
    let bindData4 = filterByKeys(mainData,group_delete4384fProps?.controls);
    setgroup_delete4384f(bindData4||{})
    setgroup_delete4384fProps({...group_delete4384fProps,presetValues:mainData||{}})  
 ...
 if (bt_delete676ed?.isHidden) {
  ...
  return (
    <div 
     onMouseDown={(e:any) => 
      getRouteScreenDetails('CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:performanceReviewDocument:AFVK:v1','performancereviewdocument','needstopPropagate')=='not in assembler'?e.stopPropagation():null
    }
    >
      ...
      <Modal 
        ...
        showOverlay = {true}
        position = {"center"}
        modalName = "performancereviewdocdelete"
        className='w-[40%] h-[] bg-gray-50 overflow-auto'
      >
        <PagePerformancereviewdocdeletepage2/>
      </Modal>
        {showFlag && <Button 
          ref={buttonRef}
          ...
          onClick={handleClick}
          view='flat-contrast'
          disabled= {bt_delete676ed?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
