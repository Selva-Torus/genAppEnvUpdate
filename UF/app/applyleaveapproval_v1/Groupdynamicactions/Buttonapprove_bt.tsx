...
const Buttonapprove_bt = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const {cancel5617b, setcancel5617b}= useContext(TotalContext) as TotalContextProps;
  const {approve_bt60190, setapprove_bt60190}= useContext(TotalContext) as TotalContextProps;
  const {reject_bt8ac85, setreject_bt8ac85}= useContext(TotalContext) as TotalContextProps;
  ...
  const dynamicactionsafd15Ref = useRef(dynamicactionsafd15);
  useEffect(() => {
    dynamicactionsafd15Ref.current = dynamicactionsafd15;
  ...
  const dynamicactionsafd15PropsRef = useRef(dynamicactionsafd15Props);
  useEffect(() => {
    dynamicactionsafd15PropsRef.current = dynamicactionsafd15Props;
  }, [dynamicactionsafd15Props]);
  ...
  const handleCustomCode=async () => {
    ...
    if (code != '') {
      let codeStates: Record<string, any> = {};
        ...
        codeStates['cancel'] = cancel5617b,
        codeStates['setcancel'] = setcancel5617b,
        codeStates['approve_bt'] = approve_bt60190,
        codeStates['setapprove_bt'] = setapprove_bt60190,
        codeStates['reject_bt'] = reject_bt8ac85,
        codeStates['setreject_bt'] = setreject_bt8ac85,
  ...
  const handleMapper=async (data?:any) => {
    try{     
      data = {...data,...dynamicactionsafd15Ref.current};
      let parentRowSpan = 7;
      const orchestrationData : any = getControlOrchestrationData(
        controlData,
        "f69e987fef325fc31a092b06868afd15",
        "fdbeb312f4749bcd8f18832173a60190"
      );
    ...
    if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    }else if(dynamicactionsafd15Props?.isHaveRule==true){
      if("approve_bt" in dynamicactionsafd15Props?.dynamicActionRule){
        setShowFlag(true)
        setStyleSate({...getGridPositionFromOrder(dynamicactionsafd15Props?.dynamicActionRule?.approve_bt,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }
      else
      {
        setShowFlag(false)   
      ...
      if("approve_bt" in applyleaveapproval_v1?.dynamicactions && applyleaveapproval_v1?.dynamicactions["approve_bt"]?.itsHaveArtifact== true)
      {
        setShowFlag(applyleaveapproval_v1?.dynamicactions["approve_bt"]?.show||false)
        
        setStyleSate({...getGridPositionFromOrder(applyleaveapproval_v1?.dynamicactions?.approve_bt?.order,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }else{
        setShowFlag(false)
      }
    }
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "approve_bt60190") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "fdbeb312f4749bcd8f18832173a60190") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "approve_bt60190");
    return () => {
  ...
  useEffect(()=>{
    if (!approve_bt60190?.trigger) return;
      if(approve_bt60190?.trigger){
      setapprove_bt60190((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[approve_bt60190?.trigger])

  useEffect(()=>{
    if(approve_bt60190?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[approve_bt60190?.refresh])
  ...
  async function handleSave0190_1_1_1(){
      

  setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    await delay(1000); 

    const dynamicactionsafd15Props = dynamicactionsafd15PropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.applyLeaveApproval_v1 || {}).some(val => {
    ...
    try{
      ...
      let mainData:any=structuredClone(dynamicactionsafd15Ref.current);
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addLeaveRequestApproval:AFVK:v1|9e756f0a1ba8410787f4ea0719fde5b7"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addLeaveRequestApproval:AFVK:v1|9e756f0a1ba8410787f4ea0719fde5b7"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
        if(dynamicactionsafd15?.upId === "" && (!lockedData?.data || Object.keys(lockedData?.data)?.length == 0)){
          throw 'Please give proper data';
        }
      let eventProperty :any = {
  "id": "fdbeb312f4749bcd8f18832173a60190",
  "type": "button",
  "name": "approve_bt",
  "label": "approve_bt",
  "sequence": 1,
  "children": [
    {
      "id": "fdbeb312f4749bcd8f18832173a60190.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "fdbeb312f4749bcd8f18832173a60190.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "fdbeb312f4749bcd8f18832173a60190.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
            ...
            {
              "id": "fdbeb312f4749bcd8f18832173a60190.1.1.1.2",
              ...
              "children": [
                {
                  "id": "1fcbb0e3650b4dc5bcd0cb678fce294f.1.1.1.2.1",
                  "value": "",
                  "type": "screen",
                  "name": "leaveRequest.v1|approval_pending_table",
                  "label": "leaveRequest.v1|approval_pending_table",
                  "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:leaveRequest:AFVK:v1|approval_pending_table",
                  "elementType": "group",
                  "groupType": "table",
                  "sequence": "1.1.1.2.1",
                  "children": []
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addLeaveRequestApproval:AFVK:v1|9e756f0a1ba8410787f4ea0719fde5b7"
          ]
        }
      ]
    }
      ...
      let sourceId : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:applyLeaveApproval:AFVK:v1";
      sourceId+= "|"+"f69e987fef325fc31a092b06868afd15";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:applyLeaveApproval:AFVK:v1"+"|"+"f69e987fef325fc31a092b06868afd15"+"|"+eventProperty.id;
      ...
      if(Array.isArray(tableData) && hasValidupId){
        ...
        ...uf_initiatePf.data.nodeProperty,
        data:{"trs_event_process_status":uf_getPFDetails.status},
        upId : dynamicactionsafd15?.upId? [dynamicactionsafd15?.upId ] : upId,
        event : uf_initiatePf.data.eventProperty?.source?.status,
        sourceId : uf_initiatePf.data.eventProperty?.sourceId
      }}else{
        te_eventEmitterBody = {
        ...uf_initiatePf.data.nodeProperty,
        data:{"trs_event_process_status":uf_getPFDetails.status},
        upId : dynamicactionsafd15?.upId? [dynamicactionsafd15?.upId ] : dynamicactionsafd15?.trs_process_id? [dynamicactionsafd15?.trs_process_id ] : lockedData.processIds,
        event : uf_initiatePf.data.eventProperty?.source?.status,
        sourceId : uf_initiatePf.data.eventProperty?.sourceId,
        controlName: "approve_bt"
      }
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...dynamicactionsafd15Ref.current, ...nullFilter(new_access_groupc501f), ...nullFilter(access_req__group7ac49), ...nullFilter(emp_avail_group11178), ...nullFilter(leave_balance_group98e23), ...nullFilter(app_det_groupe2c1b), ...nullFilter(approve_group4086e), ...nullFilter(audit_group087fd) });
    let reworkKeys:any[]=[];
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"f69e987fef325fc31a092b06868afd15",
              controlId:"fdbeb312f4749bcd8f18832173a60190"
            };
            if (encryptionFlagCont) {
    ...
    //eventEmitter
    if (dynamicactionsafd15Props.ssKey !== '' && dynamicactionsafd15Props.ssKey !== undefined) {
    te_eventEmitterBody["ssKey"] = dynamicactionsafd15Props.ssKey;          
    }
    ...
    //infoMsg
    toast('Leave Request Approved', 'success',true);
    // refreshElement
    //riseListen
    // for group
    setapproval_pending_tablee294fProps((pre:any)=>({...pre,refresh:!pre?.refresh}));
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdynamicactionsafd15((prev: any) => ({ ...prev, approve_bt: true }));
        //onClick

    //eventEmitter
    await handleSave0190_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdynamicactionsafd15((prev: any) => ({ ...prev, approve_bt: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
  ...
  }, [applyleaveapproval_v1?.dynamicactions?.approve_bt,dynamicactionsafd15Props?.dynamicActionRule?.approve_bt,])

 if (approve_bt60190?.isHidden) {
    return <></>
  }
  ...
  return (
    <div
      ...
      >
        {showFlag && <Button 
          ref={buttonRef}
          className="!bg-[#22C55E] hover:!bg-[#16A34A] !text-white !rounded-lg !font-bold"
          onClick={handleClick}
          view='normal'
          disabled= {approve_bt60190?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
        >
          {keyset("Approved")}
...
export default Buttonapprove_bt
