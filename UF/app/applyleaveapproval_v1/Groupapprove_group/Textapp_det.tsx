...
const Textapp_det = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[app_deta0272?.refresh])

  if (app_deta0272?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Approval Details")}
</Text>
  </div>
  )
}

export default Textapp_det
