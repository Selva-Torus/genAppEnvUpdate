...
const Texthr_policies = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[hr_policies7ae5f?.refresh])

  if (hr_policies7ae5f?.isHidden) {
    return <></>
  }
...
export default Texthr_policies
