...
const Textbasic_infot_asset_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[basic_infot_asset_text4d8c8?.refresh])

  if (basic_infot_asset_text4d8c8?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Asset Information")}
</Text>
  </div>
  )
}

export default Textbasic_infot_asset_text
