...
const TextInputdisposal_ref = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:newAsset:AFVK:v1|2cc91251b32d441abfbad386965affa1|6b19d764d11645d3b7fad4b4dab075d5"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,newAsset_v1:{...pre?.newAsset_v1,disposal_ref:undefined}}));
    if(dynamicStateandType.type=="number"){
    setdisposal_details_groupaffa1((prev: any) => ({ ...prev, disposal_ref: +e.target.value }));
    }
    else{
    setdisposal_details_groupaffa1((prev: any) => ({ ...prev, disposal_ref: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "6b19d764d11645d3b7fad4b4dab075d5"
      );
      // const orchestrationData: any = await AxiosService.post(
      //   '/UF/Orchestration',
      //   {
      //     key: "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:newAsset:AFVK:v1",
      //     componentId: "2cc91251b32d441abfbad386965affa1",
      //     controlId: "6b19d764d11645d3b7fad4b4dab075d5",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "6b19d764d11645d3b7fad4b4dab075d5") {
        handleChange({target:{value:disposal_details_groupaffa1Ref?.current?.disposal_ref||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "6b19d764d11645d3b7fad4b4dab075d5") {
        handleBlur({target:{value:disposal_details_groupaffa1Ref?.current?.disposal_ref||""}});
      }
    };
  ...
  if(dfd_assets_v1Props?.setSearchFilters && dfd_assets_v1Props?.data)
  {
    if(Array.isArray(dfd_assets_v1Props.data) && dfd_assets_v1Props.data.length > 0){
      setdisposal_details_groupaffa1((pre:any)=>({...pre,disposal_ref:dfd_assets_v1Props.data[0]?.disposal_ref}));
    }
  }
  },[dfd_assets_v1Props?.setSearchFilters])
  if (disposal_ref075d5?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={disposal_details_groupaffa1?.disposal_ref||""}
         disabled= {disposal_ref075d5?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.newAsset_v1?.disposal_ref ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
