 ...
 /////////////
  ...
  /////////////
    ...
    if(orchestrationData?.data?.readableControls.includes("xmlviewer")){
        setxmlviewer9fe8d((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(xmlviewer9fe8d?.isDisabled==null)
      {
        setxmlviewer9fe8d((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    ...
    <div 
      ...
      className={`flex flex-col overflow-auto rounded-md  ${isDark ? 'text-white' : 'text-black'}`}
       onClick={(e:any)=>{e.stopPropagation()
        handleOnClick({}, 0);
          setmessagedataview_v1((pre:any)=>({...pre,_selectedGroup_:"tran_data_group"}))
        }}
    >
