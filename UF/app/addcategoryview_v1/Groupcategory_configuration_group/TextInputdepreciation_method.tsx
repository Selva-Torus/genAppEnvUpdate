...
const TextInputdepreciation_method = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:addCategoryView:AFVK:v1|5e61e4bb8f48b6f41b56278aaba06f09|6cb0757e55f74bc09f7cde3336150f2f"
    }
  ],
  ...
  const [dynamicStateandType,setDynamicStateandType]=useState<Record<string, any>>({name:'depreciation_method',type:"text"})
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,addCategoryView_v1:{...pre?.addCategoryView_v1,depreciation_method:undefined}}));
    if(dynamicStateandType.type=="number"){
    setcategory_configuration_group06f09((prev: any) => ({ ...prev, depreciation_method: +e.target.value }));
    }
    else{
    setcategory_configuration_group06f09((prev: any) => ({ ...prev, depreciation_method: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "6cb0757e55f74bc09f7cde3336150f2f"
      );
      ...
      //     controlId: "6cb0757e55f74bc09f7cde3336150f2f",
      //     isTable: false,
      //     from:"TextInputdepreciation_method",
      ...
      if (orchestrationData?.data?.dataType ==='integer' || orchestrationData?.data?.dataType ==='number') {
        setDynamicStateandType({name:'depreciation_method', type: 'number'});
      }
      // if(orchestrationData?.data?.schemaData?.at(0)?.nodeType=='apinode'){
      // if(orchestrationData?.data?.schemaData?.at(0)?.schema.responses["200"].content["application/json"].schema.items.properties){
      //   let type:any={name:'depreciation_method',type:'text'};
      //   type={
      //     name:'depreciation_method',
      //     type: orchestrationData?.data?.schemaData?.at(0)?.schema.responses["200"].content["application/json"].schema.items.properties.depreciation_method.type == 'string' ? 'text' : orchestrationData?.data?.schemaData?.at(0)?.schema.responses["200"].content["application/json"].schema.items.properties.depreciation_method.type =='integer' ? 'number' : orchestrationData?.data?.schemaData?.at(0)?.schema.responses["200"].content["application/json"].schema.items.properties.depreciation_method.type
      //   }
      ...
      //   type={
      //     name:'depreciation_method',
      //     type: orchestrationData?.data?.schemaData?.at(0)?.schema.properties.depreciation_method.type == 'string' ? 'text' : orchestrationData?.data?.schemaData?.at(0)?.schema.properties.depreciation_method.type =='integer' ? 'number' : orchestrationData?.data?.schemaData?.at(0)?.schema.properties.depreciation_method.type
      //   }
      //   setDynamicStateandType(type);
      // }
      // }
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "6cb0757e55f74bc09f7cde3336150f2f") {
        handleChange({target:{value:category_configuration_group06f09Ref?.current?.depreciation_method||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "6cb0757e55f74bc09f7cde3336150f2f") {
        handleBlur({target:{value:category_configuration_group06f09Ref?.current?.depreciation_method||""}});
      }
    };
  ...
  if(dfd_assetcategory_v1Props?.setSearchFilters && dfd_assetcategory_v1Props?.data)
  {
    if(Array.isArray(dfd_assetcategory_v1Props.data) && dfd_assetcategory_v1Props.data.length > 0){
      setcategory_configuration_group06f09((pre:any)=>({...pre,depreciation_method:dfd_assetcategory_v1Props.data[0]?.depreciation_method}));
    }
  }
  },[dfd_assetcategory_v1Props?.setSearchFilters])
  if (depreciation_method50f2f?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={category_configuration_group06f09?.depreciation_method||""}
         disabled= {depreciation_method50f2f?.isDisabled ? true : false}
        pin='brick-brick'     
        ...
        contentAlign={"left"}
        headerPosition='top'
        headerText="Depreciation Method"
      errorMessage={error}
        validationState={validate?.addCategoryView_v1?.depreciation_method ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
...
export default TextInputdepreciation_method
