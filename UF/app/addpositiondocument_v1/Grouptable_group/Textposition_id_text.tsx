...
const Textposition_id_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[position_id_text19613?.refresh])

  if (position_id_text19613?.isHidden) {
    return <></>
  }
...
export default Textposition_id_text
