...
const Textposition_name_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[position_name_text4bbbe?.refresh])

  if (position_name_text4bbbe?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Position Name")}
</Text>
  </div>
  )
}

export default Textposition_name_text
