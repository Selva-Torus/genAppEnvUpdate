...
const Buttonbutton_add_doc = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const doc_attached_groupedd83Ref = useRef(doc_attached_groupedd83);
  useEffect(() => {
    doc_attached_groupedd83Ref.current = doc_attached_groupedd83;
    if (!pendingAutoSearch.current) return;
      pendingAutoSearch.current = false;
      handleClick(false);
  }, [doc_attached_groupedd83]);
  
  //group props in ref to access latest props value
  const doc_attached_groupedd83PropsRef = useRef(doc_attached_groupedd83Props);
  useEffect(() => {
    doc_attached_groupedd83PropsRef.current = doc_attached_groupedd83Props;
  }, [doc_attached_groupedd83Props]);
  ...
  const handleMapper=async (data?:any) => {
    try{     
      data = {...data,...doc_attached_groupedd83Ref.current};
      let parentRowSpan = 151;
      const orchestrationData : any = getControlOrchestrationData(
        controlData,
        "62ceddbc8f37df4ce0ec31864baedd83",
        "7def11bf10de8c12af22545b1fe90946"
      );
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "button_add_doc90946") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "7def11bf10de8c12af22545b1fe90946") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "button_add_doc90946");
    return () => {
  ...
  useEffect(()=>{
    if (!button_add_doc90946?.trigger) return;
      if(button_add_doc90946?.trigger){
      setbutton_add_doc90946((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[button_add_doc90946?.trigger])

  useEffect(()=>{
    if(button_add_doc90946?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[button_add_doc90946?.refresh])
  ...
  async function handleSave0946_1_1_1(){
      

  setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    await delay(1000); 

    const doc_attached_groupedd83Props = doc_attached_groupedd83PropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.addPositionDocument_v1 || {}).some(val => {
    ...
    try{
      ...
      let mainData:any=structuredClone(doc_attached_groupedd83Ref.current);
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addPositionDocument:AFVK:v1|e3c74778f4f51177e8beb7f45d9c9574"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addPositionDocument:AFVK:v1|e3c74778f4f51177e8beb7f45d9c9574"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "7def11bf10de8c12af22545b1fe90946",
  "type": "button",
  "name": "button_add_doc",
  ...
  "children": [
    {
      "id": "7def11bf10de8c12af22545b1fe90946.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "7def11bf10de8c12af22545b1fe90946.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "7def11bf10de8c12af22545b1fe90946.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "7def11bf10de8c12af22545b1fe90946.1.1.1.1.1",
                  ...
                  "children": [
                    {
                      "id": "e61e4a1d7af13e88748e6a70ea3b28d5.1.1.1.1.1.1",
                      "value": "",
                      "type": "screen",
                ...
                "params": [
                  {
                    "name": "message",
                    "_type": "text",
                    "value": "Position Document Added Successfully",
                    "enabled": true
                  },
                  {
                    "name": "type",
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addPositionDocument:AFVK:v1|e3c74778f4f51177e8beb7f45d9c9574"
          ]
        }
      ]
    }
      ...
      sourceId+= "|"+"62ceddbc8f37df4ce0ec31864baedd83";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:addPositionDocument:AFVK:v1"+"|"+"62ceddbc8f37df4ce0ec31864baedd83"+"|"+eventProperty.id;
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...doc_attached_groupedd83Ref.current, ...nullFilter(table_group5e697) });
    let reworkKeys:any[]=[];
    ...
    if("_groupArrays_" in reworkedObject )
    {
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"62ceddbc8f37df4ce0ec31864baedd83",
              controlId:"7def11bf10de8c12af22545b1fe90946"
            };
            if (encryptionFlagCont) {
        ...
        if(doc_attached_groupedd83?.upId){
          te_saveBody['upId']= doc_attached_groupedd83?.upId;
        }
        if(doc_attached_groupedd83?.upid){
          te_saveBody['upId']= doc_attached_groupedd83?.upid;
        }
        ...
        if (doc_attached_groupedd83Props.ssKey !== '' && doc_attached_groupedd83Props.ssKey !== undefined) {
          te_saveBody["ssKey"] = doc_attached_groupedd83Props.ssKey;
    ...
    //infoMsg
    toast('Position Document Added Successfully', 'success',true);
    // refreshElement
    //riseListen
    // for group
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdoc_attached_groupedd83((prev: any) => ({ ...prev, button_add_doc: true }));
        //onClick

    //saveHandler
    await handleSave0946_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdoc_attached_groupedd83((prev: any) => ({ ...prev, button_add_doc: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
 ...
 if (button_add_doc90946?.isHidden) {
    return <></>
  }
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {button_add_doc90946?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Add Document")}
