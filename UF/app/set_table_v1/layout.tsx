...
export const metadata: Metadata = {
  title: 'TestApplication | set table',
  description: 'Screen generated from Torus metadata key: CK:CT001:FNGK:AF:FNK:UF-UFW:CATK:TAM:AFGK:TA:AFK:set_memory_table:AFVK:v1'
}
