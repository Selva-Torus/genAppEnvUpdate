...
const Textreq_maintenance = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[req_maintenance027c1?.refresh])

  if (req_maintenance027c1?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `5 / 23`,gridRow: `4 / 10`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  ...
  color="primary"
>
      {keyset("REQUIRED MAINTENANCE")}
</Text>
  </div>
  )
}

export default Textreq_maintenance
