...
const Buttonbt_edit = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "ffb1e058527b443fb0bf262f224226cc"
      );
    ...
    let filterProps2:any =  [
  {
    ...
    //enableElement
    setbutton_update74a1f((prev: any) => ({ ...prev, isDisabled: false }));
    //disableElement
    setbt_add_category240df((prev: any) => ({ ...prev, isDisabled: true }));
    //bindTran
    // For group or table
    let bindData8 = filterByKeys(mainData,category_groupe3ebdProps?.controls);
    setcategory_groupe3ebd(bindData8||{})
    setcategory_groupe3ebdProps({...category_groupe3ebdProps,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData10 = filterByKeys(mainData,category_information_groupfb68aProps?.controls);
    setcategory_information_groupfb68a(bindData10||{})
    setcategory_information_groupfb68aProps({...category_information_groupfb68aProps,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData12 = filterByKeys(mainData,category_configuration_group5d6afProps?.controls);
    setcategory_configuration_group5d6af(bindData12||{})
    setcategory_configuration_group5d6afProps({...category_configuration_group5d6afProps,presetValues:mainData||{}})  
    ...
    >
      ...
      >
        ...
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='outlined'
          disabled= {bt_edit226cc?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Edit")}
