...
import PageAddcategoryviewpage2 from '@/app/addcategoryview_v1/addcategoryview_v1page';
...
const Buttonview = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const {addcategoryview_v1Props, setaddcategoryview_v1Props}= useContext(TotalContext) as TotalContextProps;
  ...
  const handleCustomCode=async () => {
    ...
    if (code != '') {
      ...
      codeStates['addcategoryview_v1'] = addcategoryview_v1Props,
      codeStates['setaddcategoryview_v1'] = setaddcategoryview_v1Props,
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "b886d5ccf20f4b41a5935beab6b0d148"
      );
    ...
    let filterProps2:any =  [
  {
    ...
    setaddcategoryview_v1Props([...filterData2 ]);
    setShowProfileAsModalOpen2(true);
    //bindTran
    // For group or table
    let bindData4 = filterByKeys(mainData,category_group70e38Props?.controls);
    setcategory_group70e38(bindData4||{})
    setcategory_group70e38Props({...category_group70e38Props,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData6 = filterByKeys(mainData,category_information_groupa040aProps?.controls);
    setcategory_information_groupa040a(bindData6||{})
    setcategory_information_groupa040aProps({...category_information_groupa040aProps,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData8 = filterByKeys(mainData,category_configuration_group06f09Props?.controls);
    setcategory_configuration_group06f09(bindData8||{})
    setcategory_configuration_group06f09Props({...category_configuration_group06f09Props,presetValues:mainData||{}})  
  ...
  return (
    ...
    >
      ...
      <Modal 
        ...
        showOverlay = {true}
        position = {"center"}
        modalName = "addcategoryview"
        className='w-[80% ] h-[] bg-gray-50 overflow-auto'
      >
        <PageAddcategoryviewpage2/>
      </Modal>
        {showFlag && <Button 
          ref={buttonRef}
          ...
          onClick={handleClick}
          view='outlined'
          disabled= {view0d148?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("View")}
