...
const Textcategorytext = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[categorytextbfea2?.refresh])

  if (categorytextbfea2?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `4 / 22`,gridRow: `1 / 9`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
...
export default Textcategorytext
