...
const Texttc_icon = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[tc_icon1ed4f?.refresh])

  if (tc_icon1ed4f?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `4 / 7`,gridRow: `4 / 10`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=" !font-bold"
  variant="subheader-3"
