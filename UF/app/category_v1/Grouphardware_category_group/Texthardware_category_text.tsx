...
const Texthardware_category_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[hardware_category_text66f11?.refresh])

  if (hardware_category_text66f11?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `6 / 23`,gridRow: `4 / 10`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  ...
  color="primary"
>
      {keyset("HARDWARE CATEGORIES")}
</Text>
  </div>
  )
}

export default Texthardware_category_text
