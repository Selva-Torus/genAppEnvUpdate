...
const Dividersw_cat_divider = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[sw_cat_divider016f6?.refresh])

  if (sw_cat_divider016f6?.isHidden) {
    return <></>
  }
...
export default Dividersw_cat_divider
