...
const Textsoftware_category_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[software_category_text202b3?.refresh])

  if (software_category_text202b3?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("SOFTWARE CATEGORIES")}
</Text>
  </div>
  )
}

export default Textsoftware_category_text
