...
const Dropdowndisposal_method = ({lockedData,setLockedData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: any) => {
 ...
 /////////////
  ...
  useEffect(() => {
  if(disposal_details_groupe1b0c?.disposal_method=="" || disposal_details_groupe1b0c?.disposal_method==undefined || disposal_details_groupe1b0c?.disposal_method==null ){
    setSelectedItem("");
  }
  },[disposal_details_groupe1b0c?.disposal_method])
  const handleMapperValue=async()=>{
    try{
      const orchestrationData :any = getControlOrchestrationData(
        controlData,
        "2693374bb2d64ed88d121dd7c5ee1b0c",
        "0f1d9b73f65c4468aa77a600262deb30"
      );
      ...
      let staticValueProps : any[] = [
  {
    ...
    "value": {
      ...
      setdisposal_details_groupe1b0c((prev: any) => ({ ...prev, disposal_method: staticTextValue, disposal_methoddeb30: value}))
         setIsRequredData(false)
    } else {
       setdisposal_details_groupe1b0c((prev: any) => ({ ...prev, disposal_method: '', disposal_methoddeb30: '' }))
        setIsRequredData(true)
    }
    setError('')
    setValidate((pre:any)=>({...pre,initiateAssetDisposal_v1:{...pre?.initiateAssetDisposal_v1,disposal_method:undefined}}));
  ...
  useEffect(() => { disposal_details_groupe1b0cRef.current = disposal_details_groupe1b0c; }, [disposal_details_groupe1b0c]);
    useEffect(()=>{
       ...
       const handler = (id:any) => {
          if (id === "0f1d9b73f65c4468aa77a600262deb30") {
        handleClick(disposal_details_groupe1b0cRef?.current?.disposal_methoddeb30?disposal_details_groupe1b0cRef?.current?.disposal_methoddeb30:"");
          }
        };
        eventBus.on("triggerElement|onClick", handler);
        eventBus.emit("DropdownReady", "0f1d9b73f65c4468aa77a600262deb30");
        return () => {
  ...
  useEffect(() => {
    if(initialCount!=0)
     setdisposal_details_groupe1b0c((pre:any)=>({...pre,disposal_method:""}))
    else
      setInitialCount(1)
  },[disposal_methoddeb30?.refresh])

  if (disposal_methoddeb30?.isHidden) {
    return <></>
  }
  ...
  return (
    <div
      ...
      <Dropdown
        ...
        static={true}
        staticProps={items}
        disabled= {disposal_methoddeb30?.isDisabled ? true : false}
        contentAlign={"center"}
        headerPosition='top'
        headerText={
          <>
        ...
        value={
            disposal_details_groupe1b0c?.disposal_methoddeb30 ? [disposal_details_groupe1b0c?.disposal_methoddeb30] :
                disposal_details_groupe1b0c?.disposal_method ? disposal_details_groupe1b0c?.disposal_method : []
            }
        onChange={handleClick} 
        validationState={validate?.initiateAssetDisposal_v1?.disposal_method ? "invalid" : undefined}
      /> 
    </div>
  );
};

export default Dropdowndisposal_method;
