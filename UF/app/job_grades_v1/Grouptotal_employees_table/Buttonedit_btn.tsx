...
const Buttonedit_btn = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "028aae41e2c9150b761273fcd911d2da"
      );
    ...
    let filterProps2:any =  [
  {
    ...
    //enableElement
    setbutton_update4ce10((prev: any) => ({ ...prev, isDisabled: false }));
    //disableElement
    setbt_add_grade5f754((prev: any) => ({ ...prev, isDisabled: true }));
    //bindTran
    // For group or table
    let bindData8 = filterByKeys(mainData,grade_information_groupddd50Props?.controls);
    setgrade_information_groupddd50(bindData8||{})
    setgrade_information_groupddd50Props({...grade_information_groupddd50Props,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData10 = filterByKeys(mainData,compensation_benfits_group49b64Props?.controls);
    setcompensation_benfits_group49b64(bindData10||{})
    setcompensation_benfits_group49b64Props({...compensation_benfits_group49b64Props,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData12 = filterByKeys(mainData,hr_policies_group0f880Props?.controls);
    sethr_policies_group0f880(bindData12||{})
    sethr_policies_group0f880Props({...hr_policies_group0f880Props,presetValues:mainData||{}})  
    ...
    >
      ...
      >
        ...
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='outlined'
          disabled= {edit_btn1d2da?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
          icon="MdModeEdit"
