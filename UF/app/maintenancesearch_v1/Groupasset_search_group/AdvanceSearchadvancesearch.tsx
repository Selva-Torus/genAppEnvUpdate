...
const AdvancedSearchadvancesearch = ({lockedData,setLockedData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "events": {
    "NDS": [
      {
        "id": "be494a7c55845b744449808339364153",
        "type": "controlNode",
        "position": {
          "x": 9.583926492065642,
          "y": -68.86817782298927
        ...
        "data": {
          "nodeId": "be494a7c55845b744449808339364153",
          ...
          "label": "advancesearch",
          "children": [
            "be494a7c55845b744449808339364153.1.1"
          ],
          "sequence": 1,
          "nodeProperty": {}
        },
      ...
      {
        "id": "be494a7c55845b744449808339364153.1.1.1",
        "type": "handlerNode",
        "label": "searchFilter",
        ...
        "data": {
          ...
          "value": "",
          "sequence": "1.1.1",
          "parentId": "be494a7c55845b744449808339364153.1.1",
          "children": [
      ...
      },
      {
        ...
        "data": {
          ...
          "sequence": "1.1.1.1",
          "parent": "be494a7c55845b744449808339364153",
          "children": [],
          "nodeProperty": {},
          "name": "assetCategory.v1|category_table",
          "nodeLabel": "",
          "parentId": "be494a7c55845b744449808339364153.1.1.1"
        },
        "width": 60,
        "height": 58,
        "positionAbsolute": {
      ...
      {
        "id": "be494a7c55845b744449808339364153.1.1",
        "type": "eventNode",
        "position": {
          "x": -78.95073163110901,
          "y": -0.595202388869405
        ...
        "data": {
          ...
          "parent": "be494a7c55845b744449808339364153",
          "children": [
            "be494a7c55845b744449808339364153.1.1.1"
          ],
          "nodeProperty": {}
        },
    ...
    "NDE": [
      {
        ...
        "id": "be494a7c55845b744449808339364153->be494a7c55845b744449808339364153.1.1",
        "source": "be494a7c55845b744449808339364153",
        "type": "straight",
        "target": "be494a7c55845b744449808339364153.1.1",
        "animated": true
      },
      {
        "id": "be494a7c55845b744449808339364153.1.1.1->3de40d278fed40108fe057ba6413e4ac.1.1.1.1",
        "source": "be494a7c55845b744449808339364153.1.1.1",
        "type": "straight",
        "target": "3de40d278fed40108fe057ba6413e4ac.1.1.1.1"
      },
      {
        "id": "be494a7c55845b744449808339364153.1.1->be494a7c55845b744449808339364153.1.1.1",
        "source": "be494a7c55845b744449808339364153.1.1",
        "type": "straight",
        "target": "be494a7c55845b744449808339364153.1.1.1"
      }
    ],
    "NDP": {},
    "eventSummary": {
  ...
  "mapper": [
    {
      "sourceKey": [
        "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:AMS:AFK:assetMaintenance:AFVK:v1|a3386808f53949eebff60bf867dcc7a3|properties.asset_name",
        "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:AMS:AFK:assetMaintenance:AFVK:v1|a3386808f53949eebff60bf867dcc7a3|properties.maint_type",
        "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:AMS:AFK:assetMaintenance:AFVK:v1|a3386808f53949eebff60bf867dcc7a3|properties.vendor_name",
        "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:AMS:AFK:assetMaintenance:AFVK:v1|a3386808f53949eebff60bf867dcc7a3|properties.scheduled_date",
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:maintenanceSearch:AFVK:v1|e9dd9f873a8cbfc3750bc94646d1a6b1|be494a7c55845b744449808339364153"
    }
  ],
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        controlData,
        "e9dd9f873a8cbfc3750bc94646d1a6b1",
        "be494a7c55845b744449808339364153"
      );
  ...
  if(dfd_assetmaintenance_v1Props?.setSearchFilters && dfd_assetmaintenance_v1Props?.data)
  {
    if(Array.isArray(dfd_assetmaintenance_v1Props.data) && dfd_assetmaintenance_v1Props.data.length > 0){
      setasset_search_group1a6b1((pre:any)=>({...pre,asset_name:dfd_assetmaintenance_v1Props.data[0]?.asset_name}));
    }
  }
  },[dfd_assetmaintenance_v1Props?.setSearchFilters])
  if (advancesearch64153?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <AdvancedSearch
        ...
        className=""
        label={keyset("")}
         disabled= {advancesearch64153?.isDisabled ? true : false}
      />
      </div>
    </div> 
  )
