...
const Textmaintenance_text_icon = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[maintenance_text_icondf716?.refresh])

  if (maintenance_text_icondf716?.isHidden) {
    return <></>
  }
...
export default Textmaintenance_text_icon
