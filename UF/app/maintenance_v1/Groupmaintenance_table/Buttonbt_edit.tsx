...
const Buttonbt_edit = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "ad4a73d3013e4f9fbf0e504569393fc7"
      );
    ...
    let filterProps2:any =  [
  {
    ...
    "nodeBasedData": [
      {
        "nodeId": "a3386808f53949eebff60bf867dcc7a3",
        "object": {
          "properties.maint_id": "07dac0fea5ed468884365783bb5d22c1"
        }
      }
    ]
  }
    ...
    //enableElement
    setbutton_update5cdad((prev: any) => ({ ...prev, isDisabled: false }));
    //disableElement
    setschedule133fb((prev: any) => ({ ...prev, isDisabled: true }));
    //bindTran
    // For group or table
    setmaintenance_groupdb5a7(mainData||{})
    setmaintenance_groupdb5a7Props({...maintenance_groupdb5a7Props,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    setmaintenance_information_groupea3ac(mainData||{})
    setmaintenance_information_groupea3acProps({...maintenance_information_groupea3acProps,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    setexecution_details_group591cd(mainData||{})
    setexecution_details_group591cdProps({...execution_details_group591cdProps,presetValues:mainData||{}})  
    ...
    >
      ...
      >
        ...
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='outlined'
          disabled= {bt_edit93fc7?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Edit")}
