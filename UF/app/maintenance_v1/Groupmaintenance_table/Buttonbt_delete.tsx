...
import PageMaintenancedeletepage2 from '@/app/maintenancedelete_v1/maintenancedelete_v1page';
 ...
 /////////////
  ...
  const handleCustomCode=async () => {
    ...
    if (code != '') {
      ...
      codeStates['maintenancedelete_v1'] = maintenancedelete_v1Props,
      codeStates['setmaintenancedelete_v1'] = setmaintenancedelete_v1Props,
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "30ad14503f5f4542913b07a8fb570a91"
      );
    ...
    let filterProps2:any =  [
  {
    ...
    setmaintenancedelete_v1Props([...filterData2 ]);
  ...
  return (
    ...
    >
      ...
      <Modal 
        ...
        showOverlay = {true}
        position = {"center"}
        modalName = "maintenancedelete"
        className='w-[40%] h-[] bg-gray-50 overflow-auto'
      >
        <PageMaintenancedeletepage2/>
      </Modal>
        {showFlag && <Button 
          ref={buttonRef}
          ...
          onClick={handleClick}
          view='outlined'
          disabled= {bt_delete70a91?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Delete")}
