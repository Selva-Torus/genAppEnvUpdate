...
const Textheader_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[header_textbcd83?.refresh])

  if (header_textbcd83?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 16`,gridRow: `1 / 6`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  ...
  color="primary"
>
      {keyset("HUMAN RESOURCES MANAGEMENT")}
</Text>
  </div>
  )
}

export default Textheader_text
