...
import Groupasset_software_licenses_table_group  from "../Groupasset_software_licenses_table_group/Groupasset_software_licenses_table_group";
...
const Groupct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v1 = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  const data: any = await fetchBatchData(
    ...
    [user],
    'GroupCt006AfUfUfwsEcpAmsAssetsoftwarelicensesV1',
    token
  );
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "ca7a9fc41e1e4697b7ae096a6ac9f426");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v19f426Props((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("asset_software_licenses_table_group")){
        setasset_software_licenses_table_groupcb553({...asset_software_licenses_table_groupcb553,isDisabled:true});

    }else
    {
      if(asset_software_licenses_table_groupcb553?.isDisabled==null)
      {
        setasset_software_licenses_table_groupcb553({...asset_software_licenses_table_groupcb553,isDisabled:false});
      }
    }
  //////////////
    if (code != '') {
  ...
  const ct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v19f426Ref = useRef<any>(null);
  const handleClearSearch = () => {
    ct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v19f426Ref.current?.setSearchParams();
    ct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v19f426Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(ct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v19f426) && Object.keys(ct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v19f426)?.length>0)
      {
        setct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v19f426({})
      }
    }else 
      prevRefreshRef.current= true
  }, [ct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v19f426Props?.refresh,token])
  ...
  return (
    ...
    >
        {allowedComponent.includes("asset_software_licenses_table_group")  &&<Groupasset_software_licenses_table_group  
...
export default Groupct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v1
