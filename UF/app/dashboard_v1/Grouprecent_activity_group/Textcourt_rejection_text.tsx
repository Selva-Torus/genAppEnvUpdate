...
const Textcourt_rejection_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {court_rejection_texte1e9cProps, setcourt_rejection_texte1e9cProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[court_rejection_texte1e9c?.refresh])

  if (court_rejection_texte1e9c?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 15`,gridRow: `71 / 76`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  ...
  color="primary"
>
      {keyset("◉ 09:30 AM  #2026-1156")}
</Text>
  </div>
  )
}

export default Textcourt_rejection_text
