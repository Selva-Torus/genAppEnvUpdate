...
const Textamr_passed_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {amr_passed_text144d2Props, setamr_passed_text144d2Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[amr_passed_text144d2?.refresh])

  if (amr_passed_text144d2?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 15`,gridRow: `55 / 60`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  ...
  color="primary"
>
      {keyset("◉ 09:45 AM  #ACC-789012")}
</Text>
  </div>
  )
}

export default Textamr_passed_text
