...
const Textamr_passed_text1 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {amr_passed_text188d24Props, setamr_passed_text188d24Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[amr_passed_text188d24?.refresh])

  if (amr_passed_text188d24?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `61 / 66`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-1"
  color="primary"
>
      {keyset("AMR passed — Filing queued")}
</Text>
  </div>
  )
}

export default Textamr_passed_text1
