...
const Dividerdivider2 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[divider2269d0?.refresh])

  if (divider2269d0?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `35 / 38`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Dividerdivider2
