...
const Dividerdivider6 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[divider6aaa01?.refresh])

  if (divider6aaa01?.isHidden) {
    return <></>
  }
...
export default Dividerdivider6
