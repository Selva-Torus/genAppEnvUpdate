...
const Textamr_rejected_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {amr_rejected_text92e50Props, setamr_rejected_text92e50Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[amr_rejected_text92e50?.refresh])

  if (amr_rejected_text92e50?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 15`,gridRow: `103 / 108`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  ...
  color="primary"
>
      {keyset("◉ 08:55 AM  #ACC-654321")}
</Text>
  </div>
  )
}

export default Textamr_rejected_text
