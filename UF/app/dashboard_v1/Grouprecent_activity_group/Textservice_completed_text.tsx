...
const Textservice_completed_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {service_completed_text835e5Props, setservice_completed_text835e5Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[service_completed_text835e5?.refresh])

  if (service_completed_text835e5?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 15`,gridRow: `39 / 44`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  ...
  color="primary"
>
      {keyset("◉ 10:15 AM  #2026-1198")}
</Text>
  </div>
  )
}

export default Textservice_completed_text
