...
const Textservice_assigned_text1 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {service_assigned_text15a8e1Props, setservice_assigned_text15a8e1Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[service_assigned_text15a8e1?.refresh])

  if (service_assigned_text15a8e1?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `93 / 98`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-1"
  color="primary"
>
      {keyset("Service assigned — ABC Legal Process Servers")}
</Text>
  </div>
  )
}

export default Textservice_assigned_text1
