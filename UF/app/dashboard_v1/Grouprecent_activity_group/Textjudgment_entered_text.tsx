...
const Textjudgment_entered_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {judgment_entered_text2f3e7Props, setjudgment_entered_text2f3e7Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[judgment_entered_text2f3e7?.refresh])

  if (judgment_entered_text2f3e7?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 15`,gridRow: `23 / 28`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  ...
  color="primary"
>
      {keyset("◉ 10:23 AM  #2026-1234")}
</Text>
  </div>
  )
}

export default Textjudgment_entered_text
