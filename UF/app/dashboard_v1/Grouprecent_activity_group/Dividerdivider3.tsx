...
const Dividerdivider3 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[divider3acb72?.refresh])

  if (divider3acb72?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `51 / 54`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Dividerdivider3
