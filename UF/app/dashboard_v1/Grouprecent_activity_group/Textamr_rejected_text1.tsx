...
const Textamr_rejected_text1 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {amr_rejected_text11a51aProps, setamr_rejected_text11a51aProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[amr_rejected_text11a51a?.refresh])

  if (amr_rejected_text11a51a?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `109 / 114`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-1"
  color="primary"
>
      {keyset("AMR rejected — Missing affidavit")}
</Text>
  </div>
  )
}

export default Textamr_rejected_text1
