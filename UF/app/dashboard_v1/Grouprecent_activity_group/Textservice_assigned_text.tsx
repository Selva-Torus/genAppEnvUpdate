...
const Textservice_assigned_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {service_assigned_textb2d7dProps, setservice_assigned_textb2d7dProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[service_assigned_textb2d7d?.refresh])

  if (service_assigned_textb2d7d?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 15`,gridRow: `87 / 92`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  ...
  color="primary"
>
      {keyset("◉ 09:12 AM  #2026-1102")}
</Text>
  </div>
  )
}

export default Textservice_assigned_text
