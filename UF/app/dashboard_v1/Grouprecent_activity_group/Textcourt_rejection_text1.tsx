...
const Textcourt_rejection_text1 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {court_rejection_text16e38fProps, setcourt_rejection_text16e38fProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[court_rejection_text16e38f?.refresh])

  if (court_rejection_text16e38f?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `77 / 82`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-1"
  color="primary"
>
      {keyset("Court rejection — Wrong form submitted")}
</Text>
  </div>
  )
}

export default Textcourt_rejection_text1
