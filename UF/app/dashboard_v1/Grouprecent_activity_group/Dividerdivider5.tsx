...
const Dividerdivider5 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[divider52864b?.refresh])

  if (divider52864b?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `83 / 86`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Dividerdivider5
