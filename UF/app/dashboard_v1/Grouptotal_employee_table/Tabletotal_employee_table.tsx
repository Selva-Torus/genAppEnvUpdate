...
let defaultColumns:any = [
  {
    "id": "employee_id",
    "nodeid": "3119e97dff4c4b96b09f0e58f25d80db",
    "name": "Employee ID",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "employee_code",
    "nodeid": "b8f54945acf24ec29041ca3ed5cb2790",
    "name": "Employee Code",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "full_name",
    "nodeid": "1ca68afa7bfa4e0fa60d945be0c2c151",
    "name": "Employee Name",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "employee_number",
    "nodeid": "4d8f576c20564e53bf77820576a922ed",
  ...
  {
    "id": "work_email",
    "nodeid": "b257515c3e4b482981cf50ab07b6f53e",
    "name": "Email",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "gender",
    "nodeid": "d5d7711635544bc1ab41d458e9d0d57e",
    "name": "Gender",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "employment_type",
    "nodeid": "fc1c28945f02431db97fd284dffcf45c",
    "name": "Employee Type",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "hire_date",
    "nodeid": "db5aea7b5a17464fbda17d1f2bda0665",
    "name": "Hire Date",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "workmode",
    "nodeid": "6161e3c7664c4b3988c08b9af85aee17",
    "name": "Work Mode",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "employee_status",
    "nodeid": "cea632861e1640488d5e726f1f6ab428",
    "name": "Status",
    "meta": {
      "sort": true
    },
 ...
 /////////////
  ...
  const GetTableDetails = async () => {
    const orchestrationData:any = getGroupOrchestrationData(
        groupData,
        "f07ae78d451d4cc4aa18955fc6ce4e9d",
      );
  ...
  const [SearchParams,setSearchParams] = useState<any>({})
    ...
    /// settotal_employee_tablee4e9dProps
    let postIds: any = []
    let processIds: any = []
    ...
    if(needLockingAndRule.lockMode=='Single'){
      ...
      ttl: needLockingAndRule.ttl
        ...
        let keys:any
        settotal_employee_tablee4e9dProps((pre:any)=>({...pre, selectedIds:[]}))
      ...
      //////////
      //////////
        settotal_employee_tablee4e9dProps((pre:any)=>({...pre, selectedIds:[ids[ids.length-1]]}))
    }
      ...
      settotal_employee_tablee4e9dProps((pre:any)=>({...pre, selectedIds:ids}))
      if(ids?.length>0)
      {
                  }
    }
    ...
    if (checkedData.length) {
      for (let i = 0; i < checkedData.length; i++) {
        if (checkedData[i].page == page) {
          settotal_employee_tablee4e9dProps((pre:any)=>({...pre, selectedIds:checkedData[i].data}))
        }
      }
    }
  ...
  async function fetchData(page:any = 1, pageSize:any = 10, searchParams = {},dfKey:any,isRulePresent:any=false,isOnLoad = false,filterProps?:any,itsFromRefreshHandler:any=false){
    ...
    try {
          ...
          if(DFkeyAndRule?.isRulePresent==true)
          {
            api_paginationBody = {
              ...
              filterDetails: {
                ...
                nodeId: 'f07ae78d451d4cc4aa18955fc6ce4e9d',
                elementId: 'f07ae78d451d4cc4aa18955fc6ce4e9d'
              },
            }
          }else
          {
      ...
      // CopyFromData (Parent table): use presetValues if present, else use pagination-filtered data
        ...
        if ( total_employee_tablee4e9dProps?.presetValues&&Object.keys(total_employee_tablee4e9dProps?.presetValues).length > 0) {
          filtertedData = [total_employee_tablee4e9dProps?.presetValues];
        }else {
          filtertedData = structuredClone(uf_paginationDataFilter.data)||[]
          settotal_employee_tablee4e9d(api_pagination?.data?.records||[])
        }
...
const colurIndicator = (keyValue:any=[], comingValue:any,ColourIndicatorType:any) => {
  ...
  useEffect(() => {
    ...
    if (total_employee_tablee4e9dProps.filterInitalLoad) return;

    const filterControllers = total_employee_tablee4e9dProps.filterControllers ?? {};
    const jsonEntry = (filterData as any[]).find((e: any) => e['total_employee_tablee4e9d']);
    const requiredKeys: string[] = jsonEntry
      ? Object.keys(jsonEntry['total_employee_tablee4e9d']).filter((k: string) => jsonEntry['total_employee_tablee4e9d'][k] === false)
      : [];

    if (requiredKeys.length === 0) {
      UpdatedDataHandle(total_employee_tablee4e9dProps.filterProps);
      return;
    }
    ...
    settotal_employee_tablee4e9dProps((prev: any) => ({ ...prev, filterInitalLoad: true }));
    UpdatedDataHandle(total_employee_tablee4e9dProps.filterProps);

  }, [
    total_employee_tablee4e9dProps.filterControllers,
    DFkeyAndRule
  ])
  ...
  useEffect(() => {
    ...
    total_employee_tablee4e9dProps.filterProps
  ])

  useEffect(() => {
  console.log("search filter changed")
  const payload = JSON.stringify(total_employee_tablee4e9dProps.searchFilter ?? {});
  ...
  prevSearchFilterRef.current = payload;
  const searchParams = nullFilter(total_employee_tablee4e9dProps.searchFilter) || {};
...
}, [total_employee_tablee4e9dProps.searchFilter])
  ...
  useEffect(() => {
    if (total_employee_tablee4e9dProps?.clearData === true) {
      settotal_employee_tablee4e9d([]);
      setAllDataObject([]);
      setAllData([]);
      setTableData([]);
      ...
      setLockedData((pre:any) => ({...pre, data:[]}));
      settotal_employee_tablee4e9dProps((pre:any) => ({...pre, clearData: false, selectedIds: []}));
      setPaginationData((pre:any) => ({...pre, total: 0}));
    }
  }, [total_employee_tablee4e9dProps?.clearData])
  useEffect(() => {
    if (!refreshInitRef.current) {
    ...
    setSelectedPaginationData([])
    setAllDataObject([])
  }, [total_employee_tablee4e9dProps?.refresh])


  const handlePrimaryTable = () => {
    let findData = total_employee_tablee4e9dProps?.selectedIds[total_employee_tablee4e9dProps?.selectedIds?.length-1]
    if(Array.isArray(total_employee_tablee4e9d) && total_employee_tablee4e9d.length>0)
    {
      let data = total_employee_tablee4e9d[findData]
      setPrimaryTableData({
        ...primaryTableData,
        primaryKey: "",
        value: data[""],
  ...
  useEffect(() => {
    if (total_employee_tablee4e9dProps?.selectedIds?.length != 0) handlePrimaryTable()
    if (total_employee_tablee4e9dProps?.selectedIds?.length == 0){
      handleOnRowClick({},total_employee_tablee4e9dProps?.selectedIds)
    }
  }, [total_employee_tablee4e9dProps?.selectedIds])
  ...
  const bindPreviousAndNext=(currectIndex:any,forEvent:any,setData:string,parentTrigger:any="",currectPage:any)=>{ 
    ...
    {
      currectIndex=-1
      if(total_employee_tablee4e9d?.length==0)
      {
        eventBus.emit(parentTrigger, { message: "no data" });
        return
      }
      if(forEvent=="next"&&total_employee_tablee4e9d?.at((+currectIndex)+1))
      {
        const newIndex = (+currectIndex)+1;
        allState[setData](total_employee_tablee4e9d?.at(newIndex))
        eventBus.emit(parentTrigger, { index: newIndex, data: total_employee_tablee4e9d?.at(newIndex) ,currectPage:paginationData?.page});
        return newIndex
      }
      if(forEvent=="previous"&&((+currectIndex)-1)>=0&&total_employee_tablee4e9d?.at((+currectIndex)-1))
      {
        const newIndex = (+currectIndex)-1;
        allState[setData](total_employee_tablee4e9d?.at(newIndex))
        eventBus.emit(parentTrigger, { index: newIndex, data: total_employee_tablee4e9d?.at(newIndex) ,currectPage:paginationData?.page});
  ...
  if (total_employee_tablee4e9d?.isHidden) {
    return <></>
  }
  return(
    <div className='w-full h-full'>
          <div
            ...
            id={"f07ae78d451d4cc4aa18955fc6ce4e9d"}  onClick={(e:any) => {
          ...
          >
            <Table
              ...
              edgePadding={true}
              selectedIds={total_employee_tablee4e9dProps?.selectedIds}  
...
export default Tabletotal_employee_table
