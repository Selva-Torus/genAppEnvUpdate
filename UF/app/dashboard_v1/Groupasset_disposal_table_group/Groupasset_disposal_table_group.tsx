...
import Groupasset_disposal_table  from "../Groupasset_disposal_table/Groupasset_disposal_table";
...
const Groupasset_disposal_table_group = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "96fe17e7f3f74501a3b6fa58fc0329e9");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setasset_disposal_table_group329e9Props((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("asset_disposal_table")){
        setasset_disposal_table440cd({...asset_disposal_table440cd,isDisabled:true});

    }else
    {
      if(asset_disposal_table440cd?.isDisabled==null)
      {
        setasset_disposal_table440cd({...asset_disposal_table440cd,isDisabled:false});
      }
    }
  //////////////
    if (code != '') {
  ...
  const asset_disposal_table_group329e9Ref = useRef<any>(null);
  const handleClearSearch = () => {
    asset_disposal_table_group329e9Ref.current?.setSearchParams();
    asset_disposal_table_group329e9Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(asset_disposal_table_group329e9) && Object.keys(asset_disposal_table_group329e9)?.length>0)
      {
        setasset_disposal_table_group329e9({})
      }
    }else 
      prevRefreshRef.current= true
  }, [asset_disposal_table_group329e9Props?.refresh,token])
  ...
  return (
    ...
    >
        {allowedComponent.includes("asset_disposal_table")  &&<Groupasset_disposal_table  
...
export default Groupasset_disposal_table_group
