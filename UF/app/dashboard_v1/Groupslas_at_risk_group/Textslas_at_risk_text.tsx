...
const Textslas_at_risk_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {slas_at_risk_text42bdcProps, setslas_at_risk_text42bdcProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[slas_at_risk_text42bdc?.refresh])

  if (slas_at_risk_text42bdc?.isHidden) {
    return <></>
  }
...
export default Textslas_at_risk_text
