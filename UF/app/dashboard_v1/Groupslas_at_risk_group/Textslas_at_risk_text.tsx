...
const Textslas_at_risk_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {slas_at_risk_text33ae5Props, setslas_at_risk_text33ae5Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[slas_at_risk_text33ae5?.refresh])

  if (slas_at_risk_text33ae5?.isHidden) {
    return <></>
  }
