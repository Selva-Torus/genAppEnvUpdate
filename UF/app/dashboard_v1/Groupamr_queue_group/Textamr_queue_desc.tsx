...
const Textamr_queue_desc = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {amr_queue_desc10020Props, setamr_queue_desc10020Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[amr_queue_desc10020?.refresh])

  if (amr_queue_desc10020?.isHidden) {
    return <></>
  }
