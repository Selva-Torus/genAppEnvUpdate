...
const Textamr_queue_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {amr_queue_text17149Props, setamr_queue_text17149Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[amr_queue_text17149?.refresh])

  if (amr_queue_text17149?.isHidden) {
    return <></>
  }
...
export default Textamr_queue_text
