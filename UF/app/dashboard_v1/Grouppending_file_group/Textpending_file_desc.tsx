...
const Textpending_file_desc = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {pending_file_desc53378Props, setpending_file_desc53378Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[pending_file_desc53378?.refresh])

  if (pending_file_desc53378?.isHidden) {
    return <></>
  }
