...
const Textpending_file_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {pending_file_text61240Props, setpending_file_text61240Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[pending_file_text61240?.refresh])

  if (pending_file_text61240?.isHidden) {
    return <></>
  }
