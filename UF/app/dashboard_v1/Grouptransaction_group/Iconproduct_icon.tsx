...
const Iconproduct_icon = ({encryptionFlagCompData,setIsProcessing,controlData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData : any = getControlOrchestrationData(
      controlData,
      "793a6b161bb2485c995842c573d6c6f2",
      "006548a7b6b44c70a4985a772c707465"
    );
...
export default Iconproduct_icon
