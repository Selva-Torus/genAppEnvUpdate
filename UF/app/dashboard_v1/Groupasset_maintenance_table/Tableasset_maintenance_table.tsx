...
let defaultColumns:any = [
  {
    "id": "ref",
    "nodeid": "153bdb0a154648af81a29a08cf82b838",
    "name": "Ref",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "asset_name",
    "nodeid": "7af5f24362ac4dcf99fa9ffc8124d2a5",
    "name": "Asset",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "maint_type",
    "nodeid": "466ceeff6eba4828951322227a2e7fac",
    "name": "Type",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "description",
    "nodeid": "545971b659934a37b13cc6eb165b10c9",
    "name": "Description",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "vendor_name",
    "nodeid": "be55160ccbdd40098c9855ce73473ece",
    "name": "Vendor Name",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "scheduled_date",
    "nodeid": "c7ab139cbe114d5d8805c5f625467fe7",
    "name": "Scheduled Date",
    "meta": {
      "sort": true
    },
    ...
    "isSearch": false,
    "colourIndicator": [],
    "dfdName": "scheduled_date"
  },
  {
    "id": "cost",
    "nodeid": "fc58cc510629403382fb1a4af503b16a",
    "name": "Cost",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "status",
    "nodeid": "49a1e2163633429ebfd86f7c3c1c3912",
    "name": "Status",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "maint_id",
    "nodeid": "ed7308347974475fb87e178bdfca5387",
    "name": "Maint ID",
    "meta": {
      "sort": true
    },
...
const Tableasset_maintenance_table = ({ headerButtonsRenders=()=>{return<></>},headerPosition="",headerText="",lockedData,setLockedData,tableData, setTableData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch, setRefetch,setData,encryptionFlagCompData,paginationDetails,open, setOpen, ref, ButtonGoRuleData, setButtonGoRuleData,setIsProcessing,groupData,controlData}: any)=>{
 ...
 /////////////
  ...
  const {ref2b838, setref2b838}= useContext(TotalContext) as TotalContextProps  
  const {asset_name4d2a5, setasset_name4d2a5}= useContext(TotalContext) as TotalContextProps  
  const {maint_typee7fac, setmaint_typee7fac}= useContext(TotalContext) as TotalContextProps  
  const {descriptionb10c9, setdescriptionb10c9}= useContext(TotalContext) as TotalContextProps  
  const {vendor_name73ece, setvendor_name73ece}= useContext(TotalContext) as TotalContextProps  
  const {scheduled_date67fe7, setscheduled_date67fe7}= useContext(TotalContext) as TotalContextProps  
  const {cost3b16a, setcost3b16a}= useContext(TotalContext) as TotalContextProps  
  const {statusc3912, setstatusc3912}= useContext(TotalContext) as TotalContextProps  
  const {maint_ida5387, setmaint_ida5387}= useContext(TotalContext) as TotalContextProps  
  ...
  const GetTableDetails = async () => {
    const orchestrationData:any = getGroupOrchestrationData(
        groupData,
        "8c4ebc6912b743a0baa96754e416cdf1",
      );
  ...
  const [SearchParams,setSearchParams] = useState<any>({})
    ...
    if (allCode != '') {
      let codeStates: any = {};
        ...
        codeStates['ref'] = ref2b838,
        codeStates['setref'] = setref2b838,
        codeStates['asset_name'] = asset_name4d2a5,
        codeStates['setasset_name'] = setasset_name4d2a5,
        codeStates['maint_type'] = maint_typee7fac,
        codeStates['setmaint_type'] = setmaint_typee7fac,
        codeStates['description'] = descriptionb10c9,
        codeStates['setdescription'] = setdescriptionb10c9,
        codeStates['vendor_name'] = vendor_name73ece,
        codeStates['setvendor_name'] = setvendor_name73ece,
        codeStates['scheduled_date'] = scheduled_date67fe7,
        codeStates['setscheduled_date'] = setscheduled_date67fe7,
        codeStates['cost'] = cost3b16a,
        codeStates['setcost'] = setcost3b16a,
        codeStates['status'] = statusc3912,
        codeStates['setstatus'] = setstatusc3912,
        codeStates['maint_id'] = maint_ida5387,
        codeStates['setmaint_id'] = setmaint_ida5387,
  ...
  const handleUpdate = (page:any, pageSize:any) =>{
    ...
    setasset_maintenance_table6cdf1Props((pre:any)=>({...pre, selectedIds:[]}))
    let checkedData: any = selectedPaginationData
    if (checkedData.length) {
      for (let i = 0; i < checkedData.length; i++) {
        if (checkedData[i].page == page) {
          setasset_maintenance_table6cdf1Props((pre:any)=>({...pre, selectedIds:checkedData[i].data}))
        }
      }
    }
  ...
  async function fetchData(page:any = 1, pageSize:any = 10, searchParams = {},dfKey:any,isRulePresent:any=false,isOnLoad = false,filterProps?:any,itsFromRefreshHandler:any=false){
    ...
    try {
          ...
          if(DFkeyAndRule?.isRulePresent==true)
          {
            api_paginationBody = {
              ...
              filterDetails: {
                ...
                nodeId: '8c4ebc6912b743a0baa96754e416cdf1',
                elementId: '8c4ebc6912b743a0baa96754e416cdf1'
              },
            }
          }else
          {
      ...
      // CopyFromData (Parent table): use presetValues if present, else use pagination-filtered data
        ...
        if ( asset_maintenance_table6cdf1Props?.presetValues&&Object.keys(asset_maintenance_table6cdf1Props?.presetValues).length > 0) {
          filtertedData = [asset_maintenance_table6cdf1Props?.presetValues];
        }else {
          filtertedData = structuredClone(uf_paginationDataFilter.data)||[]
          setasset_maintenance_table6cdf1(api_pagination?.data?.records||[])
        }
...
const colurIndicator = (keyValue:any=[], comingValue:any,ColourIndicatorType:any) => {
  ...
  useEffect(() => {
    ...
    if (asset_maintenance_table6cdf1Props.filterInitalLoad) return;

    const filterControllers = asset_maintenance_table6cdf1Props.filterControllers ?? {};
    const jsonEntry = (filterData as any[]).find((e: any) => e['asset_maintenance_table6cdf1']);
    const requiredKeys: string[] = jsonEntry
      ? Object.keys(jsonEntry['asset_maintenance_table6cdf1']).filter((k: string) => jsonEntry['asset_maintenance_table6cdf1'][k] === false)
      : [];
    ...
    setasset_maintenance_table6cdf1Props((prev: any) => ({ ...prev, filterInitalLoad: true }));
    UpdatedDataHandle(asset_maintenance_table6cdf1Props.filterProps);

  }, [
    asset_maintenance_table6cdf1Props.filterControllers,
    DFkeyAndRule
  ])
  ...
  useEffect(() => {
    ...
    asset_maintenance_table6cdf1Props.filterProps
  ])

  useEffect(() => {
  console.log("search filter changed")
  const payload = JSON.stringify(asset_maintenance_table6cdf1Props.searchFilter ?? {});
  ...
  prevSearchFilterRef.current = payload;
  const searchParams = nullFilter(asset_maintenance_table6cdf1Props.searchFilter) || {};
...
}, [asset_maintenance_table6cdf1Props.searchFilter])
  ...
  useEffect(() => {
    if (asset_maintenance_table6cdf1Props?.clearData === true) {
      setasset_maintenance_table6cdf1([]);
      setAllDataObject([]);
      setAllData([]);
      setTableData([]);
      ...
      setasset_maintenance_table6cdf1Props((pre:any) => ({...pre, clearData: false, selectedIds: []}));
      setPaginationData((pre:any) => ({...pre, total: 0}));
    }
  }, [asset_maintenance_table6cdf1Props?.clearData])
  useEffect(() => {
    if (!refreshInitRef.current) {
    ...
    setSelectedPaginationData([])
    setAllDataObject([])
  }, [asset_maintenance_table6cdf1Props?.refresh])


  const handlePrimaryTable = () => {
    let findData = asset_maintenance_table6cdf1Props?.selectedIds[asset_maintenance_table6cdf1Props?.selectedIds?.length-1]
    if(Array.isArray(asset_maintenance_table6cdf1) && asset_maintenance_table6cdf1.length>0)
    {
      let data = asset_maintenance_table6cdf1[findData]
      setPrimaryTableData({
        ...primaryTableData,
        primaryKey: "",
        value: data[""],
  ...
  useEffect(() => {
    if (asset_maintenance_table6cdf1Props?.selectedIds?.length != 0) handlePrimaryTable()
    if (asset_maintenance_table6cdf1Props?.selectedIds?.length == 0){
      handleOnRowClick({},asset_maintenance_table6cdf1Props?.selectedIds)
    }
  }, [asset_maintenance_table6cdf1Props?.selectedIds])
  ...
  const bindPreviousAndNext=(currectIndex:any,forEvent:any,setData:string,parentTrigger:any="",currectPage:any)=>{ 
    ...
    {
      currectIndex=-1
      if(asset_maintenance_table6cdf1?.length==0)
      {
        eventBus.emit(parentTrigger, { message: "no data" });
        return
      }
      if(forEvent=="next"&&asset_maintenance_table6cdf1?.at((+currectIndex)+1))
      {
        const newIndex = (+currectIndex)+1;
        allState[setData](asset_maintenance_table6cdf1?.at(newIndex))
        eventBus.emit(parentTrigger, { index: newIndex, data: asset_maintenance_table6cdf1?.at(newIndex) ,currectPage:paginationData?.page});
        return newIndex
      }
      if(forEvent=="previous"&&((+currectIndex)-1)>=0&&asset_maintenance_table6cdf1?.at((+currectIndex)-1))
      {
        const newIndex = (+currectIndex)-1;
        allState[setData](asset_maintenance_table6cdf1?.at(newIndex))
        eventBus.emit(parentTrigger, { index: newIndex, data: asset_maintenance_table6cdf1?.at(newIndex) ,currectPage:paginationData?.page});
  ...
  if (asset_maintenance_table6cdf1?.isHidden) {
    return <></>
  }
  return(
    <div className='w-full h-full'>
          <div
            ...
            id={"8c4ebc6912b743a0baa96754e416cdf1"}  onClick={(e:any) => {
          ...
          >
            <Table
              ...
              edgePadding={true}
              selectedIds={asset_maintenance_table6cdf1Props?.selectedIds}  
...
export default Tableasset_maintenance_table
