...
const Textsoftware_licenses_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[software_licenses_text92f3e?.refresh])

  if (software_licenses_text92f3e?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("SOFTWARE LICENSES")}
</Text>
  </div>
  )
}

export default Textsoftware_licenses_text
