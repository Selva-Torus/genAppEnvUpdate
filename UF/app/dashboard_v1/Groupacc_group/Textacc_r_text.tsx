...
const Textacc_r_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[acc_r_texta9806?.refresh])

  if (acc_r_texta9806?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 24`,gridRow: `1 / 7`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  ...
  color="primary"
>
      {keyset("Pending Access Requests")}
</Text>
  </div>
  )
}

export default Textacc_r_text
