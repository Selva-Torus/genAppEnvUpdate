...
const Textservice_pending_desc = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {service_pending_desc91c8aProps, setservice_pending_desc91c8aProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[service_pending_desc91c8a?.refresh])

  if (service_pending_desc91c8a?.isHidden) {
    return <></>
  }
