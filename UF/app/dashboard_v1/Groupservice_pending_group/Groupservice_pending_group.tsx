...
import Textservice_pending_text  from "./Textservice_pending_text";
import Iconicon_warranty_expiring  from "./Iconicon_warranty_expiring";
...
export default Groupservice_pending_group
