...
const Textcourt_rejection_desc = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {court_rejection_desc7c63bProps, setcourt_rejection_desc7c63bProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[court_rejection_desc7c63b?.refresh])

  if (court_rejection_desc7c63b?.isHidden) {
    return <></>
  }
