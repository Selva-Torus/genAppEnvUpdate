...
const Textcourt_rejection_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {court_rejection_textc9a86Props, setcourt_rejection_textc9a86Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[court_rejection_textc9a86?.refresh])

  if (court_rejection_textc9a86?.isHidden) {
    return <></>
  }
