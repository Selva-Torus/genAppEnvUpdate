...
import Groupasset_disposal_table_group  from "../Groupasset_disposal_table_group/Groupasset_disposal_table_group";
...
const Groupct006_af_uf_ufws_ecp_ams_assetdisposal_v1 = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  const data: any = await fetchBatchData(
    ...
    [user],
    'GroupCt006AfUfUfwsEcpAmsAssetdisposalV1',
    token
  );
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "cfb23ecb06964be49af6f4e5f83612d1");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setct006_af_uf_ufws_ecp_ams_assetdisposal_v1612d1Props((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("asset_disposal_table_group")){
        setasset_disposal_table_group329e9({...asset_disposal_table_group329e9,isDisabled:true});

    }else
    {
      if(asset_disposal_table_group329e9?.isDisabled==null)
      {
        setasset_disposal_table_group329e9({...asset_disposal_table_group329e9,isDisabled:false});
      }
    }
  //////////////
    if (code != '') {
  ...
  const ct006_af_uf_ufws_ecp_ams_assetdisposal_v1612d1Ref = useRef<any>(null);
  const handleClearSearch = () => {
    ct006_af_uf_ufws_ecp_ams_assetdisposal_v1612d1Ref.current?.setSearchParams();
    ct006_af_uf_ufws_ecp_ams_assetdisposal_v1612d1Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(ct006_af_uf_ufws_ecp_ams_assetdisposal_v1612d1) && Object.keys(ct006_af_uf_ufws_ecp_ams_assetdisposal_v1612d1)?.length>0)
      {
        setct006_af_uf_ufws_ecp_ams_assetdisposal_v1612d1({})
      }
    }else 
      prevRefreshRef.current= true
  }, [ct006_af_uf_ufws_ecp_ams_assetdisposal_v1612d1Props?.refresh,token])
  ...
  return (
    ...
    >
        {allowedComponent.includes("asset_disposal_table_group")  &&<Groupasset_disposal_table_group  
...
export default Groupct006_af_uf_ufws_ecp_ams_assetdisposal_v1
