...
const Textpending_disposal_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[pending_disposal_text3d356?.refresh])

  if (pending_disposal_text3d356?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `4 / 10`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  ...
  color="primary"
>
      {keyset("PENDING DISPOSAL")}
</Text>
  </div>
  )
}

export default Textpending_disposal_text
