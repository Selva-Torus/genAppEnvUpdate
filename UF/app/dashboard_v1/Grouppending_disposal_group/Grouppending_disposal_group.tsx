...
import Dividerpending_disposal_divider  from "./Dividerpending_disposal_divider";
import Textpending_disposal_text  from "./Textpending_disposal_text";
import Textpending_disposal  from "./Textpending_disposal";
import Textpending_disposal_description  from "./Textpending_disposal_description";
...
const Grouppending_disposal_group = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
  ...
  let code:any = `settable_group((pre)=>({status:"pending_disposal_group"}))`;
  let idx = "";
  let item = "";
 ...
 /////////////
  ...
  const {pending_disposal_dividerd7969, setpending_disposal_dividerd7969}= useContext(TotalContext) as TotalContextProps;
  const {pending_disposal_text3d356, setpending_disposal_text3d356}= useContext(TotalContext) as TotalContextProps;
  const {pending_disposal38551, setpending_disposal38551}= useContext(TotalContext) as TotalContextProps;
  const {pending_disposal_descriptionceadc, setpending_disposal_descriptionceadc}= useContext(TotalContext) as TotalContextProps;
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "d1f40cddd7a14e2d8a97215a8552580d");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setpending_disposal_group2580dProps((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("pending_disposal_divider")){
        setpending_disposal_dividerd7969({...pending_disposal_dividerd7969,isDisabled:true});

    }else
    {
      if(pending_disposal_dividerd7969?.isDisabled==null)
      {
        setpending_disposal_dividerd7969({...pending_disposal_dividerd7969,isDisabled:false});
      }
    }
    if(orchestrationData?.data?.readableControls.includes("pending_disposal_text")){
        setpending_disposal_text3d356({...pending_disposal_text3d356,isDisabled:true});

    }else
    {
      if(pending_disposal_text3d356?.isDisabled==null)
      {
        setpending_disposal_text3d356({...pending_disposal_text3d356,isDisabled:false});
      }
    }
    if(orchestrationData?.data?.readableControls.includes("pending_disposal")){
        setpending_disposal38551({...pending_disposal38551,isDisabled:true});

    }else
    {
      if(pending_disposal38551?.isDisabled==null)
      {
        setpending_disposal38551({...pending_disposal38551,isDisabled:false});
      }
    }
    if(orchestrationData?.data?.readableControls.includes("pending_disposal_description")){
        setpending_disposal_descriptionceadc({...pending_disposal_descriptionceadc,isDisabled:true});

    }else
    {
      if(pending_disposal_descriptionceadc?.isDisabled==null)
      {
        setpending_disposal_descriptionceadc({...pending_disposal_descriptionceadc,isDisabled:false});
      }
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
        ...
        codeStates['pending_disposal_divider'] = pending_disposal_dividerd7969,
        codeStates['setpending_disposal_divider'] = setpending_disposal_dividerd7969,
        codeStates['pending_disposal_text'] = pending_disposal_text3d356,
        codeStates['setpending_disposal_text'] = setpending_disposal_text3d356,
        codeStates['pending_disposal'] = pending_disposal38551,
        codeStates['setpending_disposal'] = setpending_disposal38551,
        codeStates['pending_disposal_description'] = pending_disposal_descriptionceadc,
        codeStates['setpending_disposal_description'] = setpending_disposal_descriptionceadc,
  ...
  const pending_disposal_group2580dRef = useRef<any>(null);
  const handleClearSearch = () => {
    pending_disposal_group2580dRef.current?.setSearchParams();
    pending_disposal_group2580dRef.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(pending_disposal_group2580d) && Object.keys(pending_disposal_group2580d)?.length>0)
      {
        setpending_disposal_group2580d({})
      }
    }else 
      prevRefreshRef.current= true
  }, [pending_disposal_group2580dProps?.refresh,token])
  ...
  return (
    ...
    >
        {allowedControls.includes("pending_disposal_divider") ?<Dividerpending_disposal_divider   /* d7969 */checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
          {allowedControls.includes("pending_disposal_text") ?<Textpending_disposal_text   /* 3d356 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
          {allowedControls.includes("pending_disposal") ?<Textpending_disposal   /* 38551 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
          {allowedControls.includes("pending_disposal_description") ?<Textpending_disposal_description   /* ceadc */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
    </div>
 )
}

export default Grouppending_disposal_group
