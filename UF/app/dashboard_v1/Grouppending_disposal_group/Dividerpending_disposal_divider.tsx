...
const Dividerpending_disposal_divider = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[pending_disposal_dividerd7969?.refresh])

  if (pending_disposal_dividerd7969?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 6`,gridRow: `2 / 3`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Dividerpending_disposal_divider
