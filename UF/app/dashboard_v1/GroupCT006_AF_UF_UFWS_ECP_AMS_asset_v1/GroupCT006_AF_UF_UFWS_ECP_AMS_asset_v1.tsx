...
import Groupasset_table_group  from "../Groupasset_table_group/Groupasset_table_group";
...
const Groupct006_af_uf_ufws_ecp_ams_asset_v1 = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  const data: any = await fetchBatchData(
    ...
    [user],
    'GroupCt006AfUfUfwsEcpAmsAssetV1',
    token
  );
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "8d5b4affa122427993c71d1d8e304dc1");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setct006_af_uf_ufws_ecp_ams_asset_v104dc1Props((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("asset_table_group")){
        setasset_table_group6fffa({...asset_table_group6fffa,isDisabled:true});

    }else
    {
      if(asset_table_group6fffa?.isDisabled==null)
      {
        setasset_table_group6fffa({...asset_table_group6fffa,isDisabled:false});
      }
    }
  //////////////
    if (code != '') {
  ...
  const ct006_af_uf_ufws_ecp_ams_asset_v104dc1Ref = useRef<any>(null);
  const handleClearSearch = () => {
    ct006_af_uf_ufws_ecp_ams_asset_v104dc1Ref.current?.setSearchParams();
    ct006_af_uf_ufws_ecp_ams_asset_v104dc1Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(ct006_af_uf_ufws_ecp_ams_asset_v104dc1) && Object.keys(ct006_af_uf_ufws_ecp_ams_asset_v104dc1)?.length>0)
      {
        setct006_af_uf_ufws_ecp_ams_asset_v104dc1({})
      }
    }else 
      prevRefreshRef.current= true
  }, [ct006_af_uf_ufws_ecp_ams_asset_v104dc1Props?.refresh,token])
  ...
  return (
    ...
    >
        {allowedComponent.includes("asset_table_group")  &&<Groupasset_table_group  
...
export default Groupct006_af_uf_ufws_ecp_ams_asset_v1
