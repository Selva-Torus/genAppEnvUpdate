...
const Textavg_days_to_judgment_text1 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {avg_days_to_judgment_text14ed01Props, setavg_days_to_judgment_text14ed01Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[avg_days_to_judgment_text14ed01?.refresh])

  if (avg_days_to_judgment_text14ed01?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `17 / 25`,gridRow: `22 / 27`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className="!font-bold"
  variant="subheader-1"
...
export default Textavg_days_to_judgment_text1
