...
const Dividerdivider1 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[divider13ca73?.refresh])

  if (divider13ca73?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `17 / 20`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Dividerdivider1
