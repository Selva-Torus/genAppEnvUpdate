...
const Textcompliance_score_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {compliance_score_textbf682Props, setcompliance_score_textbf682Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[compliance_score_textbf682?.refresh])

  if (compliance_score_textbf682?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 17`,gridRow: `46 / 51`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-1"
  color="primary"
>
      {keyset("🛡️ Compliance Score")}
</Text>
  </div>
  )
}

export default Textcompliance_score_text
