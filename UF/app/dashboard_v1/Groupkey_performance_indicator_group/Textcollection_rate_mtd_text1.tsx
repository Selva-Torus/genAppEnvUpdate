...
const Textcollection_rate_mtd_text1 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {collection_rate_mtd_text16258dProps, setcollection_rate_mtd_text16258dProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[collection_rate_mtd_text16258d?.refresh])

  if (collection_rate_mtd_text16258d?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `17 / 25`,gridRow: `58 / 63`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className="!font-bold"
  variant="subheader-1"
...
export default Textcollection_rate_mtd_text1
