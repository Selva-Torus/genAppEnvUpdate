...
const Textcourt_rejection_rate_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {court_rejection_rate_text86ac0Props, setcourt_rejection_rate_text86ac0Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[court_rejection_rate_text86ac0?.refresh])

  if (court_rejection_rate_text86ac0?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 17`,gridRow: `34 / 39`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-1"
  color="primary"
>
      {keyset("📉 Court Rejection Rate")}
</Text>
  </div>
  )
}

export default Textcourt_rejection_rate_text
