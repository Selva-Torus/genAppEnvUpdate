...
const Dividerdivider4 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[divider432793?.refresh])

  if (divider432793?.isHidden) {
    return <></>
  }
...
export default Dividerdivider4
