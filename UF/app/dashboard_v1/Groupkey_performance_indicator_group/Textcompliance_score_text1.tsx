...
const Textcompliance_score_text1 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {compliance_score_text1f41e4Props, setcompliance_score_text1f41e4Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[compliance_score_text1f41e4?.refresh])

  if (compliance_score_text1f41e4?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `17 / 25`,gridRow: `46 / 51`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
...
export default Textcompliance_score_text1
