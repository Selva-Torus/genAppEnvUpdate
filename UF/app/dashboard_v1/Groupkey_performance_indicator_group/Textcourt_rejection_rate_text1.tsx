...
const Textcourt_rejection_rate_text1 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {court_rejection_rate_text10b69fProps, setcourt_rejection_rate_text10b69fProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[court_rejection_rate_text10b69f?.refresh])

  if (court_rejection_rate_text10b69f?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `17 / 25`,gridRow: `34 / 39`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
...
export default Textcourt_rejection_rate_text1
