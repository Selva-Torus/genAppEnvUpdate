...
const Texttotal_active_accounts_text1 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {total_active_accounts_text1b45d0Props, settotal_active_accounts_text1b45d0Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[total_active_accounts_text1b45d0?.refresh])

  if (total_active_accounts_text1b45d0?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `17 / 25`,gridRow: `11 / 16`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className="!font-bold"
  variant="subheader-1"
...
export default Texttotal_active_accounts_text1
