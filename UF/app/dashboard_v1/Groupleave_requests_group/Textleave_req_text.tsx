...
const Textleave_req_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[leave_req_text92f3e?.refresh])

  if (leave_req_text92f3e?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("LEAVE REQUESTS")}
</Text>
  </div>
  )
}

export default Textleave_req_text
