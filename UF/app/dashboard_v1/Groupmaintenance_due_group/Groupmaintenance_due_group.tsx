...
import Dividermaintenance_due_divider  from "./Dividermaintenance_due_divider";
import Textmaintenance_due_text  from "./Textmaintenance_due_text";
import Textmaintenance_due  from "./Textmaintenance_due";
import Textoverdue_maintenance  from "./Textoverdue_maintenance";
...
const Groupmaintenance_due_group = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
  ...
  let code:any = `settable_group((pre)=>({status:"maintenance_due_group"}))`;
  let idx = "";
  let item = "";
 ...
 /////////////
  ...
  const {maintenance_due_divider05a2b, setmaintenance_due_divider05a2b}= useContext(TotalContext) as TotalContextProps;
  const {maintenance_due_text31400, setmaintenance_due_text31400}= useContext(TotalContext) as TotalContextProps;
  const {maintenance_due09ab9, setmaintenance_due09ab9}= useContext(TotalContext) as TotalContextProps;
  const {overdue_maintenancef7357, setoverdue_maintenancef7357}= useContext(TotalContext) as TotalContextProps;
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "2366d4fada944365a8bf88f7ca4704ca");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setmaintenance_due_group704caProps((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("maintenance_due_divider")){
        setmaintenance_due_divider05a2b({...maintenance_due_divider05a2b,isDisabled:true});

    }else
    {
      if(maintenance_due_divider05a2b?.isDisabled==null)
      {
        setmaintenance_due_divider05a2b({...maintenance_due_divider05a2b,isDisabled:false});
      }
    }
    if(orchestrationData?.data?.readableControls.includes("maintenance_due_text")){
        setmaintenance_due_text31400({...maintenance_due_text31400,isDisabled:true});

    }else
    {
      if(maintenance_due_text31400?.isDisabled==null)
      {
        setmaintenance_due_text31400({...maintenance_due_text31400,isDisabled:false});
      }
    }
    if(orchestrationData?.data?.readableControls.includes("maintenance_due")){
        setmaintenance_due09ab9({...maintenance_due09ab9,isDisabled:true});

    }else
    {
      if(maintenance_due09ab9?.isDisabled==null)
      {
        setmaintenance_due09ab9({...maintenance_due09ab9,isDisabled:false});
      }
    }
    if(orchestrationData?.data?.readableControls.includes("overdue_maintenance")){
        setoverdue_maintenancef7357({...overdue_maintenancef7357,isDisabled:true});

    }else
    {
      if(overdue_maintenancef7357?.isDisabled==null)
      {
        setoverdue_maintenancef7357({...overdue_maintenancef7357,isDisabled:false});
      }
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
        ...
        codeStates['maintenance_due_divider'] = maintenance_due_divider05a2b,
        codeStates['setmaintenance_due_divider'] = setmaintenance_due_divider05a2b,
        codeStates['maintenance_due_text'] = maintenance_due_text31400,
        codeStates['setmaintenance_due_text'] = setmaintenance_due_text31400,
        codeStates['maintenance_due'] = maintenance_due09ab9,
        codeStates['setmaintenance_due'] = setmaintenance_due09ab9,
        codeStates['overdue_maintenance'] = overdue_maintenancef7357,
        codeStates['setoverdue_maintenance'] = setoverdue_maintenancef7357,
  ...
  const maintenance_due_group704caRef = useRef<any>(null);
  const handleClearSearch = () => {
    maintenance_due_group704caRef.current?.setSearchParams();
    maintenance_due_group704caRef.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(maintenance_due_group704ca) && Object.keys(maintenance_due_group704ca)?.length>0)
      {
        setmaintenance_due_group704ca({})
      }
    }else 
      prevRefreshRef.current= true
  }, [maintenance_due_group704caProps?.refresh,token])
  ...
  return (
    ...
    >
        {allowedControls.includes("maintenance_due_divider") ?<Dividermaintenance_due_divider   /* 05a2b */checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
          {allowedControls.includes("maintenance_due_text") ?<Textmaintenance_due_text   /* 31400 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
          {allowedControls.includes("maintenance_due") ?<Textmaintenance_due   /* 09ab9 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
          {allowedControls.includes("overdue_maintenance") ?<Textoverdue_maintenance   /* f7357 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
    </div>
 )
}

export default Groupmaintenance_due_group
