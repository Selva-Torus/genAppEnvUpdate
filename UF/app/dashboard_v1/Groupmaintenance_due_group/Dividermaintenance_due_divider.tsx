...
const Dividermaintenance_due_divider = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[maintenance_due_divider05a2b?.refresh])

  if (maintenance_due_divider05a2b?.isHidden) {
    return <></>
  }
...
export default Dividermaintenance_due_divider
