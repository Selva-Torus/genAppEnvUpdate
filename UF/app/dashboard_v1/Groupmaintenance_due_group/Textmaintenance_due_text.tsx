...
const Textmaintenance_due_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[maintenance_due_text31400?.refresh])

  if (maintenance_due_text31400?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("MAINTENANCE DUE")}
</Text>
  </div>
  )
}

export default Textmaintenance_due_text
