...
import Groupasset_maintenance_table_group  from "../Groupasset_maintenance_table_group/Groupasset_maintenance_table_group";
...
const Groupct006_af_uf_ufws_ecp_ams_assetmaintenance_v1 = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  const data: any = await fetchBatchData(
    ...
    [user],
    'GroupCt006AfUfUfwsEcpAmsAssetmaintenanceV1',
    token
  );
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "eeb779b0f4ef44e9ac0b9a26275c3e7e");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setct006_af_uf_ufws_ecp_ams_assetmaintenance_v1c3e7eProps((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("asset_maintenance_table_group")){
        setasset_maintenance_table_groupe042b({...asset_maintenance_table_groupe042b,isDisabled:true});

    }else
    {
      if(asset_maintenance_table_groupe042b?.isDisabled==null)
      {
        setasset_maintenance_table_groupe042b({...asset_maintenance_table_groupe042b,isDisabled:false});
      }
    }
  //////////////
    if (code != '') {
  ...
  const ct006_af_uf_ufws_ecp_ams_assetmaintenance_v1c3e7eRef = useRef<any>(null);
  const handleClearSearch = () => {
    ct006_af_uf_ufws_ecp_ams_assetmaintenance_v1c3e7eRef.current?.setSearchParams();
    ct006_af_uf_ufws_ecp_ams_assetmaintenance_v1c3e7eRef.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(ct006_af_uf_ufws_ecp_ams_assetmaintenance_v1c3e7e) && Object.keys(ct006_af_uf_ufws_ecp_ams_assetmaintenance_v1c3e7e)?.length>0)
      {
        setct006_af_uf_ufws_ecp_ams_assetmaintenance_v1c3e7e({})
      }
    }else 
      prevRefreshRef.current= true
  }, [ct006_af_uf_ufws_ecp_ams_assetmaintenance_v1c3e7eProps?.refresh,token])
  ...
  return (
    ...
    >
        {allowedComponent.includes("asset_maintenance_table_group")  &&<Groupasset_maintenance_table_group  
...
export default Groupct006_af_uf_ufws_ecp_ams_assetmaintenance_v1
