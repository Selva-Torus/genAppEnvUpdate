...
import Groupasset_software_licenses_table  from "../Groupasset_software_licenses_table/Groupasset_software_licenses_table";
...
const Groupasset_software_licenses_table_group = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  const data: any = await fetchBatchData(
    ...
    [user],
    'GroupAssetSoftwareLicensesTableGroup',
    token
  );
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "a6595ea23f9b4d419e5bf8d47f0cb553");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setasset_software_licenses_table_groupcb553Props((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("asset_software_licenses_table")){
        setasset_software_licenses_table13758({...asset_software_licenses_table13758,isDisabled:true});

    }else
    {
      if(asset_software_licenses_table13758?.isDisabled==null)
      {
        setasset_software_licenses_table13758({...asset_software_licenses_table13758,isDisabled:false});
      }
    }
  //////////////
    if (code != '') {
  ...
  const asset_software_licenses_table_groupcb553Ref = useRef<any>(null);
  const handleClearSearch = () => {
    asset_software_licenses_table_groupcb553Ref.current?.setSearchParams();
    asset_software_licenses_table_groupcb553Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(asset_software_licenses_table_groupcb553) && Object.keys(asset_software_licenses_table_groupcb553)?.length>0)
      {
        setasset_software_licenses_table_groupcb553({})
      }
    }else 
      prevRefreshRef.current= true
  }, [asset_software_licenses_table_groupcb553Props?.refresh,token])
  ...
  return (
    ...
    >
        {allowedComponent.includes("asset_software_licenses_table")  &&<Groupasset_software_licenses_table  
...
export default Groupasset_software_licenses_table_group
