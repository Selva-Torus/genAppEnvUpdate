...
const Textcollected_mtd_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {collected_mtd_text4d825Props, setcollected_mtd_text4d825Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[collected_mtd_text4d825?.refresh])

  if (collected_mtd_text4d825?.isHidden) {
    return <></>
  }
