...
const Textcollected_mtd_desc = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {collected_mtd_descfffedProps, setcollected_mtd_descfffedProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[collected_mtd_descfffed?.refresh])

  if (collected_mtd_descfffed?.isHidden) {
    return <></>
  }
