...
import Groupwarrenty_expiring_table_group  from "../Groupwarrenty_expiring_table_group/Groupwarrenty_expiring_table_group";
...
const Groupct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1 = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  const data: any = await fetchBatchData(
    ...
    [user],
    'GroupCt006AfUfUfwsEcpAmsWarrentyexpiringV1',
    token
  );
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "5a71bab18ffa4b7b97510e26b2afaac7");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1faac7Props((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("warrenty_expiring_table_group")){
        setwarrenty_expiring_table_group116d1({...warrenty_expiring_table_group116d1,isDisabled:true});

    }else
    {
      if(warrenty_expiring_table_group116d1?.isDisabled==null)
      {
        setwarrenty_expiring_table_group116d1({...warrenty_expiring_table_group116d1,isDisabled:false});
      }
    }
  //////////////
    if (code != '') {
  ...
  const ct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1faac7Ref = useRef<any>(null);
  const handleClearSearch = () => {
    ct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1faac7Ref.current?.setSearchParams();
    ct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1faac7Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(ct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1faac7) && Object.keys(ct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1faac7)?.length>0)
      {
        setct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1faac7({})
      }
    }else 
      prevRefreshRef.current= true
  }, [ct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1faac7Props?.refresh,token])
  ...
  return (
    ...
    >
        {allowedComponent.includes("warrenty_expiring_table_group")  &&<Groupwarrenty_expiring_table_group  
...
export default Groupct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1
