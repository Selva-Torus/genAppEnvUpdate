...
const Textemp_head_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[emp_head_textf66e8?.refresh])

  if (emp_head_textf66e8?.isHidden) {
    return <></>
  }
...
export default Textemp_head_text
