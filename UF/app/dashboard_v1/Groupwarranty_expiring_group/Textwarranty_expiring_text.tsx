...
const Textwarranty_expiring_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[warranty_expiring_texteee70?.refresh])

  if (warranty_expiring_texteee70?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("WARRENTY EXPIRING")}
</Text>
  </div>
  )
}

export default Textwarranty_expiring_text
