...
const Dividerwarranty_expiring_divider = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[warranty_expiring_dividerf7152?.refresh])

  if (warranty_expiring_dividerf7152?.isHidden) {
    return <></>
  }
...
export default Dividerwarranty_expiring_divider
