...
const Dividertotal_asset_divider = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[total_asset_dividerd84da?.refresh])

  if (total_asset_dividerd84da?.isHidden) {
    return <></>
  }
...
export default Dividertotal_asset_divider
