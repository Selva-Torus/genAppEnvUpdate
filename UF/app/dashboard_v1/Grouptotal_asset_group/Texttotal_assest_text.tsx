...
const Texttotal_assest_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[total_assest_text88ed3?.refresh])

  if (total_assest_text88ed3?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 21`,gridRow: `4 / 10`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
...
export default Texttotal_assest_text
