...
const Textpending_access_req_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[pending_access_req_texteee70?.refresh])

  if (pending_access_req_texteee70?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("PENDING ACCESS REQ.")}
</Text>
  </div>
  )
}

export default Textpending_access_req_text
