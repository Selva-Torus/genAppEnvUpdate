...
const Iconaccess_icon = ({encryptionFlagCompData,setIsProcessing,controlData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData : any = getControlOrchestrationData(
      controlData,
      "027e06378b9d4644bebb875afedb5bd4",
      "fbd2cf607d6d4e14921e5b802da3d558"
    );
...
return (
  <div 
    ...
    <Icon 
      className="!text-orange-500 !rounded-xl"
      data="MdLock"
      contentAlign={"center"}
    />
  </div>
...
export default Iconaccess_icon
