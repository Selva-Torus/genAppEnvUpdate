...
import GroupCT006_AF_UF_UFWS_ECP_AMS_asset_v1  from "../GroupCT006_AF_UF_UFWS_ECP_AMS_asset_v1/GroupCT006_AF_UF_UFWS_ECP_AMS_asset_v1";
import GroupCT006_AF_UF_UFWS_ECP_AMS_assetMaintenance_v1  from "../GroupCT006_AF_UF_UFWS_ECP_AMS_assetMaintenance_v1/GroupCT006_AF_UF_UFWS_ECP_AMS_assetMaintenance_v1";
import GroupCT006_AF_UF_UFWS_ECP_AMS_assetSoftwareLicenses_v1  from "../GroupCT006_AF_UF_UFWS_ECP_AMS_assetSoftwareLicenses_v1/GroupCT006_AF_UF_UFWS_ECP_AMS_assetSoftwareLicenses_v1";
import GroupCT006_AF_UF_UFWS_ECP_AMS_assetDisposal_v1  from "../GroupCT006_AF_UF_UFWS_ECP_AMS_assetDisposal_v1/GroupCT006_AF_UF_UFWS_ECP_AMS_assetDisposal_v1";
import GroupCT006_AF_UF_UFWS_ECP_AMS_warrentyExpiring_v1  from "../GroupCT006_AF_UF_UFWS_ECP_AMS_warrentyExpiring_v1/GroupCT006_AF_UF_UFWS_ECP_AMS_warrentyExpiring_v1";
...
const Groupsubscreen = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "f667536f45b249b68cb6b915f9299589");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setsubscreen99589Props((pre:any)=>({...pre,isHaveRule:true}))
    let schemaFlag:any = evaluateDecisionTable(orchestrationData?.data?.rule.nodes,{},{...decodedTokenObj,...table_group94010});
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("ct006_af_uf_ufws_ecp_ams_asset_v1")){
        setct006_af_uf_ufws_ecp_ams_asset_v104dc1({...ct006_af_uf_ufws_ecp_ams_asset_v104dc1,isDisabled:true});

    }else
    {
      if(ct006_af_uf_ufws_ecp_ams_asset_v104dc1?.isDisabled==null)
      {
        setct006_af_uf_ufws_ecp_ams_asset_v104dc1({...ct006_af_uf_ufws_ecp_ams_asset_v104dc1,isDisabled:false});
      }
    }
    if(orchestrationData?.data?.readableControls.includes("ct006_af_uf_ufws_ecp_ams_assetmaintenance_v1")){
        setct006_af_uf_ufws_ecp_ams_assetmaintenance_v1c3e7e({...ct006_af_uf_ufws_ecp_ams_assetmaintenance_v1c3e7e,isDisabled:true});

    }else
    {
      if(ct006_af_uf_ufws_ecp_ams_assetmaintenance_v1c3e7e?.isDisabled==null)
      {
        setct006_af_uf_ufws_ecp_ams_assetmaintenance_v1c3e7e({...ct006_af_uf_ufws_ecp_ams_assetmaintenance_v1c3e7e,isDisabled:false});
      }
    }
    if(orchestrationData?.data?.readableControls.includes("ct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v1")){
        setct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v19f426({...ct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v19f426,isDisabled:true});

    }else
    {
      if(ct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v19f426?.isDisabled==null)
      {
        setct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v19f426({...ct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v19f426,isDisabled:false});
      }
    }
    if(orchestrationData?.data?.readableControls.includes("ct006_af_uf_ufws_ecp_ams_assetdisposal_v1")){
        setct006_af_uf_ufws_ecp_ams_assetdisposal_v1612d1({...ct006_af_uf_ufws_ecp_ams_assetdisposal_v1612d1,isDisabled:true});

    }else
    {
      if(ct006_af_uf_ufws_ecp_ams_assetdisposal_v1612d1?.isDisabled==null)
      {
        setct006_af_uf_ufws_ecp_ams_assetdisposal_v1612d1({...ct006_af_uf_ufws_ecp_ams_assetdisposal_v1612d1,isDisabled:false});
      }
    }
    if(orchestrationData?.data?.readableControls.includes("ct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1")){
        setct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1faac7({...ct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1faac7,isDisabled:true});

    }else
    {
      if(ct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1faac7?.isDisabled==null)
      {
        setct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1faac7({...ct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1faac7,isDisabled:false});
      }
    }
  //////////////
    if (code != '') {
  ...
  const subscreen99589Ref = useRef<any>(null);
  const handleClearSearch = () => {
    subscreen99589Ref.current?.setSearchParams();
    subscreen99589Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(subscreen99589) && Object.keys(subscreen99589)?.length>0)
      {
        setsubscreen99589({})
      }
    }else 
      prevRefreshRef.current= true
  }, [subscreen99589Props?.refresh,token,
table_group94010[uoMapperData["a0b7e3ffaab7460a83c8674ce65f4240"]["source"]]
])
  ...
  return (
    ...
    >
        {(showFlag == "ct006_af_uf_ufws_ecp_ams_asset_v1") &&allowedComponent.includes("ct006_af_uf_ufws_ecp_ams_asset_v1")  &&<GroupCT006_AF_UF_UFWS_ECP_AMS_asset_v1  
        ...
        {(showFlag == "ct006_af_uf_ufws_ecp_ams_assetmaintenance_v1") &&allowedComponent.includes("ct006_af_uf_ufws_ecp_ams_assetmaintenance_v1")  &&<GroupCT006_AF_UF_UFWS_ECP_AMS_assetMaintenance_v1  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          tableData={tableData} 
          setTableData={setTableData}
          ...
          groupData={groupData}
          controlData={controlData}        />}
        {(showFlag == "ct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v1") &&allowedComponent.includes("ct006_af_uf_ufws_ecp_ams_assetsoftwarelicenses_v1")  &&<GroupCT006_AF_UF_UFWS_ECP_AMS_assetSoftwareLicenses_v1  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          tableData={tableData} 
          setTableData={setTableData}
          ...
          groupData={groupData}
          controlData={controlData}        />}
        {(showFlag == "ct006_af_uf_ufws_ecp_ams_assetdisposal_v1") &&allowedComponent.includes("ct006_af_uf_ufws_ecp_ams_assetdisposal_v1")  &&<GroupCT006_AF_UF_UFWS_ECP_AMS_assetDisposal_v1  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          tableData={tableData} 
          setTableData={setTableData}
          ...
          groupData={groupData}
          controlData={controlData}        />}
        {(showFlag == "ct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1") &&allowedComponent.includes("ct006_af_uf_ufws_ecp_ams_warrentyexpiring_v1")  &&<GroupCT006_AF_UF_UFWS_ECP_AMS_warrentyExpiring_v1  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          tableData={tableData} 
          setTableData={setTableData}
