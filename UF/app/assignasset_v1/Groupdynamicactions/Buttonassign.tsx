...
const Buttonassign = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      ...
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "b62c7c288f174f1e9163f256269090a4"
      );
    ...
    if(orchestrationData?.data?.rule?.nodes?.length > 0){
      ...
      if("assign" in dynamicactions956baProps?.dynamicActionRule){
        setShowFlag(true)
        setStyleSate({...getGridPositionFromOrder(dynamicactions956baProps?.dynamicActionRule?.assign,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }
      else
      {
        setShowFlag(false)   
      ...
      if("assign" in assignasset_v1?.dynamicactions && assignasset_v1?.dynamicactions["assign"]?.itsHaveArtifact== true)
      {
        setShowFlag(assignasset_v1?.dynamicactions["assign"]?.show||false)
        
        setStyleSate({...getGridPositionFromOrder(assignasset_v1?.dynamicactions?.assign?.order,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }else{
        setShowFlag(false)
      }
    }
  ...
  useEffect(()=>{
    ...
    const triggerElementHandler = async (id:any) => {
      if (id === "b62c7c288f174f1e9163f256269090a4") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "assign090a4");
    return () => {
  ...
  useEffect(()=>{
    if (!assign090a4?.trigger) return;
      if(assign090a4?.trigger){
      setassign090a4((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
  ...
  async function handleSave90a4_1_1_1(){
  ...
  return val === 'invalid';
    ...
    try{
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:AMS:AFK:assignAsset:AFVK:v1|bbb95c5761ad4c419d71ddd2c4907a06"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:AMS:AFK:assignAsset:AFVK:v1|bbb95c5761ad4c419d71ddd2c4907a06"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "b62c7c288f174f1e9163f256269090a4",
  "type": "button",
  "name": "assign",
  "label": "assign",
  "sequence": 1,
  "children": [
    {
      "id": "b62c7c288f174f1e9163f256269090a4.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "b62c7c288f174f1e9163f256269090a4.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "b62c7c288f174f1e9163f256269090a4.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
                ...
                "params": [
                  {
                    "name": "message",
                    "_type": "text",
                    "value": "Asset Assigned Successfully",
                    "enabled": true
                  },
                  {
                    "name": "type",
            ...
            {
              "id": "b62c7c288f174f1e9163f256269090a4.1.1.1.2",
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:AMS:AFK:assignAsset:AFVK:v1|bbb95c5761ad4c419d71ddd2c4907a06"
          ]
        }
      ]
    }
  ...
  // saveHandler
    ...
    if("_groupArrays_" in reworkedObject )
    {
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              ...
              controlId:"b62c7c288f174f1e9163f256269090a4"
            };
            if (encryptionFlagCont) {
        ...
        te_saveBody.controlName = "assign";
        if(mainData?.upId)
        {
        ...
        if(dynamicactions956ba?.upId){
          te_saveBody['upId']= dynamicactions956ba?.upId;
        }
        if(dynamicactions956ba?.upid){
          te_saveBody['upId']= dynamicactions956ba?.upid;
        }
        ...
        if (dynamicactions956baProps.ssKey !== '' && dynamicactions956baProps.ssKey !== undefined) {
          te_saveBody["ssKey"] = dynamicactions956baProps.ssKey;
    ...
    //infoMsg
    toast('Asset Assigned Successfully', 'success',true);
    // refreshElement
    //riseListen
    // for group
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdynamicactions956ba((prev: any) => ({ ...prev, assign: true }));
        //onClick

    //saveHandler
    await handleSave90a4_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdynamicactions956ba((prev: any) => ({ ...prev, assign: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
  ...
  }, [assignasset_v1?.dynamicactions?.assign,dynamicactions956baProps?.dynamicActionRule?.assign,])

 if (assign090a4?.isHidden) {
    return <></>
  }
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {assign090a4?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
