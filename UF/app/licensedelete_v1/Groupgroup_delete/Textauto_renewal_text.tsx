...
const Textauto_renewal_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[auto_renewal_textbdbd2?.refresh])

  if (auto_renewal_textbdbd2?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 9`,gridRow: `23 / 29`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-3"
  color="primary"
>
      {keyset("Auto Renewal Type")}
</Text>
  </div>
  )
}

export default Textauto_renewal_text
