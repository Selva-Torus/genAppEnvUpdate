...
const Texttextb = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  if (textbca8ba?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `9 / 17`,gridRow: `61 / 71`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=""
  variant="subheader-3"
