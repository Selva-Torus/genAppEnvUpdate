...
const Texttextc = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  if (textc76eb1?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `18 / 23`,gridRow: `60 / 70`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=""
