...
const Groupspecial_rules = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "185e829724c63ba22f1107a22e37f109");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setspecial_rules7f109Props((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("dynamic_icon")){
        setdynamic_iconc7b56((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
      if(dynamic_iconc7b56?.isDisabled==null)
      {
  ...
  const special_rules7f109Ref = useRef<any>(null);
  const handleClearSearch = () => {
    special_rules7f109Ref.current?.setSearchParams();
    special_rules7f109Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(special_rules7f109) && Object.keys(special_rules7f109)?.length>0)
      {
        setspecial_rules7f109({})
      }
    }else 
      prevRefreshRef.current= true
  }, [special_rules7f109Props?.refresh,token])
    ...
    <div key={idx}
      ...
      onClick={(e:any)=>{
        ...
        handleOnClick(item, idx);
          setviewamrcasepggraph_v1((pre:any)=>({...pre,_selectedGroup_:"special_rules"+idx}))
      }}
    >
