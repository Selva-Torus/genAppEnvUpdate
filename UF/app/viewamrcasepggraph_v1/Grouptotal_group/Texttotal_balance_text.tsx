...
const Texttotal_balance_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {total_balance_text0b418Props, settotal_balance_text0b418Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[total_balance_text0b418?.refresh])

  if (total_balance_text0b418?.isHidden) {
    return <></>
  }
