...
const Textcraete_header_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {craete_header_textae5d6Props, setcraete_header_textae5d6Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[craete_header_textae5d6?.refresh])

  if (craete_header_textae5d6?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `3 / 21`,gridRow: `1 / 8`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className="!font-bold"
  variant="subheader-3"
