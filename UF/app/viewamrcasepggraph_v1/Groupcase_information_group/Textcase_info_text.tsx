...
const Textcase_info_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {case_info_text1e3dbProps, setcase_info_text1e3dbProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[case_info_text1e3db?.refresh])

  if (case_info_text1e3db?.isHidden) {
    return <></>
  }
