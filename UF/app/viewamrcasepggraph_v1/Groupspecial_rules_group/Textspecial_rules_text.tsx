...
const Textspecial_rules_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {special_rules_text24a29Props, setspecial_rules_text24a29Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[special_rules_text24a29?.refresh])

  if (special_rules_text24a29?.isHidden) {
    return <></>
  }
