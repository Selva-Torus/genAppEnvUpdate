...
const Textreeq_doc_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {reeq_doc_text64f93Props, setreeq_doc_text64f93Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[reeq_doc_text64f93?.refresh])

  if (reeq_doc_text64f93?.isHidden) {
    return <></>
  }
