...
const Textprincipal_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {principal_text6883fProps, setprincipal_text6883fProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[principal_text6883f?.refresh])

  if (principal_text6883f?.isHidden) {
    return <></>
  }
...
export default Textprincipal_text
