...
const Textvalid_checklist_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {valid_checklist_texta0e64Props, setvalid_checklist_texta0e64Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[valid_checklist_texta0e64?.refresh])

  if (valid_checklist_texta0e64?.isHidden) {
    return <></>
  }
