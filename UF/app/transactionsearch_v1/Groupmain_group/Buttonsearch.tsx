    ...
    "nodeBasedData": [
      {
        ...
        "object": {
          ...
          "properties.cr_amount": "9a3236945d3940fa946c124e7c7042b1",
  ...
  filterData.forEach((newFilter: any) => {
    ...
    if (existingFilter) {
      const cleanedExisting = Object.keys(existingFilter).reduce(
        (acc: any, key: string) => {
          // Keep non-search values from other components
          if (
            key === 'nodeId' ||
...
async function handleSearch5() {
 ...
 if (search0e695?.isHidden) {
  ...
  return (
    <div
      style={{gridColumn: `19 / 22`,gridRow: `55 / 65`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
