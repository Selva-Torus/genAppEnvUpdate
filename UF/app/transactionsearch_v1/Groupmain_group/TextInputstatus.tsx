...
const TextInputstatus = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      "sourceKey": [
        "CK:CT005:FNGK:AF:FNK:DF-DFD:CATK:GSS:AFGK:RTGS:AFK:transaction:AFVK:v1|c2a320f6a30140a487ed20c46f1763dd|properties.trs_status"
      ],
      "targetKey": "CK:CT005:FNGK:AF:FNK:UF-UFW:CATK:GSS:AFGK:RTGS:AFK:transactionSearch:AFVK:v1|526f0e58d5454270aca67c481a99066f|d9a26bb02dd843dbabb84b9db334bd75"
    }
  ],
  ...
  return (   
    <div  
      style={{gridColumn: `9 / 17`,gridRow: `36 / 50`, gap:``, height: `100%`, overflow: 'auto', display: 'flex', flexDirection: 'column'}} >
