 ...
 /////////////
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("top_divider")){
        settop_divider52f90((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(top_divider52f90?.isDisabled==null)
      {
        settop_divider52f90((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    ...
    if(orchestrationData?.data?.readableControls.includes("bottom_divider")){
        setbottom_dividerb9220((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(bottom_dividerb9220?.isDisabled==null)
      {
        setbottom_dividerb9220((pre:any)=>({...pre,isDisabled:false}));
      }
    }
