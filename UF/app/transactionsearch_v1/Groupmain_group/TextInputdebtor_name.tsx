...
const TextInputdebtor_name = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  useEffect(()=>{
    ...
    const handlerBlur = (id:any) => {
      if (id === "02ea918896784a32a595a828d70e2d9f") {
        handleBlur({target:{value:main_group9066fRef?.current?.dr_name||""}});
      }
    };
  ...
  return (   
    <div  
      style={{gridColumn: `17 / 25`,gridRow: `6 / 20`, gap:``, height: `100%`, overflow: 'auto', display: 'flex', flexDirection: 'column'}} >
