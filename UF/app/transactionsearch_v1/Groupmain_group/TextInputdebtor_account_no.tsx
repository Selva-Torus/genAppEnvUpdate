...
const TextInputdebtor_account_no = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  useEffect(()=>{
    ...
    const handlerBlur = (id:any) => {
      if (id === "f2138b56e9f04f25b97ae414d73963e4") {
        handleBlur({target:{value:main_group9066fRef?.current?.dr_account||""}});
      }
    };
  ...
  return (   
    <div  
      style={{gridColumn: `9 / 17`,gridRow: `6 / 20`, gap:``, height: `100%`, overflow: 'auto', display: 'flex', flexDirection: 'column'}} >
