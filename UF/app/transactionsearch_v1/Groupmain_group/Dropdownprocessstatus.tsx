 ...
 /////////////
  ...
  const handlechange = async(value: any) => {
    ...
    if(value.length>0){
      ...
      setmain_group9066f((prev: any) => ({ ...prev, processstatus: getMapperDetailsBindValues[value],processstatus134a1: value,PROCESSSTATUS: getMapperDetails }))
  ...
  const handleClick=async(value?:any)=>{
    if (value.length > 0) {
      ...
      setmain_group9066f((prev: any) => ({ ...prev, processstatus: getMapperDetailsBindValues[value]}))
         setIsRequredData(false)
    } else {
