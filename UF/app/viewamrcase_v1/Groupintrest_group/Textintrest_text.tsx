...
const Textintrest_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {intrest_text58114Props, setintrest_text58114Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[intrest_text58114?.refresh])

  if (intrest_text58114?.isHidden) {
    return <></>
  }
