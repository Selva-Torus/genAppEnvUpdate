...
const Texttotal_balance_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {total_balance_texted1beProps, settotal_balance_texted1beProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[total_balance_texted1be?.refresh])

  if (total_balance_texted1be?.isHidden) {
    return <></>
  }
