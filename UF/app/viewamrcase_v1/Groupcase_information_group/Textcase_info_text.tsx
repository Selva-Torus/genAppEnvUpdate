...
const Textcase_info_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {case_info_textd4267Props, setcase_info_textd4267Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[case_info_textd4267?.refresh])

  if (case_info_textd4267?.isHidden) {
    return <></>
  }
