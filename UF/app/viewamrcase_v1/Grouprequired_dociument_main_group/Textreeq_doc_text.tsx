...
const Textreeq_doc_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {reeq_doc_text78b91Props, setreeq_doc_text78b91Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[reeq_doc_text78b91?.refresh])

  if (reeq_doc_text78b91?.isHidden) {
    return <></>
  }
