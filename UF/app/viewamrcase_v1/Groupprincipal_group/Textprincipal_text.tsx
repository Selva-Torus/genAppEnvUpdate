...
const Textprincipal_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {principal_text73a3dProps, setprincipal_text73a3dProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[principal_text73a3d?.refresh])

  if (principal_text73a3d?.isHidden) {
    return <></>
  }
