...
const Textcraete_header_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {craete_header_texte958cProps, setcraete_header_texte958cProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[craete_header_texte958c?.refresh])

  if (craete_header_texte958c?.isHidden) {
    return <></>
  }
