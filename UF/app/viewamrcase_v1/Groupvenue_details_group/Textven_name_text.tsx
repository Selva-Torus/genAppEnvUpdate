...
const Textven_name_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {ven_name_textdfed0Props, setven_name_textdfed0Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[ven_name_textdfed0?.refresh])

  if (ven_name_textdfed0?.isHidden) {
    return <></>
  }
...
export default Textven_name_text
