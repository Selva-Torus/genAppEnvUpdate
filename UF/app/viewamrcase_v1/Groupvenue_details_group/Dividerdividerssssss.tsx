...
const Dividerdividerssssss = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[dividerssssssbc99f?.refresh])

  if (dividerssssssbc99f?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `99 / 102`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Dividerdividerssssss
