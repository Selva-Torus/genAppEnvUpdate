...
const Dividerdividersssss = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[dividersssssec43b?.refresh])

  if (dividersssssec43b?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `84 / 87`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Dividerdividersssss
