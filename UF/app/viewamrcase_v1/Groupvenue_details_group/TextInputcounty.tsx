...
const TextInputcounty = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      "sourceKey": [
        "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:LAP:AFGK:LAP:AFK:addCase:AFVK:v1|0b84a99163eb8dd425338976559dd501|properties.county"
      ],
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:LAP:AFGK:LAP:AFK:viewAMRCase:AFVK:v1|7d99e3f90c038210537a6cdcd341d734|0f6b210a59e32420a52ac81fdd240b75"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,viewAMRCase_v1:{...pre?.viewAMRCase_v1,county:undefined}}));
    if(dynamicStateandType.type=="number"){
    setvenue_details_group1d734((prev: any) => ({ ...prev, county: +e.target.value }));
    }
    else{
    setvenue_details_group1d734((prev: any) => ({ ...prev, county: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "0f6b210a59e32420a52ac81fdd240b75"
      );
      ...
      //     controlId: "0f6b210a59e32420a52ac81fdd240b75",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "0f6b210a59e32420a52ac81fdd240b75") {
        handleChange({target:{value:venue_details_group1d734Ref?.current?.county||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "0f6b210a59e32420a52ac81fdd240b75") {
        handleBlur({target:{value:venue_details_group1d734Ref?.current?.county||""}});
      }
    };
  ...
  if(dfd_addcase_v1Props?.setSearchFilters && dfd_addcase_v1Props?.data)
  {
    if(Array.isArray(dfd_addcase_v1Props.data) && dfd_addcase_v1Props.data.length > 0){
      setvenue_details_group1d734((pre:any)=>({...pre,county:dfd_addcase_v1Props.data[0]?.county}));
    }
  }
  },[dfd_addcase_v1Props?.setSearchFilters])
  if (county40b75?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={venue_details_group1d734?.county||""}
         disabled= {county40b75?.isDisabled ? true : false}
        pin='brick-brick'     
        ...
        headerText="County"
      errorMessage={error}
        validationState={validate?.viewAMRCase_v1?.county ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
