...
const Dividerdividerss = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[dividerss6e19f?.refresh])

  if (dividerss6e19f?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `38 / 41`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Dividerdividerss
