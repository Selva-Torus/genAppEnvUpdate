...
const Buttonsave = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const groupe0568Ref = useRef(groupe0568);
  useEffect(() => {
    groupe0568Ref.current = groupe0568;
  ...
  const groupe0568PropsRef = useRef(groupe0568Props);
  useEffect(() => {
    groupe0568PropsRef.current = groupe0568Props;
  }, [groupe0568Props]);
  ...
  const handleMapper=async (data?:any) => {
    try{     
      data = {...data,...groupe0568Ref.current};
      let parentRowSpan = 144;
      const orchestrationData : any = getControlOrchestrationData(
        controlData,
        "ee225dc1c769462ab5bf20109e7e0568",
        "a20fcc478d3a40dc903c64d419912f95"
      );
  ...
  useEffect(()=>{
    ...
    const triggerElementHandler = async (id:any) => {
      if (id === "a20fcc478d3a40dc903c64d419912f95") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "save12f95");
    return () => {
  ...
  useEffect(()=>{
    if (!save12f95?.trigger) return;
      if(save12f95?.trigger){
      setsave12f95((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
  ...
  async function handleSave2f95_1_1_1(){
      

  setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    await delay(1000); 

    const groupe0568Props = groupe0568PropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.maker_v1 || {}).some(val => {
    ...
    try{
      ...
      let mainData:any=structuredClone(groupe0568Ref.current);
      ...
      let tagetKey:string="CK:CT001:FNGK:AF:FNK:PF-PFD:CATK:TGW01:AFGK:TGW004:AFK:cdcusertablesave:AFVK:v1|da952c0311c94b6291657429916c688e"
      let uf_getPFDetails:any={
        key: "CK:CT001:FNGK:AF:FNK:PF-PFD:CATK:TGW01:AFGK:TGW004:AFK:cdcusertablesave:AFVK:v1|da952c0311c94b6291657429916c688e"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "a20fcc478d3a40dc903c64d419912f95",
  "type": "button",
  "name": "save",
  "label": "save",
  "sequence": 1,
  "children": [
    {
      "id": "a20fcc478d3a40dc903c64d419912f95.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "a20fcc478d3a40dc903c64d419912f95.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "targetKey": [
            "CK:CT001:FNGK:AF:FNK:PF-PFD:CATK:TGW01:AFGK:TGW004:AFK:cdcusertablesave:AFVK:v1|da952c0311c94b6291657429916c688e"
          ]
        }
      ]
    }
      ...
      let sourceId : string = "CK:CT001:FNGK:AF:FNK:UF-UFW:CATK:TGW01:AFGK:TGW004:AFK:maker:AFVK:v1";
      sourceId+= "|"+"ee225dc1c769462ab5bf20109e7e0568";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT001:FNGK:AF:FNK:UF-UFW:CATK:TGW01:AFGK:TGW004:AFK:maker:AFVK:v1"+"|"+"ee225dc1c769462ab5bf20109e7e0568"+"|"+eventProperty.id;
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...groupe0568Ref.current, ...nullFilter(grouparray55d38) });
    let reworkKeys:any[]=[];
    ...
    if("_groupArrays_" in reworkedObject )
    {
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"ee225dc1c769462ab5bf20109e7e0568",
              controlId:"a20fcc478d3a40dc903c64d419912f95"
            };
            if (encryptionFlagCont) {
        ...
        if(groupe0568?.upId){
          te_saveBody['upId']= groupe0568?.upId;
        }
        if(groupe0568?.upid){
          te_saveBody['upId']= groupe0568?.upid;
        }
        ...
        if (groupe0568Props.ssKey !== '' && groupe0568Props.ssKey !== undefined) {
          te_saveBody["ssKey"] = groupe0568Props.ssKey;
    ...
    toast(te_save.data?.saved, 'success')
    ///////////////////////
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setgroupe0568((prev: any) => ({ ...prev, save: true }));
        //onClick

    //saveHandler
    await handleSave2f95_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setgroupe0568((prev: any) => ({ ...prev, save: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
 ...
 if (save12f95?.isHidden) {
    return <></>
  }

  return (
    <div
      style={{gridColumn: `18 / 24`,gridRow: `13 / 29`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          className="   "
          onClick={handleClick}
          view='action'
          disabled= {save12f95?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
        >
          {keyset("save")}
