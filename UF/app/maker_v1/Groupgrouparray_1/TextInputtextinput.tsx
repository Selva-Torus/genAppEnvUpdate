...
const TextInputtextinput = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const handleChange = async(e: any) => {
    ...
    setgrouparray55d38_1((prev: any) => ({ ...prev, textinput: +e.target.value }));
    }
    else{
    setgrouparray55d38_1((prev: any) => ({ ...prev, textinput: e.target.value }));
    }
  ...
  const grouparray55d38_1Ref = useRef<any>(grouparray55d38_1);
  useEffect(() => { grouparray55d38_1Ref.current = grouparray55d38_1; }, [grouparray55d38_1]);
  useEffect(()=>{
      handleMapperValue();
    ...
    const handlerChange = (id:any) => {
      if (id === "383f2e444c9c4ba09ccbb7151fea3fbc") {
        handleChange({target:{value:grouparray55d38_1Ref?.current?.textinput||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "383f2e444c9c4ba09ccbb7151fea3fbc") {
        handleBlur({target:{value:grouparray55d38_1Ref?.current?.textinput||""}});
      }
    };
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={grouparray55d38_1?.textinput||""}
