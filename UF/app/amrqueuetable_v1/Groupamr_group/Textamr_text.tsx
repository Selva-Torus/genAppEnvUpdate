...
const Textamr_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[amr_textcc6d3?.refresh])

  if (amr_textcc6d3?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 23`,gridRow: `1 / 8`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  ...
  color="primary"
>
      {keyset("Active Case Queue")}
</Text>
  </div>
  )
}

export default Textamr_text
