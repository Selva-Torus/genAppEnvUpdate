...
const DocumentViewerdocumentviewer = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing}:any) => {
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          componentId: "689aad20b333481c55516dd962fd4621",
          controlId: "f2d063dac2d59fd7d879808b71b0cb80",
          isTable: false,
          from:"Button",
  ...
  const fetchData = async () => {
    ...
    const scanurl: string = document_viewer_groupd4621?.attachment_id;
  ...
  useEffect(() => {
    fetchData();
  }, [document_viewer_groupd4621?.attachment_id])
  
  if (documentviewer0cb80?.isHidden) {
    return <></>
  }
  if (loading) {
    return (
