...
let defaultColumns = [
  {
    "id": "expense_name",
    "nodeid": "70404719e1c045139076996d4cc0255e",
    "name": "Expense Name",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "claim_category",
    "nodeid": "6351fbeba2b8430b9ea8ef242808981c",
    "name": "Category",
    "meta": {
      "sort": true
    },
  ...
  },
  {
    ...
    "nodeid": "bb2d2872e22c470397f24d06572a8a33",
    "name": "Amount",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "formatted_date",
    "nodeid": "293816d70cad4c00a4bc8e91ac30d1c9",
    "name": "Date",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "trs_status",
    "nodeid": "8c22a9c8f4e94cbab770a07b0e9f43c9",
    "name": "Status",
    "meta": {
      "sort": true
    },
...
const Tableoffsite_expense_user_table = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,refetch, setRefetch,setData,encryptionFlagCompData,paginationDetails,open, setOpen, ref, ButtonGoRuleData, setButtonGoRuleData }: any)=>{
 ...
 /////////////
    ...
    mapperData = [
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_User_Table:AFVK:v1|9e5d8ebb12ce43de8572e604a7794f29|2992ad80e14243999efd2301b67add32"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_User_Table:AFVK:v1|9e5d8ebb12ce43de8572e604a7794f29|70404719e1c045139076996d4cc0255e"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_User_Table:AFVK:v1|9e5d8ebb12ce43de8572e604a7794f29|6351fbeba2b8430b9ea8ef242808981c"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_User_Table:AFVK:v1|9e5d8ebb12ce43de8572e604a7794f29|bb2d2872e22c470397f24d06572a8a33"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_User_Table:AFVK:v1|9e5d8ebb12ce43de8572e604a7794f29|293816d70cad4c00a4bc8e91ac30d1c9"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_User_Table:AFVK:v1|9e5d8ebb12ce43de8572e604a7794f29|8c22a9c8f4e94cbab770a07b0e9f43c9"
  }
];
    schemaDataDFO = [
  {
  ...
  const handleUpdate = (page:any, pageSize:any) =>{
    ...
    setoffsite_expense_user_table94f29Props((pre:any)=>({...pre, selectedIds:[]}))
    let checkedData: any = selectedPaginationData
    if (checkedData.length) {
      for (let i = 0; i < checkedData.length; i++) {
        if (checkedData[i].page == page) {
          setoffsite_expense_user_table94f29Props((pre:any)=>({...pre, selectedIds:checkedData[i].data}))
        }
      }
    }
    ...
    try {
      ...
      if (isRulePresent==false) {
        ...
        const api_paginationBody: api_paginationDto = {
          ...
          count: parseInt(pageSize),
          filterDetails: {
            ufKey:'CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Offsite_Expense_User_Table:AFVK:v1:UO', 
            nodeId: '9e5d8ebb12ce43de8572e604a7794f29',
            elementId: '9e5d8ebb12ce43de8572e604a7794f29'
          },
          searchFilter: searchParams
        }
        if(encryptionFlagCont) {
      ...
      // CopyFromData (Parent table): use presetValues if present, else use pagination-filtered data
        ...
        if ( offsite_expense_user_table94f29Props?.presetValues&&Object.keys(offsite_expense_user_table94f29Props?.presetValues).length > 0) {
          filtertedData = [offsite_expense_user_table94f29Props?.presetValues];
        }else {
          filtertedData = structuredClone(uf_paginationDataFilter.data)||[]
          setoffsite_expense_user_table94f29(uf_paginationDataFilter.data||[])
        }
...
const colurIndicator = (keyValue:any=[], comingValue:any,ColourIndicatorType:any) => {
  ...
  useEffect(() => {
    if (prevRefreshRef.current) {
      UpdatedDataHandle(offsite_expense_user_table94f29Props.filterProps)
    }else 
      prevRefreshRef.current= true
  }, [offsite_expense_user_table94f29Props.filterProps])
  ...
  const handlePrimaryTable = () => {
    let findData = offsite_expense_user_table94f29Props?.selectedIds[offsite_expense_user_table94f29Props?.selectedIds?.length-1]
    if(Array.isArray(offsite_expense_user_table94f29) && offsite_expense_user_table94f29.length>0)
    {
      let data = offsite_expense_user_table94f29[findData]
      setPrimaryTableData({
        ...primaryTableData,
        primaryKey: "claim_id",
        value: data["claim_id"],
  ...
  useEffect(() => {
    if (offsite_expense_user_table94f29Props?.selectedIds?.length != 0) handlePrimaryTable()
  }, [offsite_expense_user_table94f29Props?.selectedIds])
  ...
  if (offsite_expense_user_table94f29?.isHidden) {
    return <></>
  }
  return(
    <div className='w-full h-full'>
          <div className=' w-full flex flex-row h-[70%]'>
            <Table
              ...
              tableSettings={true}
              tableSorting={true}
              selectedIds={offsite_expense_user_table94f29Props?.selectedIds}  
...
export default Tableoffsite_expense_user_table
