 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      ...
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "0e7c93cb34fc3529b98b1ec21be4d9e0"
      );
    ...
    if(orchestrationData?.data?.rule?.nodes?.length > 0){
      ...
      if("button_update" in dynamicactions2fc7fProps?.dynamicActionRule){
        setShowFlag(true)
        setStyleSate({...getGridPositionFromOrder(dynamicactions2fc7fProps?.dynamicActionRule?.button_update,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }
      else
      {
        setShowFlag(false)   
      ...
      if("button_update" in newbackgroundcheck_v1?.dynamicactions && newbackgroundcheck_v1?.dynamicactions["button_update"]?.itsHaveArtifact== true)
      {
        setShowFlag(newbackgroundcheck_v1?.dynamicactions["button_update"]?.show||false)
        
        setStyleSate({...getGridPositionFromOrder(newbackgroundcheck_v1?.dynamicactions?.button_update?.order,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }else{
        setShowFlag(false)
      }
    }
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "button_update4d9e0") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "0e7c93cb34fc3529b98b1ec21be4d9e0") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "button_update4d9e0");
    return () => {
  ...
  useEffect(()=>{
    if (!button_update4d9e0?.trigger) return;
      if(button_update4d9e0?.trigger){
      setbutton_update4d9e0((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[button_update4d9e0?.trigger])

  useEffect(()=>{
    if(button_update4d9e0?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[button_update4d9e0?.refresh])
  ...
  async function handleSaved9e0_1_1_1(){
  ...
  const hasInvalidField = Object.values(currentValidate?.newBackgroundCheck_v1 || {}).some(val => {
    ...
    try{
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:backgroundCheckModify:AFVK:v1|74d30fe50786f9dc4fe97834004d1097"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:backgroundCheckModify:AFVK:v1|74d30fe50786f9dc4fe97834004d1097"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
        if(dynamicactions2fc7f?.upId === "" && (!lockedData?.data || Object.keys(lockedData?.data)?.length == 0)){
          throw 'Please give proper data';
        }
      let eventProperty :any = {
  "id": "0e7c93cb34fc3529b98b1ec21be4d9e0",
  "type": "button",
  "name": "button_update",
  "label": "button_update",
  "sequence": 1,
  "children": [
    {
      "id": "0e7c93cb34fc3529b98b1ec21be4d9e0.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "0e7c93cb34fc3529b98b1ec21be4d9e0.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "0e7c93cb34fc3529b98b1ec21be4d9e0.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "0e7c93cb34fc3529b98b1ec21be4d9e0.1.1.1.1.1",
                  "eventContext": "rise",
                  "value": "",
                  "type": "handlerNode",
                  "name": "closeHandler",
            ...
            {
              "id": "0e7c93cb34fc3529b98b1ec21be4d9e0.1.1.1.2",
              ...
              "children": [
                {
                  "id": "6928a2c89ced40e0a513a880378ec876.1.1.1.2.1",
                  "value": "",
                  "type": "screen",
                  "name": "backgroundCheckDelete.v1",
                  "label": "backgroundCheckDelete.v1|Root",
                  "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:backgroundCheckDelete:AFVK:v1",
                  "elementType": "",
                  "groupType": "",
                  "sequence": "1.1.1.2.1",
                  "children": []
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:backgroundCheckModify:AFVK:v1|74d30fe50786f9dc4fe97834004d1097"
          ]
        }
      ]
    }
      ...
      te_eventEmitterBody = {
        ...
        upId : dynamicactions2fc7f?.upId? [dynamicactions2fc7f?.upId ] : lockedData.processIds,
      ...
      if(Array.isArray(tableData) && hasValidupId){
        ...
        ...uf_initiatePf.data.nodeProperty,
        data:{"trs_event_process_status":uf_getPFDetails.status},
        upId : dynamicactions2fc7f?.upId? [dynamicactions2fc7f?.upId ] : upId,
        event : uf_initiatePf.data.eventProperty?.source?.status,
        sourceId : uf_initiatePf.data.eventProperty?.sourceId
      }}else{
        te_eventEmitterBody = {
        ...uf_initiatePf.data.nodeProperty,
        data:{"trs_event_process_status":uf_getPFDetails.status},
        upId : dynamicactions2fc7f?.upId? [dynamicactions2fc7f?.upId ] : dynamicactions2fc7f?.trs_process_id? [dynamicactions2fc7f?.trs_process_id ] : lockedData.processIds,
        event : uf_initiatePf.data.eventProperty?.source?.status,
        sourceId : uf_initiatePf.data.eventProperty?.sourceId,
        controlName: "button_update"
      }
  ...
  // saveHandler
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              ...
              controlId:"0e7c93cb34fc3529b98b1ec21be4d9e0"
            };
            if (encryptionFlagCont) {
    ...
    te_eventEmitterBody["ssKey"] = dynamicactions2fc7fProps.ssKey;          
    }
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdynamicactions2fc7f((prev: any) => ({ ...prev, button_update: true }));
        //onClick

    //eventEmitter
    await handleSaved9e0_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdynamicactions2fc7f((prev: any) => ({ ...prev, button_update: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
  ...
  }, [newbackgroundcheck_v1?.dynamicactions?.button_update,dynamicactions2fc7fProps?.dynamicActionRule?.button_update,])

 if (button_update4d9e0?.isHidden) {
    return <></>
  }
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {button_update4d9e0?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
