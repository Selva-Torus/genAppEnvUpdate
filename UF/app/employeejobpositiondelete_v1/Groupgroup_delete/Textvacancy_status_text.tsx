...
const Textvacancy_status_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[vacancy_status_text733a2?.refresh])

  if (vacancy_status_text733a2?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Vacancy Status")}
</Text>
  </div>
  )
}

export default Textvacancy_status_text
