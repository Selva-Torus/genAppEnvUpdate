...
const Textjob_level_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[job_level_text55a41?.refresh])

  if (job_level_text55a41?.isHidden) {
    return <></>
  }
...
export default Textjob_level_text
