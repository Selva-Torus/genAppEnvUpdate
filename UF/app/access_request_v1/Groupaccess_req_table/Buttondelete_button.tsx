...
import PageAccessrequestdeletepage2 from '@/app/accessrequestdelete_v1/accessrequestdelete_v1page';
...
const Buttondelete_button = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const {accessrequestdelete_v1Props, setaccessrequestdelete_v1Props}= useContext(TotalContext) as TotalContextProps;
  ...
  const handleCustomCode=async () => {
    ...
    if (code != '') {
      ...
      codeStates['accessrequestdelete_v1'] = accessrequestdelete_v1Props,
      codeStates['setaccessrequestdelete_v1'] = setaccessrequestdelete_v1Props,
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "27e4c3b322754898a6cc110e4422035f"
      );
    ...
    let filterProps2:any =  [
  {
    ...
    setaccessrequestdelete_v1Props([...filterData2 ]);
    setShowProfileAsModalOpen2(true);
    //bindTran
    // For group or table
    let bindData4 = filterByKeys(mainData,group_delete39e95Props?.controls);
    setgroup_delete39e95(bindData4||{})
    setgroup_delete39e95Props({...group_delete39e95Props,presetValues:mainData||{}})  
 ...
 if (delete_button2035f?.isHidden) {
    return <></>
  }
  ...
  return (
    ...
    >
      ...
      <Modal 
        ...
        showOverlay = {true}
        position = {"center"}
        modalName = "accessrequestdelete"
        className='w-[40%] h-[] bg-gray-50 overflow-auto'
      >
        <PageAccessrequestdeletepage2/>
      </Modal>
        {showFlag && <Button 
          ref={buttonRef}
          ...
          onClick={handleClick}
          view='outlined'
          disabled= {delete_button2035f?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
          icon="MdDelete"
...
export default Buttondelete_button
