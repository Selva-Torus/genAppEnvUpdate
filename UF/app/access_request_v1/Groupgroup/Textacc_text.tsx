...
const Textacc_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[acc_textae1e0?.refresh])

  if (acc_textae1e0?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Access Request")}
</Text>
  </div>
  )
}

export default Textacc_text
