...
const Buttonip_approve = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      ...
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "3c826210da8644bfaa0c40da1912a0bf"
      );
    ...
    if(orchestrationData?.data?.rule?.nodes?.length > 0){
      ...
      if("ip_approve" in button_groupb9855Props?.dynamicActionRule){
        setShowFlag(true)
        setStyleSate({...getGridPositionFromOrder(button_groupb9855Props?.dynamicActionRule?.ip_approve,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }
      else
      {
        setShowFlag(false)   
      ...
      if("ip_approve" in inboundscanprocessui_v1?.button_group && inboundscanprocessui_v1?.button_group["ip_approve"]?.itsHaveArtifact== true)
      {
        setShowFlag(inboundscanprocessui_v1?.button_group["ip_approve"]?.show||false)
        
        setStyleSate({...getGridPositionFromOrder(inboundscanprocessui_v1?.button_group?.ip_approve?.order,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }else{
        setShowFlag(false)
      }
    }
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "ip_approve2a0bf") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "3c826210da8644bfaa0c40da1912a0bf") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "ip_approve2a0bf");
    return () => {
  ...
  useEffect(()=>{
    if (!ip_approve2a0bf?.trigger) return;
      if(ip_approve2a0bf?.trigger){
      setip_approve2a0bf((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[ip_approve2a0bf?.trigger])

  useEffect(()=>{
    if(ip_approve2a0bf?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[ip_approve2a0bf?.refresh])
  ...
  async function handleSavea0bf_1_1_1(){
  ...
  "id": "3c826210da8644bfaa0c40da1912a0bf",
  "type": "button",
  "name": "ip_approve",
  "label": "ip_approve",
  "sequence": 1,
  "children": [
    {
      "id": "3c826210da8644bfaa0c40da1912a0bf.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "3c826210da8644bfaa0c40da1912a0bf.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "3c826210da8644bfaa0c40da1912a0bf.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "3c826210da8644bfaa0c40da1912a0bf.1.1.1.1.1",
                  ...
                  "children": [
                    {
                      "id": "229399c32b1d4a11f4f06811a49d7eda.1.1.1.1.1.1",
                      "type": "group",
                ...
                {
                  "id": "3c826210da8644bfaa0c40da1912a0bf.1.1.1.1.2",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "abf150d5ae6f90069b1723bc4bdffb0a.1.1.1.1.2.1",
                      "type": "group",
                ...
                {
                  "id": "3c826210da8644bfaa0c40da1912a0bf.1.1.1.1.3",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "7e9ab6f094ce4f1565494f005e44baba.1.1.1.1.3.1",
                      "type": "group",
                ...
                {
                  "id": "3c826210da8644bfaa0c40da1912a0bf.1.1.1.1.4",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "350585c031252e28732f2f119b74db84.1.1.1.1.4.1",
                      "type": "group",
                ...
                {
                  "id": "3c826210da8644bfaa0c40da1912a0bf.1.1.1.1.5",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "ac53fbfc1a67cb0563533d6ce2596834.1.1.1.1.5.1",
                      "type": "group",
                ...
                {
                  "id": "3c826210da8644bfaa0c40da1912a0bf.1.1.1.1.6",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "2dd50c83e10eedb8e9f91cb7b56ad2c7.1.1.1.1.6.1",
                      "type": "group",
                ...
                {
                  "id": "3c826210da8644bfaa0c40da1912a0bf.1.1.1.1.7",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "d5e9a4b8e350e8aad037498875a10755.1.1.1.1.7.1",
                      "type": "group",
                ...
                {
                  "id": "3c826210da8644bfaa0c40da1912a0bf.1.1.1.1.8",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "aa8324302c4cf6d0af7179b8c0a85130.1.1.1.1.8.1",
                      "type": "group",
                ...
                {
                  "id": "3c826210da8644bfaa0c40da1912a0bf.1.1.1.1.9",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "refreshElement",
                  ...
                  "children": [
                    {
                      "id": "ec0fa3b3e01145269d4d5b2823e0a253.1.1.1.1.9.1",
                      "value": "",
                      "type": "screen",
                    ...
                    {
                      "id": "3c826210da8644bfaa0c40da1912a0bf.1.1.1.1.9.2",
                      "eventContext": "riseListen",
                      "value": "",
                      "type": "handlerNode",
                      "name": "showArtifact",
                      "label": "showArtifact",
                      "sequence": "1.1.1.1.9.2",
                      "children": [
                        {
                          "id": "51a9ebcaf35e447eab91232055e46fad.1.1.1.1.9.2.1",
                          "value": "",
                          "type": "screen",
        ...
        {
          "id": "3c826210da8644bfaa0c40da1912a0bf.1.1.2",
          "eventContext": "riseListen",
          "value": "",
          "type": "handlerNode",
          "name": "getFormData",
  ...
  // saveHandler
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              ...
              controlId:"3c826210da8644bfaa0c40da1912a0bf"
            };
            if (encryptionFlagCont) {
    ...
    //infoMsg
    toast('Data approved successfully', 'success',true);
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setbutton_groupb9855((prev: any) => ({ ...prev, ip_approve: true }));
        //onClick

    //eventEmitter
    await handleSavea0bf_1_1_1();
    // getFormData
    //riseListen
    // for group
    ...
    button_groupb9855PropsRef.current = mergedGetFormDataProps24;
      ...
      setIsProcessing(false);
        setbutton_groupb9855((prev: any) => ({ ...prev, ip_approve: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
  ...
  }, [inboundscanprocessui_v1?.button_group?.ip_approve,button_groupb9855Props?.dynamicActionRule?.ip_approve,control_tab_group161ff])

 if (ip_approve2a0bf?.isHidden) {
    return <></>
  }
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {ip_approve2a0bf?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
...
export default Buttonip_approve
