...
const Buttonforce_pass = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      ...
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "ce90d09ca0dd491b82c760b9c1293cf0"
      );
    ...
    if(orchestrationData?.data?.rule?.nodes?.length > 0){
      ...
      if("force_pass" in button_groupb9855Props?.dynamicActionRule){
        setShowFlag(true)
        setStyleSate({...getGridPositionFromOrder(button_groupb9855Props?.dynamicActionRule?.force_pass,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }
      else
      {
        setShowFlag(false)   
      ...
      if("force_pass" in inboundscanprocessui_v1?.button_group && inboundscanprocessui_v1?.button_group["force_pass"]?.itsHaveArtifact== true)
      {
        setShowFlag(inboundscanprocessui_v1?.button_group["force_pass"]?.show||false)
        
        setStyleSate({...getGridPositionFromOrder(inboundscanprocessui_v1?.button_group?.force_pass?.order,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }else{
        setShowFlag(false)
      }
    }
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "force_pass93cf0") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "ce90d09ca0dd491b82c760b9c1293cf0") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "force_pass93cf0");
    return () => {
  ...
  useEffect(()=>{
    if (!force_pass93cf0?.trigger) return;
      if(force_pass93cf0?.trigger){
      setforce_pass93cf0((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[force_pass93cf0?.trigger])

  useEffect(()=>{
    if(force_pass93cf0?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[force_pass93cf0?.refresh])
  ...
  async function handleSave3cf0_1_1_1(){
  ...
  "id": "ce90d09ca0dd491b82c760b9c1293cf0",
  "type": "button",
  "name": "force_pass",
  "label": "force_pass",
  "sequence": 1,
  "children": [
    {
      "id": "ce90d09ca0dd491b82c760b9c1293cf0.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "ce90d09ca0dd491b82c760b9c1293cf0.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "ce90d09ca0dd491b82c760b9c1293cf0.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "ce90d09ca0dd491b82c760b9c1293cf0.1.1.1.1.1",
                  ...
                  "children": [
                    ...
                    {
                      "id": "ce90d09ca0dd491b82c760b9c1293cf0.1.1.1.1.1.2",
                      "eventContext": "riseListen",
                      "value": "",
                      "type": "handlerNode",
                      "name": "showArtifact",
                      ...
                      "children": [
                        {
                          "id": "d2b149d226d4480382c3aa078f3fcf63.1.1.1.1.1.2.1",
                          "value": "",
                          "type": "screen",
                ...
                {
                  "id": "ce90d09ca0dd491b82c760b9c1293cf0.1.1.1.1.2",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "229399c32b1d4a11f4f06811a49d7eda.1.1.1.1.2.1",
                      "type": "group",
                ...
                {
                  "id": "ce90d09ca0dd491b82c760b9c1293cf0.1.1.1.1.3",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "abf150d5ae6f90069b1723bc4bdffb0a.1.1.1.1.3.1",
                      "type": "group",
                ...
                {
                  "id": "ce90d09ca0dd491b82c760b9c1293cf0.1.1.1.1.4",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "7e9ab6f094ce4f1565494f005e44baba.1.1.1.1.4.1",
                      "type": "group",
                ...
                {
                  "id": "ce90d09ca0dd491b82c760b9c1293cf0.1.1.1.1.5",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "350585c031252e28732f2f119b74db84.1.1.1.1.5.1",
                      "type": "group",
                ...
                {
                  "id": "ce90d09ca0dd491b82c760b9c1293cf0.1.1.1.1.6",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "ac53fbfc1a67cb0563533d6ce2596834.1.1.1.1.6.1",
                      "type": "group",
                ...
                {
                  "id": "ce90d09ca0dd491b82c760b9c1293cf0.1.1.1.1.7",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "2dd50c83e10eedb8e9f91cb7b56ad2c7.1.1.1.1.7.1",
                      "type": "group",
                ...
                {
                  "id": "ce90d09ca0dd491b82c760b9c1293cf0.1.1.1.1.8",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "d5e9a4b8e350e8aad037498875a10755.1.1.1.1.8.1",
                      "type": "group",
                ...
                {
                  "id": "ce90d09ca0dd491b82c760b9c1293cf0.1.1.1.1.9",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "aa8324302c4cf6d0af7179b8c0a85130.1.1.1.1.9.1",
                      "type": "group",
                ...
                "params": [
                  {
                    "name": "message",
                    "_type": "text",
                    "value": "Data forcepassed successfully",
                    "enabled": true
                  },
                  {
                    "name": "type",
        ...
        {
          "id": "ce90d09ca0dd491b82c760b9c1293cf0.1.1.2",
          "eventContext": "riseListen",
          "value": "",
          "type": "handlerNode",
          "name": "getFormData",
          ...
          "children": [
            {
              "id": "bb1cfd7a40ba1444e8038fc2adf161ff.1.1.2.1",
              "type": "screen",
  ...
  // saveHandler
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              ...
              controlId:"ce90d09ca0dd491b82c760b9c1293cf0"
            };
            if (encryptionFlagCont) {
    ...
    //infoMsg
    toast('Data forcepassed successfully', 'success',true);
    // refreshElement
    //riseListen
    // for group
    ...
    // showArtifact
    let filterProps3: any =  [];
      let filterData3 = await getFilterProps(filterProps3,{...overallgroup1218f,...controlgroupfbb48,...control_tab_group161ff,...rtgs_info5957a,...allcontrolsb8c72,...commoninfod7eda,...basicinfoffb0a,...additionalinfo4baba,...listgroup97a7c,...list_tab_group6782e,...validation_listcc09d,...comment_listb158b,...rtgs_listf12c6,...rtgs_list_grp82cfc,...rtgs_list_tble_groupe1ac5,...group1b1aa,...rtgs_list_tab_grp43579,...validtn_list3a9a1,...cmnt_list18a3b,...button_groupb9855});
    settransactionproduct_v1Props([...filterData3 ]);
    ...
    //riseListen
    // for group
    const mergedGetFormData21 = {...button_groupb9855Ref.current, ...control_tab_group161ff};
    setbutton_groupb9855(mergedGetFormData21);
    button_groupb9855Ref.current = mergedGetFormData21;

    const mergedGetFormDataProps21 = {...button_groupb9855PropsRef.current, ...control_tab_group161ffProps};
    setbutton_groupb9855Props(mergedGetFormDataProps21);
    button_groupb9855PropsRef.current = mergedGetFormDataProps21;
    }catch(err:any){
      savedData.current = {};
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setbutton_groupb9855((prev: any) => ({ ...prev, force_pass: true }));
        //onClick

    //eventEmitter
    await handleSave3cf0_1_1_1();
    // getFormData
    //riseListen
    // for group
    const mergedGetFormData24 = {...button_groupb9855Ref.current, ...control_tab_group161ff};
    setbutton_groupb9855(mergedGetFormData24);
    button_groupb9855Ref.current = mergedGetFormData24;

    const mergedGetFormDataProps24 = {...button_groupb9855PropsRef.current, ...control_tab_group161ffProps};
    setbutton_groupb9855Props(mergedGetFormDataProps24);
    button_groupb9855PropsRef.current = mergedGetFormDataProps24;
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setbutton_groupb9855((prev: any) => ({ ...prev, force_pass: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
  ...
  }, [inboundscanprocessui_v1?.button_group?.force_pass,button_groupb9855Props?.dynamicActionRule?.force_pass,control_tab_group161ff])

 if (force_pass93cf0?.isHidden) {
    return <></>
  }
  ...
  return (
    <div
      ...
      >
        {showFlag && <Button 
          ref={buttonRef}
          className="!bg-lime-600 !text-white !py-2 !rounded-md flex items-center gap-2"
          onClick={handleClick}
          view='action'
          disabled= {force_pass93cf0?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
...
export default Buttonforce_pass
