...
const Texttext1231 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[text1231c2aa3?.refresh])

  if (text1231c2aa3?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `8 / 23`,gridRow: `14 / 24`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=""
  variant="subheader-3"
