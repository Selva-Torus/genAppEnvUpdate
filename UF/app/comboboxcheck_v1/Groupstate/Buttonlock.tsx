...
const Buttonlock = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "51e2e8c641054c54a2c96bcc13e00a31"
      );
  ...
  const handleClick=async()=>{
    try{  
      ...
      if(validatedCondition(`otherdetails?.currency=="Brazilian real"`,selectedData)) 
      { 
    // clearHandler riseListen
    // for controller
     setgroup123488888((pre:any)=>({...pre,comboboxb:""}));
      }
      if(validatedCondition(`country=="INDIA" || country=="KOREA"`,selectedData)) 
      { 
    // clearHandler riseListen
    // for controller
     setgroup123488888((pre:any)=>({...pre,comboboxc:""}));
      }
  ...
  return (
    ...
    >
        ...
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {lock00a31?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
        >
          {keyset("lock")}
