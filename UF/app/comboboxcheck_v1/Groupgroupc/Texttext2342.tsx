...
const Texttext2342 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[text234245d6a?.refresh])

  if (text234245d6a?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `8 / 22`,gridRow: `16 / 26`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=""
  variant="subheader-3"
