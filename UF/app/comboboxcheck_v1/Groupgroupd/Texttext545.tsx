...
const Texttext545 = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[text54509a93?.refresh])

  if (text54509a93?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `5 / 23`,gridRow: `17 / 27`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=""
  variant="subheader-3"
