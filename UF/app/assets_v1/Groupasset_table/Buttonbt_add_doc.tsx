...
import PageAddassetdocumentpage2 from '@/app/addassetdocument_v1/addassetdocument_v1page';
...
const Buttonbt_add_doc = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const {addassetdocument_v1Props, setaddassetdocument_v1Props}= useContext(TotalContext) as TotalContextProps;
  ...
  const handleCustomCode=async () => {
    ...
    if (code != '') {
      ...
      codeStates['addassetdocument_v1'] = addassetdocument_v1Props,
      codeStates['setaddassetdocument_v1'] = setaddassetdocument_v1Props,
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "f379741644dc4b79bd2846811e2b191a"
      );
    ...
    let filterProps2:any =  [
  {
    ...
    setaddassetdocument_v1Props([...filterData2 ]);
    setShowProfileAsModalOpen2(true);
    //bindTran
    // For group or table
    let bindData4 = filterByKeys(mainData,asset_doc_table49f40Props?.controls);
    setasset_doc_table49f40(bindData4||{})
    setasset_doc_table49f40Props({...asset_doc_table49f40Props,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData6 = filterByKeys(mainData,doc_attached_group36b0dProps?.controls);
    setdoc_attached_group36b0d(bindData6||{})
    setdoc_attached_group36b0dProps({...doc_attached_group36b0dProps,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData8 = filterByKeys(mainData,table_groupdaaaaProps?.controls);
    settable_groupdaaaa(bindData8||{})
    settable_groupdaaaaProps({...table_groupdaaaaProps,presetValues:mainData||{}})  
  ...
  return (
    ...
    >
      ...
      <Modal 
        ...
        showOverlay = {true}
        position = {"center"}
        modalName = "addassetdocument"
        className='w-[80%] h-[] bg-gray-50 overflow-auto'
      >
        <PageAddassetdocumentpage2/>
      </Modal>
        {showFlag && <Button 
          ref={buttonRef}
          ...
          onClick={handleClick}
          view='outlined'
          disabled= {bt_add_docb191a?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Attachments")}
