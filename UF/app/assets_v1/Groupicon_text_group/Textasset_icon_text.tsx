...
const Textasset_icon_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[asset_icon_text2f408?.refresh])

  if (asset_icon_text2f408?.isHidden) {
    return <></>
  }
...
export default Textasset_icon_text
