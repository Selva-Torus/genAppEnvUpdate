...
let defaultColumns = [
  {
    "id": "expense_name",
    "nodeid": "13c368d28c4a434b8433291a8460195f",
    "name": "Expense Name",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "claim_category",
    "nodeid": "ce6300822390491888d268187668e630",
    "name": "Category",
    "meta": {
      "sort": true
    },
  ...
  },
  {
    ...
    "nodeid": "2a2bae04b027469eb6c4d295e4e2b381",
    "name": "Amount",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "expense_date",
    "nodeid": "ca2a95c821f846e6bd5108b6a6d7df86",
    "name": "Date",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "trs_status",
    "nodeid": "bc19f0de32c846a59fde244756bcecb6",
    "name": "Status",
    "meta": {
      "sort": true
    },
...
const Tabledaily_user_table = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,refetch, setRefetch,setData,encryptionFlagCompData,paginationDetails,open, setOpen, ref, ButtonGoRuleData, setButtonGoRuleData }: any)=>{
 ...
 /////////////
    ...
    mapperData = [
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Daily_Expense_User_Table:AFVK:v1|d153f9041a044b0fa7a88ce7aa876baf|391d80847c1a4171924d5e7e456dc381"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Daily_Expense_User_Table:AFVK:v1|d153f9041a044b0fa7a88ce7aa876baf|13c368d28c4a434b8433291a8460195f"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Daily_Expense_User_Table:AFVK:v1|d153f9041a044b0fa7a88ce7aa876baf|ce6300822390491888d268187668e630"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Daily_Expense_User_Table:AFVK:v1|d153f9041a044b0fa7a88ce7aa876baf|2a2bae04b027469eb6c4d295e4e2b381"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Daily_Expense_User_Table:AFVK:v1|d153f9041a044b0fa7a88ce7aa876baf|ca2a95c821f846e6bd5108b6a6d7df86"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Daily_Expense_User_Table:AFVK:v1|d153f9041a044b0fa7a88ce7aa876baf|bc19f0de32c846a59fde244756bcecb6"
  }
];
    schemaDataDFO = [
  {
  ...
  const handleUpdate = (page:any, pageSize:any) =>{
    ...
    setdaily_user_table76bafProps((pre:any)=>({...pre, selectedIds:[]}))
    let checkedData: any = selectedPaginationData
    if (checkedData.length) {
      for (let i = 0; i < checkedData.length; i++) {
        if (checkedData[i].page == page) {
          setdaily_user_table76bafProps((pre:any)=>({...pre, selectedIds:checkedData[i].data}))
        }
      }
    }
    ...
    try {
      ...
      if (isRulePresent==false) {
        ...
        const api_paginationBody: api_paginationDto = {
          ...
          count: parseInt(pageSize),
          filterDetails: {
            ufKey:'CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Daily_Expense_User_Table:AFVK:v1:UO', 
            nodeId: 'd153f9041a044b0fa7a88ce7aa876baf',
            elementId: 'd153f9041a044b0fa7a88ce7aa876baf'
          },
          searchFilter: searchParams
        }
        if(encryptionFlagCont) {
      ...
      // CopyFromData (Parent table): use presetValues if present, else use pagination-filtered data
        ...
        if ( daily_user_table76bafProps?.presetValues&&Object.keys(daily_user_table76bafProps?.presetValues).length > 0) {
          filtertedData = [daily_user_table76bafProps?.presetValues];
        }else {
          filtertedData = structuredClone(uf_paginationDataFilter.data)||[]
          setdaily_user_table76baf(uf_paginationDataFilter.data||[])
        }
...
const colurIndicator = (keyValue:any=[], comingValue:any,ColourIndicatorType:any) => {
  ...
  useEffect(() => {
    if (prevRefreshRef.current) {
      UpdatedDataHandle(daily_user_table76bafProps.filterProps)
    }else 
      prevRefreshRef.current= true
  }, [daily_user_table76bafProps.filterProps])
  ...
  const handlePrimaryTable = () => {
    let findData = daily_user_table76bafProps?.selectedIds[daily_user_table76bafProps?.selectedIds?.length-1]
    if(Array.isArray(daily_user_table76baf) && daily_user_table76baf.length>0)
    {
      let data = daily_user_table76baf[findData]
      setPrimaryTableData({
        ...primaryTableData,
        primaryKey: "claim_id",
        value: data["claim_id"],
  ...
  useEffect(() => {
    if (daily_user_table76bafProps?.selectedIds?.length != 0) handlePrimaryTable()
  }, [daily_user_table76bafProps?.selectedIds])
  ...
  if (daily_user_table76baf?.isHidden) {
    return <></>
  }
  return(
    <div className='w-full h-full'>
          <div className=' w-full flex flex-row h-[70%]'>
            <Table
              ...
              tableSettings={true}
              tableSorting={true}
              selectedIds={daily_user_table76bafProps?.selectedIds}  
...
export default Tabledaily_user_table
