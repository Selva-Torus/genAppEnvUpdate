...
const TextInputwitness_name = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:assetDisposalView:AFVK:v1|2f1878a0c47c273ea728efb4f07e5dd8|cf6d9c7536b70e605f0fb688c4b6fddf"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,assetDisposalView_v1:{...pre?.assetDisposalView_v1,witness_name:undefined}}));
    if(dynamicStateandType.type=="number"){
    setcompliance_financial_groupe5dd8((prev: any) => ({ ...prev, witness_name: +e.target.value }));
    }
    else{
    setcompliance_financial_groupe5dd8((prev: any) => ({ ...prev, witness_name: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "cf6d9c7536b70e605f0fb688c4b6fddf"
      );
      ...
      //     controlId: "cf6d9c7536b70e605f0fb688c4b6fddf",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "cf6d9c7536b70e605f0fb688c4b6fddf") {
        handleChange({target:{value:compliance_financial_groupe5dd8Ref?.current?.witness_name||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "cf6d9c7536b70e605f0fb688c4b6fddf") {
        handleBlur({target:{value:compliance_financial_groupe5dd8Ref?.current?.witness_name||""}});
      }
    };
  ...
  if(dfd_assetdisposal_v1Props?.setSearchFilters && dfd_assetdisposal_v1Props?.data)
  {
    if(Array.isArray(dfd_assetdisposal_v1Props.data) && dfd_assetdisposal_v1Props.data.length > 0){
      setcompliance_financial_groupe5dd8((pre:any)=>({...pre,witness_name:dfd_assetdisposal_v1Props.data[0]?.witness_name}));
    }
  }
  },[dfd_assetdisposal_v1Props?.setSearchFilters])
  if (witness_name6fddf?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={compliance_financial_groupe5dd8?.witness_name||""}
         disabled= {witness_name6fddf?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.assetDisposalView_v1?.witness_name ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
