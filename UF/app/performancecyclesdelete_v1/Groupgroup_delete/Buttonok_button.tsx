...
const Buttonok_button = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      ...
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "cfedf40528d4ba5b7e1c0c4b4e424d12"
      );
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "ok_button24d12") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "cfedf40528d4ba5b7e1c0c4b4e424d12") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "ok_button24d12");
    return () => {
  ...
  useEffect(()=>{
    if (!ok_button24d12?.trigger) return;
      if(ok_button24d12?.trigger){
      setok_button24d12((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[ok_button24d12?.trigger])

  useEffect(()=>{
    if(ok_button24d12?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[ok_button24d12?.refresh])
  ...
  async function handleSave4d12_1_1_1(){
      

  setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    await delay(1000); 

    const group_deletebe86eProps = group_deletebe86ePropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.performanceCyclesDelete_v1 || {}).some(val => {
    ...
    try{
      ...
      let mainData:any=structuredClone(group_deletebe86eRef.current);
      ...
      let lockedKeysLength:number;
        if(group_deletebe86e?.upId === "" && (!lockedData?.data || Object.keys(lockedData?.data)?.length == 0)){
          throw 'Please give proper data';
        }
      let eventProperty :any = {
  "id": "cfedf40528d4ba5b7e1c0c4b4e424d12",
  "type": "button",
  "name": "ok_button",
  "label": "ok_button",
  "sequence": 1,
  "children": [
    {
      "id": "cfedf40528d4ba5b7e1c0c4b4e424d12.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "cfedf40528d4ba5b7e1c0c4b4e424d12.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "cfedf40528d4ba5b7e1c0c4b4e424d12.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "cfedf40528d4ba5b7e1c0c4b4e424d12.1.1.1.1.1",
                  "eventContext": "rise",
                  "value": "",
                  "type": "handlerNode",
                  "name": "closeHandler",
            ...
            {
              "id": "cfedf40528d4ba5b7e1c0c4b4e424d12.1.1.1.2",
              ...
              "children": [
                {
                  "id": "fdda58d52835de518c271281ed326d28.1.1.1.2.1",
                  "value": "",
                  "type": "screen",
                  "name": "performanceCycles.v1|perf_cycle_table",
                  "label": "performanceCycles.v1|perf_cycle_table",
                  "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:performanceCycles:AFVK:v1|perf_cycle_table",
                  "elementType": "group",
                  "groupType": "table",
                  "sequence": "1.1.1.2.1",
                  "children": []
      ...
      let sourceId : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:performanceCyclesDelete:AFVK:v1";
      sourceId+= "|"+"42a94e2f764887a1ec7c9ac5dbbbe86e";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:performanceCyclesDelete:AFVK:v1"+"|"+"42a94e2f764887a1ec7c9ac5dbbbe86e"+"|"+eventProperty.id;
      ...
      te_eventEmitterBody = {
        ...
        upId : group_deletebe86e?.upId? [group_deletebe86e?.upId ] : lockedData.processIds,
      ...
      if(Array.isArray(tableData) && hasValidupId){
        ...
        ...uf_initiatePf.data.nodeProperty,
        data:{"trs_event_process_status":uf_getPFDetails.status},
        upId : group_deletebe86e?.upId? [group_deletebe86e?.upId ] : upId,
        event : uf_initiatePf.data.eventProperty?.source?.status,
        sourceId : uf_initiatePf.data.eventProperty?.sourceId
      }}else{
        te_eventEmitterBody = {
        ...uf_initiatePf.data.nodeProperty,
        data:{"trs_event_process_status":uf_getPFDetails.status},
        upId : group_deletebe86e?.upId? [group_deletebe86e?.upId ] : group_deletebe86e?.trs_process_id? [group_deletebe86e?.trs_process_id ] : lockedData.processIds,
        event : uf_initiatePf.data.eventProperty?.source?.status,
        sourceId : uf_initiatePf.data.eventProperty?.sourceId,
        controlName: "ok_button"
      }
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...group_deletebe86eRef.current });
    let reworkKeys:any[]=[];
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"42a94e2f764887a1ec7c9ac5dbbbe86e",
              controlId:"cfedf40528d4ba5b7e1c0c4b4e424d12"
            };
            if (encryptionFlagCont) {
    ...
    //eventEmitter
    if (group_deletebe86eProps.ssKey !== '' && group_deletebe86eProps.ssKey !== undefined) {
    te_eventEmitterBody["ssKey"] = group_deletebe86eProps.ssKey;          
    }
    ...
    //riseListen
    // for group
    setperf_cycle_table26d28Props((pre:any)=>({...pre,refresh:!pre?.refresh}));
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setgroup_deletebe86e((prev: any) => ({ ...prev, ok_button: true }));
        //onClick

    //eventEmitter
    await handleSave4d12_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setgroup_deletebe86e((prev: any) => ({ ...prev, ok_button: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
 ...
 if (ok_button24d12?.isHidden) {
    return <></>
  }

  return (
    <div
      style={{gridColumn: `19 / 25`,gridRow: `38 / 44`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          ...
          onClick={handleClick}
          view='action'
          disabled= {ok_button24d12?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
          icon="MdDoneAll"
