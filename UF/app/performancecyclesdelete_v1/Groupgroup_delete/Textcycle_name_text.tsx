...
const Textcycle_name_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[cycle_name_text7ecc5?.refresh])

  if (cycle_name_text7ecc5?.isHidden) {
    return <></>
  }
...
export default Textcycle_name_text
