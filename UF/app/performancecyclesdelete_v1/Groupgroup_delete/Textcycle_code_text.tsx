...
const Textcycle_code_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[cycle_code_textea00f?.refresh])

  if (cycle_code_textea00f?.isHidden) {
    return <></>
  }
...
export default Textcycle_code_text
