...
let defaultColumns = [
  {
    "id": "trs_created_by",
    "nodeid": "ee16650f5aae48019040074a33d1f8f9",
    "name": "Employee",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "expense_name",
    "nodeid": "2cacfe62bb06405f8f5e150111e78eca",
    "name": "Expense Name",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "claim_category",
    "nodeid": "af6128223d76437ca54d0d3c1ae8466d",
    "name": "Category",
    "meta": {
      "sort": true
    },
  ...
  },
  {
    ...
    "nodeid": "e04eacc76ea643ef8e8a6eaee4b22435",
    "name": "Amount",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "expense_date",
    "nodeid": "6b16d7e42de14526ae15afc673120458",
    "name": "Date",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "trs_status",
    "nodeid": "559a64b92542461babde36666329f4b4",
    "name": "Status",
    "meta": {
      "sort": true
    },
...
const Tabledaily_expense_manager_table = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,refetch, setRefetch,setData,encryptionFlagCompData,paginationDetails,open, setOpen, ref, ButtonGoRuleData, setButtonGoRuleData }: any)=>{
 ...
 /////////////
    ...
    mapperData = [
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Daily_Expense_Manager_Table:AFVK:v1|874fd4e0d832428da3947bcbc05e3342|5703e772c2c2430599e2d362c327ec53"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Daily_Expense_Manager_Table:AFVK:v1|874fd4e0d832428da3947bcbc05e3342|ee16650f5aae48019040074a33d1f8f9"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Daily_Expense_Manager_Table:AFVK:v1|874fd4e0d832428da3947bcbc05e3342|2cacfe62bb06405f8f5e150111e78eca"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Daily_Expense_Manager_Table:AFVK:v1|874fd4e0d832428da3947bcbc05e3342|af6128223d76437ca54d0d3c1ae8466d"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Daily_Expense_Manager_Table:AFVK:v1|874fd4e0d832428da3947bcbc05e3342|e04eacc76ea643ef8e8a6eaee4b22435"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Daily_Expense_Manager_Table:AFVK:v1|874fd4e0d832428da3947bcbc05e3342|6b16d7e42de14526ae15afc673120458"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Daily_Expense_Manager_Table:AFVK:v1|874fd4e0d832428da3947bcbc05e3342|559a64b92542461babde36666329f4b4"
  }
];
    schemaDataDFO = [
  {
  ...
  const [SearchParams,setSearchParams] = useState<any>({})
    ...
    if(needLockingAndRule.lockMode=='Single'){
      ...
      if (ids.length == 0) {
        let keys:any
        setdaily_expense_manager_tablee3342Props((pre:any)=>({...pre, selectedIds:[]}))
        setLockedData((pre:any)=>({...pre,data:[]}))
        return
      }

      daily_expense_manager_tablee3342.filter((item:any,id:number)=>{
      ...
      //////////
      //////////
      setdaily_expense_manager_tablee3342Props((pre:any)=>({...pre, selectedIds:[ids[ids.length-1]]}))      
    }
      ...
      setdaily_expense_manager_tablee3342Props((pre:any)=>({...pre, selectedIds:ids}))
    }
    ...
    if (checkedData.length) {
      for (let i = 0; i < checkedData.length; i++) {
        if (checkedData[i].page == page) {
          setdaily_expense_manager_tablee3342Props((pre:any)=>({...pre, selectedIds:checkedData[i].data}))
        }
      }
    }
    ...
    try {
      ...
      if (isRulePresent==false) {
        ...
        const api_paginationBody: api_paginationDto = {
          ...
          count: parseInt(pageSize),
          filterDetails: {
            ufKey:'CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Daily_Expense_Manager_Table:AFVK:v1:UO', 
            nodeId: '874fd4e0d832428da3947bcbc05e3342',
            elementId: '874fd4e0d832428da3947bcbc05e3342'
          },
          searchFilter: searchParams
        }
        if(encryptionFlagCont) {
      ...
      // CopyFromData (Parent table): use presetValues if present, else use pagination-filtered data
        ...
        if ( daily_expense_manager_tablee3342Props?.presetValues&&Object.keys(daily_expense_manager_tablee3342Props?.presetValues).length > 0) {
          filtertedData = [daily_expense_manager_tablee3342Props?.presetValues];
        }else {
          filtertedData = structuredClone(uf_paginationDataFilter.data)||[]
          setdaily_expense_manager_tablee3342(uf_paginationDataFilter.data||[])
        }
...
const colurIndicator = (keyValue:any=[], comingValue:any,ColourIndicatorType:any) => {
  ...
  useEffect(() => {
    if (prevRefreshRef.current) {
      UpdatedDataHandle(daily_expense_manager_tablee3342Props.filterProps)
    }else 
      prevRefreshRef.current= true
  }, [daily_expense_manager_tablee3342Props.filterProps])
  ...
  const handlePrimaryTable = () => {
    let findData = daily_expense_manager_tablee3342Props?.selectedIds[daily_expense_manager_tablee3342Props?.selectedIds?.length-1]
    if(Array.isArray(daily_expense_manager_tablee3342) && daily_expense_manager_tablee3342.length>0)
    {
      let data = daily_expense_manager_tablee3342[findData]
      setPrimaryTableData({
        ...primaryTableData,
        primaryKey: "claim_id",
        value: data["claim_id"],
  ...
  useEffect(() => {
    if (daily_expense_manager_tablee3342Props?.selectedIds?.length != 0) handlePrimaryTable()
  }, [daily_expense_manager_tablee3342Props?.selectedIds])
  ...
  if (daily_expense_manager_tablee3342?.isHidden) {
    return <></>
  }
  return(
    <div className='w-full h-full'>
          <div className=' w-full flex flex-row h-[70%]'>
            <Table
              ...
              tableSettings={true}
              tableSorting={true}
              selectedIds={daily_expense_manager_tablee3342Props?.selectedIds}  
...
export default Tabledaily_expense_manager_table
