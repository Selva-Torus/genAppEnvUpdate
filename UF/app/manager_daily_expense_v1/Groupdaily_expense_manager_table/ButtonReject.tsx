...
const ButtonReject =  ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
  ...
  },[reject4d3f0?.refresh,currentToken])
  ...
  async function handleSaved3f0_1_1_1(){
    try{
  ...
  "id": "4994c2faa28345cda1c200f42c54d3f0",
  "type": "button",
  "name": "Reject",
  "sequence": 1,
  "children": [
    {
      "id": "4994c2faa28345cda1c200f42c54d3f0.1.1",
      "type": "eventNode",
      "name": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "4994c2faa28345cda1c200f42c54d3f0.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "4994c2faa28345cda1c200f42c54d3f0.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "4994c2faa28345cda1c200f42c54d3f0.1.1.1.1.1",
        ...
        if(Array.isArray(daily_expense_manager_tablee3342))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              ...
              controlId:"4994c2faa28345cda1c200f42c54d3f0"
            };
            if (encryptionFlagCont) {
 ...
 >
        {showFlag && <Button 
          ...
          disabled= {reject4d3f0?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Reject")}
