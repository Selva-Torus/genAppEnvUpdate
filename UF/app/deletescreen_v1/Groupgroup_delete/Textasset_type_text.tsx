...
const Textasset_type_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[asset_type_textbf4bc?.refresh])

  if (asset_type_textbf4bc?.isHidden) {
    return <></>
  }
...
export default Textasset_type_text
