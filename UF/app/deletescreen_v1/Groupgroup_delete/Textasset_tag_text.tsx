...
const Textasset_tag_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[asset_tag_text6db8e?.refresh])

  if (asset_tag_text6db8e?.isHidden) {
    return <></>
  }
...
export default Textasset_tag_text
