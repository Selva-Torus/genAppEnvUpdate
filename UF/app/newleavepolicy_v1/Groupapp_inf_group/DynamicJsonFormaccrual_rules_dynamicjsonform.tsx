...
const DynamicJsonFormaccrual_rules_dynamicjsonform = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:newLeavePolicy:AFVK:v1|90fb798a8b9499384ff751e486d2196e|00c4da2fce41485eb997f149e608866d"
    }
  ],
  "schemaData": {
    "type": "object",
  ...
  const fetchSchema = async (goruleData:any={},groupData:any={}) => {
    try {
      ...
      if (data) {
        ...
        if (!app_inf_group2196e?.accrual_rules_json) {
  ...
  const handleChange = async(values: any) => {
    ...
    //setValidate((pre:any)=>({...pre,accrual_rules_json:{}}))
      setapp_inf_group2196e((prev: any) => ({ ...prev, accrual_rules_json: processedValues }))
  ...
  const handleMapperValue=async()=>{
    ...
    const orchestrationData = getControlOrchestrationData(
      ...
      "00c4da2fce41485eb997f149e608866d"
    );
...
const [dynamicDFDData,setDynamicDFDData]=useState<any>({})
  ...
  if (accrual_rules_dynamicjsonform8866d?.isHidden) {
    return <></>
  }
   if (isLoading) {
    return  <div style={{gridColumn: `1 / 25`,gridRow: `9 / 48`, gap:``, height: `100%`, overflow: 'auto'}} >
      Loading schema...</div>
  }
  ...
  return (   
    <div  
      style={{gridColumn: `1 / 25`,gridRow: `9 / 48`, gap:``, height: `100%`, overflow: 'auto'}} >
      ...
      <DynamicJsonForm
        ...
        values={app_inf_group2196e?.accrual_rules_json}
