...
const DynamicJsonFormadd_dts_dynamicjsonform = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:newLeavePolicy:AFVK:v1|90fb798a8b9499384ff751e486d2196e|e0154749e7924bd9ae02154fc9f65fd5"
    }
  ],
  "schemaData": {
    "type": "object",
  ...
  const fetchSchema = async (goruleData:any={},groupData:any={}) => {
    try {
      ...
      if (data) {
        ...
        if (!app_inf_group2196e?.additional_details) {
  ...
  const handleChange = async(values: any) => {
    ...
    //setValidate((pre:any)=>({...pre,additional_details:{}}))
      setapp_inf_group2196e((prev: any) => ({ ...prev, additional_details: processedValues }))
  ...
  const handleMapperValue=async()=>{
    ...
    const orchestrationData = getControlOrchestrationData(
      ...
      "e0154749e7924bd9ae02154fc9f65fd5"
    );
...
const [dynamicDFDData,setDynamicDFDData]=useState<any>({})
  ...
  if (add_dts_dynamicjsonform65fd5?.isHidden) {
    return <></>
  }
   if (isLoading) {
    return  <div style={{gridColumn: `1 / 25`,gridRow: `92 / 133`, gap:``, height: `100%`, overflow: 'auto'}} >
      Loading schema...</div>
  }
  ...
  return (   
    <div  
      style={{gridColumn: `1 / 25`,gridRow: `92 / 133`, gap:``, height: `100%`, overflow: 'auto'}} >
      ...
      <DynamicJsonForm
        ...
        values={app_inf_group2196e?.additional_details}
