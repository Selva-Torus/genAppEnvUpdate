...
const Textapp_rules = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[app_rules6b502?.refresh])

  if (app_rules6b502?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Applicability Rules")}
</Text>
  </div>
  )
}

export default Textapp_rules
