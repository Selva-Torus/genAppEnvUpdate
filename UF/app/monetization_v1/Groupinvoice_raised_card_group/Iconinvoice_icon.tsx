...
const Iconinvoice_icon = ({encryptionFlagCompData,setIsProcessing,controlData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData : any = getControlOrchestrationData(
      ...
      "fef625ef10aa4d2aa6d5314533c43350"
    );
...
export default Iconinvoice_icon
