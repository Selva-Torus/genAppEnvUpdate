...
const Icontpp_icon = ({encryptionFlagCompData,setIsProcessing,controlData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData : any = getControlOrchestrationData(
      ...
      "322da04a47ca408dbc7bb359a871dafd"
    );
