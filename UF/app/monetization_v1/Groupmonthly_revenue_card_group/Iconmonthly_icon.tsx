...
const Iconmonthly_icon = ({encryptionFlagCompData,setIsProcessing,controlData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData : any = getControlOrchestrationData(
      ...
      "1ece3312fb08486d9957a47f173e201a"
    );
...
export default Iconmonthly_icon
