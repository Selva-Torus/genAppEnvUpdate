...
const TextInputtextinput123 = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT001:FNGK:AF:FNK:UF-UFW:CATK:TGW01:AFGK:TGW004:AFK:dynamicAction:AFVK:v1|6be5feda482c40908776c5d938bed023|e6748bbddf7a490593b8e0dfe04292f1"
    }
  ],
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "e6748bbddf7a490593b8e0dfe04292f1"
      );
      ...
      //     controlId: "e6748bbddf7a490593b8e0dfe04292f1",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "e6748bbddf7a490593b8e0dfe04292f1") {
  ...
  if (textinput123292f1?.isHidden) {
    return <></>
  }
  return (   
    <div  
      style={{gridColumn: `4 / 10`,gridRow: `25 / 36`, gap:``, height: `100%`, overflow: 'auto', display: 'flex', flexDirection: 'column'}} >
        {isRequredData && <span style={{ color: 'red' }}>*</span>}
      <div style={{ flex: 1, minHeight: 0 }}>
      <TextInput
        require={isRequredData}
        className=""
        label={keyset("textinput123")}
        onChange= {handleChange}
        onBlur={handleBlur}
        itsHaveCurrency={true}
        type={dynamicStateandType.type}
        value={grouped023?.my_id||""}
         disabled= {textinput123292f1?.isDisabled ? true : false}
        pin='brick-brick'     
