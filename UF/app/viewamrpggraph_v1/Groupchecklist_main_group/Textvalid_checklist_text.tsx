...
const Textvalid_checklist_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {valid_checklist_text1abccProps, setvalid_checklist_text1abccProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[valid_checklist_text1abcc?.refresh])

  if (valid_checklist_text1abcc?.isHidden) {
    return <></>
  }
