...
const Texttotal_balance_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {total_balance_textc34b6Props, settotal_balance_textc34b6Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[total_balance_textc34b6?.refresh])

  if (total_balance_textc34b6?.isHidden) {
    return <></>
  }
...
export default Texttotal_balance_text
