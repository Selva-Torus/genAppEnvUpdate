...
const Texttext_efile_system = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {text_efile_system7e43bProps, settext_efile_system7e43bProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[text_efile_system7e43b?.refresh])

  if (text_efile_system7e43b?.isHidden) {
    return <></>
  }
...
export default Texttext_efile_system
