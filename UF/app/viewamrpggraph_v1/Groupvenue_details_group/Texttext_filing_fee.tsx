...
const Texttext_filing_fee = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {text_filing_fee56d8dProps, settext_filing_fee56d8dProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[text_filing_fee56d8d?.refresh])

  if (text_filing_fee56d8d?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `72 / 76`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-1"
...
export default Texttext_filing_fee
