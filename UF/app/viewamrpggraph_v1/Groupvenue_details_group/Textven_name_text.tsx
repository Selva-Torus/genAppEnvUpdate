...
const Textven_name_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {ven_name_textb2d6aProps, setven_name_textb2d6aProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[ven_name_textb2d6a?.refresh])

  if (ven_name_textb2d6a?.isHidden) {
    return <></>
  }
