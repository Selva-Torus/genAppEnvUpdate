...
const Texttext_judge = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {text_judgeba2cdProps, settext_judgeba2cdProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[text_judgeba2cd?.refresh])

  if (text_judgeba2cd?.isHidden) {
    return <></>
  }
