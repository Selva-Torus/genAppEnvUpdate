...
const Textcraete_header_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {craete_header_textc6061Props, setcraete_header_textc6061Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[craete_header_textc6061?.refresh])

  if (craete_header_textc6061?.isHidden) {
    return <></>
  }
