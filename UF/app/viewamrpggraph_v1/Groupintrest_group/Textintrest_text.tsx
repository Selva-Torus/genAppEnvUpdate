...
const Textintrest_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {intrest_texte0e7eProps, setintrest_texte0e7eProps} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[intrest_texte0e7e?.refresh])

  if (intrest_texte0e7e?.isHidden) {
    return <></>
  }
