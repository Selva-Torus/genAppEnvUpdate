...
const Textspecial_rules_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {special_rules_texta6d06Props, setspecial_rules_texta6d06Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[special_rules_texta6d06?.refresh])

  if (special_rules_texta6d06?.isHidden) {
    return <></>
  }
