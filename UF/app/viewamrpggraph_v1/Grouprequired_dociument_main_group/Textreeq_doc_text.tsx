...
const Textreeq_doc_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {reeq_doc_text07963Props, setreeq_doc_text07963Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
  ...
  useEffect(()=>{
    handleMapperValue()
  },[reeq_doc_text07963?.refresh])

  if (reeq_doc_text07963?.isHidden) {
    return <></>
  }
