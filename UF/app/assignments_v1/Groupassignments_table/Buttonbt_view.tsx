...
import PageAssignassetviewpage2 from '@/app/assignassetview_v1/assignassetview_v1page';
 ...
 /////////////
  ...
  const handleCustomCode=async () => {
    ...
    if (code != '') {
      ...
      codeStates['assignassetview_v1'] = assignassetview_v1Props,
      codeStates['setassignassetview_v1'] = setassignassetview_v1Props,
    ...
    let filterProps2:any =  [
  {
    ...
    setassignassetview_v1Props([...filterData2 ]);
    setShowProfileAsModalOpen2(true);
    //bindTran
    // For group or table
    setassign_asset_groupb4f2d(mainData||{})
    setassign_asset_groupb4f2dProps({...assign_asset_groupb4f2dProps,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    setassignment_information_groupc96e9(mainData||{})
    setassignment_information_groupc96e9Props({...assignment_information_groupc96e9Props,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    setassignment_details_group136e4(mainData||{})
    setassignment_details_group136e4Props({...assignment_details_group136e4Props,presetValues:mainData||{}})  
  ...
  return (
    ...
    >
      ...
      <Modal 
        ...
        showOverlay = {true}
        position = {"center"}
        modalName = "assignassetview"
        className='w-[80%] h-[] bg-gray-50 overflow-auto'
      >
        <PageAssignassetviewpage2/>
      </Modal>
        {showFlag && <Button 
          ref={buttonRef}
          ...
          onClick={handleClick}
          view='outlined'
          disabled= {bt_view6b7cc?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("View")}
