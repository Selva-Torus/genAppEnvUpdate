...
import PageAddassignmentdocumentpage2 from '@/app/addassignmentdocument_v1/addassignmentdocument_v1page';
 ...
 /////////////
  ...
  const handleCustomCode=async () => {
    ...
    if (code != '') {
      ...
      codeStates['addassignmentdocument_v1'] = addassignmentdocument_v1Props,
      codeStates['setaddassignmentdocument_v1'] = setaddassignmentdocument_v1Props,
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "f1f4fb1cde7e4db18448cf51f80f5447"
      );
    ...
    let filterProps2:any =  [
  {
    ...
    setaddassignmentdocument_v1Props([...filterData2 ]);
    setShowProfileAsModalOpen2(true);
    //bindTran
    // For group or table
    let bindData4 = filterByKeys(mainData,doc_table392d0Props?.controls);
    setdoc_table392d0(bindData4||{})
    setdoc_table392d0Props({...doc_table392d0Props,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData6 = filterByKeys(mainData,doc_attached_groupbc2cfProps?.controls);
    setdoc_attached_groupbc2cf(bindData6||{})
    setdoc_attached_groupbc2cfProps({...doc_attached_groupbc2cfProps,presetValues:mainData||{}})  
  ...
  return (
    ...
    >
      ...
      <Modal 
        ...
        showOverlay = {true}
        position = {"center"}
        modalName = "addassignmentdocument"
        className='w-[80%] h-[] bg-gray-50 overflow-auto'
      >
        <PageAddassignmentdocumentpage2/>
      </Modal>
        {showFlag && <Button 
          ref={buttonRef}
          ...
          onClick={handleClick}
          view='outlined'
          disabled= {bt_add_docf5447?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Attachments")}
