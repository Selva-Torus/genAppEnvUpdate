...
const Textassign_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[assign_texta5834?.refresh])

  if (assign_texta5834?.isHidden) {
    return <></>
  }
...
export default Textassign_text
