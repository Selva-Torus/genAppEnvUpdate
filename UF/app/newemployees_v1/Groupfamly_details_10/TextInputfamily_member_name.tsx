...
const TextInputfamily_member_name = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:newEmployees:AFVK:v1|6611a8f7add7494c88bbd137d53b06ea|c08450cc52254c1296869b41c6a450a1"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,newEmployees_v1:{...pre?.newEmployees_v1,member_name:undefined}}));
    if(dynamicStateandType.type=="number"){
    setfamly_detailsb06ea_10((prev: any) => ({ ...prev, member_name: +e.target.value }));
    }
    else{
    setfamly_detailsb06ea_10((prev: any) => ({ ...prev, member_name: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "c08450cc52254c1296869b41c6a450a1"
      );
      ...
      //     controlId: "c08450cc52254c1296869b41c6a450a1",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "c08450cc52254c1296869b41c6a450a1") {
        handleChange({target:{value:famly_detailsb06ea_10Ref?.current?.member_name||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "c08450cc52254c1296869b41c6a450a1") {
        handleBlur({target:{value:famly_detailsb06ea_10Ref?.current?.member_name||""}});
      }
    };
  ...
  if(dfd_familyjson_v1Props?.setSearchFilters && dfd_familyjson_v1Props?.data)
  {
    if(Array.isArray(dfd_familyjson_v1Props.data) && dfd_familyjson_v1Props.data.length > 0){
      setfamly_detailsb06ea_10((pre:any)=>({...pre,member_name:dfd_familyjson_v1Props.data[0]?.member_name}));
    }
  }
  },[dfd_familyjson_v1Props?.setSearchFilters])
  if (family_member_name450a1?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={famly_detailsb06ea_10?.member_name||""}
         disabled= {family_member_name450a1?.isDisabled ? true : false}
        pin='brick-brick'     
        placeholder='Albert'      
        view='normal'
        contentAlign={"left"}
      ...
      errorMessage={error}
        validationState={validate?.newEmployees_v1?.member_name ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
