...
const TextInputdegree = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:newEmployees:AFVK:v1|5f0c193ec40a41e8af544856fd52393a|3272d5674802438c894a68ffc300bb4f"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,newEmployees_v1:{...pre?.newEmployees_v1,degree:undefined}}));
    if(dynamicStateandType.type=="number"){
    seteducation2393a_14((prev: any) => ({ ...prev, degree: +e.target.value }));
    }
    else{
    seteducation2393a_14((prev: any) => ({ ...prev, degree: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "3272d5674802438c894a68ffc300bb4f"
      );
      ...
      //     controlId: "3272d5674802438c894a68ffc300bb4f",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "3272d5674802438c894a68ffc300bb4f") {
        handleChange({target:{value:education2393a_14Ref?.current?.degree||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "3272d5674802438c894a68ffc300bb4f") {
        handleBlur({target:{value:education2393a_14Ref?.current?.degree||""}});
      }
    };
  ...
  if(dfd_educationjson_v1Props?.setSearchFilters && dfd_educationjson_v1Props?.data)
  {
    if(Array.isArray(dfd_educationjson_v1Props.data) && dfd_educationjson_v1Props.data.length > 0){
      seteducation2393a_14((pre:any)=>({...pre,degree:dfd_educationjson_v1Props.data[0]?.degree}));
    }
  }
  },[dfd_educationjson_v1Props?.setSearchFilters])
  if (degree0bb4f?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={education2393a_14?.degree||""}
         disabled= {degree0bb4f?.isDisabled ? true : false}
        pin='brick-brick'     
        placeholder='B.E'      
        view='normal'
        contentAlign={"left"}
        ...
        headerText="Degree"
      errorMessage={error}
        validationState={validate?.newEmployees_v1?.degree ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
