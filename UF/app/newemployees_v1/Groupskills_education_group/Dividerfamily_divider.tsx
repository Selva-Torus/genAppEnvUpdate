...
const Dividerfamily_divider = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[family_divider948ae?.refresh])

  if (family_divider948ae?.isHidden) {
    return <></>
  }
...
export default Dividerfamily_divider
