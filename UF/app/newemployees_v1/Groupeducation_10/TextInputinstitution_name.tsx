...
const TextInputinstitution_name = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const handleChange = async(e: any) => {
    ...
    seteducation2393a_10((prev: any) => ({ ...prev, institution_name: +e.target.value }));
    }
    else{
    seteducation2393a_10((prev: any) => ({ ...prev, institution_name: e.target.value }));
    }
  ...
  const education2393a_10Ref = useRef<any>(education2393a_10);
  useEffect(() => { education2393a_10Ref.current = education2393a_10; }, [education2393a_10]);
  useEffect(()=>{
      handleMapperValue();
    ...
    const handlerChange = (id:any) => {
      if (id === "bdcce6cba9a64e399fe47102eecd7544") {
        handleChange({target:{value:education2393a_10Ref?.current?.institution_name||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "bdcce6cba9a64e399fe47102eecd7544") {
        handleBlur({target:{value:education2393a_10Ref?.current?.institution_name||""}});
      }
    };
  ...
  if(dfd_educationjson_v1Props?.setSearchFilters && dfd_educationjson_v1Props?.data)
  {
    if(Array.isArray(dfd_educationjson_v1Props.data) && dfd_educationjson_v1Props.data.length > 0){
      seteducation2393a_10((pre:any)=>({...pre,institution_name:dfd_educationjson_v1Props.data[0]?.institution_name}));
    }
  }
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={education2393a_10?.institution_name||""}
