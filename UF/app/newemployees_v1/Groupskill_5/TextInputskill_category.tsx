...
const TextInputskill_category = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const handleChange = async(e: any) => {
    ...
    setskill9f89a_5((prev: any) => ({ ...prev, skill_category: +e.target.value }));
    }
    else{
    setskill9f89a_5((prev: any) => ({ ...prev, skill_category: e.target.value }));
    }
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "c71f3d9d57e241f68af0c9f8a9d6fca1") {
        handleChange({target:{value:skill9f89a_5Ref?.current?.skill_category||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "c71f3d9d57e241f68af0c9f8a9d6fca1") {
        handleBlur({target:{value:skill9f89a_5Ref?.current?.skill_category||""}});
      }
    };
  ...
  if(dfd_skilljson_v1Props?.setSearchFilters && dfd_skilljson_v1Props?.data)
  {
    if(Array.isArray(dfd_skilljson_v1Props.data) && dfd_skilljson_v1Props.data.length > 0){
      setskill9f89a_5((pre:any)=>({...pre,skill_category:dfd_skilljson_v1Props.data[0]?.skill_category}));
    }
  }
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={skill9f89a_5?.skill_category||""}
