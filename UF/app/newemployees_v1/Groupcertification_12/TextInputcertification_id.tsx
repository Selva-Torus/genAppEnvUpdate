...
const TextInputcertification_id = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const handleChange = async(e: any) => {
    ...
    setcertificationc7d06_12((prev: any) => ({ ...prev, certification_id: +e.target.value }));
    }
    else{
    setcertificationc7d06_12((prev: any) => ({ ...prev, certification_id: e.target.value }));
    }
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "aafc95a55e384a2aa9d22765fda70e9e") {
        handleChange({target:{value:certificationc7d06_12Ref?.current?.certification_id||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "aafc95a55e384a2aa9d22765fda70e9e") {
        handleBlur({target:{value:certificationc7d06_12Ref?.current?.certification_id||""}});
      }
    };
  ...
  if(dfd_certifyjson_v1Props?.setSearchFilters && dfd_certifyjson_v1Props?.data)
  {
    if(Array.isArray(dfd_certifyjson_v1Props.data) && dfd_certifyjson_v1Props.data.length > 0){
      setcertificationc7d06_12((pre:any)=>({...pre,certification_id:dfd_certifyjson_v1Props.data[0]?.certification_id}));
    }
  }
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={certificationc7d06_12?.certification_id||""}
