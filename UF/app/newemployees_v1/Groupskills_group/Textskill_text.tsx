...
const Textskill_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[skill_text7b287?.refresh])

  if (skill_text7b287?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `3 / 19`,gridRow: `1 / 7`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className="!font-bold"
  variant="subheader-1"
