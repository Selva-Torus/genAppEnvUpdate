...
const Textskill_des = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[skill_des79cc6?.refresh])

  if (skill_des79cc6?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Add employee skills")}
</Text>
  </div>
  )
}

export default Textskill_des
