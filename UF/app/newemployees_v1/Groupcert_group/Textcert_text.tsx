...
const Textcert_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[cert_text784fe?.refresh])

  if (cert_text784fe?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Certifications")}
</Text>
  </div>
  )
}

export default Textcert_text
