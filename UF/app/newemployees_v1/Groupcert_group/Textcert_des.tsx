...
const Textcert_des = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[cert_desa8bdc?.refresh])

  if (cert_desa8bdc?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `3 / 21`,gridRow: `7 / 12`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-1"
  color="primary"
>
      {keyset("Add Certifications")}
</Text>
  </div>
  )
}

export default Textcert_des
