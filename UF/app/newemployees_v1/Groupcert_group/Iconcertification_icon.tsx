...
const Iconcertification_icon = ({encryptionFlagCompData,setIsProcessing,controlData}:any) => {
  ...
  const handleCode=async () => {
    ...
    const orchestrationData : any = getControlOrchestrationData(
      controlData,
      "1de0c329b6e44f19bbe77d52cefedb63",
      "f6dcf473fc2c44f3b8235067793e672f"
    );
  ...
  if (certification_icone672f?.isHidden) {
    return <></>
  }
...
export default Iconcertification_icon
