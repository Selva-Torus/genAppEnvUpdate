...
const TextInputcertification_name = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const handleChange = async(e: any) => {
    ...
    setcertificationc7d06_4((prev: any) => ({ ...prev, certification_name: +e.target.value }));
    }
    else{
    setcertificationc7d06_4((prev: any) => ({ ...prev, certification_name: e.target.value }));
    }
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "3ac4e53ff5054f8ca209e884ba126561") {
        handleChange({target:{value:certificationc7d06_4Ref?.current?.certification_name||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "3ac4e53ff5054f8ca209e884ba126561") {
        handleBlur({target:{value:certificationc7d06_4Ref?.current?.certification_name||""}});
      }
    };
  ...
  if(dfd_certifyjson_v1Props?.setSearchFilters && dfd_certifyjson_v1Props?.data)
  {
    if(Array.isArray(dfd_certifyjson_v1Props.data) && dfd_certifyjson_v1Props.data.length > 0){
      setcertificationc7d06_4((pre:any)=>({...pre,certification_name:dfd_certifyjson_v1Props.data[0]?.certification_name}));
    }
  }
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={certificationc7d06_4?.certification_name||""}
