...
const Textaddress_details = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[address_details051da?.refresh])

  if (address_details051da?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Address Details")}
</Text>
  </div>
  )
}

export default Textaddress_details
