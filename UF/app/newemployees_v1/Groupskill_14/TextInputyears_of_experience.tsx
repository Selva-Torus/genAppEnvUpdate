...
const TextInputyears_of_experience = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:newEmployees:AFVK:v1|77b5700fc0f34498a59bda374939f89a|2c1ba46a563341e4bd8ee218f2fe0aba"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,newEmployees_v1:{...pre?.newEmployees_v1,years_of_experience:undefined}}));
    if(dynamicStateandType.type=="number"){
    setskill9f89a_14((prev: any) => ({ ...prev, years_of_experience: +e.target.value }));
    }
    else{
    setskill9f89a_14((prev: any) => ({ ...prev, years_of_experience: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "2c1ba46a563341e4bd8ee218f2fe0aba"
      );
      ...
      //     controlId: "2c1ba46a563341e4bd8ee218f2fe0aba",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "2c1ba46a563341e4bd8ee218f2fe0aba") {
        handleChange({target:{value:skill9f89a_14Ref?.current?.years_of_experience||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "2c1ba46a563341e4bd8ee218f2fe0aba") {
        handleBlur({target:{value:skill9f89a_14Ref?.current?.years_of_experience||""}});
      }
    };
  ...
  if(dfd_skilljson_v1Props?.setSearchFilters && dfd_skilljson_v1Props?.data)
  {
    if(Array.isArray(dfd_skilljson_v1Props.data) && dfd_skilljson_v1Props.data.length > 0){
      setskill9f89a_14((pre:any)=>({...pre,years_of_experience:dfd_skilljson_v1Props.data[0]?.years_of_experience}));
    }
  }
  },[dfd_skilljson_v1Props?.setSearchFilters])
  if (years_of_experiencee0aba?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={skill9f89a_14?.years_of_experience||""}
         disabled= {years_of_experiencee0aba?.isDisabled ? true : false}
        pin='brick-brick'     
        placeholder='5 Years'      
        view='normal'
        contentAlign={"left"}
      ...
      errorMessage={error}
        validationState={validate?.newEmployees_v1?.years_of_experience ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
