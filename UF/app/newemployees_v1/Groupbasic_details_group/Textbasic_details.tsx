...
const Textbasic_details = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[basic_details3de86?.refresh])

  if (basic_details3de86?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Basic Details")}
</Text>
  </div>
  )
}

export default Textbasic_details
