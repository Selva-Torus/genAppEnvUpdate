...
const TextInputcertification_provider = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const handleChange = async(e: any) => {
    ...
    setcertificationc7d06_8((prev: any) => ({ ...prev, certification_provider: +e.target.value }));
    }
    else{
    setcertificationc7d06_8((prev: any) => ({ ...prev, certification_provider: e.target.value }));
    }
  ...
  const certificationc7d06_8Ref = useRef<any>(certificationc7d06_8);
  useEffect(() => { certificationc7d06_8Ref.current = certificationc7d06_8; }, [certificationc7d06_8]);
  useEffect(()=>{
      handleMapperValue();
    ...
    const handlerChange = (id:any) => {
      if (id === "d2b3b7dfe0f14b159d7e9b3d5de33172") {
        handleChange({target:{value:certificationc7d06_8Ref?.current?.certification_provider||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "d2b3b7dfe0f14b159d7e9b3d5de33172") {
        handleBlur({target:{value:certificationc7d06_8Ref?.current?.certification_provider||""}});
      }
    };
  ...
  if(dfd_certifyjson_v1Props?.setSearchFilters && dfd_certifyjson_v1Props?.data)
  {
    if(Array.isArray(dfd_certifyjson_v1Props.data) && dfd_certifyjson_v1Props.data.length > 0){
      setcertificationc7d06_8((pre:any)=>({...pre,certification_provider:dfd_certifyjson_v1Props.data[0]?.certification_provider}));
    }
  }
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={certificationc7d06_8?.certification_provider||""}
