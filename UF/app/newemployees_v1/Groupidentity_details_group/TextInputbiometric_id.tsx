...
const TextInputbiometric_id = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:newEmployees:AFVK:v1|125377fdc3004c1894d23350f816a6fe|63dd6c3174914456a510cb3f37611ad8"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,newEmployees_v1:{...pre?.newEmployees_v1,biometric_id:undefined}}));
    if(dynamicStateandType.type=="number"){
    setidentity_details_group6a6fe((prev: any) => ({ ...prev, biometric_id: +e.target.value }));
    }
    else{
    setidentity_details_group6a6fe((prev: any) => ({ ...prev, biometric_id: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "63dd6c3174914456a510cb3f37611ad8"
      );
      ...
      //     controlId: "63dd6c3174914456a510cb3f37611ad8",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "63dd6c3174914456a510cb3f37611ad8") {
        handleChange({target:{value:identity_details_group6a6feRef?.current?.biometric_id||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "63dd6c3174914456a510cb3f37611ad8") {
        handleBlur({target:{value:identity_details_group6a6feRef?.current?.biometric_id||""}});
      }
    };
  ...
  if(dfd_employees_v1Props?.setSearchFilters && dfd_employees_v1Props?.data)
  {
    if(Array.isArray(dfd_employees_v1Props.data) && dfd_employees_v1Props.data.length > 0){
      setidentity_details_group6a6fe((pre:any)=>({...pre,biometric_id:dfd_employees_v1Props.data[0]?.biometric_id}));
    }
  }
  },[dfd_employees_v1Props?.setSearchFilters])
  if (biometric_id11ad8?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={identity_details_group6a6fe?.biometric_id||""}
         disabled= {biometric_id11ad8?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.newEmployees_v1?.biometric_id ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
