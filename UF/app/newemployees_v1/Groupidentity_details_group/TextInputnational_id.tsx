...
const TextInputnational_id = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:newEmployees:AFVK:v1|125377fdc3004c1894d23350f816a6fe|ec2e8ef0e6b74d428e4a4cf3d1e30319"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,newEmployees_v1:{...pre?.newEmployees_v1,national_id:undefined}}));
    if(dynamicStateandType.type=="number"){
    setidentity_details_group6a6fe((prev: any) => ({ ...prev, national_id: +e.target.value }));
    }
    else{
    setidentity_details_group6a6fe((prev: any) => ({ ...prev, national_id: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "ec2e8ef0e6b74d428e4a4cf3d1e30319"
      );
      ...
      //     controlId: "ec2e8ef0e6b74d428e4a4cf3d1e30319",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "ec2e8ef0e6b74d428e4a4cf3d1e30319") {
        handleChange({target:{value:identity_details_group6a6feRef?.current?.national_id||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "ec2e8ef0e6b74d428e4a4cf3d1e30319") {
        handleBlur({target:{value:identity_details_group6a6feRef?.current?.national_id||""}});
      }
    };
  ...
  if(dfd_employees_v1Props?.setSearchFilters && dfd_employees_v1Props?.data)
  {
    if(Array.isArray(dfd_employees_v1Props.data) && dfd_employees_v1Props.data.length > 0){
      setidentity_details_group6a6fe((pre:any)=>({...pre,national_id:dfd_employees_v1Props.data[0]?.national_id}));
    }
  }
  },[dfd_employees_v1Props?.setSearchFilters])
  if (national_id30319?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={identity_details_group6a6fe?.national_id||""}
         disabled= {national_id30319?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.newEmployees_v1?.national_id ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
