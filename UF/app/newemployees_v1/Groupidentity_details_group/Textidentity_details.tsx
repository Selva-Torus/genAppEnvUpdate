...
const Textidentity_details = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[identity_detailsd3925?.refresh])

  if (identity_detailsd3925?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Identity Details")}
</Text>
  </div>
  )
}

export default Textidentity_details
