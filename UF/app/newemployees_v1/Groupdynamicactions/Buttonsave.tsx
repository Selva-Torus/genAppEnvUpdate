 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      ...
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "86a153f22b2040d2b95c9e81cc7c5b7c"
      );
    ...
    if(orchestrationData?.data?.rule?.nodes?.length > 0){
      ...
      if("save" in dynamicactionsa8358Props?.dynamicActionRule){
        setShowFlag(true)
        setStyleSate({...getGridPositionFromOrder(dynamicactionsa8358Props?.dynamicActionRule?.save,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }
      else
      {
        setShowFlag(false)   
      ...
      if("save" in newemployees_v1?.dynamicactions && newemployees_v1?.dynamicactions["save"]?.itsHaveArtifact== true)
      {
        setShowFlag(newemployees_v1?.dynamicactions["save"]?.show||false)
        
        setStyleSate({...getGridPositionFromOrder(newemployees_v1?.dynamicactions?.save?.order,parentRowSpan)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }else{
        setShowFlag(false)
      }
    }
  ...
  useEffect(()=>{
    ...
    const triggerElementHandler = async (id:any) => {
      if (id === "86a153f22b2040d2b95c9e81cc7c5b7c") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "savec5b7c");
    return () => {
  ...
  useEffect(()=>{
    if (!savec5b7c?.trigger) return;
      if(savec5b7c?.trigger){
      setsavec5b7c((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
  ...
  async function handleSave5b7c_1_1_1(){
  ...
  const hasInvalidField = Object.values(currentValidate?.newEmployees_v1 || {}).some(val => {
    ...
    try{
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addEmployee:AFVK:v1|f0014e01609d494cb0b5dca2db935376"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addEmployee:AFVK:v1|f0014e01609d494cb0b5dca2db935376"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "86a153f22b2040d2b95c9e81cc7c5b7c",
  "type": "button",
  "name": "save",
  "label": "save",
  "sequence": 1,
  "children": [
    {
      "id": "86a153f22b2040d2b95c9e81cc7c5b7c.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "86a153f22b2040d2b95c9e81cc7c5b7c.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "86a153f22b2040d2b95c9e81cc7c5b7c.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
                ...
                "params": [
                  {
                    "name": "message",
                    "_type": "text",
                    "value": "Employee was created successfully",
                    "enabled": true
                  },
                  {
                    "name": "type",
            ...
            {
              "id": "86a153f22b2040d2b95c9e81cc7c5b7c.1.1.1.2",
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:addEmployee:AFVK:v1|f0014e01609d494cb0b5dca2db935376"
          ]
        }
      ]
    }
  ...
  // saveHandler
    ...
    if("_groupArrays_" in reworkedObject )
    {
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              ...
              controlId:"86a153f22b2040d2b95c9e81cc7c5b7c"
            };
            if (encryptionFlagCont) {
        ...
        if(dynamicactionsa8358?.upId){
          te_saveBody['upId']= dynamicactionsa8358?.upId;
        }
        if(dynamicactionsa8358?.upid){
          te_saveBody['upId']= dynamicactionsa8358?.upid;
        }
        ...
        if (dynamicactionsa8358Props.ssKey !== '' && dynamicactionsa8358Props.ssKey !== undefined) {
          te_saveBody["ssKey"] = dynamicactionsa8358Props.ssKey;
    ...
    //infoMsg
    toast('Employee was created successfully', 'success',false);
    // refreshElement
    //riseListen
    // for group
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdynamicactionsa8358((prev: any) => ({ ...prev, save: true }));
        //onClick

    //saveHandler
    await handleSave5b7c_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdynamicactionsa8358((prev: any) => ({ ...prev, save: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
  ...
  }, [newemployees_v1?.dynamicactions?.save,dynamicactionsa8358Props?.dynamicActionRule?.save,])

 if (savec5b7c?.isHidden) {
    return <></>
  }
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='normal'
          disabled= {savec5b7c?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
