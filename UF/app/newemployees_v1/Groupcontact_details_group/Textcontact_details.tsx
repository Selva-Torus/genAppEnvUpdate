...
const Textcontact_details = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[contact_details450d3?.refresh])

  if (contact_details450d3?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Contact Details")}
</Text>
  </div>
  )
}

export default Textcontact_details
