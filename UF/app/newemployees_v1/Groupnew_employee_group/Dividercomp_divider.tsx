...
const Dividercomp_divider = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[comp_divider6b1fb?.refresh])

  if (comp_divider6b1fb?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `13 / 25`,gridRow: `129 / 133`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Dividercomp_divider
