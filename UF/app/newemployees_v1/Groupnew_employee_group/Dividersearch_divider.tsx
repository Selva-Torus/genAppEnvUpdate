...
const Dividersearch_divider = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[search_divider2e6c7?.refresh])

  if (search_divider2e6c7?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `311 / 315`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Dividersearch_divider
