...
const Divideradd_divider = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[add_dividerea333?.refresh])

  if (add_dividerea333?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `103 / 107`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Divideradd_divider
