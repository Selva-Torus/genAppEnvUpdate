...
const Textnew_emp = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[new_empe0326?.refresh])

  if (new_empe0326?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Add New Employee ")}
</Text>
  </div>
  )
}

export default Textnew_emp
