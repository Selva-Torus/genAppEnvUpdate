...
const Dividerbasic_divider = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[basic_divider2a0e2?.refresh])

  if (basic_divider2a0e2?.isHidden) {
    return <></>
  }
...
export default Dividerbasic_divider
