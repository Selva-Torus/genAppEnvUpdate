...
const Dividercontact_details_divider = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[contact_details_divider70e71?.refresh])

  if (contact_details_divider70e71?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `63 / 67`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Dividercontact_details_divider
