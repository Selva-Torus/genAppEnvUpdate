...
const Dividerskill_divider = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[skill_divider2aaad?.refresh])

  if (skill_divider2aaad?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `182 / 186`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Dividerskill_divider
