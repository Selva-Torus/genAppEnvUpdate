...
const Divideremergency_divider = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[emergency_divider6af77?.refresh])

  if (emergency_divider6af77?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `155 / 159`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Divideremergency_divider
