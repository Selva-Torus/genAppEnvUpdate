...
const TextInputoccupation = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  const handleChange = async(e: any) => {
    ...
    setfamly_detailsb06ea_1((prev: any) => ({ ...prev, occupation: +e.target.value }));
    }
    else{
    setfamly_detailsb06ea_1((prev: any) => ({ ...prev, occupation: e.target.value }));
    }
  ...
  const famly_detailsb06ea_1Ref = useRef<any>(famly_detailsb06ea_1);
  useEffect(() => { famly_detailsb06ea_1Ref.current = famly_detailsb06ea_1; }, [famly_detailsb06ea_1]);
  useEffect(()=>{
      handleMapperValue();
    ...
    const handlerChange = (id:any) => {
      if (id === "248efa5bf9c945b7a0772dddadf36ff7") {
        handleChange({target:{value:famly_detailsb06ea_1Ref?.current?.occupation||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "248efa5bf9c945b7a0772dddadf36ff7") {
        handleBlur({target:{value:famly_detailsb06ea_1Ref?.current?.occupation||""}});
      }
    };
  ...
  if(dfd_familyjson_v1Props?.setSearchFilters && dfd_familyjson_v1Props?.data)
  {
    if(Array.isArray(dfd_familyjson_v1Props.data) && dfd_familyjson_v1Props.data.length > 0){
      setfamly_detailsb06ea_1((pre:any)=>({...pre,occupation:dfd_familyjson_v1Props.data[0]?.occupation}));
    }
  }
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={famly_detailsb06ea_1?.occupation||""}
