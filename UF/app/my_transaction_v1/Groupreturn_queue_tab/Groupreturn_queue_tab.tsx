 ...
 /////////////
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if (
        !Array.isArray(return_queue_tab5611e) &&
        Object.keys(return_queue_tab5611e)?.length > 0
      ) {
        setreturn_queue_tab5611e({})
      }
    } else prevRefreshRef.current = true
  }, [return_queue_tab5611eProps?.refresh])
    ...
    <div 
      ...
      className={`flex flex-col overflow-auto rounded-md  ${isDark ? 'text-white' : 'text-black'}`}
       onClick={(e:any)=>{e.stopPropagation()
        handleOnClick({}, 0);
          settransaction_v1((pre:any)=>({...pre,_selectedGroup_:"return_queue_tab"}))
        }}
    >
