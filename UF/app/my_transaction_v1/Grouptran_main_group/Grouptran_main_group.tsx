 ...
 /////////////
  ...
  /////////////
    ...
    }else
    {
      ...
      {
        settran_tab_group08b64({...tran_tab_group08b64,isDisabled:false});
      }
    }
  //////////////
    if (code != '') {
  ...
  function handleConfirmOnLoad(){
    ...
    const handleOnload=()=>{
      // triggerButtonClick
      if(eventDecisionTable({conditionalKey:"roleName",conditionalValue:"Admin"},{...decodedTokenObj,...tran_main_group1dc7f})==false)
      {
