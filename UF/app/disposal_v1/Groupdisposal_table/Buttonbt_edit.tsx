...
const Buttonbt_edit = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "11ee2952572f42b887e3643f2d2b236b"
      );
    ...
    let filterProps2:any =  [
  {
    ...
    //bindTran
    // For group or table
    let bindData4 = filterByKeys(mainData,initiate_asset_disposal_groupdb5a7Props?.controls);
    setinitiate_asset_disposal_groupdb5a7(bindData4||{})
    setinitiate_asset_disposal_groupdb5a7Props({...initiate_asset_disposal_groupdb5a7Props,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData6 = filterByKeys(mainData,disposal_details_groupe1b0cProps?.controls);
    setdisposal_details_groupe1b0c(bindData6||{})
    setdisposal_details_groupe1b0cProps({...disposal_details_groupe1b0cProps,presetValues:mainData||{}})  
    //bindTran
    // For group or table
    let bindData8 = filterByKeys(mainData,compliance_financial_group1f9bcProps?.controls);
    setcompliance_financial_group1f9bc(bindData8||{})
    setcompliance_financial_group1f9bcProps({...compliance_financial_group1f9bcProps,presetValues:mainData||{}})  
    ...
    >
      ...
      >
        ...
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='outlined'
          disabled= {bt_editb236b?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Edit")}
