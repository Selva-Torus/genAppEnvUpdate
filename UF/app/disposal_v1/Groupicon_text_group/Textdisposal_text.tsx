...
const Textdisposal_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[disposal_text2d2ac?.refresh])

  if (disposal_text2d2ac?.isHidden) {
    return <></>
  }
...
export default Textdisposal_text
