...
import PageRequestScreenDailypage from '@/app/request_screen_daily_v1/request_screen_daily_v1page';
...
const Buttonadd =  ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
  ...
  const handleClick=async()=>{
    ...
    setrequest_screen_daily_v1Props([...filterData ]);
 ...
 if (addd126f?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `10 / 12`,gridRow: `47 / 57`, gap:``, height: `100%`, overflow: 'auto'}} 
 >
      <Modal 
      ...
      className='w-[800px] h-[] bg-gray-50 mx-auto rounded-lg shadow-xl p-5 overflow-auto'>
        ...
        {showFlag && <Button 
          ...
          disabled= {addd126f?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Add")}
