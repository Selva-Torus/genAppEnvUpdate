...
const Textoffsite_exp = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[offsite_exp949f2?.refresh])

  if (offsite_exp949f2?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `13 / 21`,gridRow: `48 / 56`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="display-1"
...
export default Textoffsite_exp
