...
let defaultColumns = [
  {
    "id": "expense_name",
    "nodeid": "ccecb0c5d2bf4ab8ade2b691d251040c",
    "name": "Expense Name",
    "meta": {
      "sort": true
    },
  ...
  },
  {
    ...
    "nodeid": "c883b780cb134b2abe506e4785754e36",
    "name": "Amount",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "trs_status",
    "nodeid": "d5df9c9e1b4b4f08a8c81bb3f3c6f7ad",
    "name": "Status",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "formatted_date",
    "nodeid": "7840d154e6bf4d12bec5aaab8f47ebf5",
    "name": "Date",
    "meta": {
      "sort": true
    },
...
const Tableoffsite_expense_table = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,refetch, setRefetch,setData,encryptionFlagCompData,paginationDetails,open, setOpen, ref, ButtonGoRuleData, setButtonGoRuleData }: any)=>{
 ...
 /////////////
    ...
    mapperData = [
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Dashboard_For_User:AFVK:v1|0918644520a24e0aa0d1781bb754ffd6|683318d1f1084428979517fe450b67db"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Dashboard_For_User:AFVK:v1|0918644520a24e0aa0d1781bb754ffd6|ccecb0c5d2bf4ab8ade2b691d251040c"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Dashboard_For_User:AFVK:v1|0918644520a24e0aa0d1781bb754ffd6|c883b780cb134b2abe506e4785754e36"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Dashboard_For_User:AFVK:v1|0918644520a24e0aa0d1781bb754ffd6|d5df9c9e1b4b4f08a8c81bb3f3c6f7ad"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Dashboard_For_User:AFVK:v1|0918644520a24e0aa0d1781bb754ffd6|7840d154e6bf4d12bec5aaab8f47ebf5"
  }
];
    schemaDataDFO = [
  {
  ...
  const handleUpdate = (page:any, pageSize:any) =>{
    ...
    setoffsite_expense_table4ffd6Props((pre:any)=>({...pre, selectedIds:[]}))
    let checkedData: any = selectedPaginationData
    if (checkedData.length) {
      for (let i = 0; i < checkedData.length; i++) {
        if (checkedData[i].page == page) {
          setoffsite_expense_table4ffd6Props((pre:any)=>({...pre, selectedIds:checkedData[i].data}))
        }
      }
    }
    ...
    try {
      ...
      if (isRulePresent==false) {
        ...
        const api_paginationBody: api_paginationDto = {
          ...
          count: parseInt(pageSize),
          filterDetails: {
            ufKey:'CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Dashboard_For_User:AFVK:v1:UO', 
            nodeId: '0918644520a24e0aa0d1781bb754ffd6',
            elementId: '0918644520a24e0aa0d1781bb754ffd6'
          },
          searchFilter: searchParams
        }
        if(encryptionFlagCont) {
      ...
      // CopyFromData (Parent table): use presetValues if present, else use pagination-filtered data
        ...
        if ( offsite_expense_table4ffd6Props?.presetValues&&Object.keys(offsite_expense_table4ffd6Props?.presetValues).length > 0) {
          filtertedData = [offsite_expense_table4ffd6Props?.presetValues];
        }else {
          filtertedData = structuredClone(uf_paginationDataFilter.data)||[]
          setoffsite_expense_table4ffd6(uf_paginationDataFilter.data||[])
        }
...
const colurIndicator = (keyValue:any=[], comingValue:any,ColourIndicatorType:any) => {
  ...
  useEffect(() => {
    if (prevRefreshRef.current) {
      UpdatedDataHandle(offsite_expense_table4ffd6Props.filterProps)
    }else 
      prevRefreshRef.current= true
  }, [offsite_expense_table4ffd6Props.filterProps])
  ...
  const handlePrimaryTable = () => {
    let findData = offsite_expense_table4ffd6Props?.selectedIds[offsite_expense_table4ffd6Props?.selectedIds?.length-1]
    if(Array.isArray(offsite_expense_table4ffd6) && offsite_expense_table4ffd6.length>0)
    {
      let data = offsite_expense_table4ffd6[findData]
      setPrimaryTableData({
        ...primaryTableData,
        primaryKey: "claim_id",
        value: data["claim_id"],
  ...
  useEffect(() => {
    if (offsite_expense_table4ffd6Props?.selectedIds?.length != 0) handlePrimaryTable()
  }, [offsite_expense_table4ffd6Props?.selectedIds])
  ...
  if (offsite_expense_table4ffd6?.isHidden) {
    return <></>
  }
  return(
    <div className='w-full h-full'>
          <div className=' w-full flex flex-row h-[70%]'>
            <Table
              ...
              tableSettings={true}
              tableSorting={true}
              selectedIds={offsite_expense_table4ffd6Props?.selectedIds}  
