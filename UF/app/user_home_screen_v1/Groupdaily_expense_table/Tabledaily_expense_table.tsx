...
let defaultColumns = [
  {
    "id": "c_id",
    "nodeid": "ca432c873cad427996ee52053c31095d",
    "name": "Claim ID",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "claim_category",
    "nodeid": "45169ac9d00c4752807d191b96016bdb",
    "name": "Category",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "amount",
    "nodeid": "bd37728aaba3486fb2f0c14531fc124c",
    "name": "Amount",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "status",
    "nodeid": "102d688c870648d59e26160298a3fa4d",
    "name": "Status",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "date",
    "nodeid": "69e7988a22a54287b15969819c75e32f",
    "name": "Date",
    "meta": {
      "sort": true
    },
...
const Tabledaily_expense_table = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,refetch, setRefetch,setData,encryptionFlagCompData,paginationDetails,open, setOpen, ref, ButtonGoRuleData, setButtonGoRuleData }: any)=>{
 ...
 /////////////
    ...
    mapperData = [
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Dashboard_For_User:AFVK:v1|2c198b49b883478ca1a170b5bad13758|ca432c873cad427996ee52053c31095d"
  },
  {
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Dashboard_For_User:AFVK:v1|2c198b49b883478ca1a170b5bad13758|45169ac9d00c4752807d191b96016bdb"
  },
  {
    "elementname": "amount",
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Dashboard_For_User:AFVK:v1|2c198b49b883478ca1a170b5bad13758|bd37728aaba3486fb2f0c14531fc124c"
  },
  {
    "elementname": "status",
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Dashboard_For_User:AFVK:v1|2c198b49b883478ca1a170b5bad13758|102d688c870648d59e26160298a3fa4d"
  },
  {
    "elementname": "date",
    ...
    "targetkey": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Dashboard_For_User:AFVK:v1|2c198b49b883478ca1a170b5bad13758|69e7988a22a54287b15969819c75e32f"
  }
];
    schemaDataDFO = [
  {
  ...
  const handleUpdate = (page:any, pageSize:any) =>{
    ...
    setdaily_expense_table13758Props((pre:any)=>({...pre, selectedIds:[]}))
    let checkedData: any = selectedPaginationData
    if (checkedData.length) {
      for (let i = 0; i < checkedData.length; i++) {
        if (checkedData[i].page == page) {
          setdaily_expense_table13758Props((pre:any)=>({...pre, selectedIds:checkedData[i].data}))
        }
      }
    }
  ...
  async function fetchData(page:any = 1, pageSize:any = 10, searchParams = {},dfKey:any,isRulePresent:any=false,isOnLoad = false,filterProps?:any) {
    ...
    try {
      ...
      if (isRulePresent==false) {
        ...
        const api_paginationBody: api_paginationDto = {
          ...
          filterDetails: {
            ...
            nodeId: '2c198b49b883478ca1a170b5bad13758',
            elementId: '2c198b49b883478ca1a170b5bad13758'
          },
          searchFilter: searchParams
        }
        if(encryptionFlagCont) {
      ...
      // CopyFromData (Parent table): use presetValues if present, else use pagination-filtered data
        ...
        if ( daily_expense_table13758Props?.presetValues&&Object.keys(daily_expense_table13758Props?.presetValues).length > 0) {
          filtertedData = [daily_expense_table13758Props?.presetValues];
        }else {
          filtertedData = structuredClone(uf_paginationDataFilter.data)||[]
          setdaily_expense_table13758(uf_paginationDataFilter.data||[])
        }
...
const colurIndicator = (keyValue:any=[], comingValue:any,ColourIndicatorType:any) => {
  ...
  useEffect(() => {
    if (prevRefreshRef.current) {
      UpdatedDataHandle(daily_expense_table13758Props.filterProps)
    }else 
      prevRefreshRef.current= true
  }, [daily_expense_table13758Props.filterProps])
  ...
  const handlePrimaryTable = () => {
    let findData = daily_expense_table13758Props?.selectedIds[daily_expense_table13758Props?.selectedIds?.length-1]
    if(Array.isArray(daily_expense_table13758) && daily_expense_table13758.length>0)
    {
      let data = daily_expense_table13758[findData]
      setPrimaryTableData({
        ...primaryTableData,
        primaryKey: "claim_id",
        value: data["claim_id"],
  ...
  useEffect(() => {
    if (daily_expense_table13758Props?.selectedIds?.length != 0) handlePrimaryTable()
  }, [daily_expense_table13758Props?.selectedIds])
  ...
  if (daily_expense_table13758?.isHidden) {
    return <></>
  }
  return(
    <div className='w-full h-full'>
          <div className=' w-full flex flex-row h-[70%]'>
            <Table
              ...
              tableSettings={true}
              tableSorting={true}
              selectedIds={daily_expense_table13758Props?.selectedIds}  
