...
const Buttonbutton_add_doc = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const doc_attached_groupac2a0Ref = useRef(doc_attached_groupac2a0);
  useEffect(() => {
    doc_attached_groupac2a0Ref.current = doc_attached_groupac2a0;
    if (!pendingAutoSearch.current) return;
      pendingAutoSearch.current = false;
      handleClick(false);
  }, [doc_attached_groupac2a0]);
  
  //group props in ref to access latest props value
  const doc_attached_groupac2a0PropsRef = useRef(doc_attached_groupac2a0Props);
  useEffect(() => {
    doc_attached_groupac2a0PropsRef.current = doc_attached_groupac2a0Props;
  }, [doc_attached_groupac2a0Props]);
  ...
  const handleMapper=async (data?:any) => {
    try{     
      data = {...data,...doc_attached_groupac2a0Ref.current};
      let parentRowSpan = 161;
      const orchestrationData : any = getControlOrchestrationData(
        controlData,
        "b2c5c38225d609b45f9969648a2ac2a0",
        "cc2103a73d9824fbfdbfe66c7d77c20b"
      );
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "button_add_doc7c20b") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "cc2103a73d9824fbfdbfe66c7d77c20b") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "button_add_doc7c20b");
    return () => {
  ...
  useEffect(()=>{
    if (!button_add_doc7c20b?.trigger) return;
      if(button_add_doc7c20b?.trigger){
      setbutton_add_doc7c20b((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[button_add_doc7c20b?.trigger])

  useEffect(()=>{
    if(button_add_doc7c20b?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[button_add_doc7c20b?.refresh])
  ...
  async function handleSavec20b_1_1_1(){
      

  setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    await delay(1000); 

    const doc_attached_groupac2a0Props = doc_attached_groupac2a0PropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.employeesDocument_v1 || {}).some(val => {
    ...
    try{
      ...
      let mainData:any=structuredClone(doc_attached_groupac2a0Ref.current);
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:employeesDocument:AFVK:v1|019902226960796cfb6dba60189c74c7"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:employeesDocument:AFVK:v1|019902226960796cfb6dba60189c74c7"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "cc2103a73d9824fbfdbfe66c7d77c20b",
  "type": "button",
  "name": "button_add_doc",
  ...
  "children": [
    {
      "id": "cc2103a73d9824fbfdbfe66c7d77c20b.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "cc2103a73d9824fbfdbfe66c7d77c20b.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "cc2103a73d9824fbfdbfe66c7d77c20b.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "cc2103a73d9824fbfdbfe66c7d77c20b.1.1.1.1.1",
                  ...
                  "children": [
                    {
                      "id": "f56c544fe9d33cadb4368d9ad2bb42f3.1.1.1.1.1.1",
                      "value": "",
                      "type": "screen",
                      "name": "employeesDocument.v1|employee_doc_table",
                      "label": "employeesDocument.v1|employee_doc_table",
                      "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:employeesDocument:AFVK:v1|employee_doc_table",
                      "elementType": "group",
                      "groupType": "table",
                ...
                {
                  "id": "cc2103a73d9824fbfdbfe66c7d77c20b.1.1.1.1.2",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "b2c5c38225d609b45f9969648a2ac2a0|1fa5fd1bdeafc39a56d02371430c5e72.1.1.1.1.2.1",
                      "type": "documentuploadpanel",
                      "name": "employeesDocument|doc_attached_group|documentuploadpanel",
                      "label": "employeesDocument|doc_attached_group|documentuploadpanel",
                      "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:employeesDocument:AFVK:v1|documentuploadpanel",
                ...
                "params": [
                  {
                    "name": "message",
                    "_type": "text",
                    "value": "Employee Document Added Successfully",
                    "enabled": true
                  },
                  {
                    "name": "type",
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:employeesDocument:AFVK:v1|019902226960796cfb6dba60189c74c7"
          ]
        }
      ]
    }
      ...
      let sourceId : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:employeesDocument:AFVK:v1";
      sourceId+= "|"+"b2c5c38225d609b45f9969648a2ac2a0";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:employeesDocument:AFVK:v1"+"|"+"b2c5c38225d609b45f9969648a2ac2a0"+"|"+eventProperty.id;
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...doc_attached_groupac2a0Ref.current, ...nullFilter(table_group034b1) });
    let reworkKeys:any[]=[];
    ...
    if("_groupArrays_" in reworkedObject )
    {
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"b2c5c38225d609b45f9969648a2ac2a0",
              controlId:"cc2103a73d9824fbfdbfe66c7d77c20b"
            };
            if (encryptionFlagCont) {
        ...
        if(doc_attached_groupac2a0?.upId){
          te_saveBody['upId']= doc_attached_groupac2a0?.upId;
        }
        if(doc_attached_groupac2a0?.upid){
          te_saveBody['upId']= doc_attached_groupac2a0?.upid;
        }
        ...
        if (doc_attached_groupac2a0Props.ssKey !== '' && doc_attached_groupac2a0Props.ssKey !== undefined) {
          te_saveBody["ssKey"] = doc_attached_groupac2a0Props.ssKey;
    ...
    //infoMsg
    toast('Employee Document Added Successfully', 'success',true);
    // refreshElement
    //riseListen
    // for group
    setemployee_doc_tableb42f3Props((pre:any)=>({...pre,refresh:!pre?.refresh}));
    ...
    // for controller
    // clearHandler riseListen
      setdoc_attached_groupac2a0((pre:any)=>({...pre,documentuploadpanel:""}));
    }catch(err:any){
      savedData.current = {};
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdoc_attached_groupac2a0((prev: any) => ({ ...prev, button_add_doc: true }));
        //onClick

    //saveHandler
    await handleSavec20b_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdoc_attached_groupac2a0((prev: any) => ({ ...prev, button_add_doc: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
 ...
 if (button_add_doc7c20b?.isHidden) {
    return <></>
  }
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {button_add_doc7c20b?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Add Document")}
