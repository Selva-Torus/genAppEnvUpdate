...
const TextInputsystem_name = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:newAccessRequestApproval:AFVK:v1|243f73b730937821efe0461c690f6698|698b8cc9713c824b4e3da3ddc925463b"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,newAccessRequestApproval_v1:{...pre?.newAccessRequestApproval_v1,system_name:undefined}}));
    if(dynamicStateandType.type=="number"){
    setaccess_req__groupf6698((prev: any) => ({ ...prev, system_name: +e.target.value }));
    }
    else{
    setaccess_req__groupf6698((prev: any) => ({ ...prev, system_name: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "698b8cc9713c824b4e3da3ddc925463b"
      );
      ...
      //     controlId: "698b8cc9713c824b4e3da3ddc925463b",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "698b8cc9713c824b4e3da3ddc925463b") {
        handleChange({target:{value:access_req__groupf6698Ref?.current?.system_name||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "698b8cc9713c824b4e3da3ddc925463b") {
        handleBlur({target:{value:access_req__groupf6698Ref?.current?.system_name||""}});
      }
    };
  ...
  if(dfd_addaccessrequestmodify_v1Props?.setSearchFilters && dfd_addaccessrequestmodify_v1Props?.data)
  {
    if(Array.isArray(dfd_addaccessrequestmodify_v1Props.data) && dfd_addaccessrequestmodify_v1Props.data.length > 0){
      setaccess_req__groupf6698((pre:any)=>({...pre,system_name:dfd_addaccessrequestmodify_v1Props.data[0]?.system_name}));
    }
  }
  },[dfd_addaccessrequestmodify_v1Props?.setSearchFilters])
  if (system_name5463b?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={access_req__groupf6698?.system_name||""}
         disabled= {system_name5463b?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.newAccessRequestApproval_v1?.system_name ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
