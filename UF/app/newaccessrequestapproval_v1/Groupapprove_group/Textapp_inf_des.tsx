...
const Textapp_inf_des = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {app_inf534a9, setapp_inf534a9}= useContext(TotalContext) as TotalContextProps;
  const {app_inf_des06c76, setapp_inf_des06c76}= useContext(TotalContext) as TotalContextProps;
  ...
  useEffect(()=>{
    handleMapperValue()
  },[app_inf_des06c76?.refresh])

  if (app_inf_des06c76?.isHidden) {
    return <></>
  }
...
export default Textapp_inf_des
