...
export default function PageNewaccessrequestV1() {
  ...
  const [paginationData,setPaginationData]=useState<PaginationData>({count:10,page:1})
    ...
    async function accesslevelcombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(newaccessrequest_v1Props.length > 0){
          for(let i=0;i< newaccessrequest_v1Props.length;i++){
            if(newaccessrequest_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:accessLevelCombo:AFVK:v1"){
              // delete newaccessrequest_v1Props[i].DFDkey;
              let temp=structuredClone(newaccessrequest_v1Props[i])
              delete temp?.DFDkey
  ...
  useEffect(()=>{
    ...
    async function addaccessrequestmodify_v1DFD(pagination:any): Promise<void>{
        ...
        if(newaccessrequest_v1Props.length > 0){
          for(let i=0;i< newaccessrequest_v1Props.length;i++){
            if(newaccessrequest_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:addAccessRequestModify:AFVK:v1"){
              // delete newaccessrequest_v1Props[i].DFDkey;
              let temp=structuredClone(newaccessrequest_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function requestprioritycombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(newaccessrequest_v1Props.length > 0){
          for(let i=0;i< newaccessrequest_v1Props.length;i++){
            if(newaccessrequest_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:requestPriorityCombo:AFVK:v1"){
              // delete newaccessrequest_v1Props[i].DFDkey;
              let temp=structuredClone(newaccessrequest_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function requesttypecombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(newaccessrequest_v1Props.length > 0){
          for(let i=0;i< newaccessrequest_v1Props.length;i++){
            if(newaccessrequest_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:requestTypeCombo:AFVK:v1"){
              // delete newaccessrequest_v1Props[i].DFDkey;
              let temp=structuredClone(newaccessrequest_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function risklevelcombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(newaccessrequest_v1Props.length > 0){
          for(let i=0;i< newaccessrequest_v1Props.length;i++){
            if(newaccessrequest_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:riskLevelCombo:AFVK:v1"){
              // delete newaccessrequest_v1Props[i].DFDkey;
              let temp=structuredClone(newaccessrequest_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function provisioningstatuscombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(newaccessrequest_v1Props.length > 0){
          for(let i=0;i< newaccessrequest_v1Props.length;i++){
            if(newaccessrequest_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:provisioningStatusCombo:AFVK:v1"){
              // delete newaccessrequest_v1Props[i].DFDkey;
              let temp=structuredClone(newaccessrequest_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  useEffect(()=>{
    ...
    async function employeenamecombo_v1DFD(pagination:any): Promise<void>{
        ...
        if(newaccessrequest_v1Props.length > 0){
          for(let i=0;i< newaccessrequest_v1Props.length;i++){
            if(newaccessrequest_v1Props[i].DFDkey == "CK:CT006:FNGK:AF:FNK:DF-DFD:CATK:ECP:AFGK:HRM:AFK:employeeNameCombo:AFVK:v1"){
              // delete newaccessrequest_v1Props[i].DFDkey;
              let temp=structuredClone(newaccessrequest_v1Props[i])
              delete temp?.DFDkey
              filterData.push(temp)
  ...
  const handleArtfactRule=async(rule:any,data:any={},allRuleData:any)=>{
    ...
    setnewaccessrequest_v1({...result,_artfactPFRule_:rule})
  }
  ...
  useEffect(() => {    
    ...
    securityCheck();
    handleOnload();
    setnewaccessrequest_v1((pre:any)=>({...pre,...allRuleData||{}}))
  }, [])

  useEffect(()=>{
    if(newaccessrequest_v1?._artfactPFRule_)
    {
      let data:any ={
        ...decodedTokenObj,
        session:decodedTokenObj,
      }
      handleArtfactRule(newaccessrequest_v1?._artfactPFRule_,data,allRuleData)
    }
  },[])
  ...
  useEffect(() => {
    const handleClickOutside = (event:any) => {
      if (parentRef.current && !parentRef.current.contains(event.target)) {
        setnewaccessrequest_v1((pre:any)=>({...pre,_selectedGroup_:""}))
      }
    };
