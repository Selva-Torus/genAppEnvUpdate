...
const Textapp_inf = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[app_infa651b?.refresh])

  if (app_infa651b?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Approval Information")}
</Text>
  </div>
  )
}

export default Textapp_inf
