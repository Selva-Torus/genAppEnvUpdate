...
const Textprov_inf_des = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[prov_inf_des3629c?.refresh])

  if (prov_inf_des3629c?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `6 / 13`,gridRow: `1 / 7`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  ...
  color="primary"
>
      {keyset("(To be filled by IT/Admin)")}
</Text>
  </div>
  )
}

export default Textprov_inf_des
