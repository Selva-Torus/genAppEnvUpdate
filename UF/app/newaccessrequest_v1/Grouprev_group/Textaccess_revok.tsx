...
const Textaccess_revok = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[access_revok8cc13?.refresh])

  if (access_revok8cc13?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Access Revocation")}
</Text>
  </div>
  )
}

export default Textaccess_revok
