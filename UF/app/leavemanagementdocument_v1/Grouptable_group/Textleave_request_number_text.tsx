...
const Textleave_request_number_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[leave_request_number_text70447?.refresh])

  if (leave_request_number_text70447?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Request Number")}
</Text>
  </div>
  )
}

export default Textleave_request_number_text
