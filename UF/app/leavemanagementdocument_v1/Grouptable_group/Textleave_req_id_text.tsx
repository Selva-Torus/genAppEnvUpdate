...
const Textleave_req_id_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[leave_req_id_textb89d8?.refresh])

  if (leave_req_id_textb89d8?.isHidden) {
    return <></>
  }
...
export default Textleave_req_id_text
