...
const Buttonbutton_add_doc = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const doc_attached_groupe2bd6Ref = useRef(doc_attached_groupe2bd6);
  useEffect(() => {
    doc_attached_groupe2bd6Ref.current = doc_attached_groupe2bd6;
    if (!pendingAutoSearch.current) return;
      pendingAutoSearch.current = false;
      handleClick(false);
  }, [doc_attached_groupe2bd6]);
  
  //group props in ref to access latest props value
  const doc_attached_groupe2bd6PropsRef = useRef(doc_attached_groupe2bd6Props);
  useEffect(() => {
    doc_attached_groupe2bd6PropsRef.current = doc_attached_groupe2bd6Props;
  }, [doc_attached_groupe2bd6Props]);
  ...
  const handleMapper=async (data?:any) => {
    try{     
      data = {...data,...doc_attached_groupe2bd6Ref.current};
      let parentRowSpan = 161;
      const orchestrationData : any = getControlOrchestrationData(
        controlData,
        "ffda8670f0fc192442a6d97bd4fe2bd6",
        "1b5717bf2309bee5c1908a101ebdaa1e"
      );
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "button_add_docdaa1e") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "1b5717bf2309bee5c1908a101ebdaa1e") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "button_add_docdaa1e");
    return () => {
  ...
  useEffect(()=>{
    if (!button_add_docdaa1e?.trigger) return;
      if(button_add_docdaa1e?.trigger){
      setbutton_add_docdaa1e((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[button_add_docdaa1e?.trigger])

  useEffect(()=>{
    if(button_add_docdaa1e?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[button_add_docdaa1e?.refresh])
  ...
  async function handleSaveaa1e_1_1_1(){
      

  setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    await delay(1000); 

    const doc_attached_groupe2bd6Props = doc_attached_groupe2bd6PropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.leaveManagementDocument_v1 || {}).some(val => {
    ...
    try{
      ...
      let mainData:any=structuredClone(doc_attached_groupe2bd6Ref.current);
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:leaveManageDocument:AFVK:v1|eed9cb662cef7dac727d472da73cf567"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:leaveManageDocument:AFVK:v1|eed9cb662cef7dac727d472da73cf567"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "1b5717bf2309bee5c1908a101ebdaa1e",
  "type": "button",
  "name": "button_add_doc",
  ...
  "children": [
    {
      "id": "1b5717bf2309bee5c1908a101ebdaa1e.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "1b5717bf2309bee5c1908a101ebdaa1e.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "1b5717bf2309bee5c1908a101ebdaa1e.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "1b5717bf2309bee5c1908a101ebdaa1e.1.1.1.1.1",
                  ...
                  "children": [
                    {
                      "id": "537d96f852345700a710b349837d1189.1.1.1.1.1.1",
                      "value": "",
                      "type": "screen",
                      "name": "leaveManagementDocument.v1|request_doc_table",
                      "label": "leaveManagementDocument.v1|request_doc_table",
                      "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:leaveManagementDocument:AFVK:v1|request_doc_table",
                      "elementType": "group",
                      "groupType": "table",
                ...
                {
                  "id": "1b5717bf2309bee5c1908a101ebdaa1e.1.1.1.1.2",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "ffda8670f0fc192442a6d97bd4fe2bd6|2e3175cc17f27646d082989ffbbbe83c.1.1.1.1.2.1",
                      "type": "documentuploadpanel",
                      "name": "leaveManagementDocument|doc_attached_group|documentuploadpanel",
                      "label": "leaveManagementDocument|doc_attached_group|documentuploadpanel",
                      "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:leaveManagementDocument:AFVK:v1|documentuploadpanel",
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:leaveManageDocument:AFVK:v1|eed9cb662cef7dac727d472da73cf567"
          ]
        }
      ]
    }
      ...
      let sourceId : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:leaveManagementDocument:AFVK:v1";
      sourceId+= "|"+"ffda8670f0fc192442a6d97bd4fe2bd6";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:leaveManagementDocument:AFVK:v1"+"|"+"ffda8670f0fc192442a6d97bd4fe2bd6"+"|"+eventProperty.id;
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...doc_attached_groupe2bd6Ref.current, ...nullFilter(table_groupf34e5) });
    let reworkKeys:any[]=[];
    ...
    if("_groupArrays_" in reworkedObject )
    {
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"ffda8670f0fc192442a6d97bd4fe2bd6",
              controlId:"1b5717bf2309bee5c1908a101ebdaa1e"
            };
            if (encryptionFlagCont) {
        ...
        if(doc_attached_groupe2bd6?.upId){
          te_saveBody['upId']= doc_attached_groupe2bd6?.upId;
        }
        if(doc_attached_groupe2bd6?.upid){
          te_saveBody['upId']= doc_attached_groupe2bd6?.upid;
        }
        ...
        if (doc_attached_groupe2bd6Props.ssKey !== '' && doc_attached_groupe2bd6Props.ssKey !== undefined) {
          te_saveBody["ssKey"] = doc_attached_groupe2bd6Props.ssKey;
    ...
    //riseListen
    // for group
    setrequest_doc_tabled1189Props((pre:any)=>({...pre,refresh:!pre?.refresh}));
    ...
    // for controller
    // clearHandler riseListen
      setdoc_attached_groupe2bd6((pre:any)=>({...pre,documentuploadpanel:""}));
    }catch(err:any){
      savedData.current = {};
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdoc_attached_groupe2bd6((prev: any) => ({ ...prev, button_add_doc: true }));
        //onClick

    //saveHandler
    await handleSaveaa1e_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdoc_attached_groupe2bd6((prev: any) => ({ ...prev, button_add_doc: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
 ...
 if (button_add_docdaa1e?.isHidden) {
    return <></>
  }
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {button_add_docdaa1e?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Add Document")}
