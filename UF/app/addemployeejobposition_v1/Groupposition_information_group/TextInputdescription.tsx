...
const TextInputdescription = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:addEmployeeJobPosition:AFVK:v1|b2c06e29b62cff17bf1e2725d255335b|a3d4b200d4194019fba4ada58c89d446"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,addEmployeeJobPosition_v1:{...pre?.addEmployeeJobPosition_v1,description:undefined}}));
    if(dynamicStateandType.type=="number"){
    setposition_information_group5335b((prev: any) => ({ ...prev, description: +e.target.value }));
    }
    else{
    setposition_information_group5335b((prev: any) => ({ ...prev, description: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "a3d4b200d4194019fba4ada58c89d446"
      );
      ...
      //     controlId: "a3d4b200d4194019fba4ada58c89d446",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "a3d4b200d4194019fba4ada58c89d446") {
        handleChange({target:{value:position_information_group5335bRef?.current?.description||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "a3d4b200d4194019fba4ada58c89d446") {
        handleBlur({target:{value:position_information_group5335bRef?.current?.description||""}});
      }
    };
  ...
  if(dfd_jobpositions_v1Props?.setSearchFilters && dfd_jobpositions_v1Props?.data)
  {
    if(Array.isArray(dfd_jobpositions_v1Props.data) && dfd_jobpositions_v1Props.data.length > 0){
      setposition_information_group5335b((pre:any)=>({...pre,description:dfd_jobpositions_v1Props.data[0]?.description}));
    }
  }
  },[dfd_jobpositions_v1Props?.setSearchFilters])
  if (description9d446?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={position_information_group5335b?.description||""}
         disabled= {description9d446?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.addEmployeeJobPosition_v1?.description ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
