...
const TextInputjob_family = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:addEmployeeJobPosition:AFVK:v1|b2c06e29b62cff17bf1e2725d255335b|fff5150f4fc34b20a9f6aabee5e4c9f2"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,addEmployeeJobPosition_v1:{...pre?.addEmployeeJobPosition_v1,job_family:undefined}}));
    if(dynamicStateandType.type=="number"){
    setposition_information_group5335b((prev: any) => ({ ...prev, job_family: +e.target.value }));
    }
    else{
    setposition_information_group5335b((prev: any) => ({ ...prev, job_family: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "fff5150f4fc34b20a9f6aabee5e4c9f2"
      );
      ...
      //     controlId: "fff5150f4fc34b20a9f6aabee5e4c9f2",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "fff5150f4fc34b20a9f6aabee5e4c9f2") {
        handleChange({target:{value:position_information_group5335bRef?.current?.job_family||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "fff5150f4fc34b20a9f6aabee5e4c9f2") {
        handleBlur({target:{value:position_information_group5335bRef?.current?.job_family||""}});
      }
    };
  ...
  if(dfd_jobpositions_v1Props?.setSearchFilters && dfd_jobpositions_v1Props?.data)
  {
    if(Array.isArray(dfd_jobpositions_v1Props.data) && dfd_jobpositions_v1Props.data.length > 0){
      setposition_information_group5335b((pre:any)=>({...pre,job_family:dfd_jobpositions_v1Props.data[0]?.job_family}));
    }
  }
  },[dfd_jobpositions_v1Props?.setSearchFilters])
  if (job_family4c9f2?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={position_information_group5335b?.job_family||""}
         disabled= {job_family4c9f2?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.addEmployeeJobPosition_v1?.job_family ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
