...
const TextInputexperience_required = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:addEmployeeJobPosition:AFVK:v1|b2c06e29b62cff17bf1e2725d255335b|535913ea4d864dda8be55a50b296a911"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,addEmployeeJobPosition_v1:{...pre?.addEmployeeJobPosition_v1,experience_required:undefined}}));
    if(dynamicStateandType.type=="number"){
    setposition_information_group5335b((prev: any) => ({ ...prev, experience_required: +e.target.value }));
    }
    else{
    setposition_information_group5335b((prev: any) => ({ ...prev, experience_required: e.target.value }));
    }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "535913ea4d864dda8be55a50b296a911"
      );
      ...
      //     controlId: "535913ea4d864dda8be55a50b296a911",
      //     isTable: false,
  ...
  useEffect(()=>{
    ...
    const handlerChange = (id:any) => {
      if (id === "535913ea4d864dda8be55a50b296a911") {
        handleChange({target:{value:position_information_group5335bRef?.current?.experience_required||""}});
      }
    };
    const handlerBlur = (id:any) => {
      if (id === "535913ea4d864dda8be55a50b296a911") {
        handleBlur({target:{value:position_information_group5335bRef?.current?.experience_required||""}});
      }
    };
  ...
  if(dfd_jobpositions_v1Props?.setSearchFilters && dfd_jobpositions_v1Props?.data)
  {
    if(Array.isArray(dfd_jobpositions_v1Props.data) && dfd_jobpositions_v1Props.data.length > 0){
      setposition_information_group5335b((pre:any)=>({...pre,experience_required:dfd_jobpositions_v1Props.data[0]?.experience_required}));
    }
  }
  },[dfd_jobpositions_v1Props?.setSearchFilters])
  if (experience_required6a911?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={position_information_group5335b?.experience_required||""}
         disabled= {experience_required6a911?.isDisabled ? true : false}
        pin='brick-brick'     
      ...
      errorMessage={error}
        validationState={validate?.addEmployeeJobPosition_v1?.experience_required ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
