...
const ButtonApprove =  ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
  ...
  },[approve098ea?.refresh,currentToken])
  ...
  async function handleSave98ea_1_1_1(){
    try{
  ...
  "id": "4953fad632eb4cf2a806de7d667098ea",
  "type": "button",
  "name": "Approve",
  "sequence": 1,
  "children": [
    {
      "id": "4953fad632eb4cf2a806de7d667098ea.1.1",
      "type": "eventNode",
      "name": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "4953fad632eb4cf2a806de7d667098ea.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "4953fad632eb4cf2a806de7d667098ea.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "4953fad632eb4cf2a806de7d667098ea.1.1.1.1.1",
                  ...
                  "children": [
                    {
                      "id": "9506371dc6dd46838910363c4b51835f.1.1.1.1.1.1",
                      "value": "",
                      "type": "screen",
                ...
                {
                  "id": "4953fad632eb4cf2a806de7d667098ea.1.1.1.1.2",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "refreshElement",
                ...
                {
                  "id": "4953fad632eb4cf2a806de7d667098ea.1.1.1.1.3",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "refreshElement",
                  ...
                  "children": [
                    {
                      "id": "e0abb5b5f6d949fa8b9e38f3f4741477|8cfd41ac08154260a70b7026e91727e3.1.1.1.1.3.1",
                      "value": "",
                      "type": "screen",
                ...
                {
                  "id": "4953fad632eb4cf2a806de7d667098ea.1.1.1.1.4",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "disableElement",
                  ...
                  "children": [
                    {
                      "id": "279c2b7585c947c9abdc712d6a18d6cc|f9c1f542ffb244dea049a6208ad4bec2.1.1.1.1.4.1",
                      "value": "",
                      "type": "screen",
                      "name": "Approval_Screen_Offsite.v1|offsite_approval_group|manager_comments",
                      "label": "|",
                      "key": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Approval_Screen_Offsite:AFVK:v1|offsite_approval_group|manager_comments",
                ...
                {
                  "id": "4953fad632eb4cf2a806de7d667098ea.1.1.1.1.5",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "disableElement",
                  ...
                  "children": [
                    {
                      "id": "279c2b7585c947c9abdc712d6a18d6cc|7adb497cc19543f99bbfc55627774228.1.1.1.1.5.1",
                      "value": "",
                      "type": "screen",
                ...
                {
                  "id": "4953fad632eb4cf2a806de7d667098ea.1.1.1.1.6",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "disableElement",
                  ...
                  "children": [
                    {
                      "id": "279c2b7585c947c9abdc712d6a18d6cc|4953fad632eb4cf2a806de7d667098ea.1.1.1.1.6.1",
                      "value": "",
                      "type": "screen",
                ...
                {
                  "id": "4953fad632eb4cf2a806de7d667098ea.1.1.1.1.7",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "refreshElement",
                  ...
                  "children": [
                    {
                      "id": "e0abb5b5f6d949fa8b9e38f3f4741477|2253d3b315914a749f8bbfdadea75ed7.1.1.1.1.7.1",
                      "value": "",
                      "type": "screen",
                      "name": "Dashboard_For_Manager.v1|manager_group|approvedcard",
                      "label": "|Approved",
                      "key": "CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:Dashboard_For_Manager:AFVK:v1|manager_group|approvedcard",
                      "elementType": "card",
                ...
                "params": [
                  {
                    ...
                    "_type": "string",
                    "selectionList": [],
                    "value": "Data Approve successfully",
                    "enabled": true
                  },
                  {
                    "name": "type",
  ...
  // saveHandler
        ...
        if(Array.isArray(offsite_approval_group8d6cc))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              ...
              controlId:"4953fad632eb4cf2a806de7d667098ea"
            };
            if (encryptionFlagCont) {
    ...
    ///////////////////////
    toast('Data Approve successfully', 'success');
    // refreshElement
    // for group
    ...
    setapprovedcard75ed7((pre:any)=>({...pre,refresh:!pre?.refresh}));
    handleDfdRefresh("approvedcard75ed7",1,10,encryptionFlagCompData)
    }
    catch(err:any)
    {
 ...
 if (approve098ea?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `20 / 22`,gridRow: `324 / 334`, gap:``, height: `100%`, overflow: 'auto'}} 
 >
        {showFlag && <Button 
          ref={buttonRef}
          className=""
          ...
          disabled= {approve098ea?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Approve")}
