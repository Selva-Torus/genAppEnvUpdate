 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    try{     
      ...
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "f8191cfbb8f0bd60326a5af144b53062"
      );
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "ok_button53062") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "f8191cfbb8f0bd60326a5af144b53062") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "ok_button53062");
    return () => {
  ...
  useEffect(()=>{
    if (!ok_button53062?.trigger) return;
      if(ok_button53062?.trigger){
      setok_button53062((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[ok_button53062?.trigger])

  useEffect(()=>{
    if(ok_button53062?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[ok_button53062?.refresh])
  ...
  async function handleSave3062_1_1_1(){
      

  setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    await delay(1000); 

    const group_deletee7496Props = group_deletee7496PropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.accessReqDocDelete_v1 || {}).some(val => {
    ...
    try{
      ...
      let mainData:any=structuredClone(group_deletee7496Ref.current);
      ...
      let lockedKeysLength:number;
        if(group_deletee7496?.upId === "" && (!lockedData?.data || Object.keys(lockedData?.data)?.length == 0)){
          throw 'Please give proper data';
        }
      let eventProperty :any = {
  "id": "f8191cfbb8f0bd60326a5af144b53062",
  "type": "button",
  "name": "ok_button",
  "label": "ok_button",
  "sequence": 1,
  "children": [
    {
      "id": "f8191cfbb8f0bd60326a5af144b53062.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "f8191cfbb8f0bd60326a5af144b53062.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "f8191cfbb8f0bd60326a5af144b53062.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "f8191cfbb8f0bd60326a5af144b53062.1.1.1.1.1",
                  "eventContext": "rise",
                  "value": "",
                  "type": "handlerNode",
                  "name": "closeHandler",
            ...
            {
              "id": "f8191cfbb8f0bd60326a5af144b53062.1.1.1.2",
      ...
      let sourceId : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:accessReqDocDelete:AFVK:v1";
      sourceId+= "|"+"58ae175d327ff504b15b255a09de7496";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:accessReqDocDelete:AFVK:v1"+"|"+"58ae175d327ff504b15b255a09de7496"+"|"+eventProperty.id;
      ...
      te_eventEmitterBody = {
        ...
        upId : group_deletee7496?.upId? [group_deletee7496?.upId ] : lockedData.processIds,
      ...
      if(Array.isArray(tableData) && hasValidupId){
        ...
        ...uf_initiatePf.data.nodeProperty,
        data:{"trs_event_process_status":uf_getPFDetails.status},
        upId : group_deletee7496?.upId? [group_deletee7496?.upId ] : upId,
        event : uf_initiatePf.data.eventProperty?.source?.status,
        sourceId : uf_initiatePf.data.eventProperty?.sourceId
      }}else{
        te_eventEmitterBody = {
        ...uf_initiatePf.data.nodeProperty,
        data:{"trs_event_process_status":uf_getPFDetails.status},
        upId : group_deletee7496?.upId? [group_deletee7496?.upId ] : group_deletee7496?.trs_process_id? [group_deletee7496?.trs_process_id ] : lockedData.processIds,
        event : uf_initiatePf.data.eventProperty?.source?.status,
        sourceId : uf_initiatePf.data.eventProperty?.sourceId,
        controlName: "ok_button"
      }
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...group_deletee7496Ref.current });
    let reworkKeys:any[]=[];
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"58ae175d327ff504b15b255a09de7496",
              controlId:"f8191cfbb8f0bd60326a5af144b53062"
            };
            if (encryptionFlagCont) {
    ...
    //eventEmitter
    if (group_deletee7496Props.ssKey !== '' && group_deletee7496Props.ssKey !== undefined) {
    te_eventEmitterBody["ssKey"] = group_deletee7496Props.ssKey;          
    }
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setgroup_deletee7496((prev: any) => ({ ...prev, ok_button: true }));
        //onClick

    //eventEmitter
    await handleSave3062_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setgroup_deletee7496((prev: any) => ({ ...prev, ok_button: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {ok_button53062?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
