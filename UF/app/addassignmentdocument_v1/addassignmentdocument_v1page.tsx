...
export default function PageAddassignmentdocumentV1() {
  ...
  const handleArtfactRule=async(rule:any,data:any={},allRuleData:any)=>{
    ...
    setaddassignmentdocument_v1({...result,_artfactPFRule_:rule})
  }
  ...
  useEffect(() => {    
    ...
    securityCheck();
    handleOnload();
    setaddassignmentdocument_v1(allRuleData)
  }, [])

  useEffect(()=>{
    if(addassignmentdocument_v1?._artfactPFRule_)
    {
      let data:any ={
        ...decodedTokenObj,
        session:decodedTokenObj,
      }
      handleArtfactRule(addassignmentdocument_v1?._artfactPFRule_,data,allRuleData)
    }
  },[])
  return (
    <>
