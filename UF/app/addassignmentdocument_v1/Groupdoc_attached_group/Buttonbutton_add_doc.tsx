...
const Buttonbutton_add_doc = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const doc_attached_groupbc2cfRef = useRef(doc_attached_groupbc2cf);
  useEffect(() => {
    doc_attached_groupbc2cfRef.current = doc_attached_groupbc2cf;
  ...
  const doc_attached_groupbc2cfPropsRef = useRef(doc_attached_groupbc2cfProps);
  useEffect(() => {
    doc_attached_groupbc2cfPropsRef.current = doc_attached_groupbc2cfProps;
  ...
  const handleMapper=async (data?:any) => {
    try{     
      data = {...data,...doc_attached_groupbc2cfRef.current};
      let parentRowSpan = 151;
      const orchestrationData : any = getControlOrchestrationData(
        controlData,
        "b85d8171ed243969ddd5e6b996fbc2cf",
        "7ef1bb0dbb67951ca685cecdd118e522"
      );
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "button_add_doc8e522") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "7ef1bb0dbb67951ca685cecdd118e522") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "button_add_doc8e522");
    return () => {
  ...
  useEffect(()=>{
    if (!button_add_doc8e522?.trigger) return;
      if(button_add_doc8e522?.trigger){
      setbutton_add_doc8e522((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[button_add_doc8e522?.trigger])

  useEffect(()=>{
    if(button_add_doc8e522?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[button_add_doc8e522?.refresh])
  ...
  async function handleSavee522_1_1_1(){

    setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    // await delay(1000); // RTGS New Payment: isProcessing turns false before API completion.

    const doc_attached_groupbc2cfProps = doc_attached_groupbc2cfPropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.addAssignmentDocument_v1 || {}).some(val => {
  ...
  return val === 'invalid';
    ...
    try{
      let mainData:any=structuredClone(doc_attached_groupbc2cfRef.current);
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:AMS:AFK:addAssignDocument:AFVK:v1|6859f478f5da4cc48edcda13756696b2"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:AMS:AFK:addAssignDocument:AFVK:v1|6859f478f5da4cc48edcda13756696b2"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "7ef1bb0dbb67951ca685cecdd118e522",
  "type": "button",
  "name": "button_add_doc",
  ...
  "children": [
    {
      "id": "7ef1bb0dbb67951ca685cecdd118e522.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "7ef1bb0dbb67951ca685cecdd118e522.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "7ef1bb0dbb67951ca685cecdd118e522.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "7ef1bb0dbb67951ca685cecdd118e522.1.1.1.1.1",
                  ...
                  "children": [
                    {
                      "id": "1cff839b6eae7947a9fa183da14392d0.1.1.1.1.1.1",
                      "value": "",
                      "type": "screen",
                      "name": "addAssignmentDocument.v1|doc_table",
                      "label": "addAssignmentDocument.v1|doc_table",
                      "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:addAssignmentDocument:AFVK:v1|doc_table",
                      "elementType": "group",
                      "groupType": "table",
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:AMS:AFK:addAssignDocument:AFVK:v1|6859f478f5da4cc48edcda13756696b2"
          ]
        }
      ]
    }
      ...
      let sourceId : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:addAssignmentDocument:AFVK:v1";
      sourceId+= "|"+"b85d8171ed243969ddd5e6b996fbc2cf";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:AMS:AFK:addAssignmentDocument:AFVK:v1"+"|"+"b85d8171ed243969ddd5e6b996fbc2cf"+"|"+eventProperty.id;
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...doc_attached_groupbc2cfRef.current, ...nullFilter(table_group75a5e) });
    let reworkKeys:any[]=[];
    ...
    if("_groupArrays_" in reworkedObject )
    {
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"b85d8171ed243969ddd5e6b996fbc2cf",
              controlId:"7ef1bb0dbb67951ca685cecdd118e522"
            };
            if (encryptionFlagCont) {
        ...
        if(doc_attached_groupbc2cf?.upId){
          te_saveBody['upId']= doc_attached_groupbc2cf?.upId;
        }
        if(doc_attached_groupbc2cf?.upid){
          te_saveBody['upId']= doc_attached_groupbc2cf?.upid;
        }
        ...
        if (doc_attached_groupbc2cfProps.ssKey !== '' && doc_attached_groupbc2cfProps.ssKey !== undefined) {
          te_saveBody["ssKey"] = doc_attached_groupbc2cfProps.ssKey;
    ...
    //riseListen
    // for group
    setdoc_table392d0Props((pre:any)=>({...pre,refresh:!pre?.refresh}));
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdoc_attached_groupbc2cf((prev: any) => ({ ...prev, button_add_doc: true }));
        //onClick

    //saveHandler
    await handleSavee522_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdoc_attached_groupbc2cf((prev: any) => ({ ...prev, button_add_doc: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
 ...
 if (button_add_doc8e522?.isHidden) {
    return <></>
  }

  return (
    <div
      style={{gridColumn: `22 / 25`,gridRow: `141 / 149`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          className="   "
          onClick={handleClick}
          view='action'
          disabled= {button_add_doc8e522?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Add Document")}
