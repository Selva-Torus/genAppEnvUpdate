...
const Buttonbutton_add_doc = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const doc_attached_groupd9ca3Ref = useRef(doc_attached_groupd9ca3);
  useEffect(() => {
    doc_attached_groupd9ca3Ref.current = doc_attached_groupd9ca3;
    if (!pendingAutoSearch.current) return;
      pendingAutoSearch.current = false;
      handleClick(false);
  }, [doc_attached_groupd9ca3]);
  
  //group props in ref to access latest props value
  const doc_attached_groupd9ca3PropsRef = useRef(doc_attached_groupd9ca3Props);
  useEffect(() => {
    doc_attached_groupd9ca3PropsRef.current = doc_attached_groupd9ca3Props;
  }, [doc_attached_groupd9ca3Props]);
  ...
  const handleMapper=async (data?:any) => {
    try{     
      data = {...data,...doc_attached_groupd9ca3Ref.current};
      let parentRowSpan = 161;
      const orchestrationData : any = getControlOrchestrationData(
        controlData,
        "1c6549bc3314b67fea47ba0463cd9ca3",
        "7f0a98458f44ef1e6f1a5d8b7a31ee80"
      );
  ...
  useEffect(()=>{
    ...
    const handler = async (id:any) => {
      if (id === "button_add_doc1ee80") {
        handleClick(false);
      }
    };
    const triggerElementHandler = async (id:any) => {
      if (id === "7f0a98458f44ef1e6f1a5d8b7a31ee80") {
        handleClick(false);
      }
    };
    eventBus.on("triggerButton", handler);
    eventBus.on("triggerElement|onClick", triggerElementHandler);
    eventBus.emit("buttonReady", "button_add_doc1ee80");
    return () => {
  ...
  useEffect(()=>{
    if (!button_add_doc1ee80?.trigger) return;
      if(button_add_doc1ee80?.trigger){
      setbutton_add_doc1ee80((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
        pendingAutoSearch.current = true;
      })();
    }
  },[button_add_doc1ee80?.trigger])

  useEffect(()=>{
    if(button_add_doc1ee80?.refresh){
    (async()=>{
      await handleMapper();
      pendingAutoSearch.current = true;
    })();
    }
  },[button_add_doc1ee80?.refresh])
  ...
  async function handleSaveee80_1_1_1(){
      

  setValidateRefetch((pre: any) => ({ ...pre, value: !pre.value, init: pre.init + 1 }));
    await delay(1000); 

    const doc_attached_groupd9ca3Props = doc_attached_groupd9ca3PropsRef.current;
  ...
  const hasInvalidField = Object.values(currentValidate?.accessRequestDocument_v1 || {}).some(val => {
    ...
    try{
      ...
      let mainData:any=structuredClone(doc_attached_groupd9ca3Ref.current);
      ...
      let tagetKey:string="CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:accessReqDocument:AFVK:v1|d39229e9d68dc41c4192ec17feb9ffbb"
      let uf_getPFDetails:any={
        key: "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:accessReqDocument:AFVK:v1|d39229e9d68dc41c4192ec17feb9ffbb"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty :any = {
  "id": "7f0a98458f44ef1e6f1a5d8b7a31ee80",
  "type": "button",
  "name": "button_add_doc",
  ...
  "children": [
    {
      "id": "7f0a98458f44ef1e6f1a5d8b7a31ee80.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "7f0a98458f44ef1e6f1a5d8b7a31ee80.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "7f0a98458f44ef1e6f1a5d8b7a31ee80.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "7f0a98458f44ef1e6f1a5d8b7a31ee80.1.1.1.1.3",
                  ...
                  "children": [
                    {
                      "id": "d902a9ff8e44f6c60f7ec1f0f80a9098.1.1.1.1.3.1",
                      "value": "",
                      "type": "screen",
                      "name": "accessRequestDocument.v1|request_doc_table",
                      "label": "accessRequestDocument.v1|request_doc_table",
                      "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:accessRequestDocument:AFVK:v1|request_doc_table",
                      "elementType": "group",
                      "groupType": "table",
                ...
                {
                  "id": "7f0a98458f44ef1e6f1a5d8b7a31ee80.1.1.1.1.4",
                  "eventContext": "riseListen",
                  "value": "",
                  "type": "handlerNode",
                  "name": "clearHandler",
                  ...
                  "children": [
                    {
                      "id": "1c6549bc3314b67fea47ba0463cd9ca3|b3bf1d59a8e68cb1b39449c99c6febb3.1.1.1.1.4.1",
                      "type": "documentuploadpanel",
                      "name": "accessRequestDocument|doc_attached_group|documentuploadpanel",
                      "label": "accessRequestDocument|doc_attached_group|documentuploadpanel",
                      "key": "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:accessRequestDocument:AFVK:v1|documentuploadpanel",
          ...
          "targetKey": [
            "CK:CT006:FNGK:AF:FNK:PF-PFD:CATK:ECP:AFGK:HRM:AFK:accessReqDocument:AFVK:v1|d39229e9d68dc41c4192ec17feb9ffbb"
          ]
        }
      ]
    }
      ...
      let sourceId : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:accessRequestDocument:AFVK:v1";
      sourceId+= "|"+"1c6549bc3314b67fea47ba0463cd9ca3";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT006:FNGK:AF:FNK:UF-UFW:CATK:ECP:AFGK:HRM:AFK:accessRequestDocument:AFVK:v1"+"|"+"1c6549bc3314b67fea47ba0463cd9ca3"+"|"+eventProperty.id;
  ...
  // saveHandler
    ...
    let reworkedObject:any = nullFilter({ ...doc_attached_groupd9ca3Ref.current, ...nullFilter(table_groupbcd33) });
    let reworkKeys:any[]=[];
    ...
    if("_groupArrays_" in reworkedObject )
    {
      ...
      if (uf_getPFDetails.key != undefined) {
        ...
        if(Array.isArray(reworkedObject))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"1c6549bc3314b67fea47ba0463cd9ca3",
              controlId:"7f0a98458f44ef1e6f1a5d8b7a31ee80"
            };
            if (encryptionFlagCont) {
        ...
        if(doc_attached_groupd9ca3?.upId){
          te_saveBody['upId']= doc_attached_groupd9ca3?.upId;
        }
        if(doc_attached_groupd9ca3?.upid){
          te_saveBody['upId']= doc_attached_groupd9ca3?.upid;
        }
        ...
        if (doc_attached_groupd9ca3Props.ssKey !== '' && doc_attached_groupd9ca3Props.ssKey !== undefined) {
          te_saveBody["ssKey"] = doc_attached_groupd9ca3Props.ssKey;
    ...
    //riseListen
    // for group
    setrequest_doc_tablea9098Props((pre:any)=>({...pre,refresh:!pre?.refresh}));
    ...
    // for controller
    // clearHandler riseListen
      setdoc_attached_groupd9ca3((pre:any)=>({...pre,documentuploadpanel:""}));
    }catch(err:any){
      savedData.current = {};
  ...
  const handleClick=async(showModal: boolean = true)=>{
    ...
    try{  
      setIsProcessing(true);
        setdoc_attached_groupd9ca3((prev: any) => ({ ...prev, button_add_doc: true }));
        //onClick

    //saveHandler
    await handleSaveee80_1_1_1();
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
        setdoc_attached_groupd9ca3((prev: any) => ({ ...prev, button_add_doc: false }));
      if(typeof err == 'string')
        toast(err, 'danger');
      else
 ...
 if (button_add_doc1ee80?.isHidden) {
    return <></>
  }
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {button_add_doc1ee80?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Add Document")}
