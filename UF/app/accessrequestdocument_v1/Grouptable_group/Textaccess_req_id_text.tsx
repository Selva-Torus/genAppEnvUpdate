...
const Textaccess_req_id_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[access_req_id_text12a0d?.refresh])

  if (access_req_id_text12a0d?.isHidden) {
    return <></>
  }
...
export default Textaccess_req_id_text
