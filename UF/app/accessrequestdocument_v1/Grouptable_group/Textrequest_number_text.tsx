...
const Textrequest_number_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[request_number_textdcd44?.refresh])

  if (request_number_textdcd44?.isHidden) {
    return <></>
  }
...
export default Textrequest_number_text
