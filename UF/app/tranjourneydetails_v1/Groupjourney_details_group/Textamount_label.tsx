...
const Textamount_label = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {amount_labelfd725Props, setamount_labelfd725Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
...
return (
  <div className="" style={{gridColumn: `1 / 13`,gridRow: `60 / 68`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-2"
