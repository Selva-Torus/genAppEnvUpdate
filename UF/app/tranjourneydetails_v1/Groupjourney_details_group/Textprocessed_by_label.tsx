...
const Textprocessed_by_label = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  const {processed_by_label542e8Props, setprocessed_by_label542e8Props} = useContext(TotalContext) as TotalContextProps;
  //////////////
...
return (
  <div className="" style={{gridColumn: `1 / 13`,gridRow: `24 / 32`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-3"
