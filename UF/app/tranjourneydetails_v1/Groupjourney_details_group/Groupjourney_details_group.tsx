...
import Textdr_account  from "./Textdr_account";
import Textcurrency_label  from "./Textcurrency_label";
import Textcredit_account_label  from "./Textcredit_account_label";
import Textdr_currency  from "./Textdr_currency";
import Textcr_account  from "./Textcr_account";
import Textamount_label  from "./Textamount_label";
import Textprocess_status_label  from "./Textprocess_status_label";
import Textcr_amount  from "./Textcr_amount";
import Textprocess_status  from "./Textprocess_status";
 ...
 /////////////
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("divider_top")){
        setdivider_tope6917((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(divider_tope6917?.isDisabled==null)
      {
        setdivider_tope6917((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("transaction_date_time_label")){
        settransaction_date_time_label669d7((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(transaction_date_time_label669d7?.isDisabled==null)
      {
        settransaction_date_time_label669d7((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("status_label")){
        setstatus_labelf3713((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(status_labelf3713?.isDisabled==null)
      {
        setstatus_labelf3713((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("transaction_date_time")){
        settransaction_date_time14856((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(transaction_date_time14856?.isDisabled==null)
      {
        settransaction_date_time14856((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("status")){
        setstatus88bc7((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(status88bc7?.isDisabled==null)
      {
        setstatus88bc7((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("processed_by_label")){
        setprocessed_by_label542e8((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(processed_by_label542e8?.isDisabled==null)
      {
        setprocessed_by_label542e8((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("debit_account_label")){
        setdebit_account_label3b1b7((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(debit_account_label3b1b7?.isDisabled==null)
      {
        setdebit_account_label3b1b7((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("processed_by")){
        setprocessed_byd2b69((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(processed_byd2b69?.isDisabled==null)
      {
        setprocessed_byd2b69((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("dr_account")){
        setdr_account36b40((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(dr_account36b40?.isDisabled==null)
      {
        setdr_account36b40((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("currency_label")){
        setcurrency_labele21ba((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(currency_labele21ba?.isDisabled==null)
      {
        setcurrency_labele21ba((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("credit_account_label")){
        setcredit_account_label65c7b((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(credit_account_label65c7b?.isDisabled==null)
      {
        setcredit_account_label65c7b((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("dr_currency")){
        setdr_currency9c8a2((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(dr_currency9c8a2?.isDisabled==null)
      {
        setdr_currency9c8a2((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("cr_account")){
        setcr_account0d1f4((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(cr_account0d1f4?.isDisabled==null)
      {
        setcr_account0d1f4((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("amount_label")){
        setamount_labelfd725((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(amount_labelfd725?.isDisabled==null)
      {
        setamount_labelfd725((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("process_status_label")){
        setprocess_status_labelb1ca9((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(process_status_labelb1ca9?.isDisabled==null)
      {
        setprocess_status_labelb1ca9((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("cr_amount")){
        setcr_amount01416((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(cr_amount01416?.isDisabled==null)
      {
        setcr_amount01416((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("process_status")){
        setprocess_status500d6((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(process_status500d6?.isDisabled==null)
      {
        setprocess_status500d6((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("divider_bottom")){
        setdivider_bottom8bad5((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(divider_bottom8bad5?.isDisabled==null)
      {
        setdivider_bottom8bad5((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("view_msg_data_btn")){
        setview_msg_data_btne6a88((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(view_msg_data_btne6a88?.isDisabled==null)
      {
        setview_msg_data_btne6a88((pre:any)=>({...pre,isDisabled:false}));
      }
    }
    if(orchestrationData?.data?.readableControls.includes("view_tran_log_btn")){
        setview_tran_log_btn9cd8c((pre:any)=>({...pre,isDisabled:true}));

    }else
    {
        if(view_tran_log_btn9cd8c?.isDisabled==null)
      {
        setview_tran_log_btn9cd8c((pre:any)=>({...pre,isDisabled:false}));
      }
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
        ...
        codeStates['dr_account'] = dr_account36b40,
        codeStates['setdr_account'] = setdr_account36b40,
        ...
        codeStates['dr_currency'] = dr_currency9c8a2,
        codeStates['setdr_currency'] = setdr_currency9c8a2,
        codeStates['cr_account'] = cr_account0d1f4,
        codeStates['setcr_account'] = setcr_account0d1f4,
        codeStates['amount_label'] = amount_labelfd725,
        codeStates['setamount_label'] = setamount_labelfd725,
        codeStates['process_status_label'] = process_status_labelb1ca9,
        codeStates['setprocess_status_label'] = setprocess_status_labelb1ca9,
        codeStates['cr_amount'] = cr_amount01416,
        codeStates['setcr_amount'] = setcr_amount01416,
        codeStates['process_status'] = process_status500d6,
        codeStates['setprocess_status'] = setprocess_status500d6,
    ...
    <div 
      ...
      className={`flex flex-col overflow-auto rounded-md  ${isDark ? 'text-white' : 'text-black'}`}
       onClick={(e:any)=>{e.stopPropagation()
        handleOnClick({}, 0);
          settranjourneydetails_v1((pre:any)=>({...pre,_selectedGroup_:"journey_details_group"}))
        }}
    >
        {allowedControls.includes("divider_top") ?<Dividerdivider_top   /* e6917 */checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
          ...
          {allowedControls.includes("dr_account") ?<Textdr_account   /* 36b40 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
          ...
          {allowedControls.includes("dr_currency") ?<Textdr_currency   /* 9c8a2 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
          {allowedControls.includes("cr_account") ?<Textcr_account   /* 0d1f4 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
          ...
          {allowedControls.includes("process_status_label") ?<Textprocess_status_label   /* b1ca9 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
          {allowedControls.includes("cr_amount") ?<Textcr_amount   /* 01416 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
          {allowedControls.includes("process_status") ?<Textprocess_status   /* 500d6 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
