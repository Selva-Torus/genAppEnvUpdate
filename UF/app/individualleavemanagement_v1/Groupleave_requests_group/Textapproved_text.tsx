...
const Textapproved_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[approved_text01cff?.refresh])

  if (approved_text01cff?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Approved This Month")}
</Text>
  </div>
  )
}

export default Textapproved_text
