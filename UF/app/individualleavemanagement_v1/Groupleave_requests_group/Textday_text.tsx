...
const Textday_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[day_text5965c?.refresh])

  if (day_text5965c?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 12`,gridRow: `16 / 22`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
