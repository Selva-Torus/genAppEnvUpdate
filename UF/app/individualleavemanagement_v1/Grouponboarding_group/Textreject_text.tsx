...
const Textreject_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[reject_text7fb06?.refresh])

  if (reject_text7fb06?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Rejected Requests")}
</Text>
  </div>
  )
}

export default Textreject_text
