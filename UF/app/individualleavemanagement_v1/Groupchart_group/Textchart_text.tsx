...
const Textchart_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[chart_textfde29?.refresh])

  if (chart_textfde29?.isHidden) {
    return <></>
  }
