...
const Textdays_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[days_text8f7e1?.refresh])

  if (days_text8f7e1?.isHidden) {
    return <></>
  }
