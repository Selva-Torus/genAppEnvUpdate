...
const Texttotal_leave_bal_text = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[total_leave_bal_textdb7dd?.refresh])

  if (total_leave_bal_textdb7dd?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 20`,gridRow: `4 / 10`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  ...
  color="primary"
>
      {keyset("Total Leave Balance")}
</Text>
  </div>
  )
}

export default Texttotal_leave_bal_text
