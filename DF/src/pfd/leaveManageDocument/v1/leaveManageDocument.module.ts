...
import { leaveManageDocumentController } from "./leaveManageDocument.controller";
...
@Module({
    imports: [TeModule],
    controllers: [leaveManageDocumentController],
...
export class leaveManageDocumentModule {}
