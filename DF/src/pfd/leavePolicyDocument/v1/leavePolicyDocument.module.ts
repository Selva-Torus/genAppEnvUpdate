...
import { leavePolicyDocumentController } from "./leavePolicyDocument.controller";
...
@Module({
    imports: [TeModule],
    controllers: [leavePolicyDocumentController],
...
export class leavePolicyDocumentModule {}
