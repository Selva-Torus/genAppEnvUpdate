...
import { accessRequestModifyController } from "./accessRequestModify.controller";
...
@Module({
    imports: [TeModule],
    controllers: [accessRequestModifyController],
...
export class accessRequestModifyModule {}
