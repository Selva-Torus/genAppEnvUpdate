...
import { addPerformanceCycleController } from "./addPerformanceCycle.controller";
...
@Module({
    imports: [TeModule],
    controllers: [addPerformanceCycleController],
...
export class addPerformanceCycleModule {}
