...
import { addCategoryDocumentController } from "./addCategoryDocument.controller";
...
@Module({
    imports: [TeModule],
    controllers: [addCategoryDocumentController],
...
export class addCategoryDocumentModule {}
