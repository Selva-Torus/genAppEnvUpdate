...
import { addPositionDocumentController } from "./addPositionDocument.controller";
...
@Module({
    imports: [TeModule],
    controllers: [addPositionDocumentController],
...
export class addPositionDocumentModule {}
