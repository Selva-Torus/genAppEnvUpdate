...
export class document_typesService {
 ...
 async findAllmethod(queryDto: any, limit:number, selectColumns:any, token:any, authContext?: any) {
  ...
  async create(createdocument_typesDto: Prisma.document_typesCreateInput,token:string,detokenize:string,detokenizeData?: any,authContext?: any) {
    try{
   ...
   */
  async createMaster(
    createdocument_typesDto: Prisma.document_typesCreateInput,
  ...
  async update(doc_type_id:number, updatedocument_typesDto: Prisma.document_typesUpdateInput,token:string, detokenize:string,detokenizeData?: any,authContext?: any) {   
    try{
...
/**
  ...
  async updateMaster(
doc_type_id:number,
    updatedocument_typesDto: Prisma.document_typesUpdateInput,
    ...
    try {
      ...
      if (workflowRole === 'AUTHORIZER') {
        ...
        if (!(await this.ufservice.hasCapability(token, 'document_types:AUTHORIZE'))) {
          throw new ForbiddenException('Caller is not entitled to authorize changes for document_types');
        }
