...
export class amr_review_sessionsService {
 ...
 async findAllmethod(queryDto: any, limit:number, selectColumns:any, token:any, authContext?: any) {
  ...
  async create(createamr_review_sessionsDto: Createamr_review_sessionsDto,token:string,detokenize:string,detokenizeData?: any,authContext?: any) {
    if (!authContext?.tenant) {
      throw new ForbiddenException('Tenant claim is missing from the token');
    }
    try{
   ...
   */
  async createMaster(
    createamr_review_sessionsDto: Createamr_review_sessionsDto,
  ...
  async update(review_id:number, updateamr_review_sessionsDto: Updateamr_review_sessionsDto,token:string, detokenize:string,detokenizeData?: any,authContext?: any) {   
    if (!authContext?.tenant) {
      throw new ForbiddenException('Tenant claim is missing from the token');
    }
    try{
...
/**
  ...
  async updateMaster(
review_id:number,
    updateamr_review_sessionsDto: Updateamr_review_sessionsDto,
