...
export class account_documentsService {
 ...
 async findAllmethod(queryDto: any, limit:number, selectColumns:any, token:any, authContext?: any) {
  ...
  async create(createaccount_documentsDto: Createaccount_documentsDto,token:string,detokenize:string,detokenizeData?: any,authContext?: any) {
    if (!authContext?.tenant) {
      throw new ForbiddenException('Tenant claim is missing from the token');
    }
    try{
   ...
   */
  async createMaster(
    createaccount_documentsDto: Createaccount_documentsDto,
  ...
  async update(doc_instance_id:number, updateaccount_documentsDto: Updateaccount_documentsDto,token:string, detokenize:string,detokenizeData?: any,authContext?: any) {   
    if (!authContext?.tenant) {
      throw new ForbiddenException('Tenant claim is missing from the token');
    }
    try{
...
doc_instance_id:number,
    updateaccount_documentsDto: Updateaccount_documentsDto,
