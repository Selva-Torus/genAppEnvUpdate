...
import { npss_customer_proxy } from '@prisma/client';
...
export class  npss_customer_proxyEntity implements npss_customer_proxy{
...
export class  npss_customer_proxy_OnlyParentEntity {
    @ApiProperty({example:"bigint"})
    npsscp_id:bigint;
    @ApiPropertyOptional({example:"string"})
    @IsOptional()
