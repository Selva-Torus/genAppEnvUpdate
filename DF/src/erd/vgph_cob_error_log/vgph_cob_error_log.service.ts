...
export class vgph_cob_error_logService {
 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
  ...
  async findOne(vgphcel_id:number,token : string) {
    try{
...
,vgphcel_id?:number) {
  ...
  async create(createvgph_cob_error_logDto: Prisma.vgph_cob_error_logCreateInput,token:string) {
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(createvgph_cob_error_logDto, 'vgph_cob_error_log', 'create'), token);
      const res = await this.prismaService.withConnection(() =>
   ...
   */
  async createMaster(
    createvgph_cob_error_logDto: Prisma.vgph_cob_error_logCreateInput,
  ...
  async update(vgphcel_id:number, updatevgph_cob_error_logDto: Prisma.vgph_cob_error_logUpdateInput,token:string) {   
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(updatevgph_cob_error_logDto,'vgph_cob_error_log','update'), token);
...
/**
  ...
  async updateMaster(
vgphcel_id:number,
    updatevgph_cob_error_logDto: Prisma.vgph_cob_error_logUpdateInput,
  ...
  async remove(vgphcel_id:number,token : string) {
    try{
