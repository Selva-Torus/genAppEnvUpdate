...
export class venue_special_rulesService {
 ...
 async findAllmethod(queryDto: any, limit:number, selectColumns:any, token:any, authContext?: any) {
  ...
  async create(createvenue_special_rulesDto: Createvenue_special_rulesDto,token:string,detokenize:string,detokenizeData?: any,authContext?: any) {
    if (!authContext?.tenant) {
      throw new ForbiddenException('Tenant claim is missing from the token');
    }
    try{
   ...
   */
  async createMaster(
    createvenue_special_rulesDto: Createvenue_special_rulesDto,
  ...
  async update(rule_id:number, updatevenue_special_rulesDto: Updatevenue_special_rulesDto,token:string, detokenize:string,detokenizeData?: any,authContext?: any) {   
    if (!authContext?.tenant) {
      throw new ForbiddenException('Tenant claim is missing from the token');
    }
    try{
...
/**
  ...
  async updateMaster(
rule_id:number,
    updatevenue_special_rulesDto: Updatevenue_special_rulesDto,
