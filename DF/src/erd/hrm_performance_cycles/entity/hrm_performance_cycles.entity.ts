...
import { hrm_performance_cycles } from '@prisma/client';
...
export class  hrm_performance_cyclesEntity implements hrm_performance_cycles{
...
export class  hrm_performance_cycles_OnlyParentEntity {
    @ApiProperty({example:"bigint"})
    cycle_id:bigint;
    @ApiProperty({example:"string"})
    cycle_code:string;
