...
,vgphcre_id?:number) {
  ...
  async create(createvgph_corporate_relationship_exceptionDto: Prisma.vgph_corporate_relationship_exceptionCreateInput,token:string) {
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(createvgph_corporate_relationship_exceptionDto, 'vgph_corporate_relationship_exception', 'create'), token);
      const res = await this.prismaService.withConnection(() =>
  ...
  async update(vgphcre_id:number, updatevgph_corporate_relationship_exceptionDto: Prisma.vgph_corporate_relationship_exceptionUpdateInput,token:string) {   
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(updatevgph_corporate_relationship_exceptionDto,'vgph_corporate_relationship_exception','update'), token);
