...
export class rejection_reason_lookupService {
 ...
 async findAllmethod(queryDto: any, limit:number, selectColumns:any, token:any, authContext?: any) {
  ...
  async create(createrejection_reason_lookupDto: Prisma.rejection_reason_lookupCreateInput,token:string,detokenize:string,detokenizeData?: any,authContext?: any) {
    try{
   ...
   */
  async createMaster(
    createrejection_reason_lookupDto: Prisma.rejection_reason_lookupCreateInput,
  ...
  async update(reason_id:number, updaterejection_reason_lookupDto: Prisma.rejection_reason_lookupUpdateInput,token:string, detokenize:string,detokenizeData?: any,authContext?: any) {   
    try{
...
/**
  ...
  async updateMaster(
reason_id:number,
    updaterejection_reason_lookupDto: Prisma.rejection_reason_lookupUpdateInput,
