...
export class wps_mohre_employee_dtlService {
 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
  ...
  async findOne(wpsmed_id:number,token : string) {
    try{
  ...
  async create(createwps_mohre_employee_dtlDto: Prisma.wps_mohre_employee_dtlCreateInput,token:string) {
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(createwps_mohre_employee_dtlDto, 'wps_mohre_employee_dtl', 'create'), token);
      const res = await this.prismaService.withConnection(() =>
   ...
   */
  async createMaster(
    createwps_mohre_employee_dtlDto: Prisma.wps_mohre_employee_dtlCreateInput,
  ...
  async update(wpsmed_id:number, updatewps_mohre_employee_dtlDto: Prisma.wps_mohre_employee_dtlUpdateInput,token:string) {   
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(updatewps_mohre_employee_dtlDto,'wps_mohre_employee_dtl','update'), token);
...
/**
  ...
  async updateMaster(
wpsmed_id:number,
    updatewps_mohre_employee_dtlDto: Prisma.wps_mohre_employee_dtlUpdateInput,
  ...
  async remove(wpsmed_id:number,token : string) {
    try{
