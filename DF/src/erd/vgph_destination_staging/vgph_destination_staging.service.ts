 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
  ...
  async create(createvgph_destination_stagingDto: Prisma.vgph_destination_stagingCreateInput,token:string) {
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(createvgph_destination_stagingDto, 'vgph_destination_staging', 'create'), token);
      const res = await this.prismaService.withConnection(() =>
  ...
  async update(vgphds_id:number,uuid: string, updatevgph_destination_stagingDto: Prisma.vgph_destination_stagingUpdateInput,token:string) {   
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(updatevgph_destination_stagingDto,'vgph_destination_staging','update'), token);
