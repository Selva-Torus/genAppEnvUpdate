...
import { npss_merchant_cashdesk } from '@prisma/client';
...
export class  npss_merchant_cashdeskEntity implements npss_merchant_cashdesk{
...
export class  npss_merchant_cashdesk_OnlyParentEntity {
    @ApiProperty({example:"bigint"})
    npssmc_id:bigint;
    @ApiProperty({example:"number"})
    npssms_id:number;
