 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
  ...
  async create(createvgph_source_tran_stagingDto: Prisma.vgph_source_tran_stagingCreateInput,token:string) {
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(createvgph_source_tran_stagingDto, 'vgph_source_tran_staging', 'create'), token);
      const res = await this.prismaService.withConnection(() =>
  ...
  async update(uuid: string, updatevgph_source_tran_stagingDto: Prisma.vgph_source_tran_stagingUpdateInput,token:string) {   
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(updatevgph_source_tran_stagingDto,'vgph_source_tran_staging','update'), token);
