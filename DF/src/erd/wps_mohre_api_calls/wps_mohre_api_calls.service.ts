 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
  ...
  async create(createwps_mohre_api_callsDto: Prisma.wps_mohre_api_callsCreateInput,token:string) {
    try{
      ...
      const encryptedData = await this.encryptData(createwps_mohre_api_callsDto, 'wps_mohre_api_calls', 'create');
      const res = await this.prismaService.withConnection(() =>
  ...
  async update(wpsm_id:number, updatewps_mohre_api_callsDto: Prisma.wps_mohre_api_callsUpdateInput,token:string) {   
    try{
      ...
      const encryptedData = await this.encryptData(updatewps_mohre_api_callsDto,'wps_mohre_api_calls','update');
