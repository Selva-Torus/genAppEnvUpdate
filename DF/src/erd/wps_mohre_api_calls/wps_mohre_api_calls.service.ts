...
export class wps_mohre_api_callsService {
 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
  ...
  async findOne(wpsm_id:number,token : string) {
    try{
  ...
  async create(createwps_mohre_api_callsDto: Prisma.wps_mohre_api_callsCreateInput,token:string) {
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(createwps_mohre_api_callsDto, 'wps_mohre_api_calls', 'create'), token);
      const res = await this.prismaService.withConnection(() =>
   ...
   */
  async createMaster(
    createwps_mohre_api_callsDto: Prisma.wps_mohre_api_callsCreateInput,
  ...
  async update(wpsm_id:number, updatewps_mohre_api_callsDto: Prisma.wps_mohre_api_callsUpdateInput,token:string) {   
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(updatewps_mohre_api_callsDto,'wps_mohre_api_calls','update'), token);
...
/**
  ...
  async updateMaster(
wpsm_id:number,
    updatewps_mohre_api_callsDto: Prisma.wps_mohre_api_callsUpdateInput,
  ...
  async remove(wpsm_id:number,token : string) {
    try{
