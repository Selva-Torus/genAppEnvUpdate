 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
  ...
  async create(createvgph_destination_tran_stagingDto: Prisma.vgph_destination_tran_stagingCreateInput,token:string) {
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(createvgph_destination_tran_stagingDto, 'vgph_destination_tran_staging', 'create'), token);
      const res = await this.prismaService.withConnection(() =>
  ...
  async update(vgphdts_id:number, updatevgph_destination_tran_stagingDto: Prisma.vgph_destination_tran_stagingUpdateInput,token:string) {   
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(updatevgph_destination_tran_stagingDto,'vgph_destination_tran_staging','update'), token);
