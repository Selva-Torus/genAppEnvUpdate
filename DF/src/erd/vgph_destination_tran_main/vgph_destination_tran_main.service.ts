...
,vgphdtm_id?:number) {
  ...
  async create(createvgph_destination_tran_mainDto: Prisma.vgph_destination_tran_mainCreateInput,token:string) {
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(createvgph_destination_tran_mainDto, 'vgph_destination_tran_main', 'create'), token);
      const res = await this.prismaService.withConnection(() =>
  ...
  async update(vgphdtm_id:number, updatevgph_destination_tran_mainDto: Prisma.vgph_destination_tran_mainUpdateInput,token:string) {   
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(updatevgph_destination_tran_mainDto,'vgph_destination_tran_main','update'), token);
