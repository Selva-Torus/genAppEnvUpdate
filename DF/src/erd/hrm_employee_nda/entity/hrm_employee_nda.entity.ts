...
import { hrm_employee_nda } from '@prisma/client';
...
export class  hrm_employee_ndaEntity implements hrm_employee_nda{
...
export class  hrm_employee_nda_OnlyParentEntity {
    @ApiProperty({example:"bigint"})
    nda_id:bigint;
    @ApiProperty({example:"string"})
    nda_number:string;
