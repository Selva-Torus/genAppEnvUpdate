...
export class activity_logService {
 ...
 async findAllmethod(queryDto: any, limit:number, selectColumns:any, token:any, authContext?: any) {
  ...
  async create(createactivity_logDto: Prisma.activity_logCreateInput,token:string,detokenize:string,detokenizeData?: any,authContext?: any) {
    try{
   ...
   */
  async createMaster(
    createactivity_logDto: Prisma.activity_logCreateInput,
  ...
  async update(activity_id:number, updateactivity_logDto: Prisma.activity_logUpdateInput,token:string, detokenize:string,detokenizeData?: any,authContext?: any) {   
    try{
...
/**
  ...
  async updateMaster(
activity_id:number,
    updateactivity_logDto: Prisma.activity_logUpdateInput,
