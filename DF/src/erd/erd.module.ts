...
@Module({
  imports: [vgph_source_mainModule,vgph_source_tran_mainModule,vgph_tran_dtl_mainModule,vgph_tran_log_mainModule,vgph_tran_error_log_mainModule,vgph_destination_mainModule,vgph_destination_tran_mainModule,vgph_nf_tran_mainModule,vgph_process_exception_mainModule,vgph_temp_mainModule,vgph_trn_secure_tokenModule,vgph_charge_tranModule,vgph_source_corporateModule,vgph_corporateModule,vgph_source_employeeModule,vgph_employeeModule,vgph_source_siModule,vgph_siModule,vgph_corporate_relationshipModule,vgph_corporate_relationship_exceptionModule,vgph_participant_bankModule,vgph_participant_branchModule,vgph_correspondent_bankModule,vgph_correspondent_exceptionModule,vgph_correspondent_nostroModule,vgph_holidayModule,vgph_clearing_holidayModule,vgph_clearing_sessionModule,vgph_participant_bank_statusModule,vgph_charge_setupModule,vgph_charge_configModule,vgph_charge_invoiceModule,vgph_beneficiaryModule,vgph_account_beneficiaryModule,vgph_source_stagingModule,vgph_source_tran_stagingModule,vgph_tran_dtl_stagingModule,vgph_destination_stagingModule,vgph_destination_tran_stagingModule,vgph_temp_stagingModule],
  controllers:[],
