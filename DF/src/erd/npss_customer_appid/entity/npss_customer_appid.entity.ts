...
import { npss_customer_appid } from '@prisma/client';
...
export class  npss_customer_appidEntity implements npss_customer_appid{
...
export class  npss_customer_appid_OnlyParentEntity {
    @ApiProperty({example:"bigint"})
    npsscapp_id:bigint;
    @ApiPropertyOptional({example:"number"})
    @IsOptional()
