 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
  ...
  async create(createvgph_tran_dtl_stagingDto: Prisma.vgph_tran_dtl_stagingCreateInput,token:string) {
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(createvgph_tran_dtl_stagingDto, 'vgph_tran_dtl_staging', 'create'), token);
      const res = await this.prismaService.withConnection(() =>
  ...
  async update(vgphtds_id:number, updatevgph_tran_dtl_stagingDto: Prisma.vgph_tran_dtl_stagingUpdateInput,token:string) {   
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(updatevgph_tran_dtl_stagingDto,'vgph_tran_dtl_staging','update'), token);
