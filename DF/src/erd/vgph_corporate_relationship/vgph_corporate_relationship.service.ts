...
,vgphcr_id?:number) {
  ...
  async create(createvgph_corporate_relationshipDto: Prisma.vgph_corporate_relationshipCreateInput,token:string) {
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(createvgph_corporate_relationshipDto, 'vgph_corporate_relationship', 'create'), token);
      const res = await this.prismaService.withConnection(() =>
  ...
  async update(vgphcr_id:number, updatevgph_corporate_relationshipDto: Prisma.vgph_corporate_relationshipUpdateInput,token:string) {   
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(updatevgph_corporate_relationshipDto,'vgph_corporate_relationship','update'), token);
