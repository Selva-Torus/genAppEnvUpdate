...
import { npss_sm_process_log } from '@prisma/client';
...
export class  npss_sm_process_logEntity implements npss_sm_process_log{
...
export class  npss_sm_process_log_OnlyParentEntity {
    @ApiProperty({example:"bigint"})
    npsssmpl_id:bigint;
    @ApiProperty({example:"string"})
    bankuserid:string;
