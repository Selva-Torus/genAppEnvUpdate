...
import { npss_merchant_accounts } from '@prisma/client';
...
export class  npss_merchant_accountsEntity implements npss_merchant_accounts{
...
export class  npss_merchant_accounts_OnlyParentEntity {
    @ApiProperty({example:"bigint"})
    npssma_id:bigint;
    @ApiProperty({example:"number"})
    npssmp_id:number;
