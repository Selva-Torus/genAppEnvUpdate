...
export class attorneysService {
 ...
 async findAllmethod(queryDto: any, limit:number, selectColumns:any, token:any, authContext?: any) {
  ...
  async create(createattorneysDto: Prisma.attorneysCreateInput,token:string,detokenize:string,detokenizeData?: any,authContext?: any) {
    try{
   ...
   */
  async createMaster(
    createattorneysDto: Prisma.attorneysCreateInput,
  ...
  async update(attorney_id:number, updateattorneysDto: Prisma.attorneysUpdateInput,token:string, detokenize:string,detokenizeData?: any,authContext?: any) {   
    try{
...
/**
  ...
  async updateMaster(
attorney_id:number,
    updateattorneysDto: Prisma.attorneysUpdateInput,
