...
export class vgph_destination_mainService {
 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
  ...
  async findOne(vgphdm_id:number,trs_tenant_id: string,trs_app_code: string,trs_product_code: string,uuid: string,token : string) {
    try{
      const res = await this.prismaService.withConnection(() =>
      this.prismaService.vgph_destination_main.findMany({ 
      where: {vgphdm_id,trs_tenant_id,trs_app_code,trs_product_code,uuid},
...
,vgphdm_id?:number) {
  ...
  async create(createvgph_destination_mainDto: Prisma.vgph_destination_mainCreateInput,token:string) {
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(createvgph_destination_mainDto, 'vgph_destination_main', 'create'), token);
      const res = await this.prismaService.withConnection(() =>
  ...
  async update(uuid: string, updatevgph_destination_mainDto: Prisma.vgph_destination_mainUpdateInput,token:string) {   
    try{
      ...
      const encryptedData = await this.normalizeDatesToUTC(await this.encryptData(updatevgph_destination_mainDto,'vgph_destination_main','update'), token);
